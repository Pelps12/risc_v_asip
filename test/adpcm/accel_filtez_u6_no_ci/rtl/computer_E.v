...
// bdlpars options:  -EE -DACCEL_ADPCM_FILTEZ -DACCEL_ADPCM_FILTEZ_U6 -info_base_name computer computer.cpp
// bdltran options:  -EE computer.IFF -c1000 -s -Zresource_fcnt=GENERATE -Zresource_mcnt=GENERATE -Zsync -Zdup_reset=YES -Zfolding_sharing=inter_stage -lb /proj/cad/cwb-6.1/packages/asic_45.BLIB -lfl /proj/cad/cwb-6.1/packages/asic_45.FLIB -o-P 
// timestamp_0: 20260830175950_10604_35134
// timestamp_5: 20260830175951_10618_90431
// timestamp_9: 20260830175951_10618_71975
// timestamp_C: 20260830175951_10618_30938
// timestamp_E: 20260830175952_10618_01140
// timestamp_V: 20260830175952_10634_77474
...
wire		JF_02 ;
wire		CT_01 ;
wire	[31:0]	RG_addr1_bpl_PC ;	// line#=computer.cpp:20,252,992
...
input		JF_02 ;
input		CT_01 ;
input	[31:0]	RG_addr1_bpl_PC ;	// line#=computer.cpp:20,252,992
wire		M_222 ;
wire		M_220 ;
wire		ST1_01d ;
wire		ST1_02d ;
...
assign	M_220 = ( JF_03 | ( ( ST1_05d & M_194 ) & ( ( RG_addr1_bpl_PC == 32'h00000001 ) | 
	( RG_addr1_bpl_PC == 32'h00000005 ) ) ) ) ;	// line#=computer.cpp:889,1015
assign	M_222 = ( ( ( ( ST1_05d & M_208 ) & ( RG_addr1_bpl_PC == 32'h00000000 ) ) | 
	...
	32'h00000004 ) ) | ( RG_addr1_bpl_PC == 32'h00000005 ) ) ) ) ;	// line#=computer.cpp:889,966,1059
always @ ( CT_01 )
	begin
...
always @ ( M_206 or M_194 or M_183 )	// line#=computer.cpp:889,894,903
	begin
...
always @ ( M_204 or M_257 or M_214 )	// line#=computer.cpp:889,894,903
	begin
...
always @ ( TR_18 or B01_streg_t6 or ST1_13d or ST1_11d or B01_streg_t5 or ST1_09d or 
	...
	B01_streg_t = ( ( { 4{ ST1_02d } } & B01_streg_t1 )
		...
		| ( { 4{ ST1_06d } } & B01_streg_t4 )	// line#=computer.cpp:889,894,903
		| ( { 4{ B01_streg_t_c1 } } & { 1'h1 , M_261 , 1'h0 } )
		| ( { 4{ ST1_09d } } & B01_streg_t5 )	// line#=computer.cpp:889,894,903
		| ( { 4{ ST1_11d } } & ST1_12 )
...
always @ ( posedge CLOCK )
	if ( RESET )
		...
		B01_streg <= B01_streg_t ;	// line#=computer.cpp:889,894,903
...
output		JF_02 ;
output		CT_01_port ;
output	[31:0]	RG_addr1_bpl_PC_port ;	// line#=computer.cpp:20,252,992
wire		M_256 ;
wire		M_255 ;
wire		M_254 ;
wire		M_253 ;
...
reg	[31:0]	RG_addr1_bpl_PC ;	// line#=computer.cpp:20,252,992
reg	FF_halt ;	// line#=computer.cpp:866
reg	[45:0]	RG_op2 ;	// line#=computer.cpp:1057
reg	[45:0]	RG_03 ;
reg	[31:0]	RL_bpl_addr_funct7_next_pc_op1 ;	// line#=computer.cpp:239,883,886,993
							// ,1014,1056,1058
...
reg	[45:0]	RG_bpl_dlt_funct7_rd ;	// line#=computer.cpp:252,254,879,883
reg	FF_take_1 ;	// line#=computer.cpp:934
reg	[15:0]	RG_rs2_word_addr ;	// line#=computer.cpp:189,882
reg	[15:0]	RG_14 ;
reg	[15:0]	RG_15 ;
reg	[15:0]	RG_16 ;
...
always @ ( posedge CLOCK )	// line#=computer.cpp:19
	if ( RESET )
		...
		regs_rg31 <= regs_wd03 ;
assign	CT_01 = ( ( ~FF_halt ) & ( ~|RG_addr1_bpl_PC [31:18] ) ) ;	// line#=computer.cpp:868
assign	CT_01_port = CT_01 ;
assign	CT_02 = ( ( ~|imem_arg_MEMB32W65536_RD1 [14:12] ) & ( ~|imem_arg_MEMB32W65536_RD1 [31:25] ) ) ;	// line#=computer.cpp:870,880,883,1113
always @ ( FF_take_1 )	// line#=computer.cpp:1020
	...
	default :
		TR_25 = 1'hx ;
	endcase
always @ ( dmem_arg_MEMB32W65536_RD1 or RL_bpl_addr_funct7_next_pc_op1 or RG_addr1_bpl_PC )	// line#=computer.cpp:966
	...
	32'h00000000 :
		...
		RL_bpl_addr_funct7_next_pc_op1 [7] , RL_bpl_addr_funct7_next_pc_op1 [7] , 
		RL_bpl_addr_funct7_next_pc_op1 [7] , RL_bpl_addr_funct7_next_pc_op1 [7] , 
		RL_bpl_addr_funct7_next_pc_op1 [7:0] } ;	// line#=computer.cpp:86,968
	32'h00000001 :
		...
		RL_bpl_addr_funct7_next_pc_op1 [15] , RL_bpl_addr_funct7_next_pc_op1 [15] , 
		RL_bpl_addr_funct7_next_pc_op1 [15] , RL_bpl_addr_funct7_next_pc_op1 [15] , 
		RL_bpl_addr_funct7_next_pc_op1 [15:0] } ;	// line#=computer.cpp:86,971
	32'h00000002 :
		val2_t4 = dmem_arg_MEMB32W65536_RD1 ;	// line#=computer.cpp:174,974
	32'h00000004 :
		val2_t4 = { 24'h000000 , RL_bpl_addr_funct7_next_pc_op1 [7:0] } ;	// line#=computer.cpp:142,977
	32'h00000005 :
		val2_t4 = { 16'h0000 , RL_bpl_addr_funct7_next_pc_op1 [15:0] } ;	// line#=computer.cpp:159,980
	default :
		val2_t4 = 32'h00000000 ;	// line#=computer.cpp:965
	endcase
assign	CT_23 = |RG_funct3_rd_rs2 ;	// line#=computer.cpp:894,903,912,923,983
					// ,1047,1093
always @ ( FF_take_1 or FF_take or RG_bpl_dlt_funct7_rd )	// line#=computer.cpp:935
...
assign	addsub32u1i1 = RG_addr1_bpl_PC ;	// line#=computer.cpp:110,904
assign	addsub32u1i2 = { RL_addr_dlt_addr_imm1_instr [24:5] , 12'h000 } ;	// line#=computer.cpp:110,904
...
assign	addsub32u_32_11i1 = RG_addr1_bpl_PC ;	// line#=computer.cpp:886
...
assign	imem_arg_MEMB32W65536_RA1 = RG_addr1_bpl_PC [17:2] ;	// line#=computer.cpp:870
assign	U_05 = ( ST1_03d & M_199 ) ;	// line#=computer.cpp:870,878,889
assign	U_06 = ( ST1_03d & M_197 ) ;	// line#=computer.cpp:870,878,889
assign	U_07 = ( ST1_03d & M_201 ) ;	// line#=computer.cpp:870,878,889
assign	U_08 = ( ST1_03d & M_203 ) ;	// line#=computer.cpp:870,878,889
assign	U_09 = ( ST1_03d & M_205 ) ;	// line#=computer.cpp:870,878,889
assign	U_10 = ( ST1_03d & M_190 ) ;	// line#=computer.cpp:870,878,889
assign	U_11 = ( ST1_03d & M_207 ) ;	// line#=computer.cpp:870,878,889
assign	U_12 = ( ST1_03d & M_195 ) ;	// line#=computer.cpp:870,878,889
assign	U_13 = ( ST1_03d & M_209 ) ;	// line#=computer.cpp:870,878,889
assign	U_15 = ( ST1_03d & M_184 ) ;	// line#=computer.cpp:870,878,889
assign	M_168 = ~|{ 29'h00000000 , imem_arg_MEMB32W65536_RD1 [14:12] } ;	// line#=computer.cpp:870,935,966,994
										// ,1015,1059
assign	M_174 = ~|( { 29'h00000000 , imem_arg_MEMB32W65536_RD1 [14:12] } ^ 32'h00000007 ) ;	// line#=computer.cpp:870,935,1015,1059
assign	M_178 = ~|( { 29'h00000000 , imem_arg_MEMB32W65536_RD1 [14:12] } ^ 32'h00000004 ) ;	// line#=computer.cpp:870,935,966,1015
												// ,1059
assign	M_180 = ~|( { 29'h00000000 , imem_arg_MEMB32W65536_RD1 [14:12] } ^ 32'h00000001 ) ;	// line#=computer.cpp:870,935,966,994
												// ,1015,1059
assign	M_185 = ~|( { 29'h00000000 , imem_arg_MEMB32W65536_RD1 [14:12] } ^ 32'h00000005 ) ;	// line#=computer.cpp:870,935,966,1015
												// ,1059
assign	M_192 = ~|( { 29'h00000000 , imem_arg_MEMB32W65536_RD1 [14:12] } ^ 32'h00000006 ) ;	// line#=computer.cpp:870,935,1015,1059
assign	U_25 = ( U_10 & M_168 ) ;	// line#=computer.cpp:870,966
assign	U_26 = ( U_10 & M_180 ) ;	// line#=computer.cpp:870,966
assign	U_28 = ( U_10 & M_178 ) ;	// line#=computer.cpp:870,966
assign	U_29 = ( U_10 & M_185 ) ;	// line#=computer.cpp:870,966
assign	M_171 = ~|( { 29'h00000000 , imem_arg_MEMB32W65536_RD1 [14:12] } ^ 32'h00000002 ) ;	// line#=computer.cpp:870,966,994,1015
												// ,1059
assign	U_32 = ( U_11 & M_180 ) ;	// line#=computer.cpp:870,994
assign	U_51 = ( U_15 & CT_02 ) ;	// line#=computer.cpp:1113
assign	U_52 = ( U_15 & ( ~CT_02 ) ) ;	// line#=computer.cpp:1113
assign	U_60 = ( ST1_04d & M_187 ) ;	// line#=computer.cpp:889
assign	U_61 = ( ST1_04d & M_206 ) ;	// line#=computer.cpp:889
assign	U_65 = ( ST1_04d & M_183 ) ;	// line#=computer.cpp:889
assign	M_176 = ~|( RG_07 ^ 32'h0000000f ) ;	// line#=computer.cpp:889,894,903,912
assign	M_183 = ~|( RG_07 ^ 32'h0000000b ) ;	// line#=computer.cpp:889,894,903,912
assign	M_183_port = M_183 ;
assign	M_187 = ~|( RG_07 ^ 32'h00000003 ) ;	// line#=computer.cpp:889,894,903,912
assign	M_196 = ~|( RG_07 ^ 32'h00000017 ) ;	// line#=computer.cpp:889,894,903,912
assign	M_198 = ~|( RG_07 ^ 32'h00000037 ) ;	// line#=computer.cpp:889,894,903,912
assign	M_200 = ~|( RG_07 ^ 32'h0000006f ) ;	// line#=computer.cpp:889,894,903,912
assign	M_202 = ~|( RG_07 ^ 32'h00000067 ) ;	// line#=computer.cpp:889,894,903,912
assign	M_204 = ~|( RG_07 ^ 32'h00000063 ) ;	// line#=computer.cpp:889,894,903,912
assign	M_204_port = M_204 ;
assign	M_206 = ~|( RG_07 ^ 32'h00000023 ) ;	// line#=computer.cpp:889,894,903,912
assign	M_206_port = M_206 ;
assign	M_208 = ~|( RG_07 ^ 32'h00000033 ) ;	// line#=computer.cpp:889,894,903,912
assign	M_208_port = M_208 ;
assign	M_210 = ~|( RG_07 ^ 32'h00000073 ) ;	// line#=computer.cpp:889,894,903,912
assign	M_172 = ~|( RG_addr1_bpl_PC ^ 32'h00000002 ) ;	// line#=computer.cpp:966,1015
assign	M_181 = ~|( RG_bpl_dlt_funct7_rd [31:0] ^ 32'h00000001 ) ;	// line#=computer.cpp:994
assign	U_83 = ( ST1_05d & M_187 ) ;	// line#=computer.cpp:889
assign	U_83_port = U_83 ;
assign	U_84 = ( ST1_05d & M_206 ) ;	// line#=computer.cpp:889
assign	M_194 = ~|( RG_07 ^ 32'h00000013 ) ;	// line#=computer.cpp:889,894,903,912
assign	M_194_port = M_194 ;
assign	U_88 = ( ST1_05d & M_183 ) ;	// line#=computer.cpp:889
assign	M_246 = ~( ( ( ( ( ( M_254 | M_206 ) | M_194 ) | M_208 ) | M_176 ) | M_183 ) | 
	M_210 ) ;	// line#=computer.cpp:889,894,903,912
assign	U_93 = ( U_84 & ( ~|RG_bpl_dlt_funct7_rd [31:0] ) ) ;	// line#=computer.cpp:994
assign	U_97 = ( U_88 & FF_take_1 ) ;	// line#=computer.cpp:1113
assign	U_98 = ( U_88 & ( ~FF_take_1 ) ) ;	// line#=computer.cpp:1113
assign	U_108 = ( ST1_06d & M_200 ) ;	// line#=computer.cpp:889
assign	U_113 = ( ST1_06d & M_194 ) ;	// line#=computer.cpp:889
assign	U_116 = ( ST1_06d & M_183 ) ;	// line#=computer.cpp:889
assign	M_170 = ~|RG_addr1_bpl_PC ;	// line#=computer.cpp:966,1015,1059
assign	M_179 = ~|( RG_addr1_bpl_PC ^ 32'h00000004 ) ;	// line#=computer.cpp:966,1015
assign	M_182 = ~|( RG_addr1_bpl_PC ^ 32'h00000001 ) ;	// line#=computer.cpp:966,1015,1059
assign	U_125 = ( U_113 & M_182 ) ;	// line#=computer.cpp:1015
assign	M_186 = ~|( RG_addr1_bpl_PC ^ 32'h00000005 ) ;	// line#=computer.cpp:966,1015,1059
assign	U_126 = ( U_113 & M_186 ) ;	// line#=computer.cpp:1015
assign	U_127 = ( U_126 & ( ~RL_addr_dlt_addr_imm1_instr [23] ) ) ;	// line#=computer.cpp:1038
assign	U_140 = ( ST1_08d & M_187 ) ;	// line#=computer.cpp:889
assign	U_142 = ( ST1_08d & M_194 ) ;	// line#=computer.cpp:889
assign	U_143 = ( ST1_08d & M_208 ) ;	// line#=computer.cpp:889
assign	U_145 = ( ST1_08d & M_183 ) ;	// line#=computer.cpp:889
assign	U_148 = ( U_140 & M_170 ) ;	// line#=computer.cpp:966
assign	U_149 = ( U_140 & M_182 ) ;	// line#=computer.cpp:966
assign	U_150 = ( U_140 & M_172 ) ;	// line#=computer.cpp:966
assign	U_151 = ( U_140 & M_179 ) ;	// line#=computer.cpp:966
assign	U_152 = ( U_140 & M_186 ) ;	// line#=computer.cpp:966
assign	U_154 = ( U_142 & M_170 ) ;	// line#=computer.cpp:1015
assign	U_157 = ( U_142 & M_179 ) ;	// line#=computer.cpp:1015
assign	M_193 = ~|( RG_addr1_bpl_PC ^ 32'h00000006 ) ;	// line#=computer.cpp:1015
assign	U_158 = ( U_142 & M_193 ) ;	// line#=computer.cpp:1015
assign	M_175 = ~|( RG_addr1_bpl_PC ^ 32'h00000007 ) ;	// line#=computer.cpp:1015
assign	U_159 = ( U_142 & M_175 ) ;	// line#=computer.cpp:1015
assign	U_161 = ( U_142 & M_186 ) ;	// line#=computer.cpp:1015
assign	U_162 = ( U_161 & FF_take_1 ) ;	// line#=computer.cpp:1038
assign	U_164 = ( U_142 & CT_23 ) ;	// line#=computer.cpp:1047
assign	U_169 = ( ST1_09d & M_202 ) ;	// line#=computer.cpp:889
assign	U_170 = ( ST1_09d & M_204 ) ;	// line#=computer.cpp:889
assign	U_174 = ( ST1_09d & M_208 ) ;	// line#=computer.cpp:889
assign	U_176 = ( ST1_09d & M_183 ) ;	// line#=computer.cpp:889
assign	U_179 = ( U_169 & CT_23 ) ;	// line#=computer.cpp:923
assign	U_186 = ( ( ST1_09d & M_187 ) & CT_23 ) ;	// line#=computer.cpp:889,983
assign	U_187 = ( U_174 & M_170 ) ;	// line#=computer.cpp:1059
assign	U_188 = ( U_174 & M_182 ) ;	// line#=computer.cpp:1059
assign	U_192 = ( U_174 & M_186 ) ;	// line#=computer.cpp:1059
assign	U_198 = ( U_192 & ( ~RL_addr_dlt_addr_imm1_instr [23] ) ) ;	// line#=computer.cpp:1080
assign	U_199 = ( U_174 & CT_23 ) ;	// line#=computer.cpp:1093
assign	U_200 = ( U_176 & FF_take_1 ) ;	// line#=computer.cpp:1113
assign	U_201 = ( U_176 & ( ~FF_take_1 ) ) ;	// line#=computer.cpp:1113
assign	U_221 = ( ST1_13d & M_183 ) ;	// line#=computer.cpp:889
assign	U_231 = ( ST1_14d & M_198 ) ;	// line#=computer.cpp:889
assign	U_232 = ( ST1_14d & M_196 ) ;	// line#=computer.cpp:889
assign	U_233 = ( ST1_14d & M_200 ) ;	// line#=computer.cpp:889
assign	U_235 = ( ST1_14d & M_204 ) ;	// line#=computer.cpp:889
assign	U_241 = ( ST1_14d & M_183 ) ;	// line#=computer.cpp:889
assign	U_244 = ( U_235 & take_t1 ) ;	// line#=computer.cpp:955
assign	U_256 = ( ST1_15d & M_183 ) ;	// line#=computer.cpp:889
assign	U_257 = ( ST1_15d & M_210 ) ;	// line#=computer.cpp:889
assign	U_258 = ( ST1_15d & M_246 ) ;	// line#=computer.cpp:889
assign	U_263 = ( M_215 & FF_take ) ;	// line#=computer.cpp:1113,1119
assign	M_227 = ( ( U_10 | U_12 ) | U_13 ) ;
always @ ( sub20u_184ot or U_65 or imem_arg_MEMB32W65536_RD1 or M_227 )
	TR_01 = ( ( { 16{ M_227 } } & { 13'h0000 , imem_arg_MEMB32W65536_RD1 [14:12] } )	// line#=computer.cpp:870,966,1015,1059
...
always @ ( add32s1ot or U_169 or TR_01 or M_231 )
	TR_02 = ( ( { 31{ M_231 } } & { 15'h0000 , TR_01 } )	// line#=computer.cpp:165,174,254,255,870
								// ,966,1015,1059
		| ( { 31{ U_169 } } & add32s1ot [31:1] )	// line#=computer.cpp:86,91,922
		) ;
always @ ( M_119_t or M_204 or RG_addr1_bpl_PC or M_202 or RL_bpl_addr_funct7_next_pc_op1 or 
	...
	RG_addr1_bpl_PC_t_c3 = ( ST1_15d & ( ( ( ( ( ( ( ( ( ( ( ST1_15d & M_198 ) | 
		...
		U_256 ) | U_257 ) | U_258 ) | ( ST1_15d & M_176 ) ) ) ;	// line#=computer.cpp:86,118,886,914
	RG_addr1_bpl_PC_t_c4 = ( ST1_15d & ( ST1_15d & M_202 ) ) ;	// line#=computer.cpp:86,91,922,925
	RG_addr1_bpl_PC_t_c5 = ( ST1_15d & ( ST1_15d & M_204 ) ) ;
	RG_addr1_bpl_PC_t = ( ( { 32{ U_11 } } & add32s1ot )					// line#=computer.cpp:86,97,992
		...
		| ( { 32{ RG_addr1_bpl_PC_t_c3 } } & RL_bpl_addr_funct7_next_pc_op1 )		// line#=computer.cpp:86,118,886,914
		| ( { 32{ RG_addr1_bpl_PC_t_c4 } } & { RG_addr1_bpl_PC [30:0] , 1'h0 } )	// line#=computer.cpp:86,91,922,925
...
assign	RG_addr1_bpl_PC_en = ( U_11 | RG_addr1_bpl_PC_t_c1 | RG_addr1_bpl_PC_t_c2 | 
	RG_addr1_bpl_PC_t_c3 | RG_addr1_bpl_PC_t_c4 | RG_addr1_bpl_PC_t_c5 ) ;	// line#=computer.cpp:889
always @ ( posedge CLOCK )	// line#=computer.cpp:889
	if ( RESET )
		...
		RG_addr1_bpl_PC <= RG_addr1_bpl_PC_t ;	// line#=computer.cpp:86,91,97,118,165
							// ,174,252,253,254,255,870,886,889
							// ,914,922,925,966,992,1015,1059
assign	RG_addr1_bpl_PC_port = RG_addr1_bpl_PC ;
assign	M_213 = ~|RG_bpl_dlt_funct7_rd [6:0] ;	// line#=computer.cpp:1113,1123
always @ ( U_258 or U_257 or M_213 or RG_funct3_rd_rs2 or FF_take_1 or U_256 )	// line#=computer.cpp:1113,1123
	begin
	FF_halt_t_c1 = ( ( ( ( U_256 & ( ~FF_take_1 ) ) & ( ~( ( ( ( ( ( ( ~|{ RG_funct3_rd_rs2 [2:1] , 
		...
		M_213 ) ) ) ) | U_257 ) | U_258 ) ;	// line#=computer.cpp:1176,1187,1196
	FF_halt_t = ( { 1{ FF_halt_t_c1 } } & 1'h1 )	// line#=computer.cpp:1176,1187,1196
		 ;	// line#=computer.cpp:866
	end
assign	FF_halt_en = ( ST1_01d | FF_halt_t_c1 ) ;	// line#=computer.cpp:1113,1123
always @ ( posedge CLOCK )	// line#=computer.cpp:1113,1123
	if ( FF_halt_en )
		FF_halt <= FF_halt_t ;	// line#=computer.cpp:866,1113,1123,1176
					// ,1187,1196
...
always @ ( RG_bpl_dlt_funct7_rd or U_84 or TR_20 or U_145 or U_65 or regs_rd00 or 
	...
	TR_03_c1 = ( U_65 | U_145 ) ;	// line#=computer.cpp:165,174,252,253,254
					// ,255
	TR_03 = ( ( { 32{ ST1_03d } } & regs_rd00 )		// line#=computer.cpp:1057
...
always @ ( add48s_461ot or ST1_07d or mul32s1ot or ST1_13d or ST1_11d or ST1_10d or 
	...
	RG_03_t = ( ( { 46{ ST1_02d } } & { 14'h0000 , addsub32u_32_11ot } )	// line#=computer.cpp:886
...
always @ ( posedge CLOCK )
	if ( RG_03_en )
		RG_03 <= RG_03_t ;	// line#=computer.cpp:256,886
always @ ( rsft32u1ot or U_151 or RG_bpl_dlt_funct7_rd or U_98 )
	TR_21 = ( ( { 8{ U_98 } } & { 1'h0 , RG_bpl_dlt_funct7_rd [6:0] } )
		| ( { 8{ U_151 } } & rsft32u1ot [7:0] )	// line#=computer.cpp:141,142,977
		) ;
assign	M_233 = ( U_98 | U_151 ) ;
always @ ( rsft32u1ot or U_152 or TR_21 or M_233 )
	TR_22 = ( ( { 16{ M_233 } } & { 8'h00 , TR_21 } )	// line#=computer.cpp:141,142,977
		| ( { 16{ U_152 } } & rsft32u1ot [15:0] )	// line#=computer.cpp:158,159,980
		) ;
always @ ( TR_22 or U_152 or M_233 or regs_rd00 or U_15 )
	begin
	TR_04_c1 = ( M_233 | U_152 ) ;	// line#=computer.cpp:141,142,158,159,977
					// ,980
	TR_04 = ( ( { 18{ U_15 } } & regs_rd00 [17:0] )		// line#=computer.cpp:1115,1116
		| ( { 18{ TR_04_c1 } } & { 2'h0 , TR_22 } )	// line#=computer.cpp:141,142,158,159,977
								// ,980
		) ;
	end
assign	M_228 = ( ( ( U_15 | U_98 ) | U_151 ) | U_152 ) ;
always @ ( add32s1ot or U_244 or TR_04 or M_228 )
	TR_05 = ( ( { 31{ M_228 } } & { 13'h0000 , TR_04 } )	// line#=computer.cpp:141,142,158,159,977
								// ,980,1115,1116
		| ( { 31{ U_244 } } & add32s1ot [31:1] )	// line#=computer.cpp:956
		) ;
always @ ( U_149 or rsft32u1ot or U_126 )
	TR_23 = ( ( { 16{ U_126 } } & rsft32u1ot [31:16] )	// line#=computer.cpp:1043
...
always @ ( U_148 or rsft32u1ot or TR_23 or U_149 or U_126 )
	begin
	TR_06_c1 = ( U_126 | U_149 ) ;	// line#=computer.cpp:86,158,159,971,1043
	TR_06 = ( ( { 24{ TR_06_c1 } } & { TR_23 , rsft32u1ot [15:8] } )	// line#=computer.cpp:86,158,159,971,1043
...
always @ ( add32s1ot or U_233 or addsub32u2ot or RL_addr_dlt_addr_imm1_instr or 
	...
	regs_rd02 or U_61 or TR_05 or U_244 or M_228 or regs_rd01 or U_13 )	// line#=computer.cpp:889,1061
	begin
	RL_bpl_addr_funct7_next_pc_op1_t_c1 = ( M_228 | U_244 ) ;	// line#=computer.cpp:141,142,158,159,956
									// ,977,980,1115,1116
	RL_bpl_addr_funct7_next_pc_op1_t_c2 = ( ( ( ST1_05d & M_204 ) | U_83 ) | 
		ST1_09d ) ;	// line#=computer.cpp:142,159,886,968,971
				// ,977,980
	RL_bpl_addr_funct7_next_pc_op1_t_c3 = ( ( U_126 | U_148 ) | U_149 ) ;	// line#=computer.cpp:86,141,142,158,159
										// ,968,971,1043
	RL_bpl_addr_funct7_next_pc_op1_t_c4 = ( U_143 & RL_addr_dlt_addr_imm1_instr [23] ) ;	// line#=computer.cpp:1062
	RL_bpl_addr_funct7_next_pc_op1_t = ( ( { 32{ U_13 } } & regs_rd01 )				// line#=computer.cpp:1056
		| ( { 32{ RL_bpl_addr_funct7_next_pc_op1_t_c1 } } & { 1'h0 , TR_05 } )			// line#=computer.cpp:141,142,158,159,956
													// ,977,980,1115,1116
		| ( { 32{ U_61 } } & regs_rd02 )							// line#=computer.cpp:993
		| ( { 32{ RL_bpl_addr_funct7_next_pc_op1_t_c2 } } & RG_bpl_dlt_funct7_rd [31:0] )	// line#=computer.cpp:142,159,886,968,971
													// ,977,980
		| ( { 32{ U_125 } } & lsft32u1ot )							// line#=computer.cpp:1035
		| ( { 32{ RL_bpl_addr_funct7_next_pc_op1_t_c3 } } & { TR_06 , rsft32u1ot [7:0] } )	// line#=computer.cpp:86,141,142,158,159
													// ,968,971,1043
		| ( { 32{ RL_bpl_addr_funct7_next_pc_op1_t_c4 } } & addsub32u2ot )			// line#=computer.cpp:1062
		| ( { 32{ U_233 } } & add32s1ot )							// line#=computer.cpp:86,118,914
		) ;
	end
assign	RL_bpl_addr_funct7_next_pc_op1_en = ( U_13 | RL_bpl_addr_funct7_next_pc_op1_t_c1 | 
	...
	RL_bpl_addr_funct7_next_pc_op1_t_c4 | U_233 ) ;	// line#=computer.cpp:889,1061
always @ ( posedge CLOCK )	// line#=computer.cpp:889,1061
	if ( RL_bpl_addr_funct7_next_pc_op1_en )
		RL_bpl_addr_funct7_next_pc_op1 <= RL_bpl_addr_funct7_next_pc_op1_t ;	// line#=computer.cpp:86,118,141,142,158
											// ,159,886,889,914,956,968,971,977
											// ,980,993,1035,1043,1056,1061
											// ,1062,1115,1116
assign	M_223 = ( regs_rd00 ^ regs_rd01 ) ;	// line#=computer.cpp:937,940
always @ ( imem_arg_MEMB32W65536_RD1 or U_15 or M_223 or U_09 )
	FF_take_t = ( ( { 1{ U_09 } } & ( ~|M_223 ) )				// line#=computer.cpp:937
		| ( { 1{ U_15 } } & ( |imem_arg_MEMB32W65536_RD1 [11:7] ) )	// line#=computer.cpp:870,879,1119
		) ;
assign	FF_take_en = ( U_09 | U_15 ) ;
always @ ( posedge CLOCK )
	if ( FF_take_en )
		FF_take <= FF_take_t ;	// line#=computer.cpp:870,879,937,1119
...
always @ ( M_205 or M_203 or M_201 or M_197 or M_199 or M_209 or M_185 or imem_arg_MEMB32W65536_RD1 or 
	...
	TR_07_c1 = ( ( ( ( M_195 & M_168 ) | ( M_195 & M_178 ) ) | ( M_195 & M_192 ) ) | 
		( M_195 & M_174 ) ) ;	// line#=computer.cpp:86,91,870,1012
	TR_07_c2 = ( ( ( ( ( ( ( M_195 & M_185 ) | M_209 ) | M_199 ) | M_197 ) | 
		M_201 ) | M_203 ) | M_205 ) ;	// line#=computer.cpp:870
...
always @ ( regs_rd02 or U_65 or addsub32u_322ot or U_11 or add32s1ot or U_10 )
	TR_08 = ( ( { 18{ U_10 } } & add32s1ot [17:0] )				// line#=computer.cpp:86,91,964
		| ( { 18{ U_11 } } & { 2'h0 , addsub32u_322ot [17:2] } )	// line#=computer.cpp:199,208
		| ( { 18{ U_65 } } & regs_rd02 [17:0] )				// line#=computer.cpp:1115,1116
		) ;
always @ ( TR_08 or U_65 or U_11 or U_10 or TR_07 or imem_arg_MEMB32W65536_RD1 or 
	...
	M_178 or M_168 or U_12 )	// line#=computer.cpp:870,1015
	begin
	...
	RL_addr_dlt_addr_imm1_instr_t_c2 = ( ( U_10 | U_11 ) | U_65 ) ;	// line#=computer.cpp:86,91,199,208,964
									// ,1115,1116
	RL_addr_dlt_addr_imm1_instr_t = ( ( { 25{ RL_addr_dlt_addr_imm1_instr_t_c1 } } & 
		...
		| ( { 25{ RL_addr_dlt_addr_imm1_instr_t_c2 } } & { 7'h00 , TR_08 } )	// line#=computer.cpp:86,91,199,208,964
											// ,1115,1116
		) ;
	end
assign	RL_addr_dlt_addr_imm1_instr_en = ( RL_addr_dlt_addr_imm1_instr_t_c1 | RL_addr_dlt_addr_imm1_instr_t_c2 ) ;	// line#=computer.cpp:870,1015
...
always @ ( RG_bpl_dlt_funct7_rd or ST1_04d or U_52 or imem_arg_MEMB32W65536_RD1 or 
	...
	begin
	RG_funct3_rd_rs2_t_c1 = ( ( U_12 | U_11 ) | U_51 ) ;	// line#=computer.cpp:870,882
	RG_funct3_rd_rs2_t = ( ( { 5{ RG_funct3_rd_rs2_t_c1 } } & imem_arg_MEMB32W65536_RD1 [24:20] )	// line#=computer.cpp:870,882
		| ( { 5{ U_52 } } & { 2'h0 , imem_arg_MEMB32W65536_RD1 [14:12] } )			// line#=computer.cpp:870,880
		| ( { 5{ ST1_04d } } & RG_bpl_dlt_funct7_rd [4:0] ) ) ;
	end
assign	RG_funct3_rd_rs2_en = ( RG_funct3_rd_rs2_t_c1 | U_52 | ST1_04d ) ;
always @ ( posedge CLOCK )
	if ( RG_funct3_rd_rs2_en )
		RG_funct3_rd_rs2 <= RG_funct3_rd_rs2_t ;	// line#=computer.cpp:870,880,882
assign	M_255 = ( ( ( ( M_199 | M_197 ) | M_201 ) | M_203 ) | M_190 ) ;	// line#=computer.cpp:870,878,889
always @ ( M_207 or M_205 or imem_arg_MEMB32W65536_RD1 or M_218 or M_209 or M_195 or 
	M_255 )
	begin
	TR_09_c1 = ( ( ( M_255 | M_195 ) | M_209 ) | M_218 ) ;	// line#=computer.cpp:870,879
	TR_09_c2 = ( M_205 | M_207 ) ;	// line#=computer.cpp:870,935,994
	TR_09 = ( ( { 5{ TR_09_c1 } } & imem_arg_MEMB32W65536_RD1 [11:7] )		// line#=computer.cpp:870,879
		| ( { 5{ TR_09_c2 } } & { 2'h0 , imem_arg_MEMB32W65536_RD1 [14:12] } )	// line#=computer.cpp:870,935,994
		) ;
	end
assign	M_225 = ( ( ( ( ( ( ( ( U_05 | U_06 ) | U_07 ) | U_08 ) | U_10 ) | U_12 ) | 
	U_13 ) | U_51 ) | ( U_09 | U_11 ) ) ;	// line#=computer.cpp:966
always @ ( RL_bpl_addr_funct7_next_pc_op1 or U_201 or imem_arg_MEMB32W65536_RD1 or 
	U_52 or TR_09 or M_225 )
	TR_10 = ( ( { 7{ M_225 } } & { 2'h0 , TR_09 } )			// line#=computer.cpp:870,879,935,994
		| ( { 7{ U_52 } } & imem_arg_MEMB32W65536_RD1 [31:25] )	// line#=computer.cpp:870,883
		| ( { 7{ U_201 } } & RL_bpl_addr_funct7_next_pc_op1 [6:0] ) ) ;
assign	M_229 = ( ( M_225 | U_52 ) | U_201 ) ;	// line#=computer.cpp:966
assign	M_230 = ( ( ( ( U_60 & M_170 ) | ( U_60 & M_182 ) ) | ( U_60 & M_179 ) ) | 
	( U_60 & M_186 ) ) ;	// line#=computer.cpp:966
always @ ( RL_bpl_addr_funct7_next_pc_op1 or U_170 or RG_03 or ST1_05d or dmem_arg_MEMB32W65536_RD1 or 
	...
	TR_11 = ( ( { 32{ M_229 } } & { 25'h0000000 , TR_10 } )		// line#=computer.cpp:870,879,883,935,994
		| ( { 32{ M_230 } } & dmem_arg_MEMB32W65536_RD1 )	// line#=computer.cpp:142,159,968,971,977
									// ,980
		| ( { 32{ ST1_05d } } & RG_03 [31:0] )			// line#=computer.cpp:886
...
always @ ( add48s_462ot or ST1_14d or ST1_12d or RG_03 or ST1_11d or ST1_10d or 
	...
	M_230 or M_229 )	// line#=computer.cpp:966
	begin
	RG_bpl_dlt_funct7_rd_t_c1 = ( ( ( M_229 | M_230 ) | ST1_05d ) | U_170 ) ;	// line#=computer.cpp:142,159,870,879,883
											// ,886,935,968,971,977,980,994
	...
	RG_bpl_dlt_funct7_rd_t = ( ( { 46{ RG_bpl_dlt_funct7_rd_t_c1 } } & { 14'h0000 , 
			TR_11 } )							// line#=computer.cpp:142,159,870,879,883
											// ,886,935,968,971,977,980,994
...
assign	RG_bpl_dlt_funct7_rd_en = ( RG_bpl_dlt_funct7_rd_t_c1 | RG_bpl_dlt_funct7_rd_t_c2 | 
	RG_bpl_dlt_funct7_rd_t_c3 | RG_bpl_dlt_funct7_rd_t_c4 ) ;	// line#=computer.cpp:966
always @ ( posedge CLOCK )	// line#=computer.cpp:966
	if ( RG_bpl_dlt_funct7_rd_en )
		RG_bpl_dlt_funct7_rd <= RG_bpl_dlt_funct7_rd_t ;	// line#=computer.cpp:142,159,174,252,253
									// ,254,255,256,870,879,883,886,935
									// ,966,968,971,977,980,994
assign	M_188 = ~|( { 29'h00000000 , imem_arg_MEMB32W65536_RD1 [14:12] } ^ 32'h00000003 ) ;	// line#=computer.cpp:870,1015,1059
always @ ( take_t1 or U_235 or M_196 or M_198 or ST1_13d or RL_addr_dlt_addr_imm1_instr or 
	...
	M_223 or M_180 or U_09 )	// line#=computer.cpp:870,889,935,1015
					// ,1059
	begin
	FF_take_1_t_c1 = ( U_09 & M_180 ) ;	// line#=computer.cpp:940
	FF_take_1_t_c2 = ( U_09 & M_178 ) ;	// line#=computer.cpp:943
	FF_take_1_t_c3 = ( U_09 & M_185 ) ;	// line#=computer.cpp:946
	FF_take_1_t_c4 = ( U_09 & M_192 ) ;	// line#=computer.cpp:949
	FF_take_1_t_c5 = ( U_09 & M_174 ) ;	// line#=computer.cpp:952
	FF_take_1_t_c6 = ( U_12 & M_171 ) ;	// line#=computer.cpp:1020
	FF_take_1_t_c7 = ( U_12 & M_188 ) ;	// line#=computer.cpp:1023
	FF_take_1_t_c8 = ( U_13 & M_171 ) ;	// line#=computer.cpp:1071
	FF_take_1_t_c9 = ( U_13 & M_188 ) ;	// line#=computer.cpp:1074
	FF_take_1_t_c10 = ( ST1_05d & M_200 ) ;	// line#=computer.cpp:894,912
	FF_take_1_t_c11 = ( U_126 | U_143 ) ;	// line#=computer.cpp:1038,1061
	FF_take_1_t_c12 = ( ST1_13d & M_198 ) ;	// line#=computer.cpp:894,912
	FF_take_1_t_c13 = ( ST1_13d & M_196 ) ;	// line#=computer.cpp:903
	FF_take_1_t = ( ( { 1{ FF_take_1_t_c1 } } & ( |M_223 ) )			// line#=computer.cpp:940
		| ( { 1{ FF_take_1_t_c2 } } & comp32s_12ot [3] )			// line#=computer.cpp:943
		| ( { 1{ FF_take_1_t_c3 } } & comp32s_12ot [0] )			// line#=computer.cpp:946
		| ( { 1{ FF_take_1_t_c4 } } & comp32u_11ot [3] )			// line#=computer.cpp:949
		| ( { 1{ FF_take_1_t_c5 } } & comp32u_11ot [0] )			// line#=computer.cpp:952
		| ( { 1{ FF_take_1_t_c6 } } & comp32s_1_11ot [3] )			// line#=computer.cpp:1020
		| ( { 1{ FF_take_1_t_c7 } } & comp32u_13ot [3] )			// line#=computer.cpp:1023
		| ( { 1{ FF_take_1_t_c8 } } & comp32s_11ot [3] )			// line#=computer.cpp:1071
		| ( { 1{ FF_take_1_t_c9 } } & comp32u_12ot [3] )			// line#=computer.cpp:1074
		| ( { 1{ U_15 } } & CT_02 )						// line#=computer.cpp:1113
		| ( { 1{ FF_take_1_t_c10 } } & CT_23 )					// line#=computer.cpp:894,912
		| ( { 1{ FF_take_1_t_c11 } } & RL_addr_dlt_addr_imm1_instr [23] )	// line#=computer.cpp:1038,1061
		| ( { 1{ FF_take_1_t_c12 } } & CT_23 )					// line#=computer.cpp:894,912
		| ( { 1{ FF_take_1_t_c13 } } & CT_23 )					// line#=computer.cpp:903
		| ( { 1{ U_235 } } & take_t1 )						// line#=computer.cpp:955
		) ;
	end
assign	FF_take_1_en = ( FF_take_1_t_c1 | FF_take_1_t_c2 | FF_take_1_t_c3 | FF_take_1_t_c4 | 
	...
	U_235 ) ;	// line#=computer.cpp:870,889,935,1015
			// ,1059
always @ ( posedge CLOCK )	// line#=computer.cpp:870,889,935,1015
				// ,1059
	if ( FF_take_1_en )
		FF_take_1 <= FF_take_1_t ;	// line#=computer.cpp:870,889,894,903,912
						// ,935,940,943,946,949,952,955
						// ,1015,1020,1023,1038,1059,1061
						// ,1071,1074,1113
always @ ( sub20u_182ot or U_88 or sub20u_183ot or U_65 or addsub32u_321ot or U_61 or 
	RG_funct3_rd_rs2 or M_194 or ST1_04d )	// line#=computer.cpp:889
	begin
...
assign	RG_rs2_word_addr_en = ( RG_rs2_word_addr_t_c1 | U_61 | U_65 | U_88 ) ;	// line#=computer.cpp:889
always @ ( posedge CLOCK )	// line#=computer.cpp:889
...
assign	M_190 = ~|( { 25'h0000000 , imem_arg_MEMB32W65536_RD1 [6:0] } ^ 32'h00000003 ) ;	// line#=computer.cpp:870,878,889
assign	M_195 = ~|( { 25'h0000000 , imem_arg_MEMB32W65536_RD1 [6:0] } ^ 32'h00000013 ) ;	// line#=computer.cpp:870,878,889
assign	M_197 = ~|( { 25'h0000000 , imem_arg_MEMB32W65536_RD1 [6:0] } ^ 32'h00000017 ) ;	// line#=computer.cpp:870,878,889
assign	M_199 = ~|( { 25'h0000000 , imem_arg_MEMB32W65536_RD1 [6:0] } ^ 32'h00000037 ) ;	// line#=computer.cpp:870,878,889
assign	M_201 = ~|( { 25'h0000000 , imem_arg_MEMB32W65536_RD1 [6:0] } ^ 32'h0000006f ) ;	// line#=computer.cpp:870,878,889
assign	M_203 = ~|( { 25'h0000000 , imem_arg_MEMB32W65536_RD1 [6:0] } ^ 32'h00000067 ) ;	// line#=computer.cpp:870,878,889
assign	M_205 = ~|( { 25'h0000000 , imem_arg_MEMB32W65536_RD1 [6:0] } ^ 32'h00000063 ) ;	// line#=computer.cpp:870,878,889
assign	M_207 = ~|( { 25'h0000000 , imem_arg_MEMB32W65536_RD1 [6:0] } ^ 32'h00000023 ) ;	// line#=computer.cpp:870,878,889
assign	M_209 = ~|( { 25'h0000000 , imem_arg_MEMB32W65536_RD1 [6:0] } ^ 32'h00000033 ) ;	// line#=computer.cpp:870,878,889
assign	JF_02 = ( ( ( ( M_255 | M_207 ) | M_195 ) | M_209 ) | M_218 ) ;	// line#=computer.cpp:870,878,889
always @ ( RG_bpl_dlt_funct7_rd or M_206 or M_214 or CT_23 or M_200 )	// line#=computer.cpp:894,912
	begin
	JF_03_c1 = ( ( M_200 & CT_23 ) | M_214 ) ;
	JF_03 = ( ( { 1{ JF_03_c1 } } & 1'h1 )
		| ( { 1{ M_206 } } & ( RG_bpl_dlt_funct7_rd [31:0] == 32'h00000000 ) )	// line#=computer.cpp:994
		) ;
	end
always @ ( RG_bpl_dlt_funct7_rd or M_206 or M_194 )
	JF_06 = ( ( { 1{ M_194 } } & 1'h1 )
		| ( { 1{ M_206 } } & ( RG_bpl_dlt_funct7_rd [31:0] == 32'h00000002 ) )	// line#=computer.cpp:994
		) ;
assign	M_214 = ( M_183 & FF_take_1 ) ;	// line#=computer.cpp:912
assign	M_214_port = M_214 ;
assign	M_250 = ( M_183 & ( ~FF_take_1 ) ) ;	// line#=computer.cpp:912
assign	M_257 = ( M_198 | M_196 ) ;	// line#=computer.cpp:889,894,903,912
...
always @ ( RG_bpl_dlt_funct7_rd or M_206 or M_246 or M_210 or M_250 or M_176 or 
	...
	JF_08 = ( ( { 1{ JF_08_c1 } } & 1'h1 )
		| ( { 1{ M_206 } } & ( ~( ( RG_bpl_dlt_funct7_rd [31:0] == 32'h00000000 ) | 
			( RG_bpl_dlt_funct7_rd [31:0] == 32'h00000002 ) ) ) )	// line#=computer.cpp:994
		) ;
	end
assign	M_254 = ( ( ( ( M_257 | M_200 ) | M_202 ) | M_204 ) | M_187 ) ;	// line#=computer.cpp:889,894,903,912
assign	JF_15 = ( ( ( M_198 & CT_23 ) | ( M_196 & CT_23 ) ) | M_183 ) ;	// line#=computer.cpp:889,894,903,912
always @ ( RG_addr1_bpl_PC or RL_bpl_addr_funct7_next_pc_op1 or FF_take_1 )	// line#=computer.cpp:955
	begin
...
always @ ( RG_addr1_bpl_PC or U_233 or U_244 or regs_rd02 or U_169 or U_154 or regs_rd00 or 
	M_226 )
	begin
	add32s1i1_c1 = ( U_154 | U_169 ) ;	// line#=computer.cpp:86,91,922,1017
	add32s1i1_c2 = ( U_244 | U_233 ) ;	// line#=computer.cpp:86,118,914,956
	add32s1i1 = ( ( { 32{ M_226 } } & regs_rd00 )		// line#=computer.cpp:86,91,97,964,992
		| ( { 32{ add32s1i1_c1 } } & regs_rd02 )	// line#=computer.cpp:86,91,922,1017
		| ( { 32{ add32s1i1_c2 } } & RG_addr1_bpl_PC )	// line#=computer.cpp:86,118,914,956
		) ;
	end
always @ ( M_190 or imem_arg_MEMB32W65536_RD1 or M_207 )
	TR_12 = ( ( { 5{ M_207 } } & imem_arg_MEMB32W65536_RD1 [11:7] )		// line#=computer.cpp:86,96,97,870,879
										// ,883,992
		| ( { 5{ M_190 } } & imem_arg_MEMB32W65536_RD1 [24:20] )	// line#=computer.cpp:86,91,870,882,964
		) ;
always @ ( U_244 or RL_addr_dlt_addr_imm1_instr or U_169 )
	M_265 = ( ( { 6{ U_169 } } & { RL_addr_dlt_addr_imm1_instr [24] , RL_addr_dlt_addr_imm1_instr [17:13] } )	// line#=computer.cpp:86,91,882,922
...
always @ ( M_266 or U_233 or M_237 or RL_addr_dlt_addr_imm1_instr or U_154 or TR_12 or 
	...
	add32s1i2 = ( ( { 21{ M_226 } } & { imem_arg_MEMB32W65536_RD1 [31] , imem_arg_MEMB32W65536_RD1 [31] , 
		...
		| ( { 21{ U_154 } } & { RL_addr_dlt_addr_imm1_instr [11] , RL_addr_dlt_addr_imm1_instr [11] , 
			...
			RL_addr_dlt_addr_imm1_instr [11] , RL_addr_dlt_addr_imm1_instr [11] , 
			RL_addr_dlt_addr_imm1_instr [11] , RL_addr_dlt_addr_imm1_instr [11] , 
			RL_addr_dlt_addr_imm1_instr [11] , RL_addr_dlt_addr_imm1_instr [11:0] } )	// line#=computer.cpp:1017
...
assign	M_215 = ( U_256 & FF_take_1 ) ;	// line#=computer.cpp:1113,1119
always @ ( RG_op2 or U_241 or RG_03 or ST1_12d or add48s_461ot or M_215 )	// line#=computer.cpp:1119
...
always @ ( RL_addr_dlt_addr_imm1_instr or ST1_08d or ST1_06d or M_216 or regs_rd02 or 
	...
	sub20u_181i1 = ( ( { 18{ ST1_04d } } & regs_rd02 [17:0] )			// line#=computer.cpp:165,254,255,1115
											// ,1116
...
always @ ( RL_bpl_addr_funct7_next_pc_op1 or ST1_06d or regs_rd02 or M_224 )
	TR_15 = ( ( { 16{ M_224 } } & regs_rd02 [15:0] )					// line#=computer.cpp:211,212,993,999
		| ( { 16{ ST1_06d } } & { 8'h00 , RL_bpl_addr_funct7_next_pc_op1 [7:0] } )	// line#=computer.cpp:192,193,996
		) ;
always @ ( RL_bpl_addr_funct7_next_pc_op1 or U_188 or regs_rd02 or U_125 or TR_15 or 
	M_232 )
	lsft32u1i1 = ( ( { 32{ M_232 } } & { 16'h0000 , TR_15 } )	// line#=computer.cpp:192,193,211,212,993
									// ,996,999
		| ( { 32{ U_125 } } & regs_rd02 )			// line#=computer.cpp:1035
		| ( { 32{ U_188 } } & RL_bpl_addr_funct7_next_pc_op1 )	// line#=computer.cpp:1068
		) ;
assign	M_232 = ( ( U_61 & M_181 ) | ( ST1_06d & M_206 ) ) ;	// line#=computer.cpp:889,994
always @ ( RG_op2 or U_188 or RG_rs2_word_addr or U_125 or RG_addr1_bpl_PC or M_232 )
	lsft32u1i2 = ( ( { 5{ M_232 } } & { RG_addr1_bpl_PC [1:0] , 3'h0 } )	// line#=computer.cpp:190,191,192,193,209
										// ,210,211,212,996,999
		| ( { 5{ U_125 } } & RG_rs2_word_addr [4:0] )			// line#=computer.cpp:1035
		| ( { 5{ U_188 } } & RG_op2 [4:0] )				// line#=computer.cpp:1068
		) ;
always @ ( regs_rd02 or U_127 or RL_bpl_addr_funct7_next_pc_op1 or U_198 or M_236 )
	begin
	rsft32u1i1_c1 = ( M_236 | U_198 ) ;	// line#=computer.cpp:141,142,158,159,968
						// ,971,977,980,1083
	rsft32u1i1 = ( ( { 32{ rsft32u1i1_c1 } } & RL_bpl_addr_funct7_next_pc_op1 )	// line#=computer.cpp:141,142,158,159,968
											// ,971,977,980,1083
		| ( { 32{ U_127 } } & regs_rd02 )					// line#=computer.cpp:1043
		) ;
	end
...
always @ ( RG_rs2_word_addr or U_127 or RG_op2 or U_198 or RL_addr_dlt_addr_imm1_instr or 
	M_236 )
	rsft32u1i2 = ( ( { 5{ M_236 } } & { RL_addr_dlt_addr_imm1_instr [1:0] , 3'h0 } )	// line#=computer.cpp:141,142,158,159,968
												// ,971,977,980
		| ( { 5{ U_198 } } & RG_op2 [4:0] )						// line#=computer.cpp:1083
		| ( { 5{ U_127 } } & RG_rs2_word_addr [4:0] )					// line#=computer.cpp:1043
		) ;
always @ ( RL_bpl_addr_funct7_next_pc_op1 or M_212 or regs_rd02 or M_217 )
	rsft32s1i1 = ( ( { 32{ M_217 } } & regs_rd02 )			// line#=computer.cpp:1040
		| ( { 32{ M_212 } } & RL_bpl_addr_funct7_next_pc_op1 )	// line#=computer.cpp:1081
		) ;
...
always @ ( RG_op2 or M_212 or RG_rs2_word_addr or M_217 )
	rsft32s1i2 = ( ( { 5{ M_217 } } & RG_rs2_word_addr [4:0] )	// line#=computer.cpp:1040
		| ( { 5{ M_212 } } & RG_op2 [4:0] )			// line#=computer.cpp:1081
		) ;
assign	addsub32u2i1 = RL_bpl_addr_funct7_next_pc_op1 ;	// line#=computer.cpp:1062,1064
assign	addsub32u2i2 = RG_op2 [31:0] ;	// line#=computer.cpp:1062,1064
...
always @ ( addsub32u_322ot or U_32 or U_29 or U_28 or U_26 or U_25 or RL_addr_dlt_addr_imm1_instr or 
	...
	dmem_arg_MEMB32W65536_RA1 = ( ( { 16{ U_51 } } & regs_rd00 [17:2] )		// line#=computer.cpp:165,174,252,253
		...
		| ( { 16{ U_150 } } & RL_addr_dlt_addr_imm1_instr [17:2] )		// line#=computer.cpp:165,174,974
...
assign	M_218 = ( M_184 & CT_02 ) ;	// line#=computer.cpp:870,878,889
always @ ( M_209 or imem_arg_MEMB32W65536_RD1 or M_241 or M_249 or M_248 or M_253 or 
	...
	regs_ad00_c1 = ( ( ( ( ( ( ( ( ( ( M_218 | ( M_195 & M_188 ) ) | ( M_195 & 
		...
		M_249 ) | M_241 ) ;	// line#=computer.cpp:870,881
	regs_ad00 = ( ( { 5{ regs_ad00_c1 } } & imem_arg_MEMB32W65536_RD1 [19:15] )	// line#=computer.cpp:870,881
		| ( { 5{ M_209 } } & imem_arg_MEMB32W65536_RD1 [24:20] )		// line#=computer.cpp:870
		) ;
	end
...
always @ ( M_241 or M_249 or M_248 or M_253 or M_256 or M_245 or imem_arg_MEMB32W65536_RD1 or 
	...
	regs_ad01_c1 = ( ( ( ( ( M_245 | M_256 ) | M_253 ) | M_248 ) | M_249 ) | 
		M_241 ) ;	// line#=computer.cpp:870
	regs_ad01 = ( ( { 5{ M_209 } } & imem_arg_MEMB32W65536_RD1 [19:15] )	// line#=computer.cpp:870,881
...
assign	regs_ad03 = RG_funct3_rd_rs2 ;	// line#=computer.cpp:110,895,904,913,924
					// ,984,1048,1094,1120
assign	M_189 = ~|( RG_addr1_bpl_PC ^ 32'h00000003 ) ;	// line#=computer.cpp:1015
always @ ( add48s_462ot or U_263 or U_231 or addsub32u1ot or U_232 or M_175 or M_193 or 
	...
	add32s1ot or U_154 or U_164 or RG_bpl_dlt_funct7_rd or U_179 or U_108 )	// line#=computer.cpp:1061,1080
	begin
	regs_wd03_c1 = ( U_108 | U_179 ) ;	// line#=computer.cpp:913,924
	regs_wd03_c2 = ( U_164 & U_154 ) ;	// line#=computer.cpp:1017
	regs_wd03_c3 = ( ( ( ( U_164 & ( U_142 & M_172 ) ) | ( U_164 & ( U_142 & 
		M_189 ) ) ) | ( U_199 & ( U_174 & M_172 ) ) ) | ( U_199 & ( U_174 & 
		M_189 ) ) ) ;
	regs_wd03_c4 = ( U_164 & U_157 ) ;	// line#=computer.cpp:1026
	regs_wd03_c5 = ( U_164 & U_158 ) ;	// line#=computer.cpp:1029
	regs_wd03_c6 = ( U_164 & U_159 ) ;	// line#=computer.cpp:1032
	regs_wd03_c7 = ( ( U_164 & ( ( U_142 & M_182 ) | ( U_161 & ( ~FF_take_1 ) ) ) ) | 
		( U_199 & ( U_187 & FF_take_1 ) ) ) ;	// line#=computer.cpp:1035,1043,1062
	regs_wd03_c8 = ( ( U_164 & U_162 ) | ( U_199 & ( U_192 & RL_addr_dlt_addr_imm1_instr [23] ) ) ) ;	// line#=computer.cpp:1040,1081
	regs_wd03_c9 = ( U_199 & ( U_187 & ( ~FF_take_1 ) ) ) ;	// line#=computer.cpp:1064
	regs_wd03_c10 = ( U_199 & U_188 ) ;	// line#=computer.cpp:1068
	regs_wd03_c11 = ( U_199 & ( U_174 & M_179 ) ) ;	// line#=computer.cpp:1077
	regs_wd03_c12 = ( U_199 & U_198 ) ;	// line#=computer.cpp:1083
	regs_wd03_c13 = ( U_199 & ( U_174 & M_193 ) ) ;	// line#=computer.cpp:1087
	regs_wd03_c14 = ( U_199 & ( U_174 & M_175 ) ) ;	// line#=computer.cpp:1090
	regs_wd03 = ( ( { 32{ regs_wd03_c1 } } & RG_bpl_dlt_funct7_rd [31:0] )				// line#=computer.cpp:913,924
		| ( { 32{ regs_wd03_c2 } } & add32s1ot )						// line#=computer.cpp:1017
		...
		| ( { 32{ regs_wd03_c7 } } & RL_bpl_addr_funct7_next_pc_op1 )				// line#=computer.cpp:1035,1043,1062
		| ( { 32{ regs_wd03_c8 } } & rsft32s1ot )						// line#=computer.cpp:1040,1081
		| ( { 32{ U_186 } } & val2_t4 )								// line#=computer.cpp:984
		...
		| ( { 32{ regs_wd03_c12 } } & rsft32u1ot )						// line#=computer.cpp:1083
		...
		| ( { 32{ U_231 } } & { RL_addr_dlt_addr_imm1_instr [24:5] , 12'h000 } )		// line#=computer.cpp:110,895
		| ( { 32{ U_263 } } & add48s_462ot [45:14] )						// line#=computer.cpp:256,258,1115,1116
													// ,1120
		) ;
	end
assign	regs_we03 = ( ( ( ( ( ( ( U_108 | U_164 ) | U_186 ) | U_179 ) | U_199 ) | 
	U_232 ) | U_231 ) | U_263 ) ;	// line#=computer.cpp:110,895,904,913,924
					// ,984,1048,1094,1120
