...
// timestamp_0: 20260617182553_48046_41891
// timestamp_5: 20260617182553_48060_95917
// timestamp_9: 20260617182555_48060_05513
// timestamp_C: 20260617182555_48060_10065
// timestamp_E: 20260617182555_48060_91299
// timestamp_V: 20260617182555_48074_02855
...
reg	[5:0]	RG_i_rd ;	// line#=computer.cpp:743,840
reg	RG_50 ;
...
reg	[31:0]	RL_el_imm1_mil_next_pc_op2 ;	// line#=computer.cpp:358,360,730,847,973
						// ,975,1018,1019
reg	[4:0]	RG_addr_byte_offset_rd_rs2 ;	// line#=computer.cpp:209,840,843
...
always @ ( full_dec_accumd_11_rg04 or full_dec_accumd_11_rg03 or full_dec_accumd_11_rg02 or 
	full_dec_accumd_11_rg01 or full_dec_accumd_11_rg00 or RG_i_rd )	// line#=computer.cpp:640
	case ( RG_i_rd [2:0] )
	3'h0 :
...
always @ ( full_dec_accumc_11_rg04 or full_dec_accumc_11_rg03 or full_dec_accumc_11_rg02 or 
	full_dec_accumc_11_rg01 or full_dec_accumc_11_rg00 or RG_i_rd )	// line#=computer.cpp:640
	case ( RG_i_rd [2:0] )
	3'h0 :
...
assign	M_477 = ( regs_rd00 ^ regs_rd01 ) ;	// line#=computer.cpp:898,901
always @ ( comp32u_11ot or comp32s_12ot or M_477 or imem_arg_MEMB32W65536_RD1 )	// line#=computer.cpp:831,896
	case ( imem_arg_MEMB32W65536_RD1 [14:12] )
	3'h0 :
		take_t3 = ~|M_477 ;	// line#=computer.cpp:898
	3'h1 :
		take_t3 = |M_477 ;	// line#=computer.cpp:901
	3'h4 :
...
assign	CT_03 = ( ( ~|{ ~imem_arg_MEMB32W65536_RD1 [14:13] , imem_arg_MEMB32W65536_RD1 [12] } ) & 
	M_476 ) ;	// line#=computer.cpp:831,841,844,1121
assign	M_476 = ~|imem_arg_MEMB32W65536_RD1 [31:25] ;	// line#=computer.cpp:831,841,844,1074
							// ,1084,1094,1104,1106,1117,1121
assign	CT_04 = ( ( ~|{ ~imem_arg_MEMB32W65536_RD1 [14] , imem_arg_MEMB32W65536_RD1 [13] , 
	~imem_arg_MEMB32W65536_RD1 [12] } ) & M_476 ) ;	// line#=computer.cpp:831,841,844,1117
assign	CT_05 = ( ( ~|{ ~imem_arg_MEMB32W65536_RD1 [14] , imem_arg_MEMB32W65536_RD1 [13:12] } ) & 
	M_476 ) ;	// line#=computer.cpp:831,841,844,1106
assign	CT_06 = ( ( ~|{ imem_arg_MEMB32W65536_RD1 [14] , ~imem_arg_MEMB32W65536_RD1 [13:12] } ) & 
	M_476 ) ;	// line#=computer.cpp:831,841,844,1104
...
assign	CT_09 = ( ( ~|{ imem_arg_MEMB32W65536_RD1 [14] , ~imem_arg_MEMB32W65536_RD1 [13] , 
	imem_arg_MEMB32W65536_RD1 [12] } ) & M_476 ) ;	// line#=computer.cpp:831,841,844,1094
assign	CT_10 = ( ( ~|{ imem_arg_MEMB32W65536_RD1 [14:13] , ~imem_arg_MEMB32W65536_RD1 [12] } ) & 
	M_476 ) ;	// line#=computer.cpp:831,841,844,1084
assign	CT_11 = ( ( ~|imem_arg_MEMB32W65536_RD1 [14:12] ) & M_476 ) ;	// line#=computer.cpp:831,841,844,1074
...
assign	incr3s1i1 = RG_i_rd [2:0] ;	// line#=computer.cpp:743
assign	incr4s1i1 = { RG_i_rd [2:0] , 1'h1 } ;	// line#=computer.cpp:744
assign	incr4s2i1 = { RG_i_rd [2:0] , 1'h1 } ;	// line#=computer.cpp:745
...
assign	addsub32s5i2 = RG_decis ;	// line#=computer.cpp:660
assign	addsub32s5_f = 2'h1 ;
assign	addsub32s6i1 = RG_56 ;	// line#=computer.cpp:660
assign	addsub32s6i2 = RG_55 ;	// line#=computer.cpp:660
...
assign	addsub32s9i2 = RG_60 ;	// line#=computer.cpp:660
...
assign	full_wl_code_table1i1 = regs_rd01 [5:2] ;	// line#=computer.cpp:422,698,703,1096
							// ,1097
assign	full_h1i1 = { RG_i_rd [2:0] , 2'h2 } ;	// line#=computer.cpp:744
assign	full_h2i1 = { RG_i_rd [2:0] , 2'h3 } ;	// line#=computer.cpp:745
...
assign	addsub20s_19_21i1 = addsub32s13ot [30:14] ;	// line#=computer.cpp:416,417,701,702
...
assign	addsub20s_19_22i2 = addsub32s4ot [31:14] ;	// line#=computer.cpp:660,661,716,718
...
assign	addsub20s_19_51i2 = addsub32s4ot [31:14] ;	// line#=computer.cpp:660,661,716,722
assign	addsub20s_19_51_f = 2'h1 ;
assign	comp32s_1_11i1 = regs_rd00 ;	// line#=computer.cpp:981
assign	comp32s_1_11i2 = imem_arg_MEMB32W65536_RD1 [31:20] ;	// line#=computer.cpp:831,981
assign	imem_arg_MEMB32W65536_RA1 = RG_next_pc_PC [17:2] ;	// line#=computer.cpp:831
assign	U_01 = ( ST1_02d & CT_01 ) ;	// line#=computer.cpp:829
assign	U_07 = ( ST1_03d & M_461 ) ;	// line#=computer.cpp:831,839,850
assign	U_08 = ( ST1_03d & M_463 ) ;	// line#=computer.cpp:831,839,850
assign	U_09 = ( ST1_03d & M_465 ) ;	// line#=computer.cpp:831,839,850
assign	U_10 = ( ST1_03d & M_457 ) ;	// line#=computer.cpp:831,839,850
assign	U_11 = ( ST1_03d & M_449 ) ;	// line#=computer.cpp:831,839,850
assign	U_12 = ( ST1_03d & M_431 ) ;	// line#=computer.cpp:831,839,850
assign	U_13 = ( ST1_03d & M_447 ) ;	// line#=computer.cpp:831,839,850
assign	U_15 = ( ST1_03d & M_435 ) ;	// line#=computer.cpp:831,839,850
assign	M_429 = ~|( { 25'h0000000 , imem_arg_MEMB32W65536_RD1 [6:0] } ^ 32'h00000017 ) ;	// line#=computer.cpp:831,839,850
assign	M_431 = ~|( { 25'h0000000 , imem_arg_MEMB32W65536_RD1 [6:0] } ^ 32'h00000013 ) ;	// line#=computer.cpp:831,839,850
assign	M_435 = ~|( { 25'h0000000 , imem_arg_MEMB32W65536_RD1 [6:0] } ^ 32'h0000000b ) ;	// line#=computer.cpp:831,839,850
assign	M_445 = ~|( { 25'h0000000 , imem_arg_MEMB32W65536_RD1 [6:0] } ^ 32'h00000037 ) ;	// line#=computer.cpp:831,839,850
assign	M_447 = ~|( { 25'h0000000 , imem_arg_MEMB32W65536_RD1 [6:0] } ^ 32'h00000033 ) ;	// line#=computer.cpp:831,839,850
assign	M_449 = ~|( { 25'h0000000 , imem_arg_MEMB32W65536_RD1 [6:0] } ^ 32'h00000023 ) ;	// line#=computer.cpp:831,839,850
assign	M_457 = ~|( { 25'h0000000 , imem_arg_MEMB32W65536_RD1 [6:0] } ^ 32'h00000003 ) ;	// line#=computer.cpp:831,839,850
assign	M_461 = ~|( { 25'h0000000 , imem_arg_MEMB32W65536_RD1 [6:0] } ^ 32'h0000006f ) ;	// line#=computer.cpp:831,839,850
assign	M_463 = ~|( { 25'h0000000 , imem_arg_MEMB32W65536_RD1 [6:0] } ^ 32'h00000067 ) ;	// line#=computer.cpp:831,839,850
assign	M_465 = ~|( { 25'h0000000 , imem_arg_MEMB32W65536_RD1 [6:0] } ^ 32'h00000063 ) ;	// line#=computer.cpp:831,839,850
assign	M_437 = ~|( { 29'h00000000 , imem_arg_MEMB32W65536_RD1 [14:12] } ^ 32'h00000007 ) ;	// line#=computer.cpp:831,896,976,1020
												// ,1022,1041
assign	M_439 = ~|( { 29'h00000000 , imem_arg_MEMB32W65536_RD1 [14:12] } ^ 32'h00000006 ) ;	// line#=computer.cpp:831,896,976,1020
												// ,1022,1041
assign	M_441 = ~|( { 29'h00000000 , imem_arg_MEMB32W65536_RD1 [14:12] } ^ 32'h00000005 ) ;	// line#=computer.cpp:831,896,927,976
												// ,1020
assign	M_443 = ~|( { 29'h00000000 , imem_arg_MEMB32W65536_RD1 [14:12] } ^ 32'h00000004 ) ;	// line#=computer.cpp:831,896,927,976
												// ,1020,1022,1041
assign	M_451 = ~|{ 29'h00000000 , imem_arg_MEMB32W65536_RD1 [14:12] } ;	// line#=computer.cpp:831,896,927,955,976
										// ,1020
assign	M_455 = ~|( { 29'h00000000 , imem_arg_MEMB32W65536_RD1 [14:12] } ^ 32'h00000001 ) ;	// line#=computer.cpp:831,896,927,955,976
												// ,1020,1022,1041
assign	U_25 = ( U_09 & take_t3 ) ;	// line#=computer.cpp:916
assign	U_26 = ( U_10 & M_451 ) ;	// line#=computer.cpp:831,927
assign	U_27 = ( U_10 & M_455 ) ;	// line#=computer.cpp:831,927
assign	U_29 = ( U_10 & M_443 ) ;	// line#=computer.cpp:831,927
assign	U_30 = ( U_10 & M_441 ) ;	// line#=computer.cpp:831,927
assign	M_453 = ~|( { 29'h00000000 , imem_arg_MEMB32W65536_RD1 [14:12] } ^ 32'h00000002 ) ;	// line#=computer.cpp:831,927,955,976
												// ,1020
assign	U_32 = ( U_11 & M_451 ) ;	// line#=computer.cpp:831,955
assign	U_33 = ( U_11 & M_455 ) ;	// line#=computer.cpp:831,955
assign	U_34 = ( U_11 & M_453 ) ;	// line#=computer.cpp:831,955
assign	U_36 = ( U_12 & M_451 ) ;	// line#=computer.cpp:831,976
assign	U_43 = ( U_12 & M_441 ) ;	// line#=computer.cpp:831,976
assign	U_45 = ( U_43 & ( ~imem_arg_MEMB32W65536_RD1 [30] ) ) ;	// line#=computer.cpp:831,999
assign	U_46 = ( U_13 & M_451 ) ;	// line#=computer.cpp:831,1020
assign	U_48 = ( U_13 & M_453 ) ;	// line#=computer.cpp:831,1020
assign	U_51 = ( U_13 & M_441 ) ;	// line#=computer.cpp:831,1020
...
assign	U_80 = ( ST1_04d & M_446 ) ;	// line#=computer.cpp:850
assign	U_81 = ( ST1_04d & M_430 ) ;	// line#=computer.cpp:850
assign	U_82 = ( ST1_04d & M_462 ) ;	// line#=computer.cpp:850
assign	U_83 = ( ST1_04d & M_464 ) ;	// line#=computer.cpp:850
assign	U_84 = ( ST1_04d & M_466 ) ;	// line#=computer.cpp:850
assign	U_85 = ( ST1_04d & M_458 ) ;	// line#=computer.cpp:850
assign	U_86 = ( ST1_04d & M_450 ) ;	// line#=computer.cpp:850
assign	U_87 = ( ST1_04d & M_432 ) ;	// line#=computer.cpp:850
assign	U_88 = ( ST1_04d & M_448 ) ;	// line#=computer.cpp:850
assign	U_89 = ( ST1_04d & M_434 ) ;	// line#=computer.cpp:850
assign	U_90 = ( ST1_04d & M_436 ) ;	// line#=computer.cpp:850
assign	U_91 = ( ST1_04d & M_468 ) ;	// line#=computer.cpp:850
assign	M_430 = ~|( RG_60 ^ 32'h00000017 ) ;	// line#=computer.cpp:850
assign	M_432 = ~|( RG_60 ^ 32'h00000013 ) ;	// line#=computer.cpp:850
assign	M_434 = ~|( RG_60 ^ 32'h0000000f ) ;	// line#=computer.cpp:850
assign	M_436 = ~|( RG_60 ^ 32'h0000000b ) ;	// line#=computer.cpp:850
assign	M_446 = ~|( RG_60 ^ 32'h00000037 ) ;	// line#=computer.cpp:850
assign	M_448 = ~|( RG_60 ^ 32'h00000033 ) ;	// line#=computer.cpp:850
assign	M_450 = ~|( RG_60 ^ 32'h00000023 ) ;	// line#=computer.cpp:850
assign	M_458 = ~|( RG_60 ^ 32'h00000003 ) ;	// line#=computer.cpp:850
assign	M_462 = ~|( RG_60 ^ 32'h0000006f ) ;	// line#=computer.cpp:850
assign	M_464 = ~|( RG_60 ^ 32'h00000067 ) ;	// line#=computer.cpp:850
assign	M_466 = ~|( RG_60 ^ 32'h00000063 ) ;	// line#=computer.cpp:850
assign	M_468 = ~|( RG_60 ^ 32'h00000073 ) ;	// line#=computer.cpp:850
assign	U_92 = ( ST1_04d & M_499 ) ;	// line#=computer.cpp:850
...
assign	M_442 = ~|( RG_full_dec_del_bpl_instr ^ 32'h00000005 ) ;	// line#=computer.cpp:927
assign	M_444 = ~|( RG_full_dec_del_bpl_instr ^ 32'h00000004 ) ;	// line#=computer.cpp:927
assign	M_452 = ~|RG_full_dec_del_bpl_instr ;	// line#=computer.cpp:927,955,1020
assign	M_454 = ~|( RG_full_dec_del_bpl_instr ^ 32'h00000002 ) ;	// line#=computer.cpp:927,955
assign	M_456 = ~|( RG_full_dec_del_bpl_instr ^ 32'h00000001 ) ;	// line#=computer.cpp:927,955,976
assign	U_105 = ( U_85 & M_469 ) ;	// line#=computer.cpp:944
assign	U_106 = ( U_86 & M_452 ) ;	// line#=computer.cpp:955
assign	U_107 = ( U_86 & M_456 ) ;	// line#=computer.cpp:955
assign	U_116 = ( U_87 & M_456 ) ;	// line#=computer.cpp:976
assign	M_469 = |RG_i_rd [4:0] ;	// line#=computer.cpp:944,1008,1054
assign	U_118 = ( U_87 & M_469 ) ;	// line#=computer.cpp:1008
assign	U_119 = ( U_88 & M_452 ) ;	// line#=computer.cpp:1020
assign	U_128 = ( U_119 & ( ~RG_85 ) ) ;	// line#=computer.cpp:1022
assign	U_129 = ( U_88 & M_469 ) ;	// line#=computer.cpp:1054
...
assign	U_174 = ( ST1_05d & lop3u_11ot ) ;	// line#=computer.cpp:743
assign	U_175 = ( ST1_05d & ( ~lop3u_11ot ) ) ;	// line#=computer.cpp:743
assign	U_176 = ( U_175 & M_470 ) ;	// line#=computer.cpp:1100
assign	U_181 = ( ( ST1_06d & comp32s_11ot [1] ) & M_470 ) ;	// line#=computer.cpp:374,1127
assign	U_186 = ( ST1_07d & comp32s_12ot [1] ) ;	// line#=computer.cpp:374
assign	U_187 = ( ST1_07d & ( ~comp32s_12ot [1] ) ) ;	// line#=computer.cpp:374
assign	M_470 = |RG_addr_byte_offset_rd_rs2 ;	// line#=computer.cpp:1100,1127
assign	U_188 = ( U_186 & M_470 ) ;	// line#=computer.cpp:1127
assign	U_191 = ( ( U_187 & ( ~CT_73 ) ) & M_470 ) ;	// line#=computer.cpp:372,1127
always @ ( addsub32s_32_22ot or M_479 or sub40s9ot or M_478 )
	RG_full_dec_del_bph_t = ( ( { 32{ M_478 } } & sub40s9ot [39:8] )	// line#=computer.cpp:676
		| ( { 32{ M_479 } } & addsub32s_32_22ot )			// line#=computer.cpp:690
		) ;
...
assign	M_478 = ( ST1_04d & ( U_134 & RG_74 ) ) ;	// line#=computer.cpp:666
assign	M_479 = ( ST1_04d & U_147 ) ;
always @ ( RL_full_dec_del_bph_mask_mil_op1 or M_479 or sub40s1ot or M_478 )
	RG_full_dec_del_bph_1_t = ( ( { 32{ M_478 } } & sub40s1ot [39:8] )	// line#=computer.cpp:676
		| ( { 32{ M_479 } } & RL_full_dec_del_bph_mask_mil_op1 )	// line#=computer.cpp:690
		) ;
...
always @ ( addsub32s10ot or M_479 or sub40s7ot or M_478 )
	RG_full_dec_del_bph_2_t = ( ( { 32{ M_478 } } & sub40s7ot [39:8] )	// line#=computer.cpp:676
...
always @ ( addsub32s_321ot or M_479 or sub40s6ot or M_478 )
	RG_full_dec_del_bph_3_t = ( ( { 32{ M_478 } } & sub40s6ot [39:8] )	// line#=computer.cpp:676
		| ( { 32{ M_479 } } & addsub32s_321ot )				// line#=computer.cpp:690
		) ;
...
always @ ( addsub32s2ot or M_479 or sub40s5ot or M_478 )
	RG_full_dec_del_bph_4_t = ( ( { 32{ M_478 } } & sub40s5ot [39:8] )	// line#=computer.cpp:676
...
always @ ( addsub32s12ot or M_479 or sub40s4ot or M_478 )
	RG_full_dec_del_bph_5_t = ( ( { 32{ M_478 } } & sub40s4ot [39:8] )	// line#=computer.cpp:676
		| ( { 32{ M_479 } } & addsub32s12ot )				// line#=computer.cpp:690
		) ;
...
always @ ( addsub32s_32_11ot or M_481 or sub40s8ot or M_480 )
	RG_full_dec_del_bpl_t = ( ( { 32{ M_480 } } & sub40s8ot [39:8] )	// line#=computer.cpp:676
		| ( { 32{ M_481 } } & addsub32s_32_11ot )			// line#=computer.cpp:690
		) ;
...
assign	M_480 = ( ST1_04d & ( U_134 & RG_71 ) ) ;	// line#=computer.cpp:666
assign	M_481 = ( ST1_04d & U_137 ) ;
always @ ( RG_full_dec_del_bpl_instr or M_481 or sub40s3ot or M_480 )
	RG_full_dec_del_bpl_1_t = ( ( { 32{ M_480 } } & sub40s3ot [39:8] )	// line#=computer.cpp:676
		| ( { 32{ M_481 } } & RG_full_dec_del_bpl_instr )		// line#=computer.cpp:690
		) ;
...
always @ ( addsub32s_32_12ot or M_481 or sub40s11ot or M_480 )
	RG_full_dec_del_bpl_2_t = ( ( { 32{ M_480 } } & sub40s11ot [39:8] )	// line#=computer.cpp:676
		| ( { 32{ M_481 } } & addsub32s_32_12ot )			// line#=computer.cpp:690
		) ;
...
always @ ( addsub32s13ot or M_481 or sub40s12ot or M_480 )
	RG_full_dec_del_bpl_3_t = ( ( { 32{ M_480 } } & sub40s12ot [39:8] )	// line#=computer.cpp:676
		| ( { 32{ M_481 } } & addsub32s13ot )				// line#=computer.cpp:690
		) ;
...
always @ ( RG_full_dec_del_bpl_word_addr or M_481 or sub40s2ot or M_480 )
	RG_full_dec_del_bpl_4_t = ( ( { 32{ M_480 } } & sub40s2ot [39:8] )	// line#=computer.cpp:676
		| ( { 32{ M_481 } } & RG_full_dec_del_bpl_word_addr )		// line#=computer.cpp:690
		) ;
...
always @ ( addsub32s_32_21ot or M_481 or sub40s10ot or M_480 )
	RG_full_dec_del_bpl_5_t = ( ( { 32{ M_480 } } & sub40s10ot [39:8] )	// line#=computer.cpp:676
		| ( { 32{ M_481 } } & addsub32s_32_21ot )			// line#=computer.cpp:690
		) ;
...
always @ ( addsub32s2ot or U_175 or addsub32s13ot or U_174 or sub24s_231ot or M_483 )
	RG_xa1_t = ( ( { 32{ M_483 } } & { sub24s_231ot [22] , sub24s_231ot [22] , 
		...
		| ( { 32{ U_174 } } & addsub32s13ot )					// line#=computer.cpp:744
		| ( { 32{ U_175 } } & addsub32s2ot )					// line#=computer.cpp:747
		) ;
...
always @ ( addsub32s_321ot or U_175 or addsub32s_32_11ot or U_174 or sub28s_251ot or 
	...
	RG_xa2_xs_t = ( ( { 30{ U_60 } } & { addsub20s2ot [19] , addsub20s2ot [19] , 
		...
		| ( { 30{ U_174 } } & addsub32s_32_11ot [29:0] )			// line#=computer.cpp:745
		| ( { 30{ U_175 } } & addsub32s_321ot [29:0] )				// line#=computer.cpp:748
		) ;
...
always @ ( RG_full_dec_ah2_wd3 or M_483 or rsft12u2ot or U_60 )
	RG_full_dec_deth_wd3_t = ( ( { 15{ U_60 } } & { 3'h0 , rsft12u2ot } )	// line#=computer.cpp:431
		| ( { 15{ M_483 } } & { RG_full_dec_ah2_wd3 [11:0] , 3'h0 } )	// line#=computer.cpp:432,721
		) ;
...
always @ ( RG_full_dec_ah2_wd3 or U_92 or U_91 or U_89 or U_88 or U_87 or U_86 or 
	...
	U_131 or U_135 or ST1_04d or apl2_41_t4 or M_483 or rsft12u1ot or U_60 )	// line#=computer.cpp:1074,1084
	begin
	...
	RG_full_dec_ah2_wd3_t = ( ( { 15{ U_60 } } & { 3'h0 , rsft12u1ot } )	// line#=computer.cpp:431
		| ( { 15{ M_483 } } & apl2_41_t4 )				// line#=computer.cpp:443,724
		| ( { 15{ RG_full_dec_ah2_wd3_t_c1 } } & RG_full_dec_ah2_wd3 ) ) ;
	end
assign	RG_full_dec_ah2_wd3_en = ( U_60 | M_483 | RG_full_dec_ah2_wd3_t_c1 ) ;	// line#=computer.cpp:1074,1084
...
always @ ( RG_full_dec_deth_wd3 or M_483 or addsub16s_151ot or U_60 )
	RG_apl2_full_dec_detl_t = ( ( { 15{ U_60 } } & addsub16s_151ot )	// line#=computer.cpp:440
		| ( { 15{ M_483 } } & { RG_full_dec_deth_wd3 [11:0] , 3'h0 } )	// line#=computer.cpp:432,707
		) ;
...
always @ ( apl2_51_t4 or M_483 or addsub16s_152ot or U_60 )
	RG_apl2_full_dec_al2_t = ( ( { 15{ U_60 } } & addsub16s_152ot )	// line#=computer.cpp:440
		| ( { 15{ M_483 } } & apl2_51_t4 )			// line#=computer.cpp:443,710
		) ;
...
always @ ( adpcm_quantl_pos3ot or comp32s_11ot or ST1_06d or TR_01 or ST1_07d or 
	...
	begin
	RG_i_rd_t_c1 = ( ( ( ST1_03d | ST1_04d ) | ST1_05d ) | ST1_07d ) ;	// line#=computer.cpp:743,831,840
	RG_i_rd_t_c2 = ( ST1_06d & ( ~comp32s_11ot [1] ) ) ;	// line#=computer.cpp:377
	RG_i_rd_t = ( ( { 6{ RG_i_rd_t_c1 } } & { 1'h0 , TR_01 } )	// line#=computer.cpp:743,831,840
...
always @ ( posedge CLOCK )	// line#=computer.cpp:374
	if ( RG_i_rd_en )
		RG_i_rd <= RG_i_rd_t ;	// line#=computer.cpp:374,377,743,831,840
...
always @ ( imem_arg_MEMB32W65536_RD1 or M_463 or M_429 or M_445 )	// line#=computer.cpp:831,839,850
	begin
	TR_23_c1 = ( ( M_445 | M_429 ) | M_463 ) ;	// line#=computer.cpp:831
...
always @ ( incr32s2ot or ST1_06d or U_09 or addsub20s1ot or U_60 or rsft32u2ot or 
	...
	RL_el_imm1_mil_next_pc_op2_t_c1 = ( ( ( ( ( U_46 & ( ~imem_arg_MEMB32W65536_RD1 [30] ) ) | 
		( U_13 & M_443 ) ) | ( U_13 & M_439 ) ) | ( U_13 & M_437 ) ) | U_61 ) ;	// line#=computer.cpp:1018,1123,1124
	RL_el_imm1_mil_next_pc_op2_t_c2 = ( ( ( U_12 & M_443 ) | ( U_12 & M_439 ) ) | 
		( U_12 & M_437 ) ) ;	// line#=computer.cpp:86,91,831,973
	...
	RL_el_imm1_mil_next_pc_op2_t_c5 = ( U_13 & M_455 ) ;	// line#=computer.cpp:1029
	...
	RL_el_imm1_mil_next_pc_op2_t = ( ( { 32{ ST1_02d } } & mul32s2ot [31:0] )		// line#=computer.cpp:660
		...
		| ( { 32{ RL_el_imm1_mil_next_pc_op2_t_c3 } } & addsub32s13ot )			// line#=computer.cpp:86,118,875,978
...
always @ ( RG_i_rd or ST1_04d or addsub32s13ot or M_486 or imem_arg_MEMB32W65536_RD1 or 
	U_12 or U_15 )
	begin
	RG_addr_byte_offset_rd_rs2_t_c1 = ( U_15 | U_12 ) ;	// line#=computer.cpp:831,843
	RG_addr_byte_offset_rd_rs2_t = ( ( { 5{ RG_addr_byte_offset_rd_rs2_t_c1 } } & 
			imem_arg_MEMB32W65536_RD1 [24:20] )		// line#=computer.cpp:831,843
		| ( { 5{ M_486 } } & { 3'h0 , addsub32s13ot [1:0] } )	// line#=computer.cpp:86,91,97,209,925
									// ,953
		| ( { 5{ ST1_04d } } & RG_i_rd [4:0] )			// line#=computer.cpp:840
		) ;
	end
...
always @ ( posedge CLOCK )
	if ( RG_addr_byte_offset_rd_rs2_en )
		RG_addr_byte_offset_rd_rs2 <= RG_addr_byte_offset_rd_rs2_t ;	// line#=computer.cpp:86,91,97,209,831
										// ,840,843,925,953
always @ ( posedge CLOCK )
	RG_i <= RG_i_rd [1:0] ;
...
assign	M_459 = ~|( { 29'h00000000 , imem_arg_MEMB32W65536_RD1 [14:12] } ^ 32'h00000003 ) ;	// line#=computer.cpp:831,976,1020
assign	M_485 = ( ( ST1_03d & M_445 ) | ( ST1_03d & M_429 ) ) ;	// line#=computer.cpp:831,839,850,1020
always @ ( comp32s_11ot or ST1_06d or mul16s_276ot or U_60 or U_46 or CT_03 or U_61 or 
	...
	U_08 or U_07 or M_485 )	// line#=computer.cpp:831,976,1020
	begin
	RG_85_t_c1 = ( M_485 | ( U_07 | U_08 ) ) ;	// line#=computer.cpp:831,840,855,864,873
							// ,884
	RG_85_t_c2 = ( U_12 & M_453 ) ;	// line#=computer.cpp:981
	RG_85_t_c3 = ( U_12 & M_459 ) ;	// line#=computer.cpp:984
	RG_85_t_c4 = ( U_13 & M_459 ) ;	// line#=computer.cpp:1035
...
assign	M_499 = ~( ( M_500 | M_436 ) | M_468 ) ;	// line#=computer.cpp:850
assign	M_500 = ( ( ( ( ( ( ( ( ( M_446 | M_430 ) | M_462 ) | M_464 ) | M_466 ) | 
	M_458 ) | M_450 ) | M_432 ) | M_448 ) | M_434 ) ;	// line#=computer.cpp:850
...
always @ ( sub24s_231ot or U_175 )
	TR_03 = ( { 23{ U_175 } } & sub24s_231ot )	// line#=computer.cpp:747
		 ;	// line#=computer.cpp:733
assign	sub28s_251i1 = { TR_03 , 2'h0 } ;	// line#=computer.cpp:733,747
...
always @ ( TR_04 or M_490 or regs_rd02 or U_116 )
	lsft32u1i1 = ( ( { 32{ U_116 } } & regs_rd02 )		// line#=computer.cpp:996
		| ( { 32{ M_490 } } & { 16'h0000 , TR_04 } )	// line#=computer.cpp:192,193,210,957
		) ;
always @ ( addsub32s13ot or U_32 or RG_addr_byte_offset_rd_rs2 or U_107 )
	M_524 = ( ( { 2{ U_107 } } & RG_addr_byte_offset_rd_rs2 [1:0] )	// line#=computer.cpp:210,211,212,960
...
always @ ( M_524 or M_490 or RG_addr_byte_offset_rd_rs2 or U_116 )
	lsft32u1i2 = ( ( { 5{ U_116 } } & RG_addr_byte_offset_rd_rs2 )	// line#=computer.cpp:996
...
always @ ( dmem_arg_MEMB32W65536_RD1 or M_497 or regs_rd00 or U_45 )
	rsft32u1i1 = ( ( { 32{ U_45 } } & regs_rd00 )			// line#=computer.cpp:1004
		| ( { 32{ M_497 } } & dmem_arg_MEMB32W65536_RD1 )	// line#=computer.cpp:141,142,158,159,929
									// ,932,938,941
		) ;
assign	M_497 = ( ( ( ( U_85 & M_442 ) | ( U_85 & M_444 ) ) | ( U_85 & M_456 ) ) | 
	( U_85 & M_452 ) ) ;	// line#=computer.cpp:927
always @ ( RG_addr_byte_offset_rd_rs2 or M_497 or imem_arg_MEMB32W65536_RD1 or U_45 )
	rsft32u1i2 = ( ( { 5{ U_45 } } & imem_arg_MEMB32W65536_RD1 [24:20] )		// line#=computer.cpp:831,843,1004
		| ( { 5{ M_497 } } & { RG_addr_byte_offset_rd_rs2 [1:0] , 3'h0 } )	// line#=computer.cpp:141,142,158,159,929
											// ,932,938,941
		) ;
...
always @ ( M_287_t or U_73 or M_284_t or U_147 )
	TR_06 = ( ( { 24{ U_147 } } & { M_284_t , M_284_t , M_284_t , M_284_t , M_284_t , 
			...
			M_284_t , M_284_t , M_284_t , M_284_t , M_284_t , M_284_t , 
			M_284_t , M_284_t , M_284_t , M_284_t , M_284_t , M_284_t , 
			M_284_t } )	// line#=computer.cpp:690
		| ( { 24{ U_73 } } & { M_287_t , M_287_t , M_287_t , M_287_t , M_287_t , 
			M_287_t , M_287_t , M_287_t , M_287_t , M_287_t , M_287_t , 
			M_287_t , M_287_t , M_287_t , M_287_t , M_287_t , M_287_t , 
			M_287_t , M_287_t , M_287_t , M_287_t , M_287_t , M_287_t , 
			M_287_t } )	// line#=computer.cpp:690
		) ;
always @ ( addsub32s13ot or U_175 or TR_06 or M_493 )
	addsub32s2i1 = ( ( { 32{ M_493 } } & { TR_06 , 8'h80 } )	// line#=computer.cpp:690
		| ( { 32{ U_175 } } & addsub32s13ot )			// line#=computer.cpp:744,747
		) ;
always @ ( sub28s_251ot or U_175 or sub40s1ot or U_73 or sub40s5ot or U_147 )
	addsub32s2i2 = ( ( { 32{ U_147 } } & sub40s5ot [39:8] )				// line#=computer.cpp:689,690
...
always @ ( regs_rd02 or U_83 or sub40s7ot or U_147 or RG_full_dec_del_bpl_word_addr or 
	U_60 )
	addsub32s10i1 = ( ( { 32{ U_60 } } & RG_full_dec_del_bpl_word_addr )	// line#=computer.cpp:660
...
always @ ( U_83 or M_286_t or U_147 or RG_full_dec_del_bpl_instr or U_60 )
	addsub32s10i2 = ( ( { 32{ U_60 } } & RG_full_dec_del_bpl_instr )	// line#=computer.cpp:660
...
always @ ( M_283_t or U_147 or RL_el_imm1_mil_next_pc_op2 or U_60 )
	addsub32s12i1 = ( ( { 32{ U_60 } } & RL_el_imm1_mil_next_pc_op2 )	// line#=computer.cpp:660
...
always @ ( sub40s4ot or U_147 or RL_full_dec_del_bph_mask_mil_op1 or U_60 )
	addsub32s12i2 = ( ( { 32{ U_60 } } & RL_full_dec_del_bph_mask_mil_op1 )	// line#=computer.cpp:660
...
always @ ( sub40s12ot or U_137 or RG_next_pc_PC or U_07 or U_25 or regs_rd00 or 
	...
	addsub32s13i1_c2 = ( U_25 | U_07 ) ;	// line#=computer.cpp:86,118,875,917
	addsub32s13i1 = ( ( { 32{ addsub32s13i1_c1 } } & { TR_07 , mul20s_321ot [30:0] } )	// line#=computer.cpp:415,416,744
		| ( { 32{ U_11 } } & regs_rd01 )						// line#=computer.cpp:86,97,953
		| ( { 32{ M_487 } } & regs_rd00 )						// line#=computer.cpp:86,91,925,978
...
always @ ( M_517 or imem_arg_MEMB32W65536_RD1 or M_449 )
	TR_08 = ( ( { 5{ M_449 } } & imem_arg_MEMB32W65536_RD1 [11:7] )		// line#=computer.cpp:86,96,97,831,840
										// ,844,953
		| ( { 5{ M_517 } } & imem_arg_MEMB32W65536_RD1 [24:20] )	// line#=computer.cpp:86,91,831,843,925
										// ,978
		) ;
always @ ( M_473 or TR_08 or imem_arg_MEMB32W65536_RD1 or M_511 )
	M_527 = ( ( { 6{ M_511 } } & { imem_arg_MEMB32W65536_RD1 [31] , TR_08 } )	// line#=computer.cpp:86,91,96,97,831,840
											// ,843,844,925,953,978
...
always @ ( addsub32s1ot or ST1_05d or M_291_t or U_137 or M_528 or imem_arg_MEMB32W65536_RD1 or 
	...
	addsub32s13i2 = ( ( { 32{ U_60 } } & { mul20s_32_11ot [30] , mul20s_32_11ot [30:0] } )	// line#=computer.cpp:416
		...
		| ( { 32{ U_137 } } & { M_291_t , M_291_t , M_291_t , M_291_t , M_291_t , 
			...
			M_291_t , M_291_t , M_291_t , M_291_t , M_291_t , M_291_t , 
			M_291_t , M_291_t , M_291_t , M_291_t , M_291_t , M_291_t , 
			M_291_t , 8'h80 } )							// line#=computer.cpp:690
...
always @ ( RG_wd or ST1_07d or regs_rd01 or U_48 or regs_rd00 or M_488 )
	comp32s_12i1 = ( ( { 32{ M_488 } } & regs_rd00 )	// line#=computer.cpp:904,907
		| ( { 32{ U_48 } } & regs_rd01 )		// line#=computer.cpp:1017,1032
		| ( { 32{ ST1_07d } } & RG_wd )			// line#=computer.cpp:374
		) ;
assign	M_488 = ( ( U_09 & M_443 ) | ( U_09 & M_441 ) ) ;	// line#=computer.cpp:831,896
always @ ( RG_decis or ST1_07d or regs_rd00 or U_48 or regs_rd01 or M_488 )
	comp32s_12i2 = ( ( { 32{ M_488 } } & regs_rd01 )	// line#=computer.cpp:904,907
...
always @ ( full_dec_accumc_01_rg05 or U_175 or RL_el_imm1_mil_next_pc_op2 or U_134 or 
	...
	TR_11 = ( ( { 20{ U_60 } } & { RG_apl2_full_dec_al2 , 5'h00 } )		// line#=computer.cpp:440
		...
		| ( { 20{ U_175 } } & full_dec_accumc_01_rg05 )			// line#=computer.cpp:747
		) ;
assign	sub24s_231i1 = { TR_11 , 2'h0 } ;	// line#=computer.cpp:440,732,747
always @ ( full_dec_accumc_01_rg05 or U_175 or RL_el_imm1_mil_next_pc_op2 or U_134 or 
	RG_apl2_full_dec_al2 or U_60 )
...
always @ ( full_dec_accumd_01_rg05 or U_175 or RG_xa2_xs or U_134 or RG_full_dec_ah2_wd3 or 
	...
	TR_12 = ( ( { 20{ U_60 } } & { RG_full_dec_ah2_wd3 , 5'h00 } )	// line#=computer.cpp:440
		...
		| ( { 20{ U_175 } } & full_dec_accumd_01_rg05 )		// line#=computer.cpp:748
		) ;
assign	sub24s_232i1 = { TR_12 , 2'h0 } ;	// line#=computer.cpp:440,733,748
always @ ( full_dec_accumd_01_rg05 or U_175 or RG_xa2_xs or U_134 or RG_full_dec_ah2_wd3 or 
	U_60 )
...
always @ ( addsub32s13ot or U_26 or U_27 or U_29 or U_30 or M_491 or RG_next_pc_PC or 
	...
	addsub32u_321i1_c1 = ( M_491 | ( ( ( U_30 | U_29 ) | U_27 ) | U_26 ) ) ;	// line#=computer.cpp:86,91,97,131,148
											// ,180,199,925,953
	addsub32u_321i1 = ( ( { 32{ M_494 } } & RG_next_pc_PC )		// line#=computer.cpp:847
...
always @ ( M_489 or M_494 )
	M_542 = ( ( { 2{ M_494 } } & 2'h1 )	// line#=computer.cpp:847
...
always @ ( addsub32s_32_11ot or U_175 or M_285_t or U_147 or mul20s_311ot or U_60 )
	addsub32s_321i1 = ( ( { 31{ U_60 } } & mul20s_311ot )					// line#=computer.cpp:415,416
		...
		| ( { 31{ U_175 } } & { addsub32s_32_11ot [29] , addsub32s_32_11ot [29:0] } )	// line#=computer.cpp:745,748
		) ;
...
always @ ( RG_xa2_xs or ST1_05d or M_292_t or U_137 )
	addsub32s_32_12i1 = ( ( { 30{ U_137 } } & { M_292_t , M_292_t , M_292_t , 
			...
			M_292_t , M_292_t , M_292_t , M_292_t , M_292_t , M_292_t , 
			M_292_t , M_292_t , M_292_t , M_292_t , M_292_t , M_292_t , 
			M_292_t , 8'h80 } )		// line#=computer.cpp:690
		| ( { 30{ ST1_05d } } & RG_xa2_xs )	// line#=computer.cpp:745
		) ;
always @ ( mul20s_31_11ot or ST1_05d or sub40s11ot or U_137 )
	addsub32s_32_12i2 = ( ( { 32{ U_137 } } & sub40s11ot [39:8] )	// line#=computer.cpp:689,690
...
always @ ( M_293_t or U_66 or M_289_t or U_137 )
	TR_14 = ( ( { 1{ U_137 } } & M_289_t )	// line#=computer.cpp:690
		| ( { 1{ U_66 } } & M_293_t )	// line#=computer.cpp:690
		) ;
assign	addsub32s_32_21i1 = { TR_14 , 8'h80 } ;	// line#=computer.cpp:690
...
always @ ( M_290_t or U_66 or M_288_t or U_147 )
	TR_15 = ( ( { 1{ U_147 } } & M_288_t )	// line#=computer.cpp:690
		| ( { 1{ U_66 } } & M_290_t )	// line#=computer.cpp:690
		) ;
assign	M_492 = ( U_147 | U_66 ) ;
always @ ( TR_15 or M_492 )
	TR_16 = ( { 2{ M_492 } } & { TR_15 , 1'h1 } )	// line#=computer.cpp:690
		 ;	// line#=computer.cpp:359
assign	addsub32s_32_22i1 = { TR_16 , 7'h00 } ;	// line#=computer.cpp:359,690
...
always @ ( addsub32u_321ot or M_449 or M_441 or M_443 or M_455 or M_451 or addsub32s13ot or 
	M_453 or M_457 )
	begin
	dmem_arg_MEMB32W65536_RA1_c1 = ( M_457 & M_453 ) ;	// line#=computer.cpp:86,91,165,174,925
								// ,935
...
always @ ( RG_full_dec_del_bpl_word_addr or U_107 or U_106 or addsub32s13ot or U_34 )
	...
	dmem_arg_MEMB32W65536_WA2 = ( ( { 16{ U_34 } } & addsub32s13ot [17:2] )				// line#=computer.cpp:86,97,218,227,953
...
always @ ( M_449 or M_447 or M_474 or imem_arg_MEMB32W65536_RD1 or M_513 or M_516 or 
	...
	regs_ad00_c1 = ( ( ( ( ( ( ( ( ( ( ( ( ( ( ( ( M_504 & ( ~CT_09 ) ) & ( ~
		...
		M_509 ) | M_510 ) | M_516 ) | M_513 ) ;	// line#=computer.cpp:831,842
	regs_ad00_c2 = ( M_474 | ( M_447 | M_449 ) ) ;	// line#=computer.cpp:831,843
...
always @ ( M_513 or M_516 or M_510 or M_509 or M_508 or M_507 or imem_arg_MEMB32W65536_RD1 or 
	...
	begin
	regs_ad01_c1 = ( ( M_474 | M_447 ) | M_449 ) ;	// line#=computer.cpp:831,842
	regs_ad01_c2 = ( ( ( ( ( M_507 | M_508 ) | M_509 ) | M_510 ) | M_516 ) | 
		M_513 ) ;	// line#=computer.cpp:831
...
always @ ( RG_addr_byte_offset_rd_rs2 or U_188 or U_191 or U_181 or U_176 or RG_i_rd or 
	M_496 )
	begin
	regs_ad04_c1 = ( ( ( U_176 | U_181 ) | U_191 ) | U_188 ) ;	// line#=computer.cpp:1101,1128
	regs_ad04 = ( ( { 5{ M_496 } } & RG_i_rd [4:0] )			// line#=computer.cpp:110,856,865,874,885
										// ,945,1009,1055
		| ( { 5{ regs_ad04_c1 } } & RG_addr_byte_offset_rd_rs2 )	// line#=computer.cpp:1101,1128
		) ;
	end
...
always @ ( M_011_t3 or U_188 or M_011_t4 or U_191 or M_011_t2 or U_181 or TR_24 or 
	...
	TR_18 = ( ( { 6{ M_495 } } & { 5'h00 , TR_24 } )
		| ( { 6{ U_181 } } & M_011_t2 )	// line#=computer.cpp:1128
		| ( { 6{ U_191 } } & M_011_t4 )	// line#=computer.cpp:1128
		| ( { 6{ U_188 } } & M_011_t3 )	// line#=computer.cpp:1128
		) ;
...
always @ ( addsub32s2ot or addsub32s_321ot or U_176 or RG_full_dec_del_bpl_instr or 
	...
	regs_wd04_c1 = ( ( U_118 & ( ( U_87 & M_452 ) | ( U_87 & M_442 ) ) ) | ( 
		U_129 & ( ( ( U_119 & RG_85 ) | ( U_88 & M_456 ) ) | ( U_88 & M_442 ) ) ) ) ;	// line#=computer.cpp:978,1023,1029
	regs_wd04_c2 = ( ( ( M_495 | U_181 ) | U_191 ) | U_188 ) ;	// line#=computer.cpp:1128
	regs_wd04_c3 = ( U_118 & ( U_87 & M_444 ) ) ;	// line#=computer.cpp:987
	regs_wd04_c4 = ( U_118 & ( U_87 & M_440 ) ) ;	// line#=computer.cpp:990
	regs_wd04_c5 = ( U_118 & ( U_87 & M_438 ) ) ;	// line#=computer.cpp:993
	regs_wd04_c6 = ( U_118 & U_116 ) ;	// line#=computer.cpp:996
	regs_wd04_c7 = ( U_96 | U_95 ) ;	// line#=computer.cpp:874,885
	regs_wd04_c8 = ( ( U_129 & U_128 ) | U_94 ) ;	// line#=computer.cpp:110,865,1025
	regs_wd04_c9 = ( U_129 & ( U_88 & M_444 ) ) ;	// line#=computer.cpp:1038
	regs_wd04_c10 = ( U_129 & ( U_88 & M_440 ) ) ;	// line#=computer.cpp:1048
	regs_wd04_c11 = ( U_129 & ( U_88 & M_438 ) ) ;	// line#=computer.cpp:1051
	regs_wd04 = ( ( { 32{ U_105 } } & val2_t4 )							// line#=computer.cpp:945
		...
		| ( { 32{ U_176 } } & { addsub32s_321ot [29:14] , addsub32s2ot [29:14] } )		// line#=computer.cpp:747,748,766,1096
													// ,1097,1101
		) ;
	end
assign	M_496 = ( ( ( ( ( ( U_105 | U_118 ) | U_96 ) | U_129 ) | U_94 ) | U_95 ) | 
	U_93 ) ;
assign	regs_we04 = ( ( ( ( M_496 | U_176 ) | U_181 ) | U_191 ) | U_188 ) ;	// line#=computer.cpp:110,856,865,874,885
