...
// bdlpars options:  -EE -DACCEL_ADPCM_UPZERO -DACCEL_ADPCM_UPZERO_U6 -DACCEL_ADPCM_FULL_ENCODE -DACCEL_ADPCM_FULL_ENCODE_QMF_U10 -info_base_name computer computer.cpp
// bdltran options:  -EE computer.IFF -c1000 -s -Zresource_fcnt=GENERATE -Zresource_mcnt=GENERATE -Zsync -Zdup_reset=YES -Zfolding_sharing=inter_stage -lb /proj/cad/cwb-6.1/packages/asic_45.BLIB -lfl /proj/cad/cwb-6.1/packages/asic_45.FLIB -o-P 
// timestamp_0: 20260830210729_53630_03229
// timestamp_5: 20260830210730_53652_98952
// timestamp_9: 20260830210737_53652_61178
// timestamp_C: 20260830210737_53652_46998
// timestamp_E: 20260830210737_53652_28360
// timestamp_V: 20260830210739_53683_70165
...
assign	addsub32s_311i1 = RG_full_enc_tqmf_4 ;	// line#=computer.cpp:610
assign	addsub32s_311i2 = addsub32s_3012ot ;	// line#=computer.cpp:595,610
assign	addsub32s_311_f = 2'h2 ;
assign	addsub32s_312i1 = RG_full_enc_tqmf_4 ;	// line#=computer.cpp:609
...
assign	M_816 = ~|( RG_106 ^ 32'h00000017 ) ;	// line#=computer.cpp:889,1113,1123,1133
						// ,1161
assign	M_818 = ~|( RG_106 ^ 32'h00000013 ) ;	// line#=computer.cpp:889,1113,1123,1133
						// ,1161
assign	M_820 = ~|( RG_106 ^ 32'h0000000f ) ;	// line#=computer.cpp:889,1113,1123,1133
						// ,1161
assign	M_822 = ~|( RG_106 ^ 32'h0000000b ) ;	// line#=computer.cpp:889,1113,1123,1133
						// ,1161
assign	M_822_port = M_822 ;
assign	M_834 = ~|( RG_106 ^ 32'h00000037 ) ;	// line#=computer.cpp:889,1113,1123,1133
						// ,1161
assign	M_836 = ~|( RG_106 ^ 32'h00000033 ) ;	// line#=computer.cpp:889,1113,1123,1133
						// ,1161
assign	M_838 = ~|( RG_106 ^ 32'h00000023 ) ;	// line#=computer.cpp:889,1113,1123,1133
						// ,1161
assign	M_847 = ~|( RG_106 ^ 32'h00000003 ) ;	// line#=computer.cpp:889,1113,1123,1133
						// ,1161
assign	M_850 = ~|( RG_106 ^ 32'h0000006f ) ;	// line#=computer.cpp:889,1113,1123,1133
						// ,1161
assign	M_852 = ~|( RG_106 ^ 32'h00000067 ) ;	// line#=computer.cpp:889,1113,1123,1133
						// ,1161
assign	M_854 = ~|( RG_106 ^ 32'h00000063 ) ;	// line#=computer.cpp:889,1113,1123,1133
						// ,1161
assign	M_856 = ~|( RG_106 ^ 32'h00000073 ) ;	// line#=computer.cpp:889,1113,1123,1133
						// ,1161
...
always @ ( posedge CLOCK )
	if ( RESET )
		...
		RG_full_enc_tqmf_1 <= RG_full_enc_tqmf_1_t ;	// line#=computer.cpp:539,606,1125,1126
...
always @ ( posedge CLOCK )
	if ( RG_106_en )
		RG_106 <= RG_106_t ;	// line#=computer.cpp:520,870,878,889
...
always @ ( RG_PC or RG_addr_bli_mask_next_pc or dmem_arg_MEMB32W65536_RD1 or M_844 or 
	...
	U_53 or addsub28s_25_41ot or ST1_03d )	// line#=computer.cpp:994
	begin
