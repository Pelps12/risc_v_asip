...
// timestamp_0: 20260617174904_24805_78311
// timestamp_5: 20260617174904_24819_62213
// timestamp_9: 20260617174907_24819_31080
// timestamp_C: 20260617174907_24819_39950
// timestamp_E: 20260617174907_24819_98770
// timestamp_V: 20260617174908_24834_05947
...
assign	addsub24s_221i1 = { RG_full_enc_tqmf_16 [19:0] , 2'h0 } ;	// line#=computer.cpp:573
assign	addsub24s_221i2 = RG_full_enc_tqmf_16 [21:0] ;	// line#=computer.cpp:573
...
assign	addsub32s_305i2 = RG_full_enc_tqmf_1 ;	// line#=computer.cpp:576
...
assign	addsub32s_309i2 = RG_full_enc_tqmf_11 ;	// line#=computer.cpp:574
assign	addsub32s_309_f = 2'h1 ;
assign	addsub32s_3010i1 = { RG_full_enc_tqmf_22 [27:0] , 2'h0 } ;	// line#=computer.cpp:573
assign	addsub32s_3010i2 = RG_full_enc_tqmf_22 ;	// line#=computer.cpp:573
...
assign	addsub32s_3015i1 = { addsub28s10ot [27:3] , RG_full_enc_tqmf_13 [2:0] , 2'h0 } ;	// line#=computer.cpp:574
assign	addsub32s_3015i2 = { addsub32s_323ot [29:1] , RG_full_enc_tqmf_5 [0] } ;	// line#=computer.cpp:574
assign	addsub32s_3015_f = 2'h1 ;
assign	addsub32s_3016i1 = RG_75 ;	// line#=computer.cpp:573
assign	addsub32s_3016i2 = { addsub32s_307ot [29:4] , addsub32s_3010ot [3:2] , RG_full_enc_tqmf_22 [1:0] } ;	// line#=computer.cpp:573
...
assign	addsub32s_291i2 = { addsub32s_325ot [28:1] , RG_full_enc_tqmf_18 [0] } ;	// line#=computer.cpp:573
...
always @ ( TR_56 or M_852 or RG_full_enc_tqmf_15 or U_52 )
	TR_09 = ( ( { 20{ U_52 } } & RG_full_enc_tqmf_15 [19:0] )	// line#=computer.cpp:574
...
always @ ( RG_dlt_full_enc_al1 or U_128 or RG_full_enc_tqmf_17 or U_52 )
	TR_10 = ( ( { 22{ U_52 } } & RG_full_enc_tqmf_17 [21:0] )	// line#=computer.cpp:574
		| ( { 22{ U_128 } } & { RG_dlt_full_enc_al1 , 6'h00 } )	// line#=computer.cpp:447
		) ;
assign	addsub24s2i1 = { TR_10 , 2'h0 } ;	// line#=computer.cpp:447,574
always @ ( RG_dlt_full_enc_al1 or U_128 or RG_full_enc_tqmf_17 or U_52 )
	addsub24s2i2 = ( ( { 24{ U_52 } } & RG_full_enc_tqmf_17 [23:0] )	// line#=computer.cpp:574
...
always @ ( RG_full_enc_tqmf_6 or U_01 or RG_full_enc_tqmf_13 or U_52 )
	TR_17 = ( ( { 26{ U_52 } } & { RG_full_enc_tqmf_13 [24:0] , 1'h0 } )	// line#=computer.cpp:574
...
always @ ( RG_full_enc_tqmf_14 or U_01 or RG_full_enc_tqmf_16 or U_52 )
	TR_19 = ( ( { 25{ U_52 } } & RG_full_enc_tqmf_16 [24:0] )	// line#=computer.cpp:573
...
always @ ( RG_full_enc_tqmf_18 or addsub32s_291ot or U_52 or mul32s_324ot or U_120 )
	addsub32s5i1 = ( ( { 32{ U_120 } } & mul32s_324ot )				// line#=computer.cpp:502
		| ( { 32{ U_52 } } & { addsub32s_291ot [28] , addsub32s_291ot [28] , 
			addsub32s_291ot [28:1] , RG_full_enc_tqmf_18 [0] , 1'h0 } )	// line#=computer.cpp:573
		) ;
...
always @ ( mul32s_327ot or U_128 or RG_full_enc_tqmf_11 or addsub32s_3011ot or U_52 )
	addsub32s10i2 = ( ( { 32{ U_52 } } & { addsub32s_3011ot [29] , addsub32s_3011ot [29] , 
			addsub32s_3011ot [29:1] , RG_full_enc_tqmf_11 [0] } )	// line#=computer.cpp:574
...
always @ ( mul32s_321ot or U_120 or regs_rd02 or U_57 or RG_next_pc_PC or U_56 or 
	...
	addsub32s13i1 = ( ( { 32{ U_01 } } & { addsub28s11ot [25] , addsub28s11ot [25] , 
		...
		| ( { 32{ U_52 } } & { addsub32s_3015ot [29] , addsub32s_3015ot [29] , 
			addsub32s_3015ot [29:2] , addsub32s_323ot [1] , RG_full_enc_tqmf_5 [0] } )	// line#=computer.cpp:574,577
...
always @ ( RG_full_enc_tqmf_12 or U_52 or sub20u_182ot or U_128 )
	addsub24s_242i1 = ( ( { 24{ U_128 } } & { sub20u_182ot [17] , sub20u_182ot [17] , 
		...
		| ( { 24{ U_52 } } & { RG_full_enc_tqmf_12 [19:0] , 4'h0 } )	// line#=computer.cpp:573
		) ;
always @ ( RG_full_enc_tqmf_12 or U_52 or add20u_19_192ot or U_128 )
	addsub24s_242i2 = ( ( { 24{ U_128 } } & { 1'h0 , add20u_19_192ot , 4'h0 } )	// line#=computer.cpp:613
		| ( { 24{ U_52 } } & RG_full_enc_tqmf_12 [23:0] )			// line#=computer.cpp:573
		) ;
...
always @ ( TR_57 or M_852 or RG_full_enc_tqmf_13 or U_52 )
	TR_29 = ( ( { 18{ U_52 } } & RG_full_enc_tqmf_13 [17:0] )	// line#=computer.cpp:574
...
always @ ( RG_full_enc_ah2 or M_857 or RG_full_enc_al2_nbh or U_120 or RG_full_enc_tqmf_13 or 
	U_52 )
	addsub24s_222i2 = ( ( { 22{ U_52 } } & RG_full_enc_tqmf_13 [21:0] )				// line#=computer.cpp:574
...
always @ ( RG_full_enc_al2_nbh or U_128 or RG_full_enc_tqmf_11 or U_52 )
	TR_30 = ( ( { 20{ U_52 } } & RG_full_enc_tqmf_11 [19:0] )	// line#=computer.cpp:574
...
always @ ( RG_full_enc_tqmf_15 or U_01 or sub40s12ot or M_862 or RG_full_enc_tqmf_9 or 
	...
	addsub32s_323i2 = ( ( { 32{ U_52 } } & { addsub32s_32_13ot [28] , addsub32s_32_13ot [28] , 
			addsub32s_32_13ot [28:2] , RG_full_enc_tqmf_9 [1:0] , 1'h0 } )	// line#=computer.cpp:574
...
always @ ( RG_full_enc_tqmf_2 or U_01 or sub40s5ot or M_862 or RG_full_enc_tqmf_16 or 
	...
	addsub32s_324i2 = ( ( { 32{ U_52 } } & { addsub32s_326ot [29] , addsub32s_326ot [29] , 
			addsub32s_326ot [29:1] , RG_full_enc_tqmf_16 [0] } )	// line#=computer.cpp:573
...
always @ ( RG_full_enc_tqmf_3 or U_01 or sub40s11ot or M_862 or RG_full_enc_tqmf_18 or 
	...
	addsub32s_325i2 = ( ( { 32{ U_52 } } & { addsub32s_32_11ot [28] , addsub32s_32_11ot [28] , 
			addsub32s_32_11ot [28] , addsub32s_32_11ot [28:2] , RG_full_enc_tqmf_18 [1:0] } )	// line#=computer.cpp:573
...
always @ ( TR_71 or U_196 or RG_full_enc_tqmf_5 or U_01 )
	TR_60 = ( ( { 28{ U_01 } } & RG_full_enc_tqmf_5 [27:0] )	// line#=computer.cpp:574
...
always @ ( sub40s2ot or U_196 or RG_full_enc_tqmf_16 or addsub32s_308ot or U_52 or 
	...
	addsub32s_326i2 = ( ( { 32{ U_01 } } & { RG_full_enc_tqmf_5 [29] , RG_full_enc_tqmf_5 [29] , 
		...
		| ( { 32{ U_52 } } & { addsub32s_308ot [29] , addsub32s_308ot [29] , 
			addsub32s_308ot [29:2] , RG_full_enc_tqmf_16 [1:0] } )	// line#=computer.cpp:573
...
always @ ( TR_73 or M_866 or RG_full_enc_tqmf_10 or U_52 )
	TR_48 = ( ( { 26{ U_52 } } & RG_full_enc_tqmf_10 [25:0] )				// line#=computer.cpp:573
...
always @ ( RG_full_enc_tqmf or U_01 or RG_full_enc_tqmf_11 or addsub32s_309ot or 
	U_52 )
	addsub32s_3011i1 = ( ( { 30{ U_52 } } & { addsub32s_309ot [29:2] , RG_full_enc_tqmf_11 [1:0] } )	// line#=computer.cpp:574
