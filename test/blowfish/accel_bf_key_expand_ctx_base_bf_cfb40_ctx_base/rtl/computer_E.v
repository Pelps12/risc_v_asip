...
// bdlpars options:  -EE -DACCEL_BF_KEY_EXPAND -DACCEL_BF_CFB40 -info_base_name computer computer.cpp
// bdltran options:  -EE computer.IFF -c1000 -s -Zresource_fcnt=GENERATE -Zresource_mcnt=GENERATE -Zsync -Zdup_reset=YES -Zfolding_sharing=inter_stage -lb /proj/cad/cwb-6.1/packages/asic_45.BLIB -lfl /proj/cad/cwb-6.1/packages/asic_45.FLIB -o-P 
// timestamp_0: 20260830204818_02239_88406
// timestamp_5: 20260830204819_02266_44977
// timestamp_9: 20260830204833_02266_53620
// timestamp_C: 20260830204833_02266_01260
// timestamp_E: 20260830204834_02266_57231
// timestamp_V: 20260830204835_02367_27949
...
assign	U_57 = ( ( U_16 & CT_13 ) & ( ~CT_12 ) ) ;	// line#=computer.cpp:486,1000
...
assign	U_401 = ( U_364 & RG_102 ) ;	// line#=computer.cpp:1000
...
assign	C_134 = ( ( ( ~FF_bf_ctx_fault_handled ) & ( ~|{ ~RG_funct3 [2:1] , RG_funct3 [0] } ) ) & 
	M_2319 ) ;	// line#=computer.cpp:1012
assign	U_523 = ( ST1_17d & C_134 ) ;	// line#=computer.cpp:1012
...
assign	M_2319 = ~|RG_funct7 ;	// line#=computer.cpp:1012,1057
...
always @ ( bf_ctx_fault_t5 or U_1055 or U_927 or FF_bf_ctx_valid or U_621 or handled_t5 or 
	...
	FF_bf_ctx_fault_handled_t_c1 = ( ( ( ( ( ( ( ( ( U_476 & B_04_t ) | ST1_07d ) | 
		U_523 ) | ST1_22d ) | U_549 ) | ST1_26d ) | U_610 ) | U_622 ) | U_1119 ) ;	// line#=computer.cpp:368,1002,1016,1064
												// ,1069
...
always @ ( RG_count_instr_rd_stream1_words or U_1055 or l_10_t8 or U_1039 or l_9_t8 or 
	...
	begin
	RG_k0_r_stream0_value_t_c1 = ( M_2339 | M_2377 ) ;	// line#=computer.cpp:321,596,1001,1062
								// ,1063
...
always @ ( index_1_t1 or U_547 or words_a06_t1 or ST1_21d or RG_index_1 or M_2410 or 
	...
	begin
	RG_index_length_words_t_c1 = ( M_2339 | U_548 ) ;	// line#=computer.cpp:587,1001,1067,1068
...
always @ ( l_11_t8 or U_1055 or r_11_t7 or U_1054 or r_11_t6 or U_1052 or r_11_t5 or 
	...
	begin
	RG_k1_r_stream1_w1_t_c1 = ( M_2339 | M_2376 ) ;	// line#=computer.cpp:372,597,1001,1062
							// ,1063
...
assign	M_2450 = ( M_2328 & ( ~CT_12 ) ) ;	// line#=computer.cpp:486,1000
...
assign	M_2328 = ( M_1788 & CT_13 ) ;	// line#=computer.cpp:486,1000
...
assign	M_2440 = ( ( ( M_1912 | M_1846 ) | M_2036 ) | M_2016 ) ;	// line#=computer.cpp:486,725,733,744
									// ,1000
assign	M_2438 = ( ( ( M_2440 | M_1808 ) | M_1837 ) | M_1902 ) ;	// line#=computer.cpp:486,1000
