...
// timestamp_0: 20260830210558_16031_43426
// timestamp_5: 20260830210558_16045_62446
// timestamp_9: 20260830210559_16045_32468
// timestamp_C: 20260830210559_16045_21570
// timestamp_E: 20260830210559_16045_22240
// timestamp_V: 20260830210559_16072_58449
...
reg	[31:0]	RG_imm1_instr_l ;	// line#=computer.cpp:371,867
reg	RG_22 ;
reg	RG_23 ;
...
always @ ( C_bf_ctx_read_word_1_t or U_180 or RG_imm1_instr_l or M_04 or ST1_07d or 
	...
	regs_rg10_t_c2 = ( ( U_107 | ST1_07d ) & M_04 ) ;	// line#=computer.cpp:240,601
	regs_rg10_t_c3 = ( U_180 & M_04 ) ;	// line#=computer.cpp:334
	regs_rg10_t = ( ( { 32{ regs_rg10_t_c1 } } & regs_wd04 )
		| ( { 32{ regs_rg10_t_c2 } } & RG_imm1_instr_l )	// line#=computer.cpp:240,601
...
always @ ( U_185 or C_bf_ctx_read_word_1_t or U_181 or M_139_t or ST1_07d or RG_old_x_stream0_w0 or 
	...
	regs_rg11_t_c4 = ( U_181 & M_05 ) ;	// line#=computer.cpp:335
	regs_rg11_t_c5 = ( U_185 & M_05 ) ;	// line#=computer.cpp:335
	regs_rg11_t = ( ( { 32{ regs_rg11_t_c1 } } & regs_wd04 )
		| ( { 32{ regs_rg11_t_c2 } } & RG_old_x_stream0_w0 )	// line#=computer.cpp:241
		| ( { 32{ regs_rg11_t_c3 } } & M_139_t )		// line#=computer.cpp:602
		| ( { 32{ regs_rg11_t_c4 } } & C_bf_ctx_read_word_1_t )	// line#=computer.cpp:335
...
assign	M_264 = ~RG_29 ;	// line#=computer.cpp:335,336
...
always @ ( U_185 or M_264 or U_181 or C_bf_ctx_read_word_1_t or U_182 or words_rg00 or 
	...
	regs_rg12_t_c3 = ( U_182 & M_06 ) ;	// line#=computer.cpp:336
	regs_rg12_t_c4 = ( ( ( U_181 & M_264 ) | U_185 ) & M_06 ) ;	// line#=computer.cpp:336
...
always @ ( words_rg05 or M_11 or ST1_08d or regs_wd04 or regs_d04 or regs_we04 )	// line#=computer.cpp:19
	...
	regs_rg17_t_c2 = ( ST1_08d & M_11 ) ;	// line#=computer.cpp:605
...
always @ ( words_rg09 or words_rg08 or words_rg07 or words_rg06 or words_rg05 or 
	words_rg04 or words_rg03 or words_rg02 or words_rg01 or words_rg00 or M_389 )	// line#=computer.cpp:585
	case ( M_389 )
	4'h0 :
...
always @ ( RG_regs_w2 or M_13 or U_108 or words_wd01 or words_d01 or words_we01 )	// line#=computer.cpp:585
	begin
...
always @ ( RG_regs_w3 or M_14 or U_108 or words_wd01 or words_d01 or words_we01 )	// line#=computer.cpp:585
	begin
...
always @ ( RG_regs or M_15 or U_108 or words_wd01 or words_d01 or words_we01 )	// line#=computer.cpp:585
	begin
...
always @ ( RG_regs_1 or M_16 or U_108 or words_wd01 or words_d01 or words_we01 )	// line#=computer.cpp:585
	begin
...
always @ ( RG_regs_2 or M_17 or U_108 or words_wd01 or words_d01 or words_we01 )	// line#=computer.cpp:585
	begin
...
always @ ( RG_regs_3 or M_18 or U_108 or words_wd01 or words_d01 or words_we01 )	// line#=computer.cpp:585
	begin
...
always @ ( RG_index_regs or M_19 or U_108 or words_wd01 or words_d01 or words_we01 )	// line#=computer.cpp:585
	begin
...
always @ ( RG_r_regs_stream1_w1 or M_22 or U_108 or words_wd01 or words_d01 or words_we01 )	// line#=computer.cpp:585
	begin
	...
	words_rg09_t = ( ( { 32{ words_rg09_t_c1 } } & words_wd01 )
		| ( { 32{ words_rg09_t_c2 } } & RG_r_regs_stream1_w1 )	// line#=computer.cpp:587
		) ;
	end
...
assign	CT_03 = ( ( ~|{ imem_arg_MEMB32W65536_RD1 [14:13] , ~imem_arg_MEMB32W65536_RD1 [12] } ) & 
	M_338 ) ;	// line#=computer.cpp:725,735,738,987
always @ ( FF_take or RG_r_regs_stream1_w1 )	// line#=computer.cpp:790
	...
	endcase
always @ ( dmem_arg_MEMB32W65536_0_RD1 or rsft32u1ot or RG_imm1_instr_l )	// line#=computer.cpp:821
...
assign	M_137_t = ( words_rd00 ^ RG_old_x_stream0_w0 ) ;	// line#=computer.cpp:599
assign	M_139_t = ( words_rd00 ^ RG_r_regs_stream1_w1 ) ;	// line#=computer.cpp:600
assign	CT_39 = ~|addsub32u_321ot [31:8] ;	// line#=computer.cpp:277,298,299
assign	CT_40 = ~|{ addsub32u_321ot [31:9] , ~addsub32u_321ot [8] } ;	// line#=computer.cpp:279,298,299
...
assign	r_t = ( ( RG_r_regs_stream1_w1 ^ RL_addr_addr1_next_pc_op1_PC ) ^ C_accel_bf_ctx_f_1_t2 ) ;	// line#=computer.cpp:382
assign	l_t1 = ( ( RG_imm1_instr_l ^ RL_addr_addr1_next_pc_op1_PC ) ^ C_accel_bf_ctx_f_1_t2 ) ;	// line#=computer.cpp:384,387
...
assign	U_05 = ( ST1_03d & M_317 ) ;	// line#=computer.cpp:725,733,744
assign	U_06 = ( ST1_03d & M_315 ) ;	// line#=computer.cpp:725,733,744
assign	U_07 = ( ST1_03d & M_319 ) ;	// line#=computer.cpp:725,733,744
assign	U_09 = ( ST1_03d & M_324 ) ;	// line#=computer.cpp:725,733,744
assign	U_10 = ( ST1_03d & M_302 ) ;	// line#=computer.cpp:725,733,744
assign	U_11 = ( ST1_03d & M_326 ) ;	// line#=computer.cpp:725,733,744
assign	U_12 = ( ST1_03d & M_313 ) ;	// line#=computer.cpp:725,733,744
assign	U_13 = ( ST1_03d & M_328 ) ;	// line#=computer.cpp:725,733,744
assign	U_16 = ( ST1_03d & ( ~|( { 25'h0000000 , imem_arg_MEMB32W65536_RD1 [6:0] } ^ 
	32'h0000000b ) ) ) ;	// line#=computer.cpp:725,733,744
assign	M_302 = ~|( { 25'h0000000 , imem_arg_MEMB32W65536_RD1 [6:0] } ^ 32'h00000003 ) ;	// line#=computer.cpp:725,733,744
assign	M_313 = ~|( { 25'h0000000 , imem_arg_MEMB32W65536_RD1 [6:0] } ^ 32'h00000013 ) ;	// line#=computer.cpp:725,733,744
assign	M_315 = ~|( { 25'h0000000 , imem_arg_MEMB32W65536_RD1 [6:0] } ^ 32'h00000017 ) ;	// line#=computer.cpp:725,733,744
assign	M_317 = ~|( { 25'h0000000 , imem_arg_MEMB32W65536_RD1 [6:0] } ^ 32'h00000037 ) ;	// line#=computer.cpp:725,733,744
assign	M_319 = ~|( { 25'h0000000 , imem_arg_MEMB32W65536_RD1 [6:0] } ^ 32'h0000006f ) ;	// line#=computer.cpp:725,733,744
assign	M_324 = ~|( { 25'h0000000 , imem_arg_MEMB32W65536_RD1 [6:0] } ^ 32'h00000063 ) ;	// line#=computer.cpp:725,733,744
assign	M_326 = ~|( { 25'h0000000 , imem_arg_MEMB32W65536_RD1 [6:0] } ^ 32'h00000023 ) ;	// line#=computer.cpp:725,733,744
assign	M_328 = ~|( { 25'h0000000 , imem_arg_MEMB32W65536_RD1 [6:0] } ^ 32'h00000033 ) ;	// line#=computer.cpp:725,733,744
assign	U_22 = ( U_09 & M_309 ) ;	// line#=computer.cpp:725,735,790
assign	U_23 = ( U_09 & M_273 ) ;	// line#=computer.cpp:725,735,790
assign	M_258 = ~|{ 29'h00000000 , imem_arg_MEMB32W65536_RD1 [14:12] } ;	// line#=computer.cpp:725,733,735,744,790
										// ,821,849,870,914
assign	M_273 = ~|( { 29'h00000000 , imem_arg_MEMB32W65536_RD1 [14:12] } ^ 32'h00000007 ) ;	// line#=computer.cpp:725,733,735,744,790
												// ,870,914
assign	M_279 = ~|( { 29'h00000000 , imem_arg_MEMB32W65536_RD1 [14:12] } ^ 32'h00000004 ) ;	// line#=computer.cpp:725,733,735,744,790
												// ,821,870,914
assign	M_284 = ~|( { 29'h00000000 , imem_arg_MEMB32W65536_RD1 [14:12] } ^ 32'h00000001 ) ;	// line#=computer.cpp:725,735,790,821,849
												// ,870,914
assign	M_296 = ~|( { 29'h00000000 , imem_arg_MEMB32W65536_RD1 [14:12] } ^ 32'h00000005 ) ;	// line#=computer.cpp:725,733,735,744,790
												// ,821,870,914
assign	M_309 = ~|( { 29'h00000000 , imem_arg_MEMB32W65536_RD1 [14:12] } ^ 32'h00000006 ) ;	// line#=computer.cpp:725,733,735,744,790
												// ,870,914
assign	U_25 = ( U_10 & M_258 ) ;	// line#=computer.cpp:725,735,821
assign	U_26 = ( U_10 & M_284 ) ;	// line#=computer.cpp:725,735,821
assign	U_28 = ( U_10 & M_279 ) ;	// line#=computer.cpp:725,735,821
assign	U_29 = ( U_10 & M_296 ) ;	// line#=computer.cpp:725,735,821
assign	M_266 = ~|( { 29'h00000000 , imem_arg_MEMB32W65536_RD1 [14:12] } ^ 32'h00000002 ) ;	// line#=computer.cpp:725,735,821,849,870
												// ,914
assign	U_31 = ( U_11 & M_258 ) ;	// line#=computer.cpp:725,735,849
assign	U_32 = ( U_11 & M_284 ) ;	// line#=computer.cpp:725,735,849
assign	U_37 = ( U_12 & M_303 ) ;	// line#=computer.cpp:725,735,870
assign	M_303 = ~|( { 29'h00000000 , imem_arg_MEMB32W65536_RD1 [14:12] } ^ 32'h00000003 ) ;	// line#=computer.cpp:725,735,870,914
assign	U_46 = ( U_13 & M_303 ) ;	// line#=computer.cpp:725,735,914
assign	U_53 = ( ST1_04d & M_318 ) ;	// line#=computer.cpp:744
assign	U_54 = ( ST1_04d & M_316 ) ;	// line#=computer.cpp:744
assign	U_55 = ( ST1_04d & M_320 ) ;	// line#=computer.cpp:744
assign	U_56 = ( ST1_04d & M_322 ) ;	// line#=computer.cpp:744
assign	U_57 = ( ST1_04d & M_325 ) ;	// line#=computer.cpp:744
assign	U_58 = ( ST1_04d & M_304 ) ;	// line#=computer.cpp:744
assign	U_59 = ( ST1_04d & M_327 ) ;	// line#=computer.cpp:744
assign	U_60 = ( ST1_04d & M_314 ) ;	// line#=computer.cpp:744
assign	U_61 = ( ST1_04d & M_329 ) ;	// line#=computer.cpp:744
assign	U_63 = ( ST1_04d & M_331 ) ;	// line#=computer.cpp:744
assign	U_64 = ( ST1_04d & M_294 ) ;	// line#=computer.cpp:744
assign	M_278 = ~|( RG_i_index_next_pc_PC ^ 32'h0000000f ) ;	// line#=computer.cpp:744
assign	M_294 = ~|( RG_i_index_next_pc_PC ^ 32'h0000000b ) ;	// line#=computer.cpp:744
assign	M_304 = ~|( RG_i_index_next_pc_PC ^ 32'h00000003 ) ;	// line#=computer.cpp:744
assign	M_314 = ~|( RG_i_index_next_pc_PC ^ 32'h00000013 ) ;	// line#=computer.cpp:744
assign	M_316 = ~|( RG_i_index_next_pc_PC ^ 32'h00000017 ) ;	// line#=computer.cpp:744
assign	M_318 = ~|( RG_i_index_next_pc_PC ^ 32'h00000037 ) ;	// line#=computer.cpp:744
assign	M_320 = ~|( RG_i_index_next_pc_PC ^ 32'h0000006f ) ;	// line#=computer.cpp:744
assign	M_322 = ~|( RG_i_index_next_pc_PC ^ 32'h00000067 ) ;	// line#=computer.cpp:744
assign	M_325 = ~|( RG_i_index_next_pc_PC ^ 32'h00000063 ) ;	// line#=computer.cpp:744
assign	M_327 = ~|( RG_i_index_next_pc_PC ^ 32'h00000023 ) ;	// line#=computer.cpp:744
assign	M_329 = ~|( RG_i_index_next_pc_PC ^ 32'h00000033 ) ;	// line#=computer.cpp:744
assign	M_331 = ~|( RG_i_index_next_pc_PC ^ 32'h00000073 ) ;	// line#=computer.cpp:744
assign	U_65 = ( ST1_04d & M_373 ) ;	// line#=computer.cpp:744
assign	U_67 = ( U_54 & FF_take ) ;	// line#=computer.cpp:758
assign	U_70 = ( U_57 & take_t1 ) ;	// line#=computer.cpp:810
assign	M_259 = ~|RG_imm1_instr_l ;	// line#=computer.cpp:821,849
assign	M_267 = ~|( RG_imm1_instr_l ^ 32'h00000002 ) ;	// line#=computer.cpp:821,849
assign	M_285 = ~|( RG_imm1_instr_l ^ 32'h00000001 ) ;	// line#=computer.cpp:821,849
assign	M_334 = |RG_i_rd ;	// line#=computer.cpp:778,838,902,948
assign	U_83 = ( U_60 & M_260 ) ;	// line#=computer.cpp:870
assign	U_90 = ( U_60 & M_298 ) ;	// line#=computer.cpp:870
assign	M_260 = ~|RG_r_regs_stream1_w1 ;	// line#=computer.cpp:870,914
assign	U_94 = ( U_61 & M_260 ) ;	// line#=computer.cpp:914
assign	M_286 = ~|( RG_r_regs_stream1_w1 ^ 32'h00000001 ) ;	// line#=computer.cpp:870,914
assign	M_298 = ~|( RG_r_regs_stream1_w1 ^ 32'h00000005 ) ;	// line#=computer.cpp:870,914
assign	U_99 = ( U_61 & M_298 ) ;	// line#=computer.cpp:914
assign	U_102 = ( U_94 & RG_imm1_instr_l [23] ) ;	// line#=computer.cpp:916
assign	U_103 = ( U_94 & ( ~RG_imm1_instr_l [23] ) ) ;	// line#=computer.cpp:916
assign	U_107 = ( U_64 & RG_29 ) ;	// line#=computer.cpp:987
assign	U_108 = ( U_64 & FF_take ) ;	// line#=computer.cpp:1012
assign	U_122 = ( ST1_07d & FF_take ) ;	// line#=computer.cpp:595
assign	C_06 = ( ( ( ~handled_t4 ) & M_268 ) & ( ~|{ RG_funct7 [6:1] , ~RG_funct7 [0] } ) ) ;	// line#=computer.cpp:1061
assign	U_126 = ( ST1_09d & C_06 ) ;	// line#=computer.cpp:1061
assign	U_127 = ( ST1_09d & ( ~C_06 ) ) ;	// line#=computer.cpp:1061
assign	C_07 = ( ( ( M_339 | comp32u_1_11ot [2] ) | comp32u_12ot [2] ) | gop36u_11ot ) ;	// line#=computer.cpp:311,1062,1063
assign	U_129 = ( U_126 & ( ~C_07 ) ) ;	// line#=computer.cpp:311
assign	C_08 = ( ( ~bf_ctx_valid_t ) & ( |( regs_rg05 ^ bf_ctx_load_next_t1 ) ) ) ;	// line#=computer.cpp:315,1062,1063
assign	M_268 = ~|{ RG_funct3_i_1 [2] , ~RG_funct3_i_1 [1] , RG_funct3_i_1 [0] } ;	// line#=computer.cpp:1057,1061,1066,1071
assign	C_09 = ( M_370 & ( ~|RG_funct7 ) ) ;	// line#=computer.cpp:1057
assign	U_138 = ( ST1_10d & comp32u_11ot [3] ) ;	// line#=computer.cpp:319
assign	U_145 = ( U_138 & ( ~comp32u_1_11ot [3] ) ) ;	// line#=computer.cpp:295
assign	U_147 = ( U_145 & ( ~CT_39 ) ) ;	// line#=computer.cpp:277,299
assign	U_149 = ( U_147 & ( ~CT_40 ) ) ;	// line#=computer.cpp:279,299
assign	U_152 = ( ( ST1_10d & ( ~comp32u_11ot [3] ) ) & ( ~FF_bf_ctx_valid ) ) ;	// line#=computer.cpp:319,323
assign	M_370 = ( ( ~FF_bf_ctx_fault_handled ) & M_268 ) ;	// line#=computer.cpp:1057,1066,1071
assign	C_11 = ( M_370 & ( ~|{ RG_funct7 [6:2] , ~RG_funct7 [1] , RG_funct7 [0] } ) ) ;	// line#=computer.cpp:1066
assign	U_155 = ( ST1_11d & C_11 ) ;	// line#=computer.cpp:1066
assign	U_156 = ( ST1_11d & ( ~C_11 ) ) ;	// line#=computer.cpp:1066
assign	M_339 = ~|regs_rg06 ;	// line#=computer.cpp:311,329,330,1062
				// ,1063,1067,1068
assign	C_12 = ( ( ( ( ( ~FF_bf_ctx_valid ) | M_339 ) | comp32u_1_11ot [2] ) | comp32u_12ot [2] ) | 
	gop36u_11ot ) ;	// line#=computer.cpp:329,330,1067,1068
assign	U_157 = ( U_155 & C_12 ) ;	// line#=computer.cpp:329,330
assign	U_158 = ( U_155 & ( ~C_12 ) ) ;	// line#=computer.cpp:329,330
assign	C_13 = ( M_370 & ( ~|{ RG_funct7 [6:2] , ~RG_funct7 [1:0] } ) ) ;	// line#=computer.cpp:1071
assign	U_170 = ( ST1_12d & ( ~|( RG_funct3_i [1:0] ^ 2'h1 ) ) ) ;
assign	U_173 = ( ST1_12d & ( ~comp32u_12ot [3] ) ) ;	// line#=computer.cpp:288
assign	U_174 = ( U_173 & CT_52 ) ;	// line#=computer.cpp:267,291
assign	U_175 = ( U_173 & ( ~CT_52 ) ) ;	// line#=computer.cpp:267,291
assign	U_176 = ( U_175 & CT_51 ) ;	// line#=computer.cpp:269,291
assign	U_177 = ( U_175 & ( ~CT_51 ) ) ;	// line#=computer.cpp:269,291
assign	U_178 = ( U_177 & CT_50 ) ;	// line#=computer.cpp:271,291
assign	U_179 = ( U_177 & ( ~CT_50 ) ) ;	// line#=computer.cpp:271,291
...
assign	U_184 = ( U_180 & RG_29 ) ;	// line#=computer.cpp:335,336
assign	U_185 = ( U_180 & M_264 ) ;	// line#=computer.cpp:335
assign	U_186 = ( U_181 & RG_29 ) ;	// line#=computer.cpp:335,336
assign	U_188 = ( U_182 & M_333 ) ;	// line#=computer.cpp:337
...
assign	U_216 = ( ST1_14d & FF_bf_ctx_valid ) ;	// line#=computer.cpp:347
...
always @ ( RL_addr_addr1_next_pc_op1_PC or M_348 or M_183_t or M_343 )
	TR_03 = ( ( { 31{ M_343 } } & M_183_t )
		| ( { 31{ M_348 } } & RL_addr_addr1_next_pc_op1_PC [31:1] )	// line#=computer.cpp:1104
		) ;
assign	M_333 = |RG_count_op2_regs_word_addr [31:2] ;	// line#=computer.cpp:337
always @ ( incr32u1ot or RG_29 )	// line#=computer.cpp:335
	case ( RG_29 )
	1'h1 :
	...
	endcase
always @ ( addsub32u1ot or RG_29 )	// line#=computer.cpp:336
	case ( RG_29 )
	1'h1 :
	...
	endcase
always @ ( addsub32u1ot or M_333 )	// line#=computer.cpp:337
	case ( M_333 )
	1'h1 :
...
always @ ( RG_i_index_next_pc_PC_t3 or U_182 or RG_i_index_next_pc_PC_t2 or U_181 or 
	...
	U_60 or U_59 or U_58 or U_54 or U_53 or ST1_04d or TR_01 or M_358 or ST1_03d )	// line#=computer.cpp:744
	begin
	RG_i_index_next_pc_PC_t_c1 = ( ST1_03d | M_358 ) ;	// line#=computer.cpp:319,725,733,744
	RG_i_index_next_pc_PC_t_c2 = ( ST1_04d & ( ( ( ( ( ( ( ( ( U_53 | U_54 ) | 
		U_58 ) | U_59 ) | U_60 ) | U_61 ) | ( ST1_04d & M_278 ) ) | U_63 ) | 
		U_64 ) | U_65 ) ) ;	// line#=computer.cpp:741
	RG_i_index_next_pc_PC_t_c3 = ( ( ST1_04d & U_55 ) | ( ST1_04d & U_56 ) ) ;	// line#=computer.cpp:86,91,118,769,777
											// ,780
	RG_i_index_next_pc_PC_t_c4 = ( M_343 | M_348 ) ;	// line#=computer.cpp:1104
	RG_i_index_next_pc_PC_t_c5 = ( M_357 | U_127 ) ;
	RG_i_index_next_pc_PC_t_c6 = ( ST1_13d & M_367 ) ;	// line#=computer.cpp:337
	RG_i_index_next_pc_PC_t = ( ( { 32{ RG_i_index_next_pc_PC_t_c1 } } & { 25'h0000000 , 
			TR_01 } )										// line#=computer.cpp:319,725,733,744
		| ( { 32{ RG_i_index_next_pc_PC_t_c2 } } & RG_09 )						// line#=computer.cpp:741
		| ( { 32{ RG_i_index_next_pc_PC_t_c3 } } & { add32s1ot [31:1] , ( 
			M_320 & add32s1ot [0] ) } )								// line#=computer.cpp:86,91,118,769,777
														// ,780
		...
		| ( { 32{ U_138 } } & incr32u1ot )								// line#=computer.cpp:319
		| ( { 32{ U_158 } } & regs_rg05 )								// line#=computer.cpp:334,1067,1068
		| ( { 32{ RG_i_index_next_pc_PC_t_c6 } } & C_bf_ctx_read_word_1_t )				// line#=computer.cpp:337
		| ( { 32{ U_180 } } & RG_i_index_next_pc_PC_t1 )						// line#=computer.cpp:335
		| ( { 32{ U_181 } } & RG_i_index_next_pc_PC_t2 )						// line#=computer.cpp:336
		| ( { 32{ U_182 } } & RG_i_index_next_pc_PC_t3 )						// line#=computer.cpp:337
		) ;
	end
assign	RG_i_index_next_pc_PC_en = ( RG_i_index_next_pc_PC_t_c1 | RG_i_index_next_pc_PC_t_c2 | 
	...
	U_138 | U_158 | RG_i_index_next_pc_PC_t_c6 | U_180 | U_181 | U_182 ) ;	// line#=computer.cpp:744
always @ ( posedge CLOCK )	// line#=computer.cpp:744
	if ( RESET )
		RG_i_index_next_pc_PC <= 32'h00000000 ;
	else if ( RG_i_index_next_pc_PC_en )
		RG_i_index_next_pc_PC <= RG_i_index_next_pc_PC_t ;	// line#=computer.cpp:86,91,118,319,334
									// ,335,336,337,725,733,741,744,769
									// ,777,780,1067,1068,1104
...
assign	M_355 = ( ( ST1_05d & FF_bf_ctx_valid ) | U_158 ) ;	// line#=computer.cpp:367
always @ ( RG_funct3_i_1 or M_344 or TR_24 or U_188 or U_186 or M_359 or i_11_t1 or 
	...
	TR_04 = ( ( { 3{ ST1_03d } } & imem_arg_MEMB32W65536_RD1 [14:12] )	// line#=computer.cpp:725,735
		...
		| ( { 3{ M_344 } } & RG_funct3_i_1 )				// line#=computer.cpp:595
		) ;
	end
...
always @ ( RG_funct3_i_t1 or ST1_15d or TR_04 or U_188 or U_186 or U_184 or M_344 or 
	...
	RG_funct3_i_t_c1 = ( ( ( ( ( M_342 | M_355 ) | M_344 ) | U_184 ) | U_186 ) | 
		U_188 ) ;	// line#=computer.cpp:595,725,735
...
assign	M_357 = ( U_126 & ( ( U_126 & C_07 ) | ( U_129 & C_08 ) ) ) ;	// line#=computer.cpp:311,315
assign	M_358 = ( U_126 & ( U_129 & ( ~C_08 ) ) ) ;	// line#=computer.cpp:315
always @ ( bf_ctx_fault_t4 or ST1_15d or bf_ctx_fault_t3 or U_156 or FF_bf_ctx_fault or 
	...
	FF_bf_ctx_fault_t_c2 = ( M_357 | U_157 ) ;	// line#=computer.cpp:312,316,331
	FF_bf_ctx_fault_t_c3 = ( M_358 | U_127 ) ;	// line#=computer.cpp:305
	FF_bf_ctx_fault_t = ( ( { 1{ FF_bf_ctx_fault_t_c1 } } & FF_bf_ctx_fault_handled )
		...
		| ( { 1{ FF_bf_ctx_fault_t_c3 } } & ( ( ~C_09 ) & FF_bf_ctx_fault ) )	// line#=computer.cpp:305
...
always @ ( posedge CLOCK )
	if ( RESET )
		...
		FF_bf_ctx_fault <= FF_bf_ctx_fault_t ;	// line#=computer.cpp:305,312,316,331
always @ ( bf_ctx_valid_t1 or C_13 or U_156 or bf_ctx_valid_t or ST1_09d )	// line#=computer.cpp:1071
	begin
	FF_bf_ctx_valid_t_c1 = ( U_156 & C_13 ) ;	// line#=computer.cpp:341
...
always @ ( bf_ctx_fault_t4 or ST1_15d or CT_51 or ST1_12d or handled_t6 or U_156 or 
	...
	FF_bf_ctx_fault_handled_t_c1 = ( ( ( ( ( ST1_05d | ST1_08d ) | U_126 ) | 
		ST1_10d ) | U_155 ) | ST1_16d ) ;	// line#=computer.cpp:368,1016,1064,1069
	FF_bf_ctx_fault_handled_t = ( ( { 1{ U_16 } } & CT_03 )		// line#=computer.cpp:979,987,990
		...
		| ( { 1{ U_127 } } & handled_t4 )
		| ( { 1{ U_156 } } & handled_t6 )
		| ( { 1{ ST1_12d } } & CT_51 )				// line#=computer.cpp:269,291
		| ( { 1{ ST1_15d } } & bf_ctx_fault_t4 ) ) ;
	end
...
always @ ( handled_t6 or FF_bf_ctx_fault or ST1_16d or bf_ctx_fault_t3 or U_156 or 
	U_157 or U_65 or U_63 or ST1_04d )	// line#=computer.cpp:1087
	begin
	FF_halt_t_c1 = ( ( ( ST1_04d & ( U_63 | U_65 ) ) | ( ( U_157 | ( U_156 & 
		bf_ctx_fault_t3 ) ) | ( ST1_16d & FF_bf_ctx_fault ) ) ) | ( ( U_156 & ( 
		~bf_ctx_fault_t3 ) ) & ( U_156 & ( ~handled_t6 ) ) ) ) ;	// line#=computer.cpp:966,1081,1088,1099
...
always @ ( RG_count_op2_regs_word_addr or RG_r_regs_stream1_w1 or ST1_15d or regs_rg10 or 
	...
	begin
	RG_old_x_stream0_w0_t_c1 = ( ( ST1_02d | ST1_05d ) | ST1_09d ) ;	// line#=computer.cpp:239,596,1062,1063
	RG_old_x_stream0_w0_t = ( ( { 32{ RG_old_x_stream0_w0_t_c1 } } & regs_rg10 )			// line#=computer.cpp:239,596,1062,1063
		| ( { 32{ ST1_15d } } & ( RG_r_regs_stream1_w1 ^ RG_count_op2_regs_word_addr ) )	// line#=computer.cpp:386
		) ;
	end
...
always @ ( regs_rg05 or M_347 or RG_index_regs_t1 or ST1_02d )
	RG_index_regs_t = ( ( { 32{ ST1_02d } } & RG_index_regs_t1 )
		| ( { 32{ M_347 } } & regs_rg05 )	// line#=computer.cpp:1062,1063,1067,1068
		) ;
...
always @ ( bf_ctx_p_rg17 or ST1_14d or regs_rg06 or M_347 or addsub32u1ot or U_32 or 
	...
	RG_count_op2_regs_word_addr_t = ( ( { 32{ ST1_02d } } & RG_count_op2_regs_word_addr_t1 )
		...
		| ( { 32{ M_347 } } & regs_rg06 )							// line#=computer.cpp:1062,1063,1067,1068
...
always @ ( add32s1ot or M_326 )
	TR_25 = ( { 16{ M_326 } } & add32s1ot [17:2] )	// line#=computer.cpp:86,97,847
...
always @ ( RL_addr_addr1_next_pc_op1_PC_t2 or ST1_14d or U_231 or U_230 or U_229 or 
	...
	RL_addr_addr1_next_pc_op1_PC_t = ( ( { 32{ ST1_02d } } & RL_addr_addr1_next_pc_op1_PC_t1 )
		...
		| ( { 32{ M_350 } } & { 14'h0000 , TR_25 , add32s1ot [1:0] } )	// line#=computer.cpp:86,91,97,819,847
		| ( { 32{ RL_addr_addr1_next_pc_op1_PC_t_c1 } } & RG_i_index_next_pc_PC )
		| ( { 32{ ST1_05d } } & l_t )					// line#=computer.cpp:382
		| ( { 32{ U_217 } } & r_t )					// line#=computer.cpp:384
		| ( { 32{ U_218 } } & l_t1 )					// line#=computer.cpp:382
		| ( { 32{ U_219 } } & r_t )					// line#=computer.cpp:382,384
		| ( { 32{ U_220 } } & l_t1 )					// line#=computer.cpp:382,384
		| ( { 32{ U_221 } } & r_t )					// line#=computer.cpp:382,384
		| ( { 32{ U_222 } } & l_t1 )					// line#=computer.cpp:382,384
		| ( { 32{ U_223 } } & r_t )					// line#=computer.cpp:382,384
		| ( { 32{ U_224 } } & l_t1 )					// line#=computer.cpp:382,384
		| ( { 32{ U_225 } } & r_t )					// line#=computer.cpp:382,384
		| ( { 32{ U_226 } } & l_t1 )					// line#=computer.cpp:382,384
		| ( { 32{ U_227 } } & r_t )					// line#=computer.cpp:382,384
		| ( { 32{ U_228 } } & l_t1 )					// line#=computer.cpp:382,384
		| ( { 32{ U_229 } } & r_t )					// line#=computer.cpp:382,384
		| ( { 32{ U_230 } } & l_t1 )					// line#=computer.cpp:382,384
		| ( { 32{ U_231 } } & r_t )					// line#=computer.cpp:382,384
...
always @ ( posedge CLOCK )
	if ( RESET )
		...
		RL_addr_addr1_next_pc_op1_PC <= RL_addr_addr1_next_pc_op1_PC_t ;	// line#=computer.cpp:86,91,97,382,384
											// ,587,819,847,911
always @ ( regs_rg28 or U_01 )
	RG_r_regs_stream1_w1_t1 = ( { 32{ U_01 } } & regs_rg28 )	// line#=computer.cpp:587
		 ;
always @ ( l_t1 or M_308 or M_301 or M_276 or M_295 or M_307 or M_312 or M_300 or 
	...
	RG_r_regs_stream1_w1_t_c3 = ( ST1_15d & ( ~( ( ( ( ( ( ( ( ( ( ( ( ( ( M_262 | 
		...
		M_300 ) | M_312 ) | M_307 ) | M_295 ) | M_276 ) | M_301 ) | M_308 ) ) ) ;	// line#=computer.cpp:384,387
	RG_r_regs_stream1_w1_t = ( ( { 32{ ST1_02d } } & RG_r_regs_stream1_w1_t1 )
		...
		| ( { 32{ U_217 } } & r_t )										// line#=computer.cpp:382
		| ( { 32{ U_219 } } & r_t )										// line#=computer.cpp:382
		| ( { 32{ U_221 } } & r_t )										// line#=computer.cpp:382
		| ( { 32{ U_223 } } & r_t )										// line#=computer.cpp:382
		| ( { 32{ U_225 } } & r_t )										// line#=computer.cpp:382
		| ( { 32{ U_227 } } & r_t )										// line#=computer.cpp:382
		| ( { 32{ U_229 } } & r_t )										// line#=computer.cpp:382
		| ( { 32{ U_231 } } & r_t )										// line#=computer.cpp:382
		| ( { 32{ RG_r_regs_stream1_w1_t_c3 } } & l_t1 )							// line#=computer.cpp:384,387
		) ;
	end
...
always @ ( M_326 or M_302 or imem_arg_MEMB32W65536_RD1 or M_324 or M_323 or M_319 or 
	...
	TR_06_c1 = ( ( ( ( ( ( ( M_313 & M_296 ) | M_328 ) | M_317 ) | M_315 ) | 
		M_319 ) | M_323 ) | M_324 ) ;	// line#=computer.cpp:725
	TR_06_c2 = ( M_302 | M_326 ) ;	// line#=computer.cpp:725,735,821,849
...
assign	M_323 = ~|( { 25'h0000000 , imem_arg_MEMB32W65536_RD1 [6:0] } ^ 32'h00000067 ) ;	// line#=computer.cpp:725,733,735,744,870
always @ ( U_230 or U_228 or U_226 or U_224 or U_222 or U_220 or l_t1 or U_218 or 
	...
	regs_rg11 or ST1_02d )	// line#=computer.cpp:725,733,735,744,870
	begin
	RG_imm1_instr_l_t_c1 = ( ( ( ( U_12 & M_258 ) | ( U_12 & M_279 ) ) | ( U_12 & 
		M_309 ) ) | ( U_12 & M_273 ) ) ;	// line#=computer.cpp:86,91,725,867
	RG_imm1_instr_l_t_c2 = ( ( ( ( ( ( ( ( U_12 & M_296 ) | U_13 ) | U_05 ) | 
		U_06 ) | U_07 ) | ( ST1_03d & M_323 ) ) | U_09 ) | ( U_10 | U_11 ) ) ;	// line#=computer.cpp:725,735,821,849
	RG_imm1_instr_l_t = ( ( { 32{ ST1_02d } } & ( ( regs_rg11 ^ regs_rg12 ) ^ 
		...
		| ( { 32{ RG_imm1_instr_l_t_c2 } } & { 7'h00 , TR_06 } )			// line#=computer.cpp:725,735,821,849
		| ( { 32{ ST1_05d } } & l_t )							// line#=computer.cpp:371
		| ( { 32{ ST1_06d } } & M_137_t )						// line#=computer.cpp:599
		| ( { 32{ U_218 } } & l_t1 )							// line#=computer.cpp:384
		| ( { 32{ U_220 } } & l_t1 )							// line#=computer.cpp:384
		| ( { 32{ U_222 } } & l_t1 )							// line#=computer.cpp:384
		| ( { 32{ U_224 } } & l_t1 )							// line#=computer.cpp:384
		| ( { 32{ U_226 } } & l_t1 )							// line#=computer.cpp:384
		| ( { 32{ U_228 } } & l_t1 )							// line#=computer.cpp:384
		| ( { 32{ U_230 } } & l_t1 )							// line#=computer.cpp:384
		) ;
	end
assign	RG_imm1_instr_l_en = ( ST1_02d | RG_imm1_instr_l_t_c1 | RG_imm1_instr_l_t_c2 | 
	ST1_05d | ST1_06d | U_218 | U_220 | U_222 | U_224 | U_226 | U_228 | U_230 ) ;	// line#=computer.cpp:725,733,735,744,870
always @ ( posedge CLOCK )	// line#=computer.cpp:725,733,735,744,870
	if ( RG_imm1_instr_l_en )
		RG_imm1_instr_l <= RG_imm1_instr_l_t ;	// line#=computer.cpp:86,91,240,371,384
							// ,599,725,733,735,744,821,849,867
							// ,870,988,989
always @ ( CT_50 or ST1_12d or CT_01 or ST1_02d )
	RG_22_t = ( ( { 1{ ST1_02d } } & CT_01 )	// line#=computer.cpp:723
		| ( { 1{ ST1_12d } } & CT_50 )		// line#=computer.cpp:271,291
		) ;
assign	RG_22_en = ( ST1_02d | ST1_12d ) ;
always @ ( posedge CLOCK )
	if ( RG_22_en )
		RG_22 <= RG_22_t ;	// line#=computer.cpp:271,291,723
...
always @ ( incr3u1ot or ST1_06d or RG_funct3_i or ST1_12d or M_345 )
	begin
	RG_funct3_i_1_t_c1 = ( M_345 | ST1_12d ) ;	// line#=computer.cpp:735
...
always @ ( RG_count_op2_regs_word_addr or RG_funct3_i or ST1_12d or comp32u_1_11ot or 
	...
	begin
	RG_29_t_c1 = ( ST1_12d & ( ~|RG_funct3_i [1:0] ) ) ;	// line#=computer.cpp:335
	RG_29_t = ( ( { 1{ ST1_03d } } & CT_03 )					// line#=computer.cpp:987
		| ( { 1{ U_170 } } & comp32u_1_11ot [2] )				// line#=computer.cpp:336
		| ( { 1{ RG_29_t_c1 } } & ( |RG_count_op2_regs_word_addr [31:1] ) )	// line#=computer.cpp:335
		) ;
	end
always @ ( posedge CLOCK )
	RG_29 <= RG_29_t ;	// line#=computer.cpp:335,336,987
assign	M_338 = ~|imem_arg_MEMB32W65536_RD1 [31:25] ;	// line#=computer.cpp:725,735,738,987
							// ,1012
assign	M_340 = ( regs_rd00 ^ regs_rd01 ) ;	// line#=computer.cpp:792,795
always @ ( FF_bf_ctx_valid or ST1_14d or lop3u_11ot or ST1_06d or M_338 or CT_03 or 
	...
	FF_take_t_c2 = ( U_09 & M_258 ) ;	// line#=computer.cpp:792
	FF_take_t_c3 = ( U_09 & M_284 ) ;	// line#=computer.cpp:795
	FF_take_t_c4 = ( U_09 & M_279 ) ;	// line#=computer.cpp:798
	FF_take_t_c5 = ( U_09 & M_296 ) ;	// line#=computer.cpp:801
	FF_take_t_c6 = ( ( M_351 | U_46 ) | ST1_12d ) ;	// line#=computer.cpp:288,804,878,929
	FF_take_t_c7 = ( U_12 & M_266 ) ;	// line#=computer.cpp:875
	FF_take_t_c8 = ( U_13 & M_266 ) ;	// line#=computer.cpp:926
	FF_take_t = ( ( { 1{ FF_take_t_c1 } } & ( |imem_arg_MEMB32W65536_RD1 [11:7] ) )	// line#=computer.cpp:725,734,749,758,767
		| ( { 1{ FF_take_t_c2 } } & ( ~|M_340 ) )				// line#=computer.cpp:792
		| ( { 1{ FF_take_t_c3 } } & ( |M_340 ) )				// line#=computer.cpp:795
		...
		| ( { 1{ U_16 } } & ( ( ( ~CT_03 ) & ( ~|{ ~imem_arg_MEMB32W65536_RD1 [14:13] , 
			imem_arg_MEMB32W65536_RD1 [12] } ) ) & M_338 ) )		// line#=computer.cpp:725,735,738,979,987
											// ,990,1012
...
always @ ( posedge CLOCK )	// line#=computer.cpp:725,735,790,870,914
	if ( FF_take_en )
		FF_take <= FF_take_t ;	// line#=computer.cpp:288,347,595,725,734
					...
					// ,926,929,979,987,990,1012
assign	FF_take_port = FF_take ;
assign	M_373 = ~( M_374 | M_294 ) ;	// line#=computer.cpp:744
assign	M_374 = ( ( ( ( ( ( ( ( ( ( M_318 | M_316 ) | M_320 ) | M_322 ) | M_325 ) | 
	M_304 ) | M_327 ) | M_314 ) | M_329 ) | M_278 ) | M_331 ) ;	// line#=computer.cpp:744
...
always @ ( RL_addr_addr1_next_pc_op1_PC or RG_09 or add32s1ot or take_t1 )	// line#=computer.cpp:810
	begin
	M_183_t_c1 = ~take_t1 ;
	M_183_t = ( ( { 31{ take_t1 } } & add32s1ot [31:1] )	// line#=computer.cpp:811
		| ( { 31{ M_183_t_c1 } } & { RG_09 [31:2] , RL_addr_addr1_next_pc_op1_PC [1] } ) ) ;
	end
assign	JF_02 = ( ( ~M_335 ) & ( ~B_02_t ) ) ;
assign	JF_03 = ( ( ~M_335 ) & B_02_t ) ;
assign	JF_04 = ~FF_bf_ctx_valid ;	// line#=computer.cpp:367
always @ ( FF_bf_ctx_fault_handled or C_09 )
	begin
	handled_t4_c1 = ~C_09 ;
	handled_t4 = ( ( { 1{ C_09 } } & 1'h1 )	// line#=computer.cpp:1059
		| ( { 1{ handled_t4_c1 } } & FF_bf_ctx_fault_handled ) ) ;
	end
assign	bf_ctx_valid_t = ( ( ~C_09 ) & FF_bf_ctx_valid ) ;	// line#=computer.cpp:304
...
assign	M_332 = ~|RG_i_index_next_pc_PC ;	// line#=computer.cpp:320
assign	M_265 = ~M_332 ;	// line#=computer.cpp:320
assign	M_291 = ~|{ RG_i_index_next_pc_PC [31:1] , ~RG_i_index_next_pc_PC [0] } ;	// line#=computer.cpp:320
...
always @ ( value_t_t1 or RG_r_regs_stream1_w1 or M_291 or M_265 or RG_old_x_stream0_w0 or 
	M_332 )	// line#=computer.cpp:320
	begin
	value_t_c1 = ( M_265 & M_291 ) ;	// line#=computer.cpp:320
	value_t_c2 = ( M_265 & ( ~M_291 ) ) ;	// line#=computer.cpp:320
	value_t = ( ( { 32{ M_332 } } & RG_old_x_stream0_w0 )		// line#=computer.cpp:320
...
always @ ( FF_bf_ctx_fault_handled or C_13 )
	begin
	handled_t6_c1 = ~C_13 ;
	handled_t6 = ( ( { 1{ C_13 } } & 1'h1 )	// line#=computer.cpp:1073
		| ( { 1{ handled_t6_c1 } } & FF_bf_ctx_fault_handled ) ) ;
	end
always @ ( FF_bf_ctx_fault or bf_ctx_valid_t1 or C_13 )	// line#=computer.cpp:342
	begin
	bf_ctx_fault_t3_c1 = ( C_13 & ( ~bf_ctx_valid_t1 ) ) ;	// line#=computer.cpp:343
...
always @ ( bf_ctx_s3_RD1 or bf_ctx_s2_RD1 or RG_22 or bf_ctx_s1_RD1 or FF_bf_ctx_fault_handled or 
	bf_ctx_s0_RD1 or RG_23 or bf_ctx_p_rd00 or FF_take )	// line#=computer.cpp:288
	begin
	C_bf_ctx_read_word_1_t_c1 = ( ( ~FF_take ) & RG_23 ) ;	// line#=computer.cpp:268
	C_bf_ctx_read_word_1_t_c2 = ( ( ~FF_take ) & ( ( ~RG_23 ) & FF_bf_ctx_fault_handled ) ) ;	// line#=computer.cpp:270
	C_bf_ctx_read_word_1_t_c3 = ( ( ~FF_take ) & ( ( ( ~RG_23 ) & ( ~FF_bf_ctx_fault_handled ) ) & 
		RG_22 ) ) ;	// line#=computer.cpp:272
	C_bf_ctx_read_word_1_t_c4 = ( ( ~FF_take ) & ( ( ( ~RG_23 ) & ( ~FF_bf_ctx_fault_handled ) ) & ( 
		~RG_22 ) ) ) ;	// line#=computer.cpp:273
...
always @ ( RG_29 )	// line#=computer.cpp:335
	case ( RG_29 )
	1'h1 :
		TR_30 = 1'h1 ;
	1'h0 :
	...
	default :
		TR_30 = 1'hx ;
	endcase
always @ ( M_333 )	// line#=computer.cpp:337
	case ( M_333 )
	1'h1 :
		JF_09_t1 = 1'h1 ;
	1'h0 :
...
always @ ( JF_09_t1 or M_270 or M_288 or TR_30 or M_261 )
	JF_09 = ( ( { 1{ M_261 } } & TR_30 )	// line#=computer.cpp:335
		| ( { 1{ M_288 } } & TR_30 )	// line#=computer.cpp:336
		| ( { 1{ M_270 } } & JF_09_t1 )	// line#=computer.cpp:337
		) ;
...
always @ ( RL_addr_addr1_next_pc_op1_PC or U_55 or U_70 or regs_rd02 or U_56 or 
	...
	add32s1i1 = ( ( { 32{ M_350 } } & regs_rd00 )				// line#=computer.cpp:86,91,97,819,847
...
always @ ( M_302 or imem_arg_MEMB32W65536_RD1 or M_326 )
	TR_08 = ( ( { 5{ M_326 } } & imem_arg_MEMB32W65536_RD1 [11:7] )		// line#=computer.cpp:86,96,97,725,734
										// ,738,847
		| ( { 5{ M_302 } } & imem_arg_MEMB32W65536_RD1 [24:20] )	// line#=computer.cpp:86,91,725,737,819
		) ;
always @ ( M_322 or RG_imm1_instr_l or M_336 )
	M_395 = ( ( { 6{ M_336 } } & { RG_imm1_instr_l [0] , RG_imm1_instr_l [4:1] , 
			1'h0 } )								// line#=computer.cpp:86,102,103,104,105
												// ,106,738,788,811
		| ( { 6{ M_322 } } & { RG_imm1_instr_l [24] , RG_imm1_instr_l [17:13] } )	// line#=computer.cpp:86,91,737,777
		) ;
...
always @ ( M_396 or U_55 or U_56 or U_70 or RG_imm1_instr_l or U_83 or TR_08 or 
	...
	add32s1i2 = ( ( { 21{ M_350 } } & { imem_arg_MEMB32W65536_RD1 [31] , imem_arg_MEMB32W65536_RD1 [31] , 
		...
		| ( { 21{ U_83 } } & { RG_imm1_instr_l [11] , RG_imm1_instr_l [11] , 
			...
			RG_imm1_instr_l [11] , RG_imm1_instr_l [11] , RG_imm1_instr_l [11] , 
			RG_imm1_instr_l [11] , RG_imm1_instr_l [11:0] } )	// line#=computer.cpp:872
...
always @ ( TR_26 or M_364 or regs_rd02 or M_377 or RL_addr_addr1_next_pc_op1_PC or 
	M_378 )
	lsft32u1i1 = ( ( { 32{ M_378 } } & RL_addr_addr1_next_pc_op1_PC )	// line#=computer.cpp:923
		| ( { 32{ M_377 } } & regs_rd02 )				// line#=computer.cpp:890
...
always @ ( RL_addr_addr1_next_pc_op1_PC or M_364 or RG_rs2 or M_377 or RG_count_op2_regs_word_addr or 
	M_378 )
	lsft32u1i2 = ( ( { 5{ M_378 } } & RG_count_op2_regs_word_addr [4:0] )		// line#=computer.cpp:923
		| ( { 5{ M_377 } } & RG_rs2 )						// line#=computer.cpp:890
...
always @ ( dmem_arg_MEMB32W65536_0_RD1 or M_365 or regs_rd02 or M_383 or RL_addr_addr1_next_pc_op1_PC or 
	M_384 )
	rsft32u1i1 = ( ( { 32{ M_384 } } & RL_addr_addr1_next_pc_op1_PC )	// line#=computer.cpp:938
		| ( { 32{ M_383 } } & regs_rd02 )				// line#=computer.cpp:898
		| ( { 32{ M_365 } } & dmem_arg_MEMB32W65536_0_RD1 )		// line#=computer.cpp:141,142,158,159,823
										// ,826,832,835
		) ;
assign	M_365 = ( ( ( ( M_304 & ( ~|( RG_imm1_instr_l ^ 32'h00000005 ) ) ) | ( M_304 & ( 
	~|( RG_imm1_instr_l ^ 32'h00000004 ) ) ) ) | ( M_304 & M_285 ) ) | ( M_304 & 
	M_259 ) ) ;	// line#=computer.cpp:821
...
always @ ( RL_addr_addr1_next_pc_op1_PC or M_365 or RG_rs2 or M_383 or RG_count_op2_regs_word_addr or 
	M_384 )
	rsft32u1i2 = ( ( { 5{ M_384 } } & RG_count_op2_regs_word_addr [4:0] )		// line#=computer.cpp:938
		| ( { 5{ M_383 } } & RG_rs2 )						// line#=computer.cpp:898
		| ( { 5{ M_365 } } & { RL_addr_addr1_next_pc_op1_PC [1:0] , 3'h0 } )	// line#=computer.cpp:141,142,158,159,823
											// ,826,832,835
		) ;
always @ ( regs_rd02 or M_314 or RL_addr_addr1_next_pc_op1_PC or M_329 )
	rsft32s1i1 = ( ( { 32{ M_329 } } & RL_addr_addr1_next_pc_op1_PC )	// line#=computer.cpp:936
		| ( { 32{ M_314 } } & regs_rd02 )				// line#=computer.cpp:895
		) ;
always @ ( RG_rs2 or M_314 or RG_count_op2_regs_word_addr or M_329 )
	rsft32s1i2 = ( ( { 5{ M_329 } } & RG_count_op2_regs_word_addr [4:0] )	// line#=computer.cpp:936
		| ( { 5{ M_314 } } & RG_rs2 )					// line#=computer.cpp:895
		) ;
...
always @ ( RG_index_regs or U_184 or RG_i_index_next_pc_PC or U_138 )
	incr32u1i1 = ( ( { 32{ U_138 } } & RG_i_index_next_pc_PC )	// line#=computer.cpp:319
		| ( { 32{ U_184 } } & RG_index_regs )			// line#=computer.cpp:335
		) ;
assign	M_390 = ( M_270 & M_333 ) ;	// line#=computer.cpp:336,337
always @ ( add32s1ot or U_25 or U_26 or U_28 or U_29 or M_353 or regs_rg05 or M_356 or 
	...
	begin
	addsub32u1i1_c1 = ( M_354 | U_102 ) ;	// line#=computer.cpp:110,759,917,919
	addsub32u1i1_c2 = ( ( ST1_10d | U_01 ) | U_173 ) ;	// line#=computer.cpp:290,321,741
	...
	addsub32u1i1 = ( ( { 32{ addsub32u1i1_c1 } } & RL_addr_addr1_next_pc_op1_PC )	// line#=computer.cpp:110,759,917,919
		...
		| ( { 32{ M_360 } } & { 31'h00000001 , M_390 } )			// line#=computer.cpp:336,337
		| ( { 32{ U_234 } } & bf_ctx_s0_RD1 )					// line#=computer.cpp:351,352,355
		| ( { 32{ M_356 } } & regs_rg05 )					// line#=computer.cpp:311,329,330,1062
											// ,1063,1067,1068
...
always @ ( M_352 or RG_imm1_instr_l or U_67 )
	TR_27 = ( ( { 20{ U_67 } } & RG_imm1_instr_l [24:5] )	// line#=computer.cpp:110,759
...
always @ ( U_173 or M_397 or M_349 )
	M_398 = ( ( { 23{ M_349 } } & { M_397 [20:1] , 1'h0 , M_397 [0] , 1'h0 } )	// line#=computer.cpp:110,131,148,180,199
											// ,741,759
		| ( { 23{ U_173 } } & 23'h000005 )					// line#=computer.cpp:290
		) ;
...
always @ ( regs_rg06 or M_356 or bf_ctx_s1_RD1 or U_234 or RG_index_regs or U_188 or 
	...
	addsub32u1i2_c1 = ( M_349 | U_173 ) ;	// line#=computer.cpp:110,131,148,180,199
						// ,290,741,759
	addsub32u1i2_c2 = ( ( ST1_10d | U_186 ) | U_188 ) ;	// line#=computer.cpp:321,336,337
	addsub32u1i2 = ( ( { 32{ U_94 } } & RG_count_op2_regs_word_addr )	// line#=computer.cpp:917,919
		...
		| ( { 32{ U_234 } } & bf_ctx_s1_RD1 )				// line#=computer.cpp:351,352,355
		| ( { 32{ M_356 } } & regs_rg06 )				// line#=computer.cpp:311,329,330,1062
										// ,1063,1067,1068
		) ;
	end
...
always @ ( M_393 or M_356 or ST1_12d or regs_rd00 or U_46 or imem_arg_MEMB32W65536_RD1 or 
	...
	comp32u_12i2_c2 = ( ST1_12d | M_356 ) ;	// line#=computer.cpp:288,311,329,330
	comp32u_12i2 = ( ( { 32{ comp32u_12i2_c1 } } & regs_rd01 )	// line#=computer.cpp:804,807
		...
		| ( { 32{ comp32u_12i2_c2 } } & { 21'h000000 , M_393 [2] , 8'h04 , 
			M_393 [1:0] } )					// line#=computer.cpp:288,311,329,330
		) ;
	end
...
always @ ( regs_rd03 or M_285 )
	TR_16 = ( { 8{ M_285 } } & regs_rd03 [15:8] )	// line#=computer.cpp:211,212,854
...
always @ ( ST1_10d or bf_ctx_s2_RD1 or addsub32u1ot or U_234 or regs_rg13 or U_01 )
	addsub32u_321i1 = ( ( { 32{ U_01 } } & regs_rg13 )			// line#=computer.cpp:240,988,989
		| ( { 32{ U_234 } } & ( addsub32u1ot [31:0] ^ bf_ctx_s2_RD1 ) )	// line#=computer.cpp:351,352,353,354,355
...
always @ ( ST1_10d or bf_ctx_s3_RD1 or U_234 or regs_rg14 or U_01 )
	addsub32u_321i2 = ( ( { 32{ U_01 } } & regs_rg14 )	// line#=computer.cpp:240,988,989
		| ( { 32{ U_234 } } & bf_ctx_s3_RD1 )		// line#=computer.cpp:353,354,355
...
always @ ( RG_bf_ctx_load_next or U_152 or regs_rg15 or addsub32u_321ot or U_01 )
	addsub32u_322i1 = ( ( { 32{ U_01 } } & ( addsub32u_321ot ^ regs_rg15 ) )	// line#=computer.cpp:240,988,989
		| ( { 32{ U_152 } } & RG_bf_ctx_load_next )				// line#=computer.cpp:324
		) ;
always @ ( RG_count_op2_regs_word_addr or U_152 or regs_rg16 or U_01 )
	addsub32u_322i2 = ( ( { 32{ U_01 } } & regs_rg16 )		// line#=computer.cpp:240,988,989
		| ( { 32{ U_152 } } & RG_count_op2_regs_word_addr )	// line#=computer.cpp:324
		) ;
assign	addsub32u_322_f = 2'h1 ;
always @ ( regs_rg06 or M_356 or RG_count_op2_regs_word_addr or U_170 or addsub32u1ot or 
	U_138 )
	comp32u_1_11i1 = ( ( { 32{ U_138 } } & addsub32u1ot [31:0] )	// line#=computer.cpp:295,321
		| ( { 32{ U_170 } } & RG_count_op2_regs_word_addr )	// line#=computer.cpp:336
		| ( { 32{ M_356 } } & regs_rg06 )			// line#=computer.cpp:311,329,330,1062
									// ,1063,1067,1068
		) ;
always @ ( M_356 or U_170 or U_138 )
	M_394 = ( ( { 3{ U_138 } } & 3'h5 )	// line#=computer.cpp:295
		| ( { 3{ U_170 } } & 3'h1 )	// line#=computer.cpp:336
		| ( { 3{ M_356 } } & 3'h2 )	// line#=computer.cpp:311,329,330
		) ;
assign	comp32u_1_11i2 = { M_394 [2] , 1'h0 , M_394 [1:0] , 1'h0 } ;
assign	imem_arg_MEMB32W65536_RE1 = U_01 ;	// line#=computer.cpp:725
assign	M_366 = ( M_259 | M_285 ) ;	// line#=computer.cpp:821,849
...
always @ ( addsub32u1ot or M_326 or M_296 or M_279 or M_284 or M_258 or add32s1ot or 
	M_266 or M_302 )
	begin
	dmem_arg_MEMB32W65536_0_RA1_c1 = ( M_302 & M_266 ) ;	// line#=computer.cpp:86,91,165,174,819
								// ,829
...
always @ ( RL_addr_addr1_next_pc_op1_PC or U_216 or addsub32u1ot or U_174 )
	bf_ctx_s0_RA1 = ( ( { 8{ U_174 } } & addsub32u1ot [7:0] )		// line#=computer.cpp:268,290
		| ( { 8{ U_216 } } & RL_addr_addr1_next_pc_op1_PC [31:24] )	// line#=computer.cpp:351
		) ;
...
always @ ( RL_addr_addr1_next_pc_op1_PC or U_216 or addsub32u1ot or U_176 )
	bf_ctx_s1_RA1 = ( ( { 8{ U_176 } } & addsub32u1ot [7:0] )		// line#=computer.cpp:270,290
		| ( { 8{ U_216 } } & RL_addr_addr1_next_pc_op1_PC [23:16] )	// line#=computer.cpp:352
		) ;
...
always @ ( RL_addr_addr1_next_pc_op1_PC or U_216 or addsub32u1ot or U_178 )
	bf_ctx_s2_RA1 = ( ( { 8{ U_178 } } & addsub32u1ot [7:0] )		// line#=computer.cpp:272,290
		| ( { 8{ U_216 } } & RL_addr_addr1_next_pc_op1_PC [15:8] )	// line#=computer.cpp:353
		) ;
...
always @ ( RL_addr_addr1_next_pc_op1_PC or U_216 or addsub32u1ot or U_179 )
	bf_ctx_s3_RA1 = ( ( { 8{ U_179 } } & addsub32u1ot [7:0] )		// line#=computer.cpp:273,290
		| ( { 8{ U_216 } } & RL_addr_addr1_next_pc_op1_PC [7:0] )	// line#=computer.cpp:354
		) ;
assign	bf_ctx_s3_RE1 = ( U_179 | U_216 ) ;
assign	bf_ctx_s3_WE2 = ( U_149 & ( ~CT_41 ) ) ;
assign	bf_ctx_p_we01 = ( U_138 & comp32u_1_11ot [3] ) ;	// line#=computer.cpp:295,296
always @ ( M_362 or M_376 or M_375 or M_382 or M_385 or M_372 or M_302 or M_326 or 
	...
	regs_ad00_c1 = ( ( ( ( ( ( ( ( ( ( M_313 & M_303 ) | ( M_313 & M_266 ) ) | 
		...
		M_362 ) ;	// line#=computer.cpp:725,736
	regs_ad00 = ( ( { 5{ M_328 } } & imem_arg_MEMB32W65536_RD1 [24:20] )	// line#=computer.cpp:725,737
...
always @ ( M_362 or M_376 or M_375 or M_382 or M_385 or M_372 or imem_arg_MEMB32W65536_RD1 or 
	...
	regs_ad01_c1 = ( ( ( ( ( M_372 | M_385 ) | M_382 ) | M_375 ) | M_376 ) | 
		M_362 ) ;	// line#=computer.cpp:725,737
	regs_ad01 = ( ( { 5{ M_328 } } & imem_arg_MEMB32W65536_RD1 [19:15] )	// line#=computer.cpp:725,736
...
always @ ( M_318 or RG_count_op2_regs_word_addr or RL_addr_addr1_next_pc_op1_PC or 
	...
	M_334 or M_304 )	// line#=computer.cpp:870,893,914,935
	begin
	regs_wd04_c1 = ( M_304 & M_334 ) ;	// line#=computer.cpp:839
	regs_wd04_c2 = ( M_386 & U_83 ) ;	// line#=computer.cpp:872
	regs_wd04_c3 = ( ( ( ( M_386 & ( U_60 & M_272 ) ) | ( M_386 & ( U_60 & M_306 ) ) ) | 
		( M_387 & ( U_61 & M_272 ) ) ) | ( M_387 & ( U_61 & M_306 ) ) ) ;
	regs_wd04_c4 = ( M_386 & ( U_60 & M_283 ) ) ;	// line#=computer.cpp:881
	regs_wd04_c5 = ( M_386 & ( U_60 & M_311 ) ) ;	// line#=computer.cpp:884
	regs_wd04_c6 = ( M_386 & ( U_60 & M_275 ) ) ;	// line#=computer.cpp:887
	regs_wd04_c7 = ( ( M_386 & ( U_60 & M_286 ) ) | ( M_387 & ( U_61 & M_286 ) ) ) ;	// line#=computer.cpp:890,923
	regs_wd04_c8 = ( ( M_386 & ( U_90 & RG_imm1_instr_l [23] ) ) | ( M_387 & 
		( U_99 & RG_imm1_instr_l [23] ) ) ) ;	// line#=computer.cpp:895,936
	regs_wd04_c9 = ( ( M_386 & ( U_90 & ( ~RG_imm1_instr_l [23] ) ) ) | ( M_387 & 
		( U_99 & ( ~RG_imm1_instr_l [23] ) ) ) ) ;	// line#=computer.cpp:898,938
	regs_wd04_c10 = ( ( M_322 & M_334 ) | ( M_320 & FF_take ) ) ;	// line#=computer.cpp:768,779
	regs_wd04_c11 = ( ( M_387 & ( U_102 | U_103 ) ) | ( M_316 & FF_take ) ) ;	// line#=computer.cpp:110,759,917,919
	regs_wd04_c12 = ( M_387 & ( U_61 & M_283 ) ) ;	// line#=computer.cpp:932
	regs_wd04_c13 = ( M_387 & ( U_61 & M_311 ) ) ;	// line#=computer.cpp:942
	regs_wd04_c14 = ( M_387 & ( U_61 & M_275 ) ) ;	// line#=computer.cpp:945
	regs_wd04_c15 = ( M_318 & FF_take ) ;	// line#=computer.cpp:110,750
	regs_wd04 = ( ( { 32{ regs_wd04_c1 } } & val2_t4 )							// line#=computer.cpp:839
		...
		| ( { 32{ regs_wd04_c4 } } & ( regs_rd02 ^ { RG_imm1_instr_l [11] , 
			...
			RG_imm1_instr_l [11] , RG_imm1_instr_l [11] , RG_imm1_instr_l [11] , 
			RG_imm1_instr_l [11] , RG_imm1_instr_l [11] , RG_imm1_instr_l [11] , 
			RG_imm1_instr_l [11] , RG_imm1_instr_l [11:0] } ) )					// line#=computer.cpp:881
		| ( { 32{ regs_wd04_c5 } } & ( regs_rd02 | { RG_imm1_instr_l [11] , 
			...
			RG_imm1_instr_l [11] , RG_imm1_instr_l [11] , RG_imm1_instr_l [11] , 
			RG_imm1_instr_l [11] , RG_imm1_instr_l [11] , RG_imm1_instr_l [11] , 
			RG_imm1_instr_l [11] , RG_imm1_instr_l [11:0] } ) )					// line#=computer.cpp:884
		| ( { 32{ regs_wd04_c6 } } & ( regs_rd02 & { RG_imm1_instr_l [11] , 
			...
			RG_imm1_instr_l [11] , RG_imm1_instr_l [11] , RG_imm1_instr_l [11] , 
			RG_imm1_instr_l [11] , RG_imm1_instr_l [11] , RG_imm1_instr_l [11] , 
			RG_imm1_instr_l [11] , RG_imm1_instr_l [11:0] } ) )					// line#=computer.cpp:887
		...
		| ( { 32{ regs_wd04_c15 } } & { RG_imm1_instr_l [24:5] , 12'h000 } )				// line#=computer.cpp:110,750
		) ;
	end
...
always @ ( RG_i_rd or ST1_07d or RG_funct3_i or ST1_06d )
	M_389 = ( ( { 4{ ST1_06d } } & { RG_funct3_i [2:0] , 1'h0 } )	// line#=computer.cpp:599
		| ( { 4{ ST1_07d } } & { RG_i_rd [2:0] , 1'h1 } )	// line#=computer.cpp:600
		) ;
assign	words_ad01 = M_389 ;
always @ ( M_139_t or ST1_07d or M_137_t or ST1_06d )
	words_wd01 = ( ( { 32{ ST1_06d } } & M_137_t )	// line#=computer.cpp:599
		| ( { 32{ ST1_07d } } & M_139_t )	// line#=computer.cpp:600
		) ;
