...
// timestamp_0: 20260830204629_97320_01002
// timestamp_5: 20260830204630_97349_82332
// timestamp_9: 20260830204630_97349_71419
// timestamp_C: 20260830204630_97349_53032
// timestamp_E: 20260830204630_97349_03635
// timestamp_V: 20260830204631_97368_80314
...
always @ ( RG_20 )	// line#=computer.cpp:595
	begin
...
always @ ( C_bf_ctx_read_word_1_t or U_177 or RL_imm1_index_instr_l_regs or M_04 or 
	...
	regs_rg10_t_c3 = ( U_177 & M_04 ) ;	// line#=computer.cpp:334
...
always @ ( U_182 or C_bf_ctx_read_word_1_t or U_178 or M_136_t or M_05 or ST1_07d or 
	...
	regs_rg11_t_c3 = ( U_178 & M_05 ) ;	// line#=computer.cpp:335
	regs_rg11_t_c4 = ( U_182 & M_05 ) ;	// line#=computer.cpp:335
	regs_rg11_t = ( ( { 32{ regs_rg11_t_c1 } } & regs_wd04 )
		| ( { 32{ regs_rg11_t_c2 } } & M_136_t )		// line#=computer.cpp:602
...
always @ ( U_182 or U_184 or C_bf_ctx_read_word_1_t or U_179 or words_rg00 or M_06 or 
	...
	regs_rg12_t_c3 = ( U_179 & M_06 ) ;	// line#=computer.cpp:336
	regs_rg12_t_c4 = ( ( U_184 | U_182 ) & M_06 ) ;	// line#=computer.cpp:336
...
always @ ( words_rg09 or words_rg08 or words_rg07 or words_rg06 or words_rg05 or 
	words_rg04 or words_rg03 or words_rg02 or words_rg01 or words_rg00 or M_380 )	// line#=computer.cpp:585
	case ( M_380 )
	4'h0 :
...
always @ ( RG_regs_w2 or M_13 or U_105 or words_wd01 or words_d01 or words_we01 )	// line#=computer.cpp:585
	begin
...
always @ ( RG_regs_w3 or M_14 or U_105 or words_wd01 or words_d01 or words_we01 )	// line#=computer.cpp:585
	begin
...
always @ ( RG_regs or M_15 or U_105 or words_wd01 or words_d01 or words_we01 )	// line#=computer.cpp:585
	begin
...
always @ ( RG_regs_1 or M_16 or U_105 or words_wd01 or words_d01 or words_we01 )	// line#=computer.cpp:585
	begin
...
always @ ( RG_regs_2 or M_17 or U_105 or words_wd01 or words_d01 or words_we01 )	// line#=computer.cpp:585
	begin
...
always @ ( RG_regs_3 or M_18 or U_105 or words_wd01 or words_d01 or words_we01 )	// line#=computer.cpp:585
	begin
...
always @ ( RG_r_regs_stream1_w1 or M_21 or U_105 or words_wd01 or words_d01 or words_we01 )	// line#=computer.cpp:585
	begin
...
assign	M_134_t = ( words_rd00 ^ RL_imm1_index_instr_l_regs ) ;	// line#=computer.cpp:599
assign	M_136_t = ( words_rd00 ^ RG_r_regs_stream1_w1 ) ;	// line#=computer.cpp:600
assign	CT_38 = ~|addsub32u_321ot [31:8] ;	// line#=computer.cpp:277,298,299
assign	CT_39 = ~|{ addsub32u_321ot [31:9] , ~addsub32u_321ot [8] } ;	// line#=computer.cpp:279,298,299
assign	CT_40 = ~|{ addsub32u_321ot [31:10] , ~addsub32u_321ot [9] , addsub32u_321ot [8] } ;	// line#=computer.cpp:281,298,299
...
assign	CT_49 = ~|{ addsub32u1ot [31:10] , ~addsub32u1ot [9] , addsub32u1ot [8] } ;	// line#=computer.cpp:271,290,291
assign	CT_50 = ~|{ addsub32u1ot [31:9] , ~addsub32u1ot [8] } ;	// line#=computer.cpp:269,290,291
assign	CT_51 = ~|addsub32u1ot [31:8] ;	// line#=computer.cpp:267,290,291
...
assign	U_05 = ( ST1_03d & M_313 ) ;	// line#=computer.cpp:725,733,744
assign	U_06 = ( ST1_03d & M_311 ) ;	// line#=computer.cpp:725,733,744
assign	U_07 = ( ST1_03d & M_315 ) ;	// line#=computer.cpp:725,733,744
assign	U_09 = ( ST1_03d & M_319 ) ;	// line#=computer.cpp:725,733,744
assign	U_10 = ( ST1_03d & M_298 ) ;	// line#=computer.cpp:725,733,744
assign	U_11 = ( ST1_03d & M_322 ) ;	// line#=computer.cpp:725,733,744
assign	U_12 = ( ST1_03d & M_309 ) ;	// line#=computer.cpp:725,733,744
assign	U_13 = ( ST1_03d & M_324 ) ;	// line#=computer.cpp:725,733,744
assign	M_298 = ~|( { 25'h0000000 , imem_arg_MEMB32W65536_RD1 [6:0] } ^ 32'h00000003 ) ;	// line#=computer.cpp:725,733,744
assign	M_309 = ~|( { 25'h0000000 , imem_arg_MEMB32W65536_RD1 [6:0] } ^ 32'h00000013 ) ;	// line#=computer.cpp:725,733,744
assign	M_311 = ~|( { 25'h0000000 , imem_arg_MEMB32W65536_RD1 [6:0] } ^ 32'h00000017 ) ;	// line#=computer.cpp:725,733,744
assign	M_313 = ~|( { 25'h0000000 , imem_arg_MEMB32W65536_RD1 [6:0] } ^ 32'h00000037 ) ;	// line#=computer.cpp:725,733,744
assign	M_315 = ~|( { 25'h0000000 , imem_arg_MEMB32W65536_RD1 [6:0] } ^ 32'h0000006f ) ;	// line#=computer.cpp:725,733,744
assign	M_319 = ~|( { 25'h0000000 , imem_arg_MEMB32W65536_RD1 [6:0] } ^ 32'h00000063 ) ;	// line#=computer.cpp:725,733,744
assign	M_322 = ~|( { 25'h0000000 , imem_arg_MEMB32W65536_RD1 [6:0] } ^ 32'h00000023 ) ;	// line#=computer.cpp:725,733,744
assign	M_324 = ~|( { 25'h0000000 , imem_arg_MEMB32W65536_RD1 [6:0] } ^ 32'h00000033 ) ;	// line#=computer.cpp:725,733,744
assign	U_22 = ( U_09 & M_303 ) ;	// line#=computer.cpp:725,735,790
assign	U_23 = ( U_09 & M_269 ) ;	// line#=computer.cpp:725,735,790
assign	M_254 = ~|{ 29'h00000000 , imem_arg_MEMB32W65536_RD1 [14:12] } ;	// line#=computer.cpp:725,733,735,744,790
										// ,821,849,870,914
assign	M_269 = ~|( { 29'h00000000 , imem_arg_MEMB32W65536_RD1 [14:12] } ^ 32'h00000007 ) ;	// line#=computer.cpp:725,733,735,744,790
												// ,870,914
assign	M_275 = ~|( { 29'h00000000 , imem_arg_MEMB32W65536_RD1 [14:12] } ^ 32'h00000004 ) ;	// line#=computer.cpp:725,733,735,744,790
												// ,821,870,914
assign	M_279 = ~|( { 29'h00000000 , imem_arg_MEMB32W65536_RD1 [14:12] } ^ 32'h00000001 ) ;	// line#=computer.cpp:725,735,790,821,849
												// ,870,914
assign	M_292 = ~|( { 29'h00000000 , imem_arg_MEMB32W65536_RD1 [14:12] } ^ 32'h00000005 ) ;	// line#=computer.cpp:725,733,735,744,790
												// ,821,870,914
assign	M_303 = ~|( { 29'h00000000 , imem_arg_MEMB32W65536_RD1 [14:12] } ^ 32'h00000006 ) ;	// line#=computer.cpp:725,733,735,744,790
												// ,870,914
assign	U_25 = ( U_10 & M_254 ) ;	// line#=computer.cpp:725,735,821
assign	U_26 = ( U_10 & M_279 ) ;	// line#=computer.cpp:725,735,821
assign	U_28 = ( U_10 & M_275 ) ;	// line#=computer.cpp:725,735,821
assign	U_29 = ( U_10 & M_292 ) ;	// line#=computer.cpp:725,735,821
assign	M_262 = ~|( { 29'h00000000 , imem_arg_MEMB32W65536_RD1 [14:12] } ^ 32'h00000002 ) ;	// line#=computer.cpp:725,735,821,849,870
												// ,914
assign	U_31 = ( U_11 & M_254 ) ;	// line#=computer.cpp:725,735,849
assign	U_32 = ( U_11 & M_279 ) ;	// line#=computer.cpp:725,735,849
assign	U_37 = ( U_12 & M_299 ) ;	// line#=computer.cpp:725,735,870
assign	M_299 = ~|( { 29'h00000000 , imem_arg_MEMB32W65536_RD1 [14:12] } ^ 32'h00000003 ) ;	// line#=computer.cpp:725,735,870,914
assign	U_46 = ( U_13 & M_299 ) ;	// line#=computer.cpp:725,735,914
assign	U_51 = ( ST1_04d & M_314 ) ;	// line#=computer.cpp:744
assign	U_52 = ( ST1_04d & M_312 ) ;	// line#=computer.cpp:744
assign	U_53 = ( ST1_04d & M_316 ) ;	// line#=computer.cpp:744
assign	U_54 = ( ST1_04d & M_317 ) ;	// line#=computer.cpp:744
assign	U_55 = ( ST1_04d & M_320 ) ;	// line#=computer.cpp:744
assign	U_56 = ( ST1_04d & M_300 ) ;	// line#=computer.cpp:744
assign	U_57 = ( ST1_04d & M_323 ) ;	// line#=computer.cpp:744
assign	U_58 = ( ST1_04d & M_310 ) ;	// line#=computer.cpp:744
assign	U_59 = ( ST1_04d & M_325 ) ;	// line#=computer.cpp:744
assign	U_61 = ( ST1_04d & M_327 ) ;	// line#=computer.cpp:744
assign	U_62 = ( ST1_04d & M_289 ) ;	// line#=computer.cpp:744
assign	M_274 = ~|( RG_next_pc_PC ^ 32'h0000000f ) ;	// line#=computer.cpp:744
assign	M_289 = ~|( RG_next_pc_PC ^ 32'h0000000b ) ;	// line#=computer.cpp:744
assign	M_300 = ~|( RG_next_pc_PC ^ 32'h00000003 ) ;	// line#=computer.cpp:744
assign	M_310 = ~|( RG_next_pc_PC ^ 32'h00000013 ) ;	// line#=computer.cpp:744
assign	M_312 = ~|( RG_next_pc_PC ^ 32'h00000017 ) ;	// line#=computer.cpp:744
assign	M_314 = ~|( RG_next_pc_PC ^ 32'h00000037 ) ;	// line#=computer.cpp:744
assign	M_316 = ~|( RG_next_pc_PC ^ 32'h0000006f ) ;	// line#=computer.cpp:744
assign	M_317 = ~|( RG_next_pc_PC ^ 32'h00000067 ) ;	// line#=computer.cpp:744
assign	M_320 = ~|( RG_next_pc_PC ^ 32'h00000063 ) ;	// line#=computer.cpp:744
assign	M_323 = ~|( RG_next_pc_PC ^ 32'h00000023 ) ;	// line#=computer.cpp:744
assign	M_325 = ~|( RG_next_pc_PC ^ 32'h00000033 ) ;	// line#=computer.cpp:744
assign	M_327 = ~|( RG_next_pc_PC ^ 32'h00000073 ) ;	// line#=computer.cpp:744
assign	U_63 = ( ST1_04d & M_365 ) ;	// line#=computer.cpp:744
assign	U_65 = ( U_52 & FF_take ) ;	// line#=computer.cpp:758
assign	U_68 = ( U_55 & take_t1 ) ;	// line#=computer.cpp:810
assign	M_255 = ~|RL_imm1_index_instr_l_regs ;	// line#=computer.cpp:821,849
assign	M_263 = ~|( RL_imm1_index_instr_l_regs ^ 32'h00000002 ) ;	// line#=computer.cpp:821,849
assign	M_280 = ~|( RL_imm1_index_instr_l_regs ^ 32'h00000001 ) ;	// line#=computer.cpp:821,849
assign	M_331 = |RG_i_rd ;	// line#=computer.cpp:778,838,902,948
assign	U_81 = ( U_58 & M_256 ) ;	// line#=computer.cpp:870
assign	U_88 = ( U_58 & M_294 ) ;	// line#=computer.cpp:870
assign	M_256 = ~|RG_r_regs_stream1_w1 ;	// line#=computer.cpp:870,914
assign	U_92 = ( U_59 & M_256 ) ;	// line#=computer.cpp:914
assign	M_282 = ~|( RG_r_regs_stream1_w1 ^ 32'h00000001 ) ;	// line#=computer.cpp:870,914
assign	M_294 = ~|( RG_r_regs_stream1_w1 ^ 32'h00000005 ) ;	// line#=computer.cpp:870,914
assign	U_97 = ( U_59 & M_294 ) ;	// line#=computer.cpp:914
assign	U_100 = ( U_92 & RL_imm1_index_instr_l_regs [23] ) ;	// line#=computer.cpp:916
assign	U_101 = ( U_92 & ( ~RL_imm1_index_instr_l_regs [23] ) ) ;	// line#=computer.cpp:916
assign	U_105 = ( U_62 & FF_bf_ctx_fault_handled ) ;	// line#=computer.cpp:1012
assign	U_116 = ( ST1_05d & FF_bf_ctx_valid ) ;	// line#=computer.cpp:367
assign	U_119 = ( ST1_07d & RG_20 ) ;	// line#=computer.cpp:595
assign	C_06 = ( ( ( ~handled_t2 ) & M_264 ) & ( ~|{ RG_funct7 [6:1] , ~RG_funct7 [0] } ) ) ;	// line#=computer.cpp:1061
assign	U_123 = ( ST1_09d & C_06 ) ;	// line#=computer.cpp:1061
assign	U_124 = ( ST1_09d & ( ~C_06 ) ) ;	// line#=computer.cpp:1061
assign	C_07 = ( ( ( M_334 | comp32u_1_11ot [2] ) | comp32u_12ot [2] ) | gop36u_11ot ) ;	// line#=computer.cpp:311,1062,1063
assign	U_126 = ( U_123 & ( ~C_07 ) ) ;	// line#=computer.cpp:311
assign	C_08 = ( ( ~bf_ctx_valid_t ) & ( |( regs_rg05 ^ bf_ctx_load_next_t1 ) ) ) ;	// line#=computer.cpp:315,1062,1063
assign	M_264 = ~|{ RG_funct3_i_1 [2] , ~RG_funct3_i_1 [1] , RG_funct3_i_1 [0] } ;	// line#=computer.cpp:1057,1061,1066,1071
assign	C_09 = ( M_363 & ( ~|RG_funct7 ) ) ;	// line#=computer.cpp:1057
assign	U_135 = ( ST1_10d & comp32u_11ot [3] ) ;	// line#=computer.cpp:319
assign	U_142 = ( U_135 & ( ~comp32u_1_11ot [3] ) ) ;	// line#=computer.cpp:295
assign	U_144 = ( U_142 & ( ~CT_38 ) ) ;	// line#=computer.cpp:277,299
assign	U_146 = ( U_144 & ( ~CT_39 ) ) ;	// line#=computer.cpp:279,299
assign	U_149 = ( ( ST1_10d & ( ~comp32u_11ot [3] ) ) & ( ~FF_bf_ctx_valid ) ) ;	// line#=computer.cpp:319,323
assign	M_363 = ( ( ~FF_bf_ctx_fault_handled ) & M_264 ) ;	// line#=computer.cpp:1057,1066,1071
assign	C_11 = ( M_363 & ( ~|{ RG_funct7 [6:2] , ~RG_funct7 [1] , RG_funct7 [0] } ) ) ;	// line#=computer.cpp:1066
assign	U_152 = ( ST1_11d & C_11 ) ;	// line#=computer.cpp:1066
assign	U_153 = ( ST1_11d & ( ~C_11 ) ) ;	// line#=computer.cpp:1066
assign	M_334 = ~|regs_rg06 ;	// line#=computer.cpp:311,329,330,1062
				// ,1063,1067,1068
assign	C_12 = ( ( ( ( ( ~FF_bf_ctx_valid ) | M_334 ) | comp32u_1_11ot [2] ) | comp32u_12ot [2] ) | 
	gop36u_11ot ) ;	// line#=computer.cpp:329,330,1067,1068
assign	U_154 = ( U_152 & C_12 ) ;	// line#=computer.cpp:329,330
assign	C_13 = ( M_363 & ( ~|{ RG_funct7 [6:2] , ~RG_funct7 [1:0] } ) ) ;	// line#=computer.cpp:1071
assign	U_167 = ( ST1_12d & ( ~|( RG_funct3_i [1:0] ^ 2'h1 ) ) ) ;
assign	U_170 = ( ST1_12d & ( ~comp32u_12ot [3] ) ) ;	// line#=computer.cpp:288
assign	U_171 = ( U_170 & CT_51 ) ;	// line#=computer.cpp:267,291
assign	U_172 = ( U_170 & ( ~CT_51 ) ) ;	// line#=computer.cpp:267,291
assign	U_173 = ( U_172 & CT_50 ) ;	// line#=computer.cpp:269,291
assign	U_174 = ( U_172 & ( ~CT_50 ) ) ;	// line#=computer.cpp:269,291
assign	U_175 = ( U_174 & CT_49 ) ;	// line#=computer.cpp:271,291
assign	U_176 = ( U_174 & ( ~CT_49 ) ) ;	// line#=computer.cpp:271,291
...
assign	U_181 = ( U_177 & RG_20 ) ;	// line#=computer.cpp:335,336
assign	U_182 = ( U_177 & M_258 ) ;	// line#=computer.cpp:335
assign	U_183 = ( U_178 & RG_20 ) ;	// line#=computer.cpp:335,336
assign	M_258 = ~RG_20 ;	// line#=computer.cpp:335,336
assign	U_184 = ( U_178 & M_258 ) ;	// line#=computer.cpp:336
assign	U_185 = ( U_179 & M_330 ) ;	// line#=computer.cpp:337
assign	M_330 = |RL_addr_addr1_count_next_pc_op1 [31:2] ;	// line#=computer.cpp:337
assign	U_186 = ( U_179 & ( ~M_330 ) ) ;	// line#=computer.cpp:337
...
assign	U_213 = ( ST1_14d & FF_bf_ctx_valid ) ;	// line#=computer.cpp:347
...
always @ ( C_bf_ctx_read_word_1_t or U_180 or RL_addr_addr1_count_next_pc_op1 or 
	...
	U_51 or ST1_04d or TR_01 or M_353 or ST1_03d )	// line#=computer.cpp:744
	begin
	RG_next_pc_PC_t_c1 = ( ST1_03d | M_353 ) ;	// line#=computer.cpp:337,725,733,744
	RG_next_pc_PC_t_c2 = ( ST1_04d & ( ( ( ( ( ( ( ( ( U_51 | U_52 ) | U_56 ) | 
		U_57 ) | U_58 ) | U_59 ) | ( ST1_04d & M_274 ) ) | U_61 ) | U_62 ) | 
		U_63 ) ) ;	// line#=computer.cpp:741
	RG_next_pc_PC_t_c3 = ( ( ST1_04d & U_53 ) | ( ST1_04d & U_54 ) ) ;	// line#=computer.cpp:86,91,118,769,777
										// ,780
	RG_next_pc_PC_t_c4 = ( M_337 | ST1_16d ) ;	// line#=computer.cpp:1104
	RG_next_pc_PC_t = ( ( { 32{ RG_next_pc_PC_t_c1 } } & { 25'h0000000 , TR_01 } )			// line#=computer.cpp:337,725,733,744
		...
		| ( { 32{ U_180 } } & C_bf_ctx_read_word_1_t )						// line#=computer.cpp:337
		) ;
	end
assign	RG_next_pc_PC_en = ( RG_next_pc_PC_t_c1 | RG_next_pc_PC_t_c2 | RG_next_pc_PC_t_c3 | 
	RG_next_pc_PC_t_c4 | U_180 ) ;	// line#=computer.cpp:744
...
always @ ( incr32u1ot or U_135 )
	RG_i_t = ( { 32{ U_135 } } & incr32u1ot )	// line#=computer.cpp:319
...
always @ ( M_330 or M_266 or U_185 or U_183 or U_181 or M_352 )
	begin
	TR_23_c1 = ( U_183 | U_185 ) ;	// line#=computer.cpp:337
	TR_23 = ( ( { 2{ M_352 } } & { 1'h0 , U_181 } )
		| ( { 2{ TR_23_c1 } } & { 1'h1 , ( M_266 & M_330 ) } )	// line#=computer.cpp:337
		) ;
	end
assign	M_338 = ( ( ( ST1_06d | U_119 ) | ST1_08d ) | ST1_12d ) ;
assign	M_349 = ( U_116 | ( U_152 & ( ~C_12 ) ) ) ;	// line#=computer.cpp:329,330
always @ ( RG_funct3_i_1 or M_338 or TR_23 or U_185 or U_183 or M_352 or i_11_t1 or 
	...
	TR_04 = ( ( { 3{ ST1_03d } } & imem_arg_MEMB32W65536_RD1 [14:12] )	// line#=computer.cpp:725,735
		...
		| ( { 3{ M_338 } } & RG_funct3_i_1 )				// line#=computer.cpp:595
		) ;
	end
...
always @ ( RG_funct3_i_t1 or ST1_15d or TR_04 or U_185 or U_183 or U_181 or M_338 or 
	...
	RG_funct3_i_t_c1 = ( ( ( ( ( M_336 | M_349 ) | M_338 ) | U_181 ) | U_183 ) | 
		U_185 ) ;	// line#=computer.cpp:595,725,735
...
assign	M_351 = ( U_123 & ( U_126 & ( ~C_08 ) ) ) ;	// line#=computer.cpp:315
always @ ( bf_ctx_fault_t4 or ST1_15d or bf_ctx_fault_t3 or U_153 or FF_bf_ctx_fault or 
	...
	FF_bf_ctx_fault_t_c2 = ( ( U_123 & ( ( U_123 & C_07 ) | ( U_126 & C_08 ) ) ) | 
		U_154 ) ;	// line#=computer.cpp:312,316,331
	FF_bf_ctx_fault_t_c3 = ( M_351 | U_124 ) ;	// line#=computer.cpp:305
...
assign	FF_bf_ctx_fault_en = ( FF_bf_ctx_fault_t_c1 | FF_bf_ctx_fault_t_c2 | FF_bf_ctx_fault_t_c3 | 
	U_153 | ST1_15d ) ;	// line#=computer.cpp:311,315
always @ ( posedge CLOCK )	// line#=computer.cpp:311,315
	if ( RESET )
		...
		FF_bf_ctx_fault <= FF_bf_ctx_fault_t ;	// line#=computer.cpp:305,311,312,315,316
							// ,331
always @ ( bf_ctx_valid_t1 or C_13 or U_153 or bf_ctx_valid_t or ST1_09d )	// line#=computer.cpp:1071
	begin
	FF_bf_ctx_valid_t_c1 = ( U_153 & C_13 ) ;	// line#=computer.cpp:341
...
assign	M_335 = ( regs_rd00 ^ regs_rd01 ) ;	// line#=computer.cpp:792,795
always @ ( B_02_t or ST1_04d or comp32s_11ot or U_13 or comp32s_1_11ot or M_262 or 
	...
	FF_take_t_c2 = ( U_09 & M_254 ) ;	// line#=computer.cpp:792
	FF_take_t_c3 = ( U_09 & M_279 ) ;	// line#=computer.cpp:795
	FF_take_t_c4 = ( U_09 & M_275 ) ;	// line#=computer.cpp:798
	FF_take_t_c5 = ( U_09 & M_292 ) ;	// line#=computer.cpp:801
	FF_take_t_c6 = ( M_345 | U_46 ) ;	// line#=computer.cpp:804,878,929
	FF_take_t_c7 = ( U_12 & M_262 ) ;	// line#=computer.cpp:875
	FF_take_t_c8 = ( U_13 & M_262 ) ;	// line#=computer.cpp:926
	FF_take_t = ( ( { 1{ FF_take_t_c1 } } & ( |imem_arg_MEMB32W65536_RD1 [11:7] ) )	// line#=computer.cpp:725,734,749,758,767
		| ( { 1{ FF_take_t_c2 } } & ( ~|M_335 ) )				// line#=computer.cpp:792
		| ( { 1{ FF_take_t_c3 } } & ( |M_335 ) )				// line#=computer.cpp:795
...
always @ ( bf_ctx_fault_t4 or ST1_15d or CT_49 or ST1_12d or handled_t4 or U_153 or 
	...
	ST1_05d or U_62 or ST1_04d or imem_arg_MEMB32W65536_RD1 or ST1_03d )	// line#=computer.cpp:725,733,744
	begin
	...
	FF_bf_ctx_fault_handled_t_c3 = ( ( ( ( ( ST1_05d | ST1_08d ) | U_123 ) | 
		ST1_10d ) | U_152 ) | ST1_16d ) ;	// line#=computer.cpp:368,1016,1064,1069
	FF_bf_ctx_fault_handled_t = ( ( { 1{ FF_bf_ctx_fault_handled_t_c1 } } & ( ( 
		...
		| ( { 1{ U_124 } } & handled_t2 )
		| ( { 1{ U_153 } } & handled_t4 )
		| ( { 1{ ST1_12d } } & CT_49 )				// line#=computer.cpp:271,291
		| ( { 1{ ST1_15d } } & bf_ctx_fault_t4 ) ) ;	// line#=computer.cpp:979
	end
assign	FF_bf_ctx_fault_handled_en = ( FF_bf_ctx_fault_handled_t_c1 | FF_bf_ctx_fault_handled_t_c2 | 
	FF_bf_ctx_fault_handled_t_c3 | U_124 | U_153 | ST1_12d | ST1_15d ) ;	// line#=computer.cpp:725,733,744
always @ ( posedge CLOCK )	// line#=computer.cpp:725,733,744
	if ( FF_bf_ctx_fault_handled_en )
		FF_bf_ctx_fault_handled <= FF_bf_ctx_fault_handled_t ;	// line#=computer.cpp:271,291,368,725,733
									// ,735,738,744,979,1012,1016,1064
									// ,1069
always @ ( handled_t4 or FF_bf_ctx_fault or ST1_16d or bf_ctx_fault_t3 or U_153 or 
	U_154 or U_63 or U_61 or ST1_04d )	// line#=computer.cpp:1087
	begin
	FF_halt_t_c1 = ( ( ( ST1_04d & ( U_61 | U_63 ) ) | ( ( U_154 | ( U_153 & 
		bf_ctx_fault_t3 ) ) | ( ST1_16d & FF_bf_ctx_fault ) ) ) | ( ( U_153 & ( 
		~bf_ctx_fault_t3 ) ) & ( U_153 & ( ~handled_t4 ) ) ) ) ;	// line#=computer.cpp:966,1081,1088,1099
...
always @ ( bf_ctx_p_rg17 or ST1_14d or regs_rg05 or M_342 or addsub32u1ot or U_32 or 
	...
	RG_index_op2_regs_word_addr_t = ( ( { 32{ ST1_02d } } & RG_index_op2_regs_word_addr_t1 )
		...
		| ( { 32{ M_342 } } & regs_rg05 )							// line#=computer.cpp:1062,1063,1067,1068
...
always @ ( add32s1ot or M_322 )
	TR_24 = ( { 16{ M_322 } } & add32s1ot [17:2] )	// line#=computer.cpp:86,97,847
...
always @ ( RL_addr_addr1_count_next_pc_op1_t2 or ST1_14d or U_228 or U_227 or U_226 or 
	...
	RL_addr_addr1_count_next_pc_op1_t = ( ( { 32{ ST1_02d } } & RL_addr_addr1_count_next_pc_op1_t1 )
		...
		| ( { 32{ M_344 } } & { 14'h0000 , TR_24 , add32s1ot [1:0] } )	// line#=computer.cpp:86,91,97,819,847
		| ( { 32{ RL_addr_addr1_count_next_pc_op1_t_c1 } } & RG_next_pc_PC )
		| ( { 32{ ST1_05d } } & l_t )					// line#=computer.cpp:382
		| ( { 32{ M_342 } } & regs_rg06 )				// line#=computer.cpp:1062,1063,1067,1068
		| ( { 32{ U_214 } } & r_t )					// line#=computer.cpp:384
		| ( { 32{ U_215 } } & l_t1 )					// line#=computer.cpp:382
		| ( { 32{ U_216 } } & r_t )					// line#=computer.cpp:382,384
		| ( { 32{ U_217 } } & l_t1 )					// line#=computer.cpp:382,384
...
always @ ( l_t1 or U_229 or U_228 or U_226 or U_224 or U_222 or U_220 or U_218 or 
	...
	RG_r_regs_stream1_w1_t = ( ( { 32{ ST1_02d } } & RG_r_regs_stream1_w1_t1 )
		...
		| ( { 32{ U_214 } } & r_t )										// line#=computer.cpp:382
		...
		| ( { 32{ U_229 } } & l_t1 )										// line#=computer.cpp:384,387
		) ;
	end
...
always @ ( M_322 or M_298 or imem_arg_MEMB32W65536_RD1 or M_319 or M_318 or M_315 or 
	...
	TR_06_c1 = ( ( ( ( ( ( ( M_309 & M_292 ) | M_324 ) | M_313 ) | M_311 ) | 
		M_315 ) | M_318 ) | M_319 ) ;	// line#=computer.cpp:725
	TR_06_c2 = ( M_298 | M_322 ) ;	// line#=computer.cpp:725,735,821,849
...
assign	M_318 = ~|( { 25'h0000000 , imem_arg_MEMB32W65536_RD1 [6:0] } ^ 32'h00000067 ) ;	// line#=computer.cpp:725,733,735,744,870
...
always @ ( RG_index_op2_regs_word_addr or RG_r_regs_stream1_w1 or U_229 or U_227 or 
	...
	M_254 or U_12 or RL_imm1_index_instr_l_regs_t1 or ST1_02d )	// line#=computer.cpp:367,725,733,735,744
									// ,870
	begin
	RL_imm1_index_instr_l_regs_t_c1 = ( ( ( ( U_12 & M_254 ) | ( U_12 & M_275 ) ) | 
		( U_12 & M_303 ) ) | ( U_12 & M_269 ) ) ;	// line#=computer.cpp:86,91,725,867
	...
	RL_imm1_index_instr_l_regs_t_c4 = ( U_178 | U_179 ) ;	// line#=computer.cpp:336,337
	RL_imm1_index_instr_l_regs_t = ( ( { 32{ ST1_02d } } & RL_imm1_index_instr_l_regs_t1 )
		...
		| ( { 32{ U_116 } } & l_t )							// line#=computer.cpp:371
		| ( { 32{ ST1_06d } } & M_134_t )						// line#=computer.cpp:599
		| ( { 32{ ST1_11d } } & regs_rg05 )						// line#=computer.cpp:334,1067,1068
		| ( { 32{ U_177 } } & incr32u1ot )						// line#=computer.cpp:335
		| ( { 32{ RL_imm1_index_instr_l_regs_t_c4 } } & addsub32u1ot [31:0] )		// line#=computer.cpp:336,337
		| ( { 32{ U_215 } } & l_t1 )							// line#=computer.cpp:384
		...
		| ( { 32{ U_229 } } & ( RG_r_regs_stream1_w1 ^ RG_index_op2_regs_word_addr ) )	// line#=computer.cpp:386
		) ;
	end
assign	RL_imm1_index_instr_l_regs_en = ( ST1_02d | RL_imm1_index_instr_l_regs_t_c1 | 
	...
	U_219 | U_221 | U_223 | U_225 | U_227 | U_229 ) ;	// line#=computer.cpp:367,725,733,735,744
								// ,870
...
always @ ( FF_bf_ctx_valid or ST1_14d or RL_addr_addr1_count_next_pc_op1 or RG_funct3_i or 
	...
	RG_20_t = ( ( { 1{ ST1_02d } } & CT_01 )					// line#=computer.cpp:723
		...
		| ( { 1{ U_167 } } & comp32u_1_11ot [2] )				// line#=computer.cpp:336
...
always @ ( posedge CLOCK )
	if ( RG_20_en )
		RG_20 <= RG_20_t ;	// line#=computer.cpp:335,336,347,595,723
...
always @ ( incr3u1ot or ST1_06d or RG_funct3_i or ST1_12d or M_339 )
	begin
	RG_funct3_i_1_t_c1 = ( M_339 | ST1_12d ) ;	// line#=computer.cpp:735
...
assign	M_365 = ~( M_366 | M_289 ) ;	// line#=computer.cpp:744
assign	M_366 = ( ( ( ( ( ( ( ( ( ( M_314 | M_312 ) | M_316 ) | M_317 ) | M_320 ) | 
	M_300 ) | M_323 ) | M_310 ) | M_325 ) | M_274 ) | M_327 ) ;	// line#=computer.cpp:744
...
always @ ( RL_addr_addr1_count_next_pc_op1 or RG_09 or add32s1ot or take_t1 )	// line#=computer.cpp:810
	begin
	M_178_t_c1 = ~take_t1 ;
	M_178_t = ( ( { 31{ take_t1 } } & add32s1ot [31:1] )	// line#=computer.cpp:811
...
always @ ( FF_bf_ctx_fault_handled or C_09 )
	begin
	handled_t2_c1 = ~C_09 ;
	handled_t2 = ( ( { 1{ C_09 } } & 1'h1 )	// line#=computer.cpp:1059
...
assign	M_328 = ~|RG_i ;	// line#=computer.cpp:320
assign	M_261 = ~M_328 ;	// line#=computer.cpp:320
assign	M_287 = ~|{ RG_i [31:1] , ~RG_i [0] } ;	// line#=computer.cpp:320
...
always @ ( value_t_t1 or RG_r_regs_stream1_w1 or M_287 or M_261 or RL_imm1_index_instr_l_regs or 
	M_328 )	// line#=computer.cpp:320
	begin
	value_t_c1 = ( M_261 & M_287 ) ;	// line#=computer.cpp:320
	value_t_c2 = ( M_261 & ( ~M_287 ) ) ;	// line#=computer.cpp:320
	value_t = ( ( { 32{ M_328 } } & RL_imm1_index_instr_l_regs )	// line#=computer.cpp:320
...
always @ ( FF_bf_ctx_fault_handled or C_13 )
	begin
	handled_t4_c1 = ~C_13 ;
	handled_t4 = ( ( { 1{ C_13 } } & 1'h1 )	// line#=computer.cpp:1073
...
always @ ( bf_ctx_s3_RD1 or bf_ctx_s2_RD1 or FF_bf_ctx_fault_handled or bf_ctx_s1_RD1 or 
	RG_23 or bf_ctx_s0_RD1 or RG_22 or bf_ctx_p_rd00 or RG_21 )	// line#=computer.cpp:288
	begin
	C_bf_ctx_read_word_1_t_c1 = ( ( ~RG_21 ) & RG_22 ) ;	// line#=computer.cpp:268
	C_bf_ctx_read_word_1_t_c2 = ( ( ~RG_21 ) & ( ( ~RG_22 ) & RG_23 ) ) ;	// line#=computer.cpp:270
	...
	C_bf_ctx_read_word_1_t = ( ( { 32{ RG_21 } } & bf_ctx_p_rd00 )		// line#=computer.cpp:289
...
always @ ( RG_20 )	// line#=computer.cpp:335
	...
	default :
		TR_29 = 1'hx ;
	endcase
always @ ( M_330 )	// line#=computer.cpp:337
	case ( M_330 )
	1'h1 :
		JF_09_t1 = 1'h1 ;
	1'h0 :
...
always @ ( JF_09_t1 or M_266 or M_284 or TR_29 or M_257 )
	JF_09 = ( ( { 1{ M_257 } } & TR_29 )	// line#=computer.cpp:335
		| ( { 1{ M_284 } } & TR_29 )	// line#=computer.cpp:336
		| ( { 1{ M_266 } } & JF_09_t1 )	// line#=computer.cpp:337
		) ;
always @ ( addsub32u_322ot or RG_20 )
	begin
	C_accel_bf_ctx_f_1_t2_c1 = ~RG_20 ;	// line#=computer.cpp:353,354,355
...
always @ ( FF_bf_ctx_fault or RG_20 )
	...
	bf_ctx_fault_t4 = ( ( { 1{ RG_20 } } & 1'h1 )	// line#=computer.cpp:348
...
always @ ( RL_addr_addr1_count_next_pc_op1 or U_53 or U_68 or regs_rd02 or U_54 or 
	...
	add32s1i1 = ( ( { 32{ M_344 } } & regs_rd00 )				// line#=computer.cpp:86,91,97,819,847
...
always @ ( M_298 or imem_arg_MEMB32W65536_RD1 or M_322 )
	TR_08 = ( ( { 5{ M_322 } } & imem_arg_MEMB32W65536_RD1 [11:7] )		// line#=computer.cpp:86,96,97,725,734
										// ,738,847
		| ( { 5{ M_298 } } & imem_arg_MEMB32W65536_RD1 [24:20] )	// line#=computer.cpp:86,91,725,737,819
		) ;
always @ ( M_317 or RL_imm1_index_instr_l_regs or M_332 )
	M_385 = ( ( { 6{ M_332 } } & { RL_imm1_index_instr_l_regs [0] , RL_imm1_index_instr_l_regs [4:1] , 
			1'h0 } )										// line#=computer.cpp:86,102,103,104,105
														// ,106,738,788,811
		| ( { 6{ M_317 } } & { RL_imm1_index_instr_l_regs [24] , RL_imm1_index_instr_l_regs [17:13] } )	// line#=computer.cpp:86,91,737,777
		) ;
...
always @ ( TR_25 or M_357 or regs_rd02 or M_369 or RL_addr_addr1_count_next_pc_op1 or 
	M_370 )
	lsft32u1i1 = ( ( { 32{ M_370 } } & RL_addr_addr1_count_next_pc_op1 )	// line#=computer.cpp:923
		| ( { 32{ M_369 } } & regs_rd02 )				// line#=computer.cpp:890
...
always @ ( RL_addr_addr1_count_next_pc_op1 or M_357 or RG_rs2 or M_369 or RG_index_op2_regs_word_addr or 
	M_370 )
	lsft32u1i2 = ( ( { 5{ M_370 } } & RG_index_op2_regs_word_addr [4:0] )		// line#=computer.cpp:923
		| ( { 5{ M_369 } } & RG_rs2 )						// line#=computer.cpp:890
...
always @ ( dmem_arg_MEMB32W65536_0_RD1 or M_358 or regs_rd02 or M_374 or RL_addr_addr1_count_next_pc_op1 or 
	M_375 )
	rsft32u1i1 = ( ( { 32{ M_375 } } & RL_addr_addr1_count_next_pc_op1 )	// line#=computer.cpp:938
		| ( { 32{ M_374 } } & regs_rd02 )				// line#=computer.cpp:898
		| ( { 32{ M_358 } } & dmem_arg_MEMB32W65536_0_RD1 )		// line#=computer.cpp:141,142,158,159,823
										// ,826,832,835
		) ;
assign	M_358 = ( ( ( ( M_300 & ( ~|( RL_imm1_index_instr_l_regs ^ 32'h00000005 ) ) ) | 
	( M_300 & ( ~|( RL_imm1_index_instr_l_regs ^ 32'h00000004 ) ) ) ) | ( M_300 & 
	M_280 ) ) | ( M_300 & M_255 ) ) ;	// line#=computer.cpp:821
...
always @ ( RL_addr_addr1_count_next_pc_op1 or M_358 or RG_rs2 or M_374 or RG_index_op2_regs_word_addr or 
	M_375 )
	rsft32u1i2 = ( ( { 5{ M_375 } } & RG_index_op2_regs_word_addr [4:0] )		// line#=computer.cpp:938
		| ( { 5{ M_374 } } & RG_rs2 )						// line#=computer.cpp:898
		| ( { 5{ M_358 } } & { RL_addr_addr1_count_next_pc_op1 [1:0] , 3'h0 } )	// line#=computer.cpp:141,142,158,159,823
											// ,826,832,835
		) ;
always @ ( regs_rd02 or M_310 or RL_addr_addr1_count_next_pc_op1 or M_325 )
	rsft32s1i1 = ( ( { 32{ M_325 } } & RL_addr_addr1_count_next_pc_op1 )	// line#=computer.cpp:936
		| ( { 32{ M_310 } } & regs_rd02 )				// line#=computer.cpp:895
		) ;
always @ ( RG_rs2 or M_310 or RG_index_op2_regs_word_addr or M_325 )
	rsft32s1i2 = ( ( { 5{ M_325 } } & RG_index_op2_regs_word_addr [4:0] )	// line#=computer.cpp:936
		| ( { 5{ M_310 } } & RG_rs2 )					// line#=computer.cpp:895
		) ;
...
always @ ( RG_index_op2_regs_word_addr or U_181 or RG_i or U_135 )
	incr32u1i1 = ( ( { 32{ U_135 } } & RG_i )			// line#=computer.cpp:319
		| ( { 32{ U_181 } } & RG_index_op2_regs_word_addr )	// line#=computer.cpp:335
		) ;
always @ ( RL_imm1_index_instr_l_regs or U_170 or add32s1ot or U_25 or U_26 or U_28 or 
	...
	begin
	addsub32u1i1_c1 = ( ( ST1_10d | U_185 ) | U_183 ) ;	// line#=computer.cpp:321,336,337
	...
	addsub32u1i1 = ( ( { 32{ addsub32u1i1_c1 } } & RG_index_op2_regs_word_addr )	// line#=computer.cpp:321,336,337
		...
		| ( { 32{ M_350 } } & regs_rg05 )					// line#=computer.cpp:311,329,330,1062
											// ,1063,1067,1068
		| ( { 32{ addsub32u1i1_c2 } } & add32s1ot )				// line#=computer.cpp:86,91,97,131,148
											// ,180,199,819,847
		| ( { 32{ U_170 } } & RL_imm1_index_instr_l_regs )			// line#=computer.cpp:290
		) ;
	end
always @ ( U_183 or U_185 or U_01 )
	TR_12 = ( ( { 3{ U_01 } } & 3'h4 )	// line#=computer.cpp:741
		| ( { 3{ U_185 } } & 3'h3 )	// line#=computer.cpp:337
		| ( { 3{ U_183 } } & 3'h2 )	// line#=computer.cpp:336
		) ;
always @ ( U_170 or TR_12 or M_343 )
	M_387 = ( ( { 4{ M_343 } } & { 1'h0 , TR_12 } )	// line#=computer.cpp:336,337,741
		| ( { 4{ U_170 } } & 4'ha )		// line#=computer.cpp:290
		) ;
assign	M_343 = ( ( U_01 | U_185 ) | U_183 ) ;
always @ ( M_346 or M_387 or U_170 or M_343 )
	begin
	M_388_c1 = ( M_343 | U_170 ) ;	// line#=computer.cpp:290,336,337,741
	M_388 = ( ( { 5{ M_388_c1 } } & { 1'h0 , M_387 } )	// line#=computer.cpp:290,336,337,741
...
always @ ( regs_rg06 or M_350 or M_388 or U_170 or M_346 or M_343 or RG_i or ST1_10d )
	begin
	addsub32u1i2_c1 = ( ( M_343 | M_346 ) | U_170 ) ;	// line#=computer.cpp:131,148,180,199,290
								// ,336,337,741
	addsub32u1i2 = ( ( { 32{ ST1_10d } } & RG_i )		// line#=computer.cpp:321
		| ( { 32{ addsub32u1i2_c1 } } & { 13'h0000 , M_388 [4] , 13'h0000 , 
			M_388 [3] , 1'h0 , M_388 [2:0] } )	// line#=computer.cpp:131,148,180,199,290
								// ,336,337,741
		| ( { 32{ M_350 } } & regs_rg06 )		// line#=computer.cpp:311,329,330,1062
								// ,1063,1067,1068
		) ;
	end
...
always @ ( M_350 or ST1_12d )
	M_383 = ( ( { 3{ ST1_12d } } & 3'h2 )	// line#=computer.cpp:288
		| ( { 3{ M_350 } } & 3'h5 )	// line#=computer.cpp:311,329,330
		) ;
always @ ( M_383 or M_350 or ST1_12d or regs_rd00 or U_46 or imem_arg_MEMB32W65536_RD1 or 
	...
	comp32u_12i2_c2 = ( ST1_12d | M_350 ) ;	// line#=computer.cpp:288,311,329,330
	comp32u_12i2 = ( ( { 32{ comp32u_12i2_c1 } } & regs_rd01 )	// line#=computer.cpp:804,807
		...
		| ( { 32{ comp32u_12i2_c2 } } & { 21'h000000 , M_383 [2] , 8'h04 , 
			M_383 [1:0] } )					// line#=computer.cpp:288,311,329,330
		) ;
	end
...
always @ ( regs_rd03 or M_280 )
	TR_15 = ( { 8{ M_280 } } & regs_rd03 [15:8] )	// line#=computer.cpp:211,212,854
...
always @ ( addsub32u1ot or ST1_10d or bf_ctx_s0_RD1 or U_231 )
	addsub32u_321i1 = ( ( { 32{ U_231 } } & bf_ctx_s0_RD1 )	// line#=computer.cpp:351,352,355
		| ( { 32{ ST1_10d } } & addsub32u1ot [31:0] )	// line#=computer.cpp:298,321
		) ;
always @ ( ST1_10d or bf_ctx_s1_RD1 or U_231 )
	addsub32u_321i2 = ( ( { 32{ U_231 } } & bf_ctx_s1_RD1 )	// line#=computer.cpp:351,352,355
...
always @ ( bf_ctx_s2_RD1 or addsub32u_321ot or U_231 or RG_bf_ctx_load_next or U_149 or 
	...
	M_348 )
	addsub32u_322i1 = ( ( { 32{ M_348 } } & RL_addr_addr1_count_next_pc_op1 )	// line#=computer.cpp:917,919
		| ( { 32{ U_65 } } & { RL_imm1_index_instr_l_regs [24:5] , 12'h000 } )	// line#=computer.cpp:110,759
		| ( { 32{ U_149 } } & RG_bf_ctx_load_next )				// line#=computer.cpp:324
		| ( { 32{ U_231 } } & ( addsub32u_321ot ^ bf_ctx_s2_RD1 ) )		// line#=computer.cpp:351,352,353,354,355
		) ;
assign	M_348 = U_92 ;
always @ ( bf_ctx_s3_RD1 or U_231 or RL_addr_addr1_count_next_pc_op1 or U_149 or 
	U_65 or RG_index_op2_regs_word_addr or M_348 )
	begin
	addsub32u_322i2_c1 = ( U_65 | U_149 ) ;	// line#=computer.cpp:110,324,759
	addsub32u_322i2 = ( ( { 32{ M_348 } } & RG_index_op2_regs_word_addr )		// line#=computer.cpp:917,919
		| ( { 32{ addsub32u_322i2_c1 } } & RL_addr_addr1_count_next_pc_op1 )	// line#=computer.cpp:110,324,759
		| ( { 32{ U_231 } } & bf_ctx_s3_RD1 )					// line#=computer.cpp:353,354,355
		) ;
	end
...
always @ ( regs_rg06 or M_350 or RL_addr_addr1_count_next_pc_op1 or U_167 or addsub32u1ot or 
	U_135 )
	comp32u_1_11i1 = ( ( { 32{ U_135 } } & addsub32u1ot [31:0] )	// line#=computer.cpp:295,321
		| ( { 32{ U_167 } } & RL_addr_addr1_count_next_pc_op1 )	// line#=computer.cpp:336
		| ( { 32{ M_350 } } & regs_rg06 )			// line#=computer.cpp:311,329,330,1062
									// ,1063,1067,1068
		) ;
always @ ( M_350 or U_167 or U_135 )
	M_384 = ( ( { 3{ U_135 } } & 3'h5 )	// line#=computer.cpp:295
		| ( { 3{ U_167 } } & 3'h1 )	// line#=computer.cpp:336
		| ( { 3{ M_350 } } & 3'h2 )	// line#=computer.cpp:311,329,330
		) ;
assign	comp32u_1_11i2 = { M_384 [2] , 1'h0 , M_384 [1:0] , 1'h0 } ;
assign	imem_arg_MEMB32W65536_RE1 = U_01 ;	// line#=computer.cpp:725
assign	M_359 = ( M_255 | M_280 ) ;	// line#=computer.cpp:821,849
...
always @ ( addsub32u1ot or M_322 or M_292 or M_275 or M_279 or M_254 or add32s1ot or 
	M_262 or M_298 )
	begin
	dmem_arg_MEMB32W65536_0_RA1_c1 = ( M_298 & M_262 ) ;	// line#=computer.cpp:86,91,165,174,819
								// ,829
...
always @ ( RL_addr_addr1_count_next_pc_op1 or U_213 or addsub32u1ot or U_171 )
	bf_ctx_s0_RA1 = ( ( { 8{ U_171 } } & addsub32u1ot [7:0] )		// line#=computer.cpp:268,290
		| ( { 8{ U_213 } } & RL_addr_addr1_count_next_pc_op1 [31:24] )	// line#=computer.cpp:351
		) ;
...
always @ ( RL_addr_addr1_count_next_pc_op1 or U_213 or addsub32u1ot or U_173 )
	bf_ctx_s1_RA1 = ( ( { 8{ U_173 } } & addsub32u1ot [7:0] )		// line#=computer.cpp:270,290
		| ( { 8{ U_213 } } & RL_addr_addr1_count_next_pc_op1 [23:16] )	// line#=computer.cpp:352
		) ;
...
always @ ( RL_addr_addr1_count_next_pc_op1 or U_213 or addsub32u1ot or U_175 )
	bf_ctx_s2_RA1 = ( ( { 8{ U_175 } } & addsub32u1ot [7:0] )		// line#=computer.cpp:272,290
		| ( { 8{ U_213 } } & RL_addr_addr1_count_next_pc_op1 [15:8] )	// line#=computer.cpp:353
		) ;
...
always @ ( RL_addr_addr1_count_next_pc_op1 or U_213 or addsub32u1ot or U_176 )
	bf_ctx_s3_RA1 = ( ( { 8{ U_176 } } & addsub32u1ot [7:0] )		// line#=computer.cpp:273,290
		| ( { 8{ U_213 } } & RL_addr_addr1_count_next_pc_op1 [7:0] )	// line#=computer.cpp:354
		) ;
assign	bf_ctx_s3_RE1 = ( U_176 | U_213 ) ;
assign	bf_ctx_s3_WE2 = ( U_146 & ( ~CT_40 ) ) ;
assign	bf_ctx_p_we01 = ( U_135 & comp32u_1_11ot [3] ) ;	// line#=computer.cpp:295,296
always @ ( M_355 or M_368 or M_367 or M_373 or M_376 or M_364 or M_298 or M_322 or 
	...
	regs_ad00_c1 = ( ( ( ( ( ( ( ( ( ( M_309 & M_299 ) | ( M_309 & M_262 ) ) | 
		...
		M_355 ) ;	// line#=computer.cpp:725,736
	regs_ad00 = ( ( { 5{ M_324 } } & imem_arg_MEMB32W65536_RD1 [24:20] )	// line#=computer.cpp:725,737
...
always @ ( M_355 or M_368 or M_367 or M_373 or M_376 or M_364 or imem_arg_MEMB32W65536_RD1 or 
	...
	regs_ad01_c1 = ( ( ( ( ( M_364 | M_376 ) | M_373 ) | M_367 ) | M_368 ) | 
		M_355 ) ;	// line#=computer.cpp:725,737
	regs_ad01 = ( ( { 5{ M_324 } } & imem_arg_MEMB32W65536_RD1 [19:15] )	// line#=computer.cpp:725,736
...
always @ ( M_314 or RG_index_op2_regs_word_addr or RL_addr_addr1_count_next_pc_op1 or 
	...
	val2_t4 or M_331 or M_300 )	// line#=computer.cpp:870,893,914,935
	begin
	regs_wd04_c1 = ( M_300 & M_331 ) ;	// line#=computer.cpp:839
	regs_wd04_c2 = ( M_377 & U_81 ) ;	// line#=computer.cpp:872
	regs_wd04_c3 = ( ( ( ( M_377 & ( U_58 & M_268 ) ) | ( M_377 & ( U_58 & M_302 ) ) ) | 
		( M_378 & ( U_59 & M_268 ) ) ) | ( M_378 & ( U_59 & M_302 ) ) ) ;
	regs_wd04_c4 = ( M_377 & ( U_58 & M_278 ) ) ;	// line#=computer.cpp:881
	regs_wd04_c5 = ( M_377 & ( U_58 & M_305 ) ) ;	// line#=computer.cpp:884
	regs_wd04_c6 = ( M_377 & ( U_58 & M_271 ) ) ;	// line#=computer.cpp:887
	regs_wd04_c7 = ( ( M_377 & ( U_58 & M_282 ) ) | ( M_378 & ( U_59 & M_282 ) ) ) ;	// line#=computer.cpp:890,923
	regs_wd04_c8 = ( ( M_377 & ( U_88 & RL_imm1_index_instr_l_regs [23] ) ) | 
		( M_378 & ( U_97 & RL_imm1_index_instr_l_regs [23] ) ) ) ;	// line#=computer.cpp:895,936
	regs_wd04_c9 = ( ( M_377 & ( U_88 & ( ~RL_imm1_index_instr_l_regs [23] ) ) ) | 
		( M_378 & ( U_97 & ( ~RL_imm1_index_instr_l_regs [23] ) ) ) ) ;	// line#=computer.cpp:898,938
	regs_wd04_c10 = ( ( M_317 & M_331 ) | ( M_316 & FF_take ) ) ;	// line#=computer.cpp:768,779
	regs_wd04_c11 = ( ( M_378 & ( U_100 | U_101 ) ) | ( M_312 & FF_take ) ) ;	// line#=computer.cpp:110,759,917,919
	regs_wd04_c12 = ( M_378 & ( U_59 & M_278 ) ) ;	// line#=computer.cpp:932
	regs_wd04_c13 = ( M_378 & ( U_59 & M_305 ) ) ;	// line#=computer.cpp:942
	regs_wd04_c14 = ( M_378 & ( U_59 & M_271 ) ) ;	// line#=computer.cpp:945
	regs_wd04_c15 = ( M_314 & FF_take ) ;	// line#=computer.cpp:110,750
...
always @ ( RG_i_rd or ST1_07d or RG_funct3_i or ST1_06d )
	M_380 = ( ( { 4{ ST1_06d } } & { RG_funct3_i [2:0] , 1'h0 } )	// line#=computer.cpp:599
		| ( { 4{ ST1_07d } } & { RG_i_rd [2:0] , 1'h1 } )	// line#=computer.cpp:600
		) ;
assign	words_ad01 = M_380 ;
always @ ( M_136_t or ST1_07d or M_134_t or ST1_06d )
	words_wd01 = ( ( { 32{ ST1_06d } } & M_134_t )	// line#=computer.cpp:599
		| ( { 32{ ST1_07d } } & M_136_t )	// line#=computer.cpp:600
		) ;
