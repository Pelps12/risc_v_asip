...
// timestamp_0: 20260830204851_02584_27468
// timestamp_5: 20260830204852_02598_47721
// timestamp_9: 20260830204900_02598_09841
// timestamp_C: 20260830204900_02598_64689
// timestamp_E: 20260830204901_02598_04915
// timestamp_V: 20260830204902_02690_52913
...
assign	U_53 = ( U_16 & CT_10 ) ;	// line#=computer.cpp:1000
...
assign	U_400 = ( U_365 & RG_84 ) ;	// line#=computer.cpp:1000
...
assign	C_133 = ( ( ( ~FF_bf_ctx_fault_handled ) & ( ~|{ ~RG_funct3 [2] , RG_funct3 [1] , 
	~RG_funct3 [0] } ) ) & M_1983 ) ;	// line#=computer.cpp:1006
assign	U_522 = ( ST1_17d & C_133 ) ;	// line#=computer.cpp:1006
...
assign	M_1983 = ~|RG_funct7_l_1 [6:0] ;	// line#=computer.cpp:1006,1057
...
always @ ( RG_r_10 or U_970 or RG_r_9 or U_954 or RG_r_8 or U_938 or RG_r_7 or U_922 or 
	...
	M_2016 or ST1_03d )	// line#=computer.cpp:1000
	begin
...
assign	RG_funct7_l_en = ( RG_funct7_l_t_c1 | RG_funct7_l_t_c2 | U_826 | U_842 | 
	U_858 | U_874 | U_890 | U_906 | U_922 | U_938 | U_954 | U_970 ) ;	// line#=computer.cpp:1000
...
always @ ( bf_ctx_fault_t5 or U_858 or FF_bf_ctx_valid or U_600 or handled_t5 or 
	...
	FF_bf_ctx_fault_handled_t_c1 = ( ( ( ( ( ( ( ( U_475 & B_04_t ) | ST1_07d ) | 
		U_522 ) | U_530 ) | ST1_21d ) | U_589 ) | U_601 ) | U_810 ) ;	// line#=computer.cpp:368,1002,1008,1064
										// ,1069
...
always @ ( l_11_t8 or U_970 or l_10_t8 or U_954 or l_9_t8 or U_938 or l_8_t8 or 
	...
	begin
	RG_k0_r_value_t_c1 = ( ST1_02d | M_2027 ) ;	// line#=computer.cpp:321,1001,1062,1063
...
always @ ( index_1_t1 or U_528 or RG_index_1 or M_2019 or regs_rg05 or U_529 or 
	ST1_02d )
	begin
	RG_index_length_t_c1 = ( ST1_02d | U_529 ) ;	// line#=computer.cpp:1001,1067,1068
...
always @ ( r_t7 or U_809 or r_t6 or U_807 or r_t5 or U_805 or r_t4 or U_803 or r_t3 or 
	...
	begin
	RG_k1_r_w1_t_c1 = ( ( ST1_02d | ST1_17d ) | M_2024 ) ;	// line#=computer.cpp:372,570,1001,1062
								// ,1063
...
assign	JF_20 = ( ( C_133 & ( ~FF_bf_ctx_valid ) ) | ( ~C_133 ) ) ;	// line#=computer.cpp:1006
...
always @ ( regs_rd02 or U_276 or RG_k0_r_value or U_406 or dmem_arg_MEMB32W65536_0_RD1 or 
	...
	rsft32u17i1 = ( ( { 32{ U_01 } } & regs_rg11 )			// line#=computer.cpp:453,1001
