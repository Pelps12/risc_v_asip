...
// bdlpars options:  -EE -DAES_MEM -DACCEL_MIX_COL -DACCEL_SUB_BYTES -DACCEL_MIX_COL_U1 -DACCEL_SUB_BYTES_U1 -info_base_name computer computer.cpp
// bdltran options:  -EE computer.IFF -c1000 -s -Zresource_fcnt=GENERATE -Zresource_mcnt=GENERATE -Zsync -Zdup_reset=YES -Zfolding_sharing=inter_stage -lb /proj/cad/cwb-6.1/packages/asic_45.BLIB -lfl /proj/cad/cwb-6.1/packages/asic_45.FLIB -o-P 
// timestamp_0: 20260604025004_94281_11519
// timestamp_5: 20260604025005_94295_88677
// timestamp_9: 20260604025005_94295_89848
// timestamp_C: 20260604025005_94295_52538
// timestamp_E: 20260604025005_94295_14691
// timestamp_V: 20260604025006_94309_77437
...
always @ ( TR_10 or B01_streg_t4 or ST1_07d or B01_streg_t3 or ST1_05d or B01_streg_t2 or 
...
reg	[2:0]	RG_i_1 ;	// line#=computer.cpp:187
reg	RG_03 ;
...
reg	[31:0]	RG_regs_3 ;	// line#=computer.cpp:20
reg	[31:0]	RG_regs_4 ;	// line#=computer.cpp:20
...
reg	RG_regs_3_t_c1 ;
reg	[31:0]	RG_regs_4_t ;
reg	[31:0]	RG_regs_4_t1 ;
reg	[24:0]	TR_02 ;
reg	TR_02_c1 ;
reg	TR_02_c2 ;
...
computer_addsub32u INST_addsub32u_1 ( .i1(addsub32u1i1) ,.i2(addsub32u1i2) ,.i3(addsub32u1_f) ,
	.o1(addsub32u1ot) );	// line#=computer.cpp:70,85,95,113,124
				// ,629,637,712
computer_incr3s INST_incr3s_1 ( .i1(incr3s1i1) ,.o1(incr3s1ot) );	// line#=computer.cpp:187,260
...
always @ ( cols_rg00 or ST1_08d or cols_1_rg00 or M_01 or ST1_06d or regs_wd04 or 
	regs_d04 or regs_we04 )	// line#=computer.cpp:20
	begin
	regs_rg10_t_c1 = ( regs_we04 & regs_d04 [21] ) ;
	regs_rg10_t_c2 = ( ST1_06d & M_01 ) ;	// line#=computer.cpp:189
	regs_rg10_t_c3 = ( ST1_08d & M_01 ) ;	// line#=computer.cpp:262
	regs_rg10_t = ( ( { 32{ regs_rg10_t_c1 } } & regs_wd04 )
		| ( { 32{ regs_rg10_t_c2 } } & cols_1_rg00 )	// line#=computer.cpp:189
		| ( { 32{ regs_rg10_t_c3 } } & cols_rg00 )	// line#=computer.cpp:262
		) ;
	end
...
always @ ( cols_rg01 or ST1_08d or cols_1_rg01 or M_02 or ST1_06d or regs_wd04 or 
	regs_d04 or regs_we04 )	// line#=computer.cpp:20
	begin
	regs_rg11_t_c1 = ( regs_we04 & regs_d04 [20] ) ;
	regs_rg11_t_c2 = ( ST1_06d & M_02 ) ;	// line#=computer.cpp:189
	regs_rg11_t_c3 = ( ST1_08d & M_02 ) ;	// line#=computer.cpp:262
	regs_rg11_t = ( ( { 32{ regs_rg11_t_c1 } } & regs_wd04 )
		| ( { 32{ regs_rg11_t_c2 } } & cols_1_rg01 )	// line#=computer.cpp:189
		| ( { 32{ regs_rg11_t_c3 } } & cols_rg01 )	// line#=computer.cpp:262
		) ;
	end
...
always @ ( cols_rg02 or ST1_08d or cols_1_rg02 or M_03 or ST1_06d or regs_wd04 or 
	regs_d04 or regs_we04 )	// line#=computer.cpp:20
	begin
	regs_rg12_t_c1 = ( regs_we04 & regs_d04 [19] ) ;
	regs_rg12_t_c2 = ( ST1_06d & M_03 ) ;	// line#=computer.cpp:189
	regs_rg12_t_c3 = ( ST1_08d & M_03 ) ;	// line#=computer.cpp:262
	regs_rg12_t = ( ( { 32{ regs_rg12_t_c1 } } & regs_wd04 )
		| ( { 32{ regs_rg12_t_c2 } } & cols_1_rg02 )	// line#=computer.cpp:189
		| ( { 32{ regs_rg12_t_c3 } } & cols_rg02 )	// line#=computer.cpp:262
		) ;
	end
...
always @ ( cols_rg03 or ST1_08d or cols_1_rg03 or M_04 or ST1_06d or regs_wd04 or 
	regs_d04 or regs_we04 )	// line#=computer.cpp:20
	begin
	regs_rg13_t_c1 = ( regs_we04 & regs_d04 [18] ) ;
	regs_rg13_t_c2 = ( ST1_06d & M_04 ) ;	// line#=computer.cpp:189
	regs_rg13_t_c3 = ( ST1_08d & M_04 ) ;	// line#=computer.cpp:262
	regs_rg13_t = ( ( { 32{ regs_rg13_t_c1 } } & regs_wd04 )
		| ( { 32{ regs_rg13_t_c2 } } & cols_1_rg03 )	// line#=computer.cpp:189
		| ( { 32{ regs_rg13_t_c3 } } & cols_rg03 )	// line#=computer.cpp:262
		) ;
	end
...
always @ ( posedge CLOCK )	// line#=computer.cpp:20
	if ( RESET )
		...
		regs_rg13 <= regs_rg13_t ;	// line#=computer.cpp:20,189,262
...
always @ ( RG_op1_regs_word_addr or M_05 or U_111 or accel_sbox2ot or accel_sbox3ot or 
	accel_sbox1ot or accel_sbox4ot or cols_d01 or ST1_07d )	// line#=computer.cpp:243,244,245,246,252
								// ,261
	begin
	cols_rg00_t_c1 = ( ST1_07d & cols_d01 [3] ) ;	// line#=computer.cpp:243,244,245,246,261
	cols_rg00_t_c2 = ( U_111 & M_05 ) ;	// line#=computer.cpp:252
...
always @ ( RG_regs_3 or M_06 or U_111 or accel_sbox2ot or accel_sbox3ot or accel_sbox1ot or 
	accel_sbox4ot or cols_d01 or ST1_07d )	// line#=computer.cpp:243,244,245,246,252
						// ,261
	begin
	cols_rg01_t_c1 = ( ST1_07d & cols_d01 [2] ) ;	// line#=computer.cpp:243,244,245,246,261
	cols_rg01_t_c2 = ( U_111 & M_06 ) ;	// line#=computer.cpp:252
	cols_rg01_t = ( ( { 32{ cols_rg01_t_c1 } } & { accel_sbox4ot , accel_sbox1ot , 
			accel_sbox3ot , accel_sbox2ot } )	// line#=computer.cpp:243,244,245,246,261
		| ( { 32{ cols_rg01_t_c2 } } & RG_regs_3 )	// line#=computer.cpp:252
		) ;
	end
...
always @ ( RG_regs_2 or M_07 or U_111 or accel_sbox2ot or accel_sbox3ot or accel_sbox1ot or 
	accel_sbox4ot or cols_d01 or ST1_07d )	// line#=computer.cpp:243,244,245,246,252
						// ,261
	begin
	cols_rg02_t_c1 = ( ST1_07d & cols_d01 [1] ) ;	// line#=computer.cpp:243,244,245,246,261
	cols_rg02_t_c2 = ( U_111 & M_07 ) ;	// line#=computer.cpp:252
	cols_rg02_t = ( ( { 32{ cols_rg02_t_c1 } } & { accel_sbox4ot , accel_sbox1ot , 
			accel_sbox3ot , accel_sbox2ot } )	// line#=computer.cpp:243,244,245,246,261
		| ( { 32{ cols_rg02_t_c2 } } & RG_regs_2 )	// line#=computer.cpp:252
		) ;
	end
...
always @ ( RG_op2_regs or M_08 or U_111 or accel_sbox2ot or accel_sbox3ot or accel_sbox1ot or 
	accel_sbox4ot or cols_d01 or ST1_07d )	// line#=computer.cpp:243,244,245,246,252
						// ,261
	begin
	cols_rg03_t_c1 = ( ST1_07d & cols_d01 [0] ) ;	// line#=computer.cpp:243,244,245,246,261
	cols_rg03_t_c2 = ( U_111 & M_08 ) ;	// line#=computer.cpp:252
	cols_rg03_t = ( ( { 32{ cols_rg03_t_c1 } } & { accel_sbox4ot , accel_sbox1ot , 
			accel_sbox3ot , accel_sbox2ot } )	// line#=computer.cpp:243,244,245,246,261
		| ( { 32{ cols_rg03_t_c2 } } & RG_op2_regs )	// line#=computer.cpp:252
		) ;
	end
...
always @ ( posedge CLOCK )	// line#=computer.cpp:243,244,245,246,252
	...
	if ( RESET )
		...
		cols_rg03 <= cols_rg03_t ;	// line#=computer.cpp:243,244,245,246,252
						// ,261
computer_decoder_2to4 INST_decoder_2to4_2 ( .DECODER_in(cols_1_ad01) ,.DECODER_out(cols_1_d01) );	// line#=computer.cpp:179
always @ ( cols_1_rg03 or cols_1_rg02 or cols_1_rg01 or cols_1_rg00 or RG_i_1 )	// line#=computer.cpp:179
	case ( RG_i_1 [1:0] )
	2'h0 :
	...
	default :
		cols_1_rd00 = 32'hx ;
	endcase
assign	M_09 = ~( ST1_05d & cols_1_d01 [3] ) ;
always @ ( RG_regs or M_09 or U_109 or M_180 or M_179 or M_178 or M_177 or cols_1_d01 or 
	ST1_05d )	// line#=computer.cpp:164,170,171,172,173
			// ,175,179,188
	begin
	cols_1_rg00_t_c1 = ( ST1_05d & cols_1_d01 [3] ) ;	// line#=computer.cpp:164,165,166,167,170
								// ,171,172,173,175,188
	cols_1_rg00_t_c2 = ( U_109 & M_09 ) ;	// line#=computer.cpp:179
	cols_1_rg00_t = ( ( { 32{ cols_1_rg00_t_c1 } } & { M_177 , M_178 , M_179 , 
			M_180 } )				// line#=computer.cpp:164,165,166,167,170
								// ,171,172,173,175,188
...
assign	M_10 = ~( ST1_05d & cols_1_d01 [2] ) ;
always @ ( RG_regs_1 or M_10 or U_109 or M_180 or M_179 or M_178 or M_177 or cols_1_d01 or 
	ST1_05d )	// line#=computer.cpp:164,170,171,172,173
			// ,175,179,188
	begin
	cols_1_rg01_t_c1 = ( ST1_05d & cols_1_d01 [2] ) ;	// line#=computer.cpp:164,165,166,167,170
								// ,171,172,173,175,188
	cols_1_rg01_t_c2 = ( U_109 & M_10 ) ;	// line#=computer.cpp:179
	cols_1_rg01_t = ( ( { 32{ cols_1_rg01_t_c1 } } & { M_177 , M_178 , M_179 , 
			M_180 } )				// line#=computer.cpp:164,165,166,167,170
								// ,171,172,173,175,188
		| ( { 32{ cols_1_rg01_t_c2 } } & RG_regs_1 )	// line#=computer.cpp:179
		) ;
	end
...
always @ ( posedge CLOCK )	// line#=computer.cpp:164,170,171,172,173
	...
	if ( RESET )
		...
		cols_1_rg01 <= cols_1_rg01_t ;	// line#=computer.cpp:164,165,166,167,170
						// ,171,172,173,175,179,188
assign	M_11 = ~( ST1_05d & cols_1_d01 [1] ) ;
always @ ( RG_regs_2 or M_11 or U_109 or M_180 or M_179 or M_178 or M_177 or cols_1_d01 or 
	ST1_05d )	// line#=computer.cpp:164,170,171,172,173
			// ,175,179,188
	begin
	cols_1_rg02_t_c1 = ( ST1_05d & cols_1_d01 [1] ) ;	// line#=computer.cpp:164,165,166,167,170
								// ,171,172,173,175,188
	cols_1_rg02_t_c2 = ( U_109 & M_11 ) ;	// line#=computer.cpp:179
	cols_1_rg02_t = ( ( { 32{ cols_1_rg02_t_c1 } } & { M_177 , M_178 , M_179 , 
			M_180 } )				// line#=computer.cpp:164,165,166,167,170
								// ,171,172,173,175,188
		| ( { 32{ cols_1_rg02_t_c2 } } & RG_regs_2 )	// line#=computer.cpp:179
		) ;
	end
...
always @ ( posedge CLOCK )	// line#=computer.cpp:164,170,171,172,173
	...
	if ( RESET )
		...
		cols_1_rg02 <= cols_1_rg02_t ;	// line#=computer.cpp:164,165,166,167,170
						// ,171,172,173,175,179,188
assign	M_12 = ~( ST1_05d & cols_1_d01 [0] ) ;
always @ ( RG_op2_regs or M_12 or U_109 or M_180 or M_179 or M_178 or M_177 or cols_1_d01 or 
	ST1_05d )	// line#=computer.cpp:164,170,171,172,173
			// ,175,179,188
	begin
	cols_1_rg03_t_c1 = ( ST1_05d & cols_1_d01 [0] ) ;	// line#=computer.cpp:164,165,166,167,170
								// ,171,172,173,175,188
	cols_1_rg03_t_c2 = ( U_109 & M_12 ) ;	// line#=computer.cpp:179
	cols_1_rg03_t = ( ( { 32{ cols_1_rg03_t_c1 } } & { M_177 , M_178 , M_179 , 
			M_180 } )				// line#=computer.cpp:164,165,166,167,170
								// ,171,172,173,175,188
		| ( { 32{ cols_1_rg03_t_c2 } } & RG_op2_regs )	// line#=computer.cpp:179
		) ;
	end
...
always @ ( FF_take or RG_regs_3 )	// line#=computer.cpp:654
	case ( RG_regs_3 )
	32'h00000000 :
...
always @ ( FF_take )	// line#=computer.cpp:694
	...
	default :
		TR_14 = 1'hx ;
	endcase
assign	e_t = ( M_126_t ^ M_124_t ) ;	// line#=computer.cpp:164,165,166,167,168
					// ,188
always @ ( M_130_t or M_126_t )	// line#=computer.cpp:164,170
	case ( M_126_t [7] )
	1'h1 :
		M_284 = { ~M_130_t [3:2] , ~M_130_t [0] , 1'h1 } ;	// line#=computer.cpp:164,170
	1'h0 :
		M_284 = { M_130_t [3:2] , M_130_t [0] , 1'h0 } ;	// line#=computer.cpp:164,165,170,188
	default :
		M_284 = 4'hx ;
	endcase
always @ ( M_129_t or M_125_t )	// line#=computer.cpp:171
	case ( M_125_t [7] )
	1'h1 :
		M_282 = { ~M_129_t [3:2] , ~M_129_t [0] , 1'h1 } ;	// line#=computer.cpp:171
	1'h0 :
		M_282 = { M_129_t [3:2] , M_129_t [0] , 1'h0 } ;	// line#=computer.cpp:165,166,171,188
	default :
		M_282 = 4'hx ;
	endcase
always @ ( M_128_t or M_124_t )	// line#=computer.cpp:172
	case ( M_124_t [7] )
	1'h1 :
		M_281 = { ~M_128_t [3:2] , ~M_128_t [0] , 1'h1 } ;	// line#=computer.cpp:172
	1'h0 :
		M_281 = { M_128_t [3:2] , M_128_t [0] , 1'h0 } ;	// line#=computer.cpp:166,167,172,188
	default :
		M_281 = 4'hx ;
	endcase
always @ ( M_127_t or M_123_t )	// line#=computer.cpp:164,173
	case ( M_123_t [7] )
	1'h1 :
		M_283 = { ~M_127_t [3:2] , ~M_127_t [0] , 1'h1 } ;	// line#=computer.cpp:164,173
	1'h0 :
		M_283 = { M_127_t [3:2] , M_127_t [0] , 1'h0 } ;	// line#=computer.cpp:164,167,173,188
	default :
		M_283 = 4'hx ;
	endcase
assign	M_123_t = ( cols_1_rd00 [31:24] ^ cols_1_rd00 [7:0] ) ;	// line#=computer.cpp:164,167,173,188
assign	M_124_t = ( cols_1_rd00 [23:16] ^ cols_1_rd00 [31:24] ) ;	// line#=computer.cpp:164,165,166,167,168
									// ,172,188
assign	M_125_t = ( cols_1_rd00 [15:8] ^ cols_1_rd00 [23:16] ) ;	// line#=computer.cpp:165,166,171,188
assign	M_126_t = ( cols_1_rd00 [7:0] ^ cols_1_rd00 [15:8] ) ;	// line#=computer.cpp:164,165,166,167,168
								// ,170,188
assign	M_127_t = ( cols_1_rd00 [30:24] ^ cols_1_rd00 [6:0] ) ;	// line#=computer.cpp:164,167,173,188
assign	M_128_t = ( cols_1_rd00 [22:16] ^ cols_1_rd00 [30:24] ) ;	// line#=computer.cpp:166,167,172,188
assign	M_129_t = ( cols_1_rd00 [14:8] ^ cols_1_rd00 [22:16] ) ;	// line#=computer.cpp:165,166,171,188
assign	M_130_t = ( cols_1_rd00 [6:0] ^ cols_1_rd00 [14:8] ) ;	// line#=computer.cpp:164,165,170,188
...
assign	cols_1_ad01 = RG_i_1 [1:0] ;	// line#=computer.cpp:164,170,171,172,173
					// ,175,188
assign	M_177 = ( ( cols_1_rd00 [31:24] ^ e_t ) ^ { M_127_t [6:4] , M_283 [3:2] , 
	M_127_t [1] , M_283 [1:0] } ) ;	// line#=computer.cpp:164,165,166,167,170
					// ,171,172,173,175,188
assign	M_178 = ( ( cols_1_rd00 [23:16] ^ e_t ) ^ { M_128_t [6:4] , M_281 [3:2] , 
	M_128_t [1] , M_281 [1:0] } ) ;	// line#=computer.cpp:164,165,166,167,170
					// ,171,172,173,175,188
assign	M_179 = ( ( cols_1_rd00 [15:8] ^ e_t ) ^ { M_129_t [6:4] , M_282 [3:2] , 
	M_129_t [1] , M_282 [1:0] } ) ;	// line#=computer.cpp:164,165,166,167,170
					// ,171,172,173,175,188
assign	M_180 = ( ( cols_1_rd00 [7:0] ^ e_t ) ^ { M_130_t [6:4] , M_284 [3:2] , M_130_t [1] , 
	M_284 [1:0] } ) ;	// line#=computer.cpp:164,165,166,167,170
				// ,171,172,173,175,188
...
assign	M_193 = ~|( { 25'h0000000 , imem_arg_MEMB32W65536_RD1 [6:0] } ^ 32'h00000063 ) ;	// line#=computer.cpp:616,623,631
assign	M_195 = ~|( { 25'h0000000 , imem_arg_MEMB32W65536_RD1 [6:0] } ^ 32'h0000006f ) ;	// line#=computer.cpp:616,623,631
...
assign	M_224 = ~|( { 25'h0000000 , imem_arg_MEMB32W65536_RD1 [6:0] } ^ 32'h00000013 ) ;	// line#=computer.cpp:616,623,631
assign	M_226 = ~|( { 25'h0000000 , imem_arg_MEMB32W65536_RD1 [6:0] } ^ 32'h00000017 ) ;	// line#=computer.cpp:616,623,631
assign	M_230 = ~|( { 25'h0000000 , imem_arg_MEMB32W65536_RD1 [6:0] } ^ 32'h0000000b ) ;	// line#=computer.cpp:616,623,631
...
assign	M_197 = ~|( { 29'h00000000 , imem_arg_MEMB32W65536_RD1 [14:12] } ^ 32'h00000001 ) ;	// line#=computer.cpp:616,654,668,681,692
												// ,711
assign	M_204 = ~|( { 29'h00000000 , imem_arg_MEMB32W65536_RD1 [14:12] } ^ 32'h00000004 ) ;	// line#=computer.cpp:616,623,631,654,668
												// ,692,711
assign	M_209 = ~|( { 29'h00000000 , imem_arg_MEMB32W65536_RD1 [14:12] } ^ 32'h00000005 ) ;	// line#=computer.cpp:616,623,631,654,668
												// ,692,711
assign	M_212 = ~|( { 29'h00000000 , imem_arg_MEMB32W65536_RD1 [14:12] } ^ 32'h00000007 ) ;	// line#=computer.cpp:616,623,631,654,692
												// ,711
assign	M_214 = ~|{ 29'h00000000 , imem_arg_MEMB32W65536_RD1 [14:12] } ;	// line#=computer.cpp:616,623,631,654,668
										// ,681,692,711
assign	M_232 = ~|( { 29'h00000000 , imem_arg_MEMB32W65536_RD1 [14:12] } ^ 32'h00000006 ) ;	// line#=computer.cpp:616,623,631,654,692
												// ,711
assign	U_25 = ( U_10 & M_214 ) ;	// line#=computer.cpp:616,668
assign	U_26 = ( U_10 & M_197 ) ;	// line#=computer.cpp:616,668
assign	U_28 = ( U_10 & M_204 ) ;	// line#=computer.cpp:616,668
...
assign	U_44 = ( U_13 & M_197 ) ;	// line#=computer.cpp:616,711
assign	M_237 = ~|( { 29'h00000000 , imem_arg_MEMB32W65536_RD1 [14:12] } ^ 32'h00000003 ) ;	// line#=computer.cpp:616,692,711,744
assign	U_52 = ( U_16 & M_237 ) ;	// line#=computer.cpp:616,744
assign	U_54 = ( ST1_04d & M_235 ) ;	// line#=computer.cpp:631
assign	U_55 = ( ST1_04d & M_227 ) ;	// line#=computer.cpp:631
assign	U_56 = ( ST1_04d & M_196 ) ;	// line#=computer.cpp:631
assign	U_57 = ( ST1_04d & M_202 ) ;	// line#=computer.cpp:631
assign	U_58 = ( ST1_04d & M_194 ) ;	// line#=computer.cpp:631
assign	U_59 = ( ST1_04d & M_238 ) ;	// line#=computer.cpp:631
...
assign	M_194 = ~|( RG_regs_4 ^ 32'h00000063 ) ;	// line#=computer.cpp:631
assign	M_196 = ~|( RG_regs_4 ^ 32'h0000006f ) ;	// line#=computer.cpp:631
assign	M_202 = ~|( RG_regs_4 ^ 32'h00000067 ) ;	// line#=computer.cpp:631
assign	M_208 = ~|( RG_regs_4 ^ 32'h00000023 ) ;	// line#=computer.cpp:631
assign	M_219 = ~|( RG_regs_4 ^ 32'h00000033 ) ;	// line#=computer.cpp:631
assign	M_225 = ~|( RG_regs_4 ^ 32'h00000013 ) ;	// line#=computer.cpp:631
assign	M_227 = ~|( RG_regs_4 ^ 32'h00000017 ) ;	// line#=computer.cpp:631
assign	M_229 = ~|( RG_regs_4 ^ 32'h00000073 ) ;	// line#=computer.cpp:631
assign	M_231 = ~|( RG_regs_4 ^ 32'h0000000b ) ;	// line#=computer.cpp:631
assign	M_235 = ~|( RG_regs_4 ^ 32'h00000037 ) ;	// line#=computer.cpp:631
assign	M_238 = ~|( RG_regs_4 ^ 32'h00000003 ) ;	// line#=computer.cpp:631
assign	M_242 = ~|( RG_regs_4 ^ 32'h0000000f ) ;	// line#=computer.cpp:631
assign	U_66 = ( ST1_04d & M_261 ) ;	// line#=computer.cpp:631
assign	U_68 = ( U_55 & FF_take ) ;	// line#=computer.cpp:637
assign	U_71 = ( U_58 & take_t1 ) ;	// line#=computer.cpp:662
assign	M_198 = ~|( RG_imm1_instr_regs_result1 ^ 32'h00000001 ) ;	// line#=computer.cpp:668,681
assign	M_215 = ~|RG_imm1_instr_regs_result1 ;	// line#=computer.cpp:668,681
assign	M_222 = ~|( RG_imm1_instr_regs_result1 ^ 32'h00000002 ) ;	// line#=computer.cpp:668,681,744
assign	M_243 = |RG_rd ;	// line#=computer.cpp:647,675,706,725
assign	U_80 = ( U_60 & M_215 ) ;	// line#=computer.cpp:681
assign	U_81 = ( U_60 & M_198 ) ;	// line#=computer.cpp:681
assign	U_84 = ( U_61 & M_216 ) ;	// line#=computer.cpp:692
assign	U_90 = ( U_61 & M_200 ) ;	// line#=computer.cpp:692
assign	M_216 = ~|RG_regs_3 ;	// line#=computer.cpp:692,711
assign	U_95 = ( U_62 & M_216 ) ;	// line#=computer.cpp:711
assign	M_211 = ~|( RG_regs_3 ^ 32'h00000005 ) ;	// line#=computer.cpp:692,711
assign	M_217 = ~RG_imm1_instr_regs_result1 [23] ;	// line#=computer.cpp:701,702,703,718,719
							// ,720
assign	U_106 = ( U_65 & M_222 ) ;	// line#=computer.cpp:744
assign	U_107 = ( U_65 & M_239 ) ;	// line#=computer.cpp:744
assign	M_239 = ~|( RG_imm1_instr_regs_result1 ^ 32'h00000003 ) ;	// line#=computer.cpp:744
assign	U_109 = ( U_106 & FF_take ) ;	// line#=computer.cpp:755
assign	U_111 = ( U_107 & FF_take ) ;	// line#=computer.cpp:761
always @ ( add32s1ot or M_207 )
	TR_11 = ( { 12{ M_207 } } & add32s1ot [13:2] )	// line#=computer.cpp:52,61,679
		 ;	// line#=computer.cpp:52,56,666
assign	M_248 = ( ST1_04d & U_56 ) ;
always @ ( add32s1ot or M_248 or TR_11 or M_250 )
	TR_01 = ( ( { 30{ M_250 } } & { 18'h00000 , TR_11 } )	// line#=computer.cpp:52,56,61,666,679
		| ( { 30{ M_248 } } & add32s1ot [31:2] )	// line#=computer.cpp:52,75,642
		) ;
always @ ( RG_addr_addr1_next_pc_PC or M_118_t or U_58 or U_57 or RG_05 or U_66 or 
	U_65 or U_64 or M_242 or U_62 or U_61 or U_60 or U_59 or U_55 or U_54 or 
	ST1_04d or add32s1ot or TR_01 or M_248 or M_250 )	// line#=computer.cpp:631
	begin
	RG_addr_addr1_next_pc_PC_t_c1 = ( M_250 | M_248 ) ;	// line#=computer.cpp:52,56,61,75,642,666
								// ,679
	RG_addr_addr1_next_pc_PC_t_c2 = ( ST1_04d & ( ( ( ( ( ( ( ( ( U_54 | U_55 ) | 
		U_59 ) | U_60 ) | U_61 ) | U_62 ) | ( ST1_04d & M_242 ) ) | U_64 ) | 
		U_65 ) | U_66 ) ) ;	// line#=computer.cpp:629
	RG_addr_addr1_next_pc_PC_t_c3 = ( ST1_04d & U_57 ) ;	// line#=computer.cpp:52,56,646,648
	RG_addr_addr1_next_pc_PC_t_c4 = ( ST1_04d & U_58 ) ;
	RG_addr_addr1_next_pc_PC_t = ( ( { 32{ RG_addr_addr1_next_pc_PC_t_c1 } } & 
			{ TR_01 , add32s1ot [1:0] } )			// line#=computer.cpp:52,56,61,75,642,666
									// ,679
		| ( { 32{ RG_addr_addr1_next_pc_PC_t_c2 } } & RG_05 )	// line#=computer.cpp:629
...
always @ ( incr3s1ot or ST1_07d or U_111 or ST1_04d )
	begin
	RG_i_t_c1 = ( ST1_04d & U_111 ) ;	// line#=computer.cpp:260
	RG_i_t = ( { 3{ ST1_07d } } & incr3s1ot )	// line#=computer.cpp:260
...
always @ ( incr3s1ot or ST1_05d or U_109 or ST1_04d )
	begin
	RG_i_1_t_c1 = ( ST1_04d & U_109 ) ;	// line#=computer.cpp:187
	RG_i_1_t = ( { 3{ ST1_05d } } & incr3s1ot )	// line#=computer.cpp:187
		 ;	// line#=computer.cpp:187
	end
assign	RG_i_1_en = ( RG_i_1_t_c1 | ST1_05d ) ;
always @ ( posedge CLOCK )
	if ( RG_i_1_en )
		RG_i_1 <= RG_i_1_t ;	// line#=computer.cpp:187
assign	RG_03_en = ST1_04d ;
always @ ( posedge CLOCK )
	if ( RG_03_en )
		RG_03 <= B_01_t ;
always @ ( U_66 or M_271 or U_65 or U_107 or FF_take or U_106 or U_64 or ST1_04d )	// line#=computer.cpp:744,755,761
	begin
	FF_halt_t_c1 = ( ST1_04d & ( ( ( ( U_64 | ( U_106 & ( ~FF_take ) ) ) | ( 
		U_107 & ( ~FF_take ) ) ) | ( U_65 & M_271 ) ) | U_66 ) ) ;	// line#=computer.cpp:732,756,762,797,808
...
always @ ( regs_rg12 or U_01 )
	RG_regs_2_t1 = ( { 32{ U_01 } } & regs_rg12 )	// line#=computer.cpp:179
		 ;
always @ ( RG_regs_4 or U_52 or RG_regs_2_t1 or ST1_02d )
	RG_regs_2_t = ( ( { 32{ ST1_02d } } & RG_regs_2_t1 )
		| ( { 32{ U_52 } } & RG_regs_4 ) ) ;
assign	RG_regs_2_en = ( ST1_02d | U_52 ) ;
always @ ( posedge CLOCK )
	if ( RESET )
		RG_regs_2 <= 32'h00000000 ;
	else if ( RG_regs_2_en )
		RG_regs_2 <= RG_regs_2_t ;	// line#=computer.cpp:179
always @ ( regs_rg13 or U_01 )
	RG_op2_regs_t1 = ( { 32{ U_01 } } & regs_rg13 )	// line#=computer.cpp:179
		 ;
always @ ( RG_imm1_instr_regs_result1 or U_52 or regs_rd00 or U_13 or RG_op2_regs_t1 or 
	ST1_02d )
	RG_op2_regs_t = ( ( { 32{ ST1_02d } } & RG_op2_regs_t1 )
		| ( { 32{ U_13 } } & regs_rd00 )	// line#=computer.cpp:710
		| ( { 32{ U_52 } } & RG_imm1_instr_regs_result1 ) ) ;
assign	RG_op2_regs_en = ( ST1_02d | U_13 | U_52 ) ;
always @ ( posedge CLOCK )
	if ( RESET )
		RG_op2_regs <= 32'h00000000 ;
	else if ( RG_op2_regs_en )
		RG_op2_regs <= RG_op2_regs_t ;	// line#=computer.cpp:179,710
always @ ( regs_rg10 or U_01 )
...
always @ ( posedge CLOCK )
	if ( RESET )
		...
		RG_op1_regs_word_addr <= RG_op1_regs_word_addr_t ;	// line#=computer.cpp:113,117,124,128,252
									// ,710
always @ ( regs_rg11 or U_01 )
	RG_regs_3_t1 = ( { 32{ U_01 } } & regs_rg11 )	// line#=computer.cpp:252
		 ;
always @ ( imem_arg_MEMB32W65536_RD1 or U_13 or U_12 or U_09 or RG_regs_3_t1 or 
	ST1_02d )
	begin
	RG_regs_3_t_c1 = ( ( U_09 | U_12 ) | U_13 ) ;	// line#=computer.cpp:616,654,692,711
	RG_regs_3_t = ( ( { 32{ ST1_02d } } & RG_regs_3_t1 )
		| ( { 32{ RG_regs_3_t_c1 } } & { 29'h00000000 , imem_arg_MEMB32W65536_RD1 [14:12] } )	// line#=computer.cpp:616,654,692,711
		) ;
	end
assign	RG_regs_3_en = ( ST1_02d | RG_regs_3_t_c1 ) ;
always @ ( posedge CLOCK )
	if ( RESET )
		RG_regs_3 <= 32'h00000000 ;
	else if ( RG_regs_3_en )
		RG_regs_3 <= RG_regs_3_t ;	// line#=computer.cpp:252,616,654,692,711
always @ ( regs_rg12 or U_01 )
	RG_regs_4_t1 = ( { 32{ U_01 } } & regs_rg12 )	// line#=computer.cpp:252
		 ;
always @ ( imem_arg_MEMB32W65536_RD1 or ST1_03d or RG_regs_4_t1 or ST1_02d )
	RG_regs_4_t = ( ( { 32{ ST1_02d } } & RG_regs_4_t1 )
		| ( { 32{ ST1_03d } } & { 25'h0000000 , imem_arg_MEMB32W65536_RD1 [6:0] } )	// line#=computer.cpp:616,623,631
		) ;
always @ ( posedge CLOCK )
	if ( RESET )
		RG_regs_4 <= 32'h00000000 ;
	else
		RG_regs_4 <= RG_regs_4_t ;	// line#=computer.cpp:252,616,623,631
always @ ( M_230 or M_207 or M_236 or imem_arg_MEMB32W65536_RD1 or M_193 or M_203 or 
	M_195 or M_226 or M_234 or M_214 or M_218 or M_209 or M_224 )
	begin
	TR_02_c1 = ( ( ( ( ( ( ( ( M_224 & M_209 ) | ( M_218 & M_214 ) ) | ( M_218 & 
		M_209 ) ) | M_234 ) | M_226 ) | M_195 ) | M_203 ) | M_193 ) ;	// line#=computer.cpp:616
	TR_02_c2 = ( ( M_236 | M_207 ) | M_230 ) ;	// line#=computer.cpp:616,668,681,744
	TR_02 = ( ( { 25{ TR_02_c1 } } & imem_arg_MEMB32W65536_RD1 [31:7] )			// line#=computer.cpp:616
		| ( { 25{ TR_02_c2 } } & { 22'h000000 , imem_arg_MEMB32W65536_RD1 [14:12] } )	// line#=computer.cpp:616,668,681,744
		) ;
	end
assign	M_203 = ~|( { 25'h0000000 , imem_arg_MEMB32W65536_RD1 [6:0] } ^ 32'h00000067 ) ;	// line#=computer.cpp:616,623,631,692,711
always @ ( regs_rg13 or U_01 )
	RG_imm1_instr_regs_result1_t1 = ( { 32{ U_01 } } & regs_rg13 )	// line#=computer.cpp:252
		 ;
always @ ( lsft32u1ot or U_44 or TR_02 or U_16 or U_11 or U_10 or U_09 or M_203 or 
	ST1_03d or U_07 or U_06 or U_05 or U_13 or M_209 or imem_arg_MEMB32W65536_RD1 or 
	M_212 or M_232 or M_204 or M_214 or U_12 or RG_imm1_instr_regs_result1_t1 or 
	ST1_02d )	// line#=computer.cpp:616,623,631,692,711
	begin
	RG_imm1_instr_regs_result1_t_c1 = ( ( ( ( U_12 & M_214 ) | ( U_12 & M_204 ) ) | 
		( U_12 & M_232 ) ) | ( U_12 & M_212 ) ) ;	// line#=computer.cpp:52,56,616,689
	RG_imm1_instr_regs_result1_t_c2 = ( ( ( ( ( ( ( ( ( U_12 & M_209 ) | ( U_13 & 
		M_214 ) ) | ( U_13 & M_209 ) ) | U_05 ) | U_06 ) | U_07 ) | ( ST1_03d & 
		M_203 ) ) | U_09 ) | ( ( U_10 | U_11 ) | U_16 ) ) ;	// line#=computer.cpp:616,668,681,744
	RG_imm1_instr_regs_result1_t = ( ( { 32{ ST1_02d } } & RG_imm1_instr_regs_result1_t1 )
		...
		| ( { 32{ RG_imm1_instr_regs_result1_t_c2 } } & { 7'h00 , TR_02 } )		// line#=computer.cpp:616,668,681,744
...
always @ ( posedge CLOCK )	// line#=computer.cpp:616,623,631,692,711
	if ( RESET )
		...
		RG_imm1_instr_regs_result1 <= RG_imm1_instr_regs_result1_t ;	// line#=computer.cpp:52,56,252,616,668
										// ,681,689,713,744
assign	M_247 = ( regs_rd00 ^ regs_rd01 ) ;	// line#=computer.cpp:655,656
always @ ( ST1_07d or incr3s1ot or ST1_05d or U_52 or U_16 or comp32u_12ot or comp32s_11ot or 
	U_13 or comp32u_13ot or M_237 or comp32s_1_11ot or M_220 or U_12 or M_212 or 
	comp32u_11ot or M_232 or M_209 or comp32s_12ot or M_204 or M_197 or M_247 or 
	M_214 or U_09 or imem_arg_MEMB32W65536_RD1 or U_07 or U_06 or U_05 )	// line#=computer.cpp:616,654,692,711,744
	begin
	FF_take_t_c1 = ( ( U_05 | U_06 ) | U_07 ) ;	// line#=computer.cpp:616,624,633,637,641
	FF_take_t_c2 = ( U_09 & M_214 ) ;	// line#=computer.cpp:655
	FF_take_t_c3 = ( U_09 & M_197 ) ;	// line#=computer.cpp:656
	FF_take_t_c4 = ( U_09 & M_204 ) ;	// line#=computer.cpp:657
	FF_take_t_c5 = ( U_09 & M_209 ) ;	// line#=computer.cpp:658
	FF_take_t_c6 = ( U_09 & M_232 ) ;	// line#=computer.cpp:659
	FF_take_t_c7 = ( U_09 & M_212 ) ;	// line#=computer.cpp:660
	FF_take_t_c8 = ( U_12 & M_220 ) ;	// line#=computer.cpp:694
	FF_take_t_c9 = ( U_12 & M_237 ) ;	// line#=computer.cpp:695
	FF_take_t_c10 = ( U_13 & M_220 ) ;	// line#=computer.cpp:714
	FF_take_t_c11 = ( U_13 & M_237 ) ;	// line#=computer.cpp:715
	FF_take_t_c12 = ( ( U_16 & M_220 ) | U_52 ) ;	// line#=computer.cpp:616,755,761
	FF_take_t = ( ( { 1{ FF_take_t_c1 } } & ( |imem_arg_MEMB32W65536_RD1 [11:7] ) )	// line#=computer.cpp:616,624,633,637,641
		| ( { 1{ FF_take_t_c2 } } & ( ~|M_247 ) )				// line#=computer.cpp:655
		| ( { 1{ FF_take_t_c3 } } & ( |M_247 ) )				// line#=computer.cpp:656
		...
		| ( { 1{ FF_take_t_c12 } } & ( ~|imem_arg_MEMB32W65536_RD1 [31:25] ) )	// line#=computer.cpp:616,755,761
		| ( { 1{ ST1_05d } } & ( ~incr3s1ot [2] ) )				// line#=computer.cpp:187
		| ( { 1{ ST1_07d } } & ( ~incr3s1ot [2] ) )				// line#=computer.cpp:260
		) ;
	end
always @ ( posedge CLOCK )	// line#=computer.cpp:616,654,692,711,744
	FF_take <= FF_take_t ;	// line#=computer.cpp:187,260,616,624,633
				// ,637,641,655,656,657,658,659,660
				// ,694,695,714,715,755,761
assign	M_261 = ~( M_262 | M_231 ) ;	// line#=computer.cpp:631
assign	M_262 = ( ( ( ( ( ( ( ( ( ( M_235 | M_227 ) | M_196 ) | M_202 ) | M_194 ) | 
	M_238 ) | M_208 ) | M_225 ) | M_219 ) | M_242 ) | M_229 ) ;	// line#=computer.cpp:631
assign	M_271 = ~( M_222 | M_239 ) ;	// line#=computer.cpp:744
assign	M_273 = ( M_231 & M_222 ) ;
assign	M_244 = ( M_273 & FF_take ) ;
assign	M_275 = ( M_231 & M_239 ) ;
always @ ( FF_take or M_275 or RG_03 or M_244 )
	begin
	B_01_t_c1 = ( M_275 & FF_take ) ;
	B_01_t = ( ( { 1{ M_244 } } & RG_03 )
		| ( { 1{ B_01_t_c1 } } & 1'h1 ) ) ;
	end
always @ ( RG_addr_addr1_next_pc_PC or RG_05 or add32s1ot or take_t1 )	// line#=computer.cpp:662
	begin
	M_118_t_c1 = ~take_t1 ;
	M_118_t = ( ( { 31{ take_t1 } } & add32s1ot [31:1] )	// line#=computer.cpp:662
		| ( { 31{ M_118_t_c1 } } & { RG_05 [31:2] , RG_addr_addr1_next_pc_PC [1] } ) ) ;
	end
assign	JF_02 = ( ( ~M_244 ) & ( ~B_01_t ) ) ;
assign	JF_03 = ( ( ~M_244 ) & B_01_t ) ;
assign	JF_04 = ~incr3s1ot [2] ;	// line#=computer.cpp:187
assign	JF_05 = ~incr3s1ot [2] ;	// line#=computer.cpp:260
...
assign	M_250 = ( U_11 | U_10 ) ;
always @ ( RG_addr_addr1_next_pc_PC or U_56 or U_71 or regs_rd02 or U_57 or U_84 or 
	regs_rd00 or M_250 )
	begin
	add32s1i1_c1 = ( U_84 | U_57 ) ;	// line#=computer.cpp:52,56,646,693
	add32s1i1_c2 = ( U_71 | U_56 ) ;	// line#=computer.cpp:52,75,642,662
	add32s1i1 = ( ( { 32{ M_250 } } & regs_rd00 )			// line#=computer.cpp:52,56,61,666,679
...
always @ ( M_236 or imem_arg_MEMB32W65536_RD1 or M_207 )
	TR_03 = ( ( { 5{ M_207 } } & imem_arg_MEMB32W65536_RD1 [11:7] )		// line#=computer.cpp:52,60,61,616,624
										// ,628,679
		| ( { 5{ M_236 } } & imem_arg_MEMB32W65536_RD1 [24:20] )	// line#=computer.cpp:52,56,616,627,666
		) ;
always @ ( M_202 or RG_imm1_instr_regs_result1 or M_245 )
	M_278 = ( ( { 6{ M_245 } } & { RG_imm1_instr_regs_result1 [0] , RG_imm1_instr_regs_result1 [4:1] , 
...
always @ ( M_196 or M_278 or RG_imm1_instr_regs_result1 or M_202 or M_245 )
	begin
	M_279_c1 = ( M_245 | M_202 ) ;	// line#=computer.cpp:52,56,65,66,67,627
					// ,628,646,652,662
	M_279 = ( ( { 14{ M_279_c1 } } & { RG_imm1_instr_regs_result1 [24] , RG_imm1_instr_regs_result1 [24] , 
			RG_imm1_instr_regs_result1 [24] , RG_imm1_instr_regs_result1 [24] , 
			RG_imm1_instr_regs_result1 [24] , RG_imm1_instr_regs_result1 [24] , 
			RG_imm1_instr_regs_result1 [24] , RG_imm1_instr_regs_result1 [24] , 
			M_278 } )					// line#=computer.cpp:52,56,65,66,67,627
									// ,628,646,652,662
		| ( { 14{ M_196 } } & { RG_imm1_instr_regs_result1 [12:5] , RG_imm1_instr_regs_result1 [13] , 
			RG_imm1_instr_regs_result1 [17:14] , 1'h0 } )	// line#=computer.cpp:52,73,74,75,625,627
									// ,642
		) ;
	end
always @ ( M_279 or U_56 or U_57 or U_71 or RG_imm1_instr_regs_result1 or U_84 or 
	TR_03 or imem_arg_MEMB32W65536_RD1 or M_250 )
	begin
	add32s1i2_c1 = ( ( U_71 | U_57 ) | U_56 ) ;	// line#=computer.cpp:52,56,65,66,67,73
							// ,74,75,625,627,628,642,646,652
							// ,662
	add32s1i2 = ( ( { 21{ M_250 } } & { imem_arg_MEMB32W65536_RD1 [31] , imem_arg_MEMB32W65536_RD1 [31] , 
			imem_arg_MEMB32W65536_RD1 [31] , imem_arg_MEMB32W65536_RD1 [31] , 
			imem_arg_MEMB32W65536_RD1 [31] , imem_arg_MEMB32W65536_RD1 [31] , 
			imem_arg_MEMB32W65536_RD1 [31] , imem_arg_MEMB32W65536_RD1 [31] , 
			imem_arg_MEMB32W65536_RD1 [31] , imem_arg_MEMB32W65536_RD1 [31:25] , 
			TR_03 } )								// line#=computer.cpp:52,56,60,61,616,624
												// ,627,628,666,679
		| ( { 21{ U_84 } } & { RG_imm1_instr_regs_result1 [11] , RG_imm1_instr_regs_result1 [11] , 
		...
		| ( { 21{ add32s1i2_c1 } } & { RG_imm1_instr_regs_result1 [24] , 
			M_279 [13:5] , RG_imm1_instr_regs_result1 [23:18] , M_279 [4:0] } )	// line#=computer.cpp:52,56,65,66,67,73
												// ,74,75,625,627,628,642,646,652
												// ,662
		) ;
	end
always @ ( regs_rd03 or M_198 )
	TR_12 = ( { 8{ M_198 } } & regs_rd03 [15:8] )	// line#=computer.cpp:131,683
		 ;	// line#=computer.cpp:120,682
always @ ( regs_rd03 or TR_12 or M_254 or regs_rd02 or U_90 or regs_rd01 or U_44 )
	lsft32u1i1 = ( ( { 32{ U_44 } } & regs_rd01 )				// line#=computer.cpp:710,713
		| ( { 32{ U_90 } } & regs_rd02 )				// line#=computer.cpp:699
		| ( { 32{ M_254 } } & { 16'h0000 , TR_12 , regs_rd03 [7:0] } )	// line#=computer.cpp:120,131,682,683
		) ;
assign	M_254 = ( U_81 | U_80 ) ;
always @ ( RG_addr_addr1_next_pc_PC or M_254 or RG_rs2 or U_90 or regs_rd00 or U_44 )
	lsft32u1i2 = ( ( { 5{ U_44 } } & regs_rd00 [4:0] )				// line#=computer.cpp:710,713
		| ( { 5{ U_90 } } & RG_rs2 )						// line#=computer.cpp:699
		| ( { 5{ M_254 } } & { RG_addr_addr1_next_pc_PC [1:0] , 3'h0 } )	// line#=computer.cpp:118,119,120,129,130
											// ,131,682,683
		) ;
always @ ( dmem_arg_MEMB32W4096_RD1 or M_265 or regs_rd02 or M_267 or RG_op1_regs_word_addr or 
	M_268 )
	rsft32u1i1 = ( ( { 32{ M_268 } } & RG_op1_regs_word_addr )	// line#=computer.cpp:718,719,720
		| ( { 32{ M_267 } } & regs_rd02 )			// line#=computer.cpp:701,702,703
		| ( { 32{ M_265 } } & dmem_arg_MEMB32W4096_RD1 )	// line#=computer.cpp:90,91,100,101,669
									// ,670,672,673
		) ;
assign	M_265 = ( ( ( ( M_238 & ( ~|( RG_imm1_instr_regs_result1 ^ 32'h00000005 ) ) ) | 
	( M_238 & ( ~|( RG_imm1_instr_regs_result1 ^ 32'h00000004 ) ) ) ) | ( M_238 & 
	M_198 ) ) | ( M_238 & M_215 ) ) ;	// line#=computer.cpp:668
assign	M_267 = ( ( M_225 & M_211 ) & M_217 ) ;
assign	M_268 = ( ( M_219 & M_211 ) & M_217 ) ;
always @ ( RG_addr_addr1_next_pc_PC or M_265 or RG_rs2 or M_267 or RG_op2_regs or 
	M_268 )
	rsft32u1i2 = ( ( { 5{ M_268 } } & RG_op2_regs [4:0] )				// line#=computer.cpp:718,719,720
		| ( { 5{ M_267 } } & RG_rs2 )						// line#=computer.cpp:701,702,703
		| ( { 5{ M_265 } } & { RG_addr_addr1_next_pc_PC [1:0] , 3'h0 } )	// line#=computer.cpp:90,91,100,101,669
											// ,670,672,673
		) ;
always @ ( regs_rd02 or M_225 or RG_op1_regs_word_addr or M_219 )
	rsft32s1i1 = ( ( { 32{ M_219 } } & RG_op1_regs_word_addr )	// line#=computer.cpp:718,719,720
		| ( { 32{ M_225 } } & regs_rd02 )			// line#=computer.cpp:701,702,703
		) ;
always @ ( RG_rs2 or M_225 or RG_op2_regs or M_219 )
	rsft32s1i2 = ( ( { 5{ M_219 } } & RG_op2_regs [4:0] )	// line#=computer.cpp:718,719,720
		| ( { 5{ M_225 } } & RG_rs2 )			// line#=computer.cpp:701,702,703
		) ;
always @ ( RG_i or ST1_07d or RG_i_1 or ST1_05d )
	incr3s1i1 = ( ( { 3{ ST1_05d } } & RG_i_1 )	// line#=computer.cpp:187
		| ( { 3{ ST1_07d } } & RG_i )		// line#=computer.cpp:260
		) ;
always @ ( RG_op1_regs_word_addr or U_95 or add32s1ot or U_25 or U_26 or U_28 or 
	U_29 or M_253 or RG_addr_addr1_next_pc_PC or M_249 )
	begin
	addsub32u1i1_c1 = ( M_253 | ( ( ( U_29 | U_28 ) | U_26 ) | U_25 ) ) ;	// line#=computer.cpp:52,56,61,85,95,113
										// ,124,666,679
	addsub32u1i1 = ( ( { 32{ M_249 } } & RG_addr_addr1_next_pc_PC )	// line#=computer.cpp:70,629,637
		| ( { 32{ addsub32u1i1_c1 } } & add32s1ot )		// line#=computer.cpp:52,56,61,85,95,113
									// ,124,666,679
		| ( { 32{ U_95 } } & RG_op1_regs_word_addr )		// line#=computer.cpp:712
		) ;
	end
always @ ( M_252 or RG_imm1_instr_regs_result1 or U_68 )
	TR_13 = ( ( { 20{ U_68 } } & RG_imm1_instr_regs_result1 [24:5] )	// line#=computer.cpp:70,637
		| ( { 20{ M_252 } } & 20'h00040 )				// line#=computer.cpp:85,95,113,124
		) ;
always @ ( U_01 or TR_13 or M_252 or U_68 )
	begin
	M_280_c1 = ( U_68 | M_252 ) ;	// line#=computer.cpp:70,85,95,113,124
					// ,637
	M_280 = ( ( { 21{ M_280_c1 } } & { TR_13 , 1'h0 } )	// line#=computer.cpp:70,85,95,113,124
								// ,637
		| ( { 21{ U_01 } } & 21'h000001 )		// line#=computer.cpp:629
		) ;
	end
assign	M_249 = ( U_68 | U_01 ) ;
always @ ( RG_op2_regs or U_95 or M_280 or M_252 or M_249 )
	begin
	addsub32u1i2_c1 = ( M_249 | M_252 ) ;	// line#=computer.cpp:70,85,95,113,124
						// ,629,637
	addsub32u1i2 = ( ( { 32{ addsub32u1i2_c1 } } & { M_280 [20:1] , 9'h000 , 
			M_280 [0] , 2'h0 } )		// line#=computer.cpp:70,85,95,113,124
							// ,629,637
		| ( { 32{ U_95 } } & RG_op2_regs )	// line#=computer.cpp:712
		) ;
	end
assign	M_253 = ( U_32 | U_31 ) ;
assign	M_252 = ( ( ( ( M_253 | U_29 ) | U_28 ) | U_26 ) | U_25 ) ;
always @ ( RG_imm1_instr_regs_result1 )	// line#=computer.cpp:712
	...
	endcase
always @ ( addsub32u1_f_t1 or U_95 or M_252 or M_249 )
	addsub32u1_f = ( ( { 2{ M_249 } } & 2'h1 )
		| ( { 2{ M_252 } } & 2'h2 )
...
always @ ( M_198 )
	M_277 = ( { 8{ M_198 } } & 8'hff )	// line#=computer.cpp:130
		 ;	// line#=computer.cpp:119
assign	lsft32u_321i1 = { M_277 , 8'hff } ;
...
assign	M_266 = ( M_215 | M_198 ) ;	// line#=computer.cpp:668,681
always @ ( regs_rd03 or M_222 or lsft32u1ot or lsft32u_321ot or dmem_arg_MEMB32W4096_RD1 or 
	M_266 )
	dmem_arg_MEMB32W4096_WD2 = ( ( { 32{ M_266 } } & ( ( dmem_arg_MEMB32W4096_RD1 & ( 
			~lsft32u_321ot ) ) | lsft32u1ot ) )	// line#=computer.cpp:119,120,130,131,682
								// ,683
		| ( { 32{ M_222 } } & regs_rd03 )		// line#=computer.cpp:139
		) ;
always @ ( addsub32u1ot or M_207 or M_209 or M_204 or M_197 or M_214 or add32s1ot or 
	M_220 or M_236 )
	begin
	dmem_arg_MEMB32W4096_RA1_c1 = ( M_236 & M_220 ) ;	// line#=computer.cpp:52,56,105,109,666
								// ,671
	dmem_arg_MEMB32W4096_RA1_c2 = ( ( ( ( ( ( M_236 & M_214 ) | ( M_236 & M_197 ) ) | 
		( M_236 & M_204 ) ) | ( M_236 & M_209 ) ) | ( M_207 & M_214 ) ) | 
		( M_207 & M_197 ) ) ;	// line#=computer.cpp:85,89,91,95,99,101
...
always @ ( RG_addr_addr1_next_pc_PC or M_222 or RG_op1_regs_word_addr or M_266 )
	dmem_arg_MEMB32W4096_WA2 = ( ( { 12{ M_266 } } & RG_op1_regs_word_addr [11:0] )	// line#=computer.cpp:119,120,130,131
...
assign	dmem_arg_MEMB32W4096_WE2 = ( ( U_80 | U_81 ) | ( U_60 & M_222 ) ) ;	// line#=computer.cpp:119,120,130,131,139
										// ,681
always @ ( M_255 or M_256 or M_257 or M_258 or M_259 or M_260 or M_236 or M_207 or 
	M_220 or M_237 or M_224 or imem_arg_MEMB32W65536_RD1 or M_218 )
	begin
	regs_ad00_c1 = ( ( ( ( ( ( ( ( ( ( M_224 & M_237 ) | ( M_224 & M_220 ) ) | 
		M_207 ) | M_236 ) | M_260 ) | M_259 ) | M_258 ) | M_257 ) | M_256 ) | 
		M_255 ) ;	// line#=computer.cpp:616,626
...
assign	M_255 = ( M_193 & M_214 ) ;
assign	M_256 = ( M_193 & M_197 ) ;
assign	M_257 = ( M_193 & M_204 ) ;
assign	M_258 = ( M_193 & M_209 ) ;
assign	M_259 = ( M_193 & M_232 ) ;
assign	M_260 = ( M_193 & M_212 ) ;
always @ ( M_255 or M_256 or M_257 or M_258 or M_259 or M_260 or imem_arg_MEMB32W65536_RD1 or 
	M_218 )
	begin
	regs_ad01_c1 = ( ( ( ( ( M_260 | M_259 ) | M_258 ) | M_257 ) | M_256 ) | 
		M_255 ) ;	// line#=computer.cpp:616,627
...
assign	regs_ad04 = RG_rd ;	// line#=computer.cpp:70,633,637,641,647
				// ,675,706,725
assign	M_200 = ~|( RG_regs_3 ^ 32'h00000001 ) ;	// line#=computer.cpp:692
assign	M_206 = ~|( RG_regs_3 ^ 32'h00000004 ) ;
assign	M_213 = ~|( RG_regs_3 ^ 32'h00000007 ) ;
assign	M_223 = ~|( RG_regs_3 ^ 32'h00000002 ) ;
assign	M_233 = ~|( RG_regs_3 ^ 32'h00000006 ) ;
assign	M_240 = ~|( RG_regs_3 ^ 32'h00000003 ) ;
assign	M_269 = ( M_219 & M_243 ) ;
assign	M_274 = ( M_225 & M_243 ) ;
always @ ( rsft32u1ot or rsft32s1ot or RG_imm1_instr_regs_result1 )	// line#=computer.cpp:701,702,703
	case ( RG_imm1_instr_regs_result1 [23] )
	1'h1 :
		TR_15 = rsft32s1ot ;	// line#=computer.cpp:701,702,703
	1'h0 :
		TR_15 = rsft32u1ot ;	// line#=computer.cpp:701,702,703
	default :
		TR_15 = 32'hx ;
	endcase
always @ ( M_235 or RG_op2_regs or RG_op1_regs_word_addr or M_200 or addsub32u1ot or 
	M_227 or U_95 or RG_05 or FF_take or M_196 or M_202 or TR_15 or M_211 or 
	lsft32u1ot or U_90 or M_213 or M_233 or RG_imm1_instr_regs_result1 or regs_rd02 or 
	M_206 or TR_14 or U_62 or M_269 or M_240 or M_223 or U_61 or add32s1ot or 
	U_84 or M_274 or val2_t4 or M_243 or M_238 )	// line#=computer.cpp:692,711
	begin
	regs_wd04_c1 = ( M_238 & M_243 ) ;	// line#=computer.cpp:675
	regs_wd04_c2 = ( M_274 & U_84 ) ;	// line#=computer.cpp:693
	regs_wd04_c3 = ( ( ( ( M_274 & ( U_61 & M_223 ) ) | ( M_274 & ( U_61 & M_240 ) ) ) | 
		( M_269 & ( U_62 & M_223 ) ) ) | ( M_269 & ( U_62 & M_240 ) ) ) ;
	regs_wd04_c4 = ( M_274 & ( U_61 & M_206 ) ) ;	// line#=computer.cpp:696
	regs_wd04_c5 = ( M_274 & ( U_61 & M_233 ) ) ;	// line#=computer.cpp:697
	regs_wd04_c6 = ( M_274 & ( U_61 & M_213 ) ) ;	// line#=computer.cpp:698
	regs_wd04_c7 = ( M_274 & U_90 ) ;	// line#=computer.cpp:699
	regs_wd04_c8 = ( M_274 & ( U_61 & M_211 ) ) ;	// line#=computer.cpp:701,702,703
	regs_wd04_c9 = ( ( M_202 & M_243 ) | ( M_196 & FF_take ) ) ;	// line#=computer.cpp:641,647
	regs_wd04_c10 = ( ( M_269 & U_95 ) | ( M_227 & FF_take ) ) ;	// line#=computer.cpp:70,637,712
	regs_wd04_c11 = ( M_269 & ( U_62 & M_200 ) ) ;	// line#=computer.cpp:713
	regs_wd04_c12 = ( M_269 & ( U_62 & M_206 ) ) ;	// line#=computer.cpp:716
	regs_wd04_c13 = ( M_269 & ( U_62 & M_233 ) ) ;	// line#=computer.cpp:722
	regs_wd04_c14 = ( M_269 & ( U_62 & M_213 ) ) ;	// line#=computer.cpp:723
	regs_wd04_c15 = ( M_269 & ( U_62 & M_211 ) ) ;	// line#=computer.cpp:718,719,720
	regs_wd04_c16 = ( M_235 & FF_take ) ;	// line#=computer.cpp:70,633
	regs_wd04 = ( ( { 32{ regs_wd04_c1 } } & val2_t4 )						// line#=computer.cpp:675
		| ( { 32{ regs_wd04_c2 } } & add32s1ot )						// line#=computer.cpp:693
		| ( { 32{ regs_wd04_c3 } } & { 31'h00000000 , TR_14 } )
		...
		| ( { 32{ regs_wd04_c8 } } & TR_15 )							// line#=computer.cpp:701,702,703
		| ( { 32{ regs_wd04_c9 } } & RG_05 )							// line#=computer.cpp:641,647
		...
		| ( { 32{ regs_wd04_c12 } } & ( RG_op1_regs_word_addr ^ RG_op2_regs ) )			// line#=computer.cpp:716
		| ( { 32{ regs_wd04_c13 } } & ( RG_op1_regs_word_addr | RG_op2_regs ) )			// line#=computer.cpp:722
		| ( { 32{ regs_wd04_c14 } } & ( RG_op1_regs_word_addr & RG_op2_regs ) )			// line#=computer.cpp:723
		| ( { 32{ regs_wd04_c15 } } & TR_15 )							// line#=computer.cpp:718,719,720
		| ( { 32{ regs_wd04_c16 } } & { RG_imm1_instr_regs_result1 [24:5] , 
			12'h000 } )									// line#=computer.cpp:70,633
		) ;
	end
assign	regs_we04 = ( ( ( ( ( ( ( U_59 & M_243 ) | ( U_61 & M_243 ) ) | ( U_57 & 
	M_243 ) ) | ( U_62 & M_243 ) ) | U_68 ) | ( U_56 & FF_take ) ) | ( U_54 & 
