...
// bdlpars options:  -EE -DAES_MEM -DACCEL_MIX_COL -DACCEL_SBOX_WORD -DACCEL_MIX_COL_U4 -DACCEL_SBOX_WORD_U1 -info_base_name computer computer.cpp
// bdltran options:  -EE computer.IFF -c1000 -s -Zresource_fcnt=GENERATE -Zresource_mcnt=GENERATE -Zsync -Zdup_reset=YES -Zfolding_sharing=inter_stage -lb /proj/cad/cwb-6.1/packages/asic_45.BLIB -lfl /proj/cad/cwb-6.1/packages/asic_45.FLIB -o-P 
// timestamp_0: 20260604025025_94902_69239
// timestamp_5: 20260604025025_94916_89067
// timestamp_9: 20260604025026_94916_98151
// timestamp_C: 20260604025026_94916_75464
// timestamp_E: 20260604025026_94916_02964
// timestamp_V: 20260604025026_94930_98935
...
wire		U_05 ;
wire		U_01 ;
wire	[3:0]	bytes_d01 ;	// line#=computer.cpp:277
wire	[1:0]	bytes_ad01 ;	// line#=computer.cpp:277
...
wire		RG_cols_5_en ;
wire		RG_col_1_en ;
reg	[7:0]	bytes_rg03 ;	// line#=computer.cpp:277
reg	[7:0]	bytes_rg02 ;	// line#=computer.cpp:277
reg	[7:0]	bytes_rg01 ;	// line#=computer.cpp:277
reg	[7:0]	bytes_rg00 ;	// line#=computer.cpp:277
...
reg	[4:0]	RG_06 ;
reg	[2:0]	RG_i ;	// line#=computer.cpp:290
reg	[1:0]	RG_08 ;
...
reg	regs_rg13_t_c1 ;
reg	regs_rg13_t_c2 ;
reg	[7:0]	bytes_rd00 ;	// line#=computer.cpp:277
reg	[7:0]	bytes_rg00_t ;
reg	bytes_rg00_t_c1 ;
reg	bytes_rg00_t_c2 ;
reg	[7:0]	bytes_rg01_t ;
reg	bytes_rg01_t_c1 ;
reg	bytes_rg01_t_c2 ;
reg	[7:0]	bytes_rg02_t ;
reg	bytes_rg02_t_c1 ;
reg	bytes_rg02_t_c2 ;
reg	[7:0]	bytes_rg03_t ;
reg	bytes_rg03_t_c1 ;
reg	bytes_rg03_t_c2 ;
reg	take_t1 ;
reg	[31:0]	val2_t4 ;
...
computer_addsub32u INST_addsub32u_1 ( .i1(addsub32u1i1) ,.i2(addsub32u1i2) ,.i3(addsub32u1_f) ,
	.o1(addsub32u1ot) );	// line#=computer.cpp:70,85,95,113,124
				// ,629,637,712
computer_incr3s INST_incr3s_1 ( .i1(incr3s1i1) ,.o1(incr3s1ot) );	// line#=computer.cpp:290
...
always @ ( RG_cols_2 or M_01 or U_129 or regs_wd04 or regs_d04 or regs_we04 )	// line#=computer.cpp:20
	begin
	regs_rg10_t_c1 = ( regs_we04 & regs_d04 [21] ) ;
	regs_rg10_t_c2 = ( U_129 & M_01 ) ;	// line#=computer.cpp:189
...
always @ ( RG_cols_3 or M_02 or U_129 or regs_wd04 or regs_d04 or regs_we04 )	// line#=computer.cpp:20
	begin
	regs_rg11_t_c1 = ( regs_we04 & regs_d04 [20] ) ;
	regs_rg11_t_c2 = ( U_129 & M_02 ) ;	// line#=computer.cpp:189
...
always @ ( RG_cols_4 or M_03 or U_129 or regs_wd04 or regs_d04 or regs_we04 )	// line#=computer.cpp:20
	begin
	regs_rg12_t_c1 = ( regs_we04 & regs_d04 [19] ) ;
	regs_rg12_t_c2 = ( U_129 & M_03 ) ;	// line#=computer.cpp:189
...
always @ ( M_180 or M_179 or M_178 or M_177 or M_04 or U_129 or regs_wd04 or regs_d04 or 
	regs_we04 )	// line#=computer.cpp:20
	begin
	regs_rg13_t_c1 = ( regs_we04 & regs_d04 [18] ) ;
	regs_rg13_t_c2 = ( U_129 & M_04 ) ;	// line#=computer.cpp:164,165,166,167,170
						// ,171,172,173,175,189
...
always @ ( posedge CLOCK )	// line#=computer.cpp:20
	if ( RESET )
		...
		regs_rg31 <= regs_wd04 ;
computer_decoder_2to4 INST_decoder_2to4_1 ( .DECODER_in(bytes_ad01) ,.DECODER_out(bytes_d01) );	// line#=computer.cpp:277
always @ ( bytes_rg03 or bytes_rg02 or bytes_rg01 or bytes_rg00 or RG_i )	// line#=computer.cpp:277
	case ( RG_i [1:0] )
	2'h0 :
		bytes_rd00 = bytes_rg00 ;
	2'h1 :
		bytes_rd00 = bytes_rg01 ;
	2'h2 :
		bytes_rd00 = bytes_rg02 ;
	2'h3 :
		bytes_rd00 = bytes_rg03 ;
	default :
		bytes_rd00 = 8'hx ;
	endcase
assign	M_05 = ~( ST1_05d & bytes_d01 [3] ) ;
always @ ( regs_rd02 or M_05 or U_110 or accel_sbox1ot or bytes_d01 or ST1_05d )	// line#=computer.cpp:277,291
	begin
	bytes_rg00_t_c1 = ( ST1_05d & bytes_d01 [3] ) ;	// line#=computer.cpp:291
	bytes_rg00_t_c2 = ( U_110 & M_05 ) ;	// line#=computer.cpp:277,278,279,280,281
						// ,748,749
	bytes_rg00_t = ( ( { 8{ bytes_rg00_t_c1 } } & accel_sbox1ot )	// line#=computer.cpp:291
		| ( { 8{ bytes_rg00_t_c2 } } & regs_rd02 [7:0] )	// line#=computer.cpp:277,278,279,280,281
									// ,748,749
		) ;
	end
assign	bytes_rg00_en = ( bytes_rg00_t_c1 | bytes_rg00_t_c2 ) ;	// line#=computer.cpp:277,291
always @ ( posedge CLOCK )	// line#=computer.cpp:277,291
	if ( RESET )
		bytes_rg00 <= 8'h00 ;
	else if ( bytes_rg00_en )
		bytes_rg00 <= bytes_rg00_t ;	// line#=computer.cpp:277,278,279,280,281
						// ,291,748,749
assign	M_06 = ~( ST1_05d & bytes_d01 [2] ) ;
always @ ( regs_rd02 or M_06 or U_110 or accel_sbox1ot or bytes_d01 or ST1_05d )	// line#=computer.cpp:277,291
	begin
	bytes_rg01_t_c1 = ( ST1_05d & bytes_d01 [2] ) ;	// line#=computer.cpp:291
	bytes_rg01_t_c2 = ( U_110 & M_06 ) ;	// line#=computer.cpp:277,278,279,280,281
						// ,748,749
	bytes_rg01_t = ( ( { 8{ bytes_rg01_t_c1 } } & accel_sbox1ot )	// line#=computer.cpp:291
		| ( { 8{ bytes_rg01_t_c2 } } & regs_rd02 [15:8] )	// line#=computer.cpp:277,278,279,280,281
									// ,748,749
		) ;
	end
assign	bytes_rg01_en = ( bytes_rg01_t_c1 | bytes_rg01_t_c2 ) ;	// line#=computer.cpp:277,291
always @ ( posedge CLOCK )	// line#=computer.cpp:277,291
	if ( RESET )
		bytes_rg01 <= 8'h00 ;
	else if ( bytes_rg01_en )
		bytes_rg01 <= bytes_rg01_t ;	// line#=computer.cpp:277,278,279,280,281
						// ,291,748,749
assign	M_07 = ~( ST1_05d & bytes_d01 [1] ) ;
always @ ( regs_rd02 or M_07 or U_110 or accel_sbox1ot or bytes_d01 or ST1_05d )	// line#=computer.cpp:277,291
	begin
	bytes_rg02_t_c1 = ( ST1_05d & bytes_d01 [1] ) ;	// line#=computer.cpp:291
	bytes_rg02_t_c2 = ( U_110 & M_07 ) ;	// line#=computer.cpp:277,278,279,280,281
						// ,748,749
	bytes_rg02_t = ( ( { 8{ bytes_rg02_t_c1 } } & accel_sbox1ot )	// line#=computer.cpp:291
		| ( { 8{ bytes_rg02_t_c2 } } & regs_rd02 [23:16] )	// line#=computer.cpp:277,278,279,280,281
									// ,748,749
		) ;
	end
assign	bytes_rg02_en = ( bytes_rg02_t_c1 | bytes_rg02_t_c2 ) ;	// line#=computer.cpp:277,291
always @ ( posedge CLOCK )	// line#=computer.cpp:277,291
	if ( RESET )
		bytes_rg02 <= 8'h00 ;
	else if ( bytes_rg02_en )
		bytes_rg02 <= bytes_rg02_t ;	// line#=computer.cpp:277,278,279,280,281
						// ,291,748,749
assign	M_08 = ~( ST1_05d & bytes_d01 [0] ) ;
always @ ( regs_rd02 or M_08 or U_110 or accel_sbox1ot or bytes_d01 or ST1_05d )	// line#=computer.cpp:277,291
	begin
	bytes_rg03_t_c1 = ( ST1_05d & bytes_d01 [0] ) ;	// line#=computer.cpp:291
	bytes_rg03_t_c2 = ( U_110 & M_08 ) ;	// line#=computer.cpp:277,278,279,280,281
						// ,748,749
	bytes_rg03_t = ( ( { 8{ bytes_rg03_t_c1 } } & accel_sbox1ot )	// line#=computer.cpp:291
		| ( { 8{ bytes_rg03_t_c2 } } & regs_rd02 [31:24] )	// line#=computer.cpp:277,278,279,280,281
									// ,748,749
		) ;
	end
assign	bytes_rg03_en = ( bytes_rg03_t_c1 | bytes_rg03_t_c2 ) ;	// line#=computer.cpp:277,291
always @ ( posedge CLOCK )	// line#=computer.cpp:277,291
	if ( RESET )
		bytes_rg03 <= 8'h00 ;
	else if ( bytes_rg03_en )
		bytes_rg03 <= bytes_rg03_t ;	// line#=computer.cpp:277,278,279,280,281
						// ,291,748,749
...
assign	CT_02 = ~|imem_arg_MEMB32W65536_RD1 [31:25] ;	// line#=computer.cpp:616,747,755
always @ ( FF_take_1 or FF_take or RG_cols )	// line#=computer.cpp:654
	case ( RG_cols )
	32'h00000000 :
...
always @ ( FF_take_1 )	// line#=computer.cpp:694
	...
	default :
		TR_15 = 1'hx ;
	endcase
assign	e_1_t = ( M_133_t ^ M_131_t ) ;	// line#=computer.cpp:164,165,166,167,168
always @ ( M_137_t or M_133_t )	// line#=computer.cpp:164,170
	case ( M_133_t [7] )
	1'h1 :
		M_283 = { ~M_137_t [3:2] , ~M_137_t [0] , 1'h1 } ;	// line#=computer.cpp:164,170
	1'h0 :
		M_283 = { M_137_t [3:2] , M_137_t [0] , 1'h0 } ;	// line#=computer.cpp:164,165,170
	default :
		M_283 = 4'hx ;
	endcase
always @ ( M_136_t or M_132_t )	// line#=computer.cpp:171
	case ( M_132_t [7] )
	1'h1 :
		M_282 = { ~M_136_t [3:2] , ~M_136_t [0] , 1'h1 } ;	// line#=computer.cpp:171
	1'h0 :
		M_282 = { M_136_t [3:2] , M_136_t [0] , 1'h0 } ;	// line#=computer.cpp:165,166,171
	default :
		M_282 = 4'hx ;
	endcase
always @ ( M_135_t or M_131_t )	// line#=computer.cpp:172
	case ( M_131_t [7] )
	1'h1 :
		M_281 = { ~M_135_t [3:2] , ~M_135_t [0] , 1'h1 } ;	// line#=computer.cpp:172
	1'h0 :
		M_281 = { M_135_t [3:2] , M_135_t [0] , 1'h0 } ;	// line#=computer.cpp:166,167,172
	default :
		M_281 = 4'hx ;
	endcase
always @ ( M_134_t or M_130_t )	// line#=computer.cpp:164,173
	case ( M_130_t [7] )
	1'h1 :
		M_280 = { ~M_134_t [3:2] , ~M_134_t [0] , 1'h1 } ;	// line#=computer.cpp:164,173
	1'h0 :
		M_280 = { M_134_t [3:2] , M_134_t [0] , 1'h0 } ;	// line#=computer.cpp:164,167,173
	default :
		M_280 = 4'hx ;
	endcase
assign	M_177 = ( ( RG_col_1 [31:24] ^ e_1_t ) ^ { M_134_t [6:4] , M_280 [3:2] , 
	M_134_t [1] , M_280 [1:0] } ) ;	// line#=computer.cpp:164,165,166,167,170
					// ,171,172,173,175
assign	M_178 = ( ( RG_col_1 [23:16] ^ e_1_t ) ^ { M_135_t [6:4] , M_281 [3:2] , 
	M_135_t [1] , M_281 [1:0] } ) ;	// line#=computer.cpp:164,165,166,167,170
					// ,171,172,173,175
assign	M_179 = ( ( RG_col_1 [15:8] ^ e_1_t ) ^ { M_136_t [6:4] , M_282 [3:2] , M_136_t [1] , 
	M_282 [1:0] } ) ;	// line#=computer.cpp:164,165,166,167,170
				// ,171,172,173,175
assign	M_180 = ( ( RG_col_1 [7:0] ^ e_1_t ) ^ { M_137_t [6:4] , M_283 [3:2] , M_137_t [1] , 
	M_283 [1:0] } ) ;	// line#=computer.cpp:164,165,166,167,170
				// ,171,172,173,175
assign	M_130_t = ( RG_col_1 [31:24] ^ RG_col_1 [7:0] ) ;	// line#=computer.cpp:164,167,173
assign	M_131_t = ( RG_col_1 [23:16] ^ RG_col_1 [31:24] ) ;	// line#=computer.cpp:164,165,166,167,168
								// ,172
assign	M_132_t = ( RG_col_1 [15:8] ^ RG_col_1 [23:16] ) ;	// line#=computer.cpp:165,166,171
assign	M_133_t = ( RG_col_1 [7:0] ^ RG_col_1 [15:8] ) ;	// line#=computer.cpp:164,165,166,167,168
								// ,170
assign	M_134_t = ( RG_col_1 [30:24] ^ RG_col_1 [6:0] ) ;	// line#=computer.cpp:164,167,173
assign	M_135_t = ( RG_col_1 [22:16] ^ RG_col_1 [30:24] ) ;	// line#=computer.cpp:166,167,172
assign	M_136_t = ( RG_col_1 [14:8] ^ RG_col_1 [22:16] ) ;	// line#=computer.cpp:165,166,171
assign	M_137_t = ( RG_col_1 [6:0] ^ RG_col_1 [14:8] ) ;	// line#=computer.cpp:164,165,170
assign	JF_05 = ~( ( ( RG_08 == 2'h0 ) | ( RG_08 == 2'h1 ) ) | ( RG_08 == 2'h2 ) ) ;
assign	incr3s1i1 = RG_i ;	// line#=computer.cpp:290
...
assign	accel_sbox1i1 = bytes_rd00 ;	// line#=computer.cpp:291
...
assign	bytes_ad01 = RG_i [1:0] ;	// line#=computer.cpp:291
assign	U_01 = ( ST1_02d & CT_01 ) ;	// line#=computer.cpp:615
assign	U_05 = ( ST1_03d & M_231 ) ;	// line#=computer.cpp:616,623,631
assign	U_06 = ( ST1_03d & M_223 ) ;	// line#=computer.cpp:616,623,631
assign	U_07 = ( ST1_03d & M_196 ) ;	// line#=computer.cpp:616,623,631
assign	U_08 = ( ST1_03d & M_202 ) ;	// line#=computer.cpp:616,623,631
assign	U_09 = ( ST1_03d & M_194 ) ;	// line#=computer.cpp:616,623,631
assign	U_10 = ( ST1_03d & M_233 ) ;	// line#=computer.cpp:616,623,631
assign	U_11 = ( ST1_03d & M_206 ) ;	// line#=computer.cpp:616,623,631
assign	U_12 = ( ST1_03d & M_221 ) ;	// line#=computer.cpp:616,623,631
assign	U_13 = ( ST1_03d & M_216 ) ;	// line#=computer.cpp:616,623,631
assign	U_16 = ( ST1_03d & M_227 ) ;	// line#=computer.cpp:616,623,631
assign	M_194 = ~|( { 25'h0000000 , imem_arg_MEMB32W65536_RD1 [6:0] } ^ 32'h00000063 ) ;	// line#=computer.cpp:616,623,631
assign	M_196 = ~|( { 25'h0000000 , imem_arg_MEMB32W65536_RD1 [6:0] } ^ 32'h0000006f ) ;	// line#=computer.cpp:616,623,631
assign	M_202 = ~|( { 25'h0000000 , imem_arg_MEMB32W65536_RD1 [6:0] } ^ 32'h00000067 ) ;	// line#=computer.cpp:616,623,631
assign	M_206 = ~|( { 25'h0000000 , imem_arg_MEMB32W65536_RD1 [6:0] } ^ 32'h00000023 ) ;	// line#=computer.cpp:616,623,631
assign	M_216 = ~|( { 25'h0000000 , imem_arg_MEMB32W65536_RD1 [6:0] } ^ 32'h00000033 ) ;	// line#=computer.cpp:616,623,631
assign	M_221 = ~|( { 25'h0000000 , imem_arg_MEMB32W65536_RD1 [6:0] } ^ 32'h00000013 ) ;	// line#=computer.cpp:616,623,631
assign	M_223 = ~|( { 25'h0000000 , imem_arg_MEMB32W65536_RD1 [6:0] } ^ 32'h00000017 ) ;	// line#=computer.cpp:616,623,631
assign	M_225 = ~|( { 25'h0000000 , imem_arg_MEMB32W65536_RD1 [6:0] } ^ 32'h00000073 ) ;	// line#=computer.cpp:616,623,631
assign	M_227 = ~|( { 25'h0000000 , imem_arg_MEMB32W65536_RD1 [6:0] } ^ 32'h0000000b ) ;	// line#=computer.cpp:616,623,631
assign	M_231 = ~|( { 25'h0000000 , imem_arg_MEMB32W65536_RD1 [6:0] } ^ 32'h00000037 ) ;	// line#=computer.cpp:616,623,631
assign	M_233 = ~|( { 25'h0000000 , imem_arg_MEMB32W65536_RD1 [6:0] } ^ 32'h00000003 ) ;	// line#=computer.cpp:616,623,631
assign	M_237 = ~|( { 25'h0000000 , imem_arg_MEMB32W65536_RD1 [6:0] } ^ 32'h0000000f ) ;	// line#=computer.cpp:616,623,631
assign	M_198 = ~|( { 29'h00000000 , imem_arg_MEMB32W65536_RD1 [14:12] } ^ 32'h00000001 ) ;	// line#=computer.cpp:616,654,668,681,692
												// ,711,744
assign	M_204 = ~|( { 29'h00000000 , imem_arg_MEMB32W65536_RD1 [14:12] } ^ 32'h00000004 ) ;	// line#=computer.cpp:616,654,668,692,711
assign	M_208 = ~|( { 29'h00000000 , imem_arg_MEMB32W65536_RD1 [14:12] } ^ 32'h00000005 ) ;	// line#=computer.cpp:616,654,668,692,711
assign	M_210 = ~|( { 29'h00000000 , imem_arg_MEMB32W65536_RD1 [14:12] } ^ 32'h00000007 ) ;	// line#=computer.cpp:616,654,692,711
assign	M_212 = ~|{ 29'h00000000 , imem_arg_MEMB32W65536_RD1 [14:12] } ;	// line#=computer.cpp:616,654,668,681,692
										// ,711
assign	M_229 = ~|( { 29'h00000000 , imem_arg_MEMB32W65536_RD1 [14:12] } ^ 32'h00000006 ) ;	// line#=computer.cpp:616,654,692,711
assign	U_25 = ( U_10 & M_212 ) ;	// line#=computer.cpp:616,668
assign	U_26 = ( U_10 & M_198 ) ;	// line#=computer.cpp:616,668
assign	U_28 = ( U_10 & M_204 ) ;	// line#=computer.cpp:616,668
assign	U_29 = ( U_10 & M_208 ) ;	// line#=computer.cpp:616,668
assign	M_218 = ~|( { 29'h00000000 , imem_arg_MEMB32W65536_RD1 [14:12] } ^ 32'h00000002 ) ;	// line#=computer.cpp:616,668,681,692,711
												// ,744
assign	U_31 = ( U_11 & M_212 ) ;	// line#=computer.cpp:616,681
assign	U_32 = ( U_11 & M_198 ) ;	// line#=computer.cpp:616,681
assign	U_44 = ( U_13 & M_198 ) ;	// line#=computer.cpp:616,711
assign	U_51 = ( U_16 & M_198 ) ;	// line#=computer.cpp:616,744
assign	U_52 = ( U_16 & M_218 ) ;	// line#=computer.cpp:616,744
assign	U_55 = ( ST1_04d & M_232 ) ;	// line#=computer.cpp:631
assign	U_56 = ( ST1_04d & M_224 ) ;	// line#=computer.cpp:631
assign	U_57 = ( ST1_04d & M_197 ) ;	// line#=computer.cpp:631
assign	U_58 = ( ST1_04d & M_203 ) ;	// line#=computer.cpp:631
assign	U_59 = ( ST1_04d & M_195 ) ;	// line#=computer.cpp:631
assign	U_60 = ( ST1_04d & M_234 ) ;	// line#=computer.cpp:631
assign	U_61 = ( ST1_04d & M_207 ) ;	// line#=computer.cpp:631
assign	U_62 = ( ST1_04d & M_222 ) ;	// line#=computer.cpp:631
assign	U_63 = ( ST1_04d & M_217 ) ;	// line#=computer.cpp:631
assign	U_65 = ( ST1_04d & M_226 ) ;	// line#=computer.cpp:631
assign	U_66 = ( ST1_04d & M_228 ) ;	// line#=computer.cpp:631
assign	M_195 = ~|( RG_cols_1 ^ 32'h00000063 ) ;	// line#=computer.cpp:631
assign	M_197 = ~|( RG_cols_1 ^ 32'h0000006f ) ;	// line#=computer.cpp:631
assign	M_203 = ~|( RG_cols_1 ^ 32'h00000067 ) ;	// line#=computer.cpp:631
assign	M_207 = ~|( RG_cols_1 ^ 32'h00000023 ) ;	// line#=computer.cpp:631
assign	M_217 = ~|( RG_cols_1 ^ 32'h00000033 ) ;	// line#=computer.cpp:631
assign	M_222 = ~|( RG_cols_1 ^ 32'h00000013 ) ;	// line#=computer.cpp:631
assign	M_224 = ~|( RG_cols_1 ^ 32'h00000017 ) ;	// line#=computer.cpp:631
assign	M_226 = ~|( RG_cols_1 ^ 32'h00000073 ) ;	// line#=computer.cpp:631
assign	M_228 = ~|( RG_cols_1 ^ 32'h0000000b ) ;	// line#=computer.cpp:631
assign	M_232 = ~|( RG_cols_1 ^ 32'h00000037 ) ;	// line#=computer.cpp:631
assign	M_234 = ~|( RG_cols_1 ^ 32'h00000003 ) ;	// line#=computer.cpp:631
assign	M_238 = ~|( RG_cols_1 ^ 32'h0000000f ) ;	// line#=computer.cpp:631
assign	U_67 = ( ST1_04d & M_265 ) ;	// line#=computer.cpp:631
assign	U_68 = ( U_55 & FF_take_1 ) ;	// line#=computer.cpp:633
assign	U_69 = ( U_56 & FF_take_1 ) ;	// line#=computer.cpp:637
assign	U_70 = ( U_57 & FF_take_1 ) ;	// line#=computer.cpp:641
assign	U_71 = ( U_58 & M_240 ) ;	// line#=computer.cpp:647
assign	U_72 = ( U_59 & take_t1 ) ;	// line#=computer.cpp:662
assign	M_199 = ~|( RG_cols ^ 32'h00000001 ) ;	// line#=computer.cpp:668,681,692,744
assign	M_205 = ~|( RG_cols ^ 32'h00000004 ) ;	// line#=computer.cpp:668
assign	M_209 = ~|( RG_cols ^ 32'h00000005 ) ;	// line#=computer.cpp:668,692,711
assign	M_213 = ~|RG_cols ;	// line#=computer.cpp:668,681,692,711
assign	M_219 = ~|( RG_cols ^ 32'h00000002 ) ;	// line#=computer.cpp:668,681,744
assign	M_240 = |RG_rd ;	// line#=computer.cpp:647,675,706,725
assign	U_80 = ( U_60 & M_240 ) ;	// line#=computer.cpp:675
assign	U_81 = ( U_61 & M_213 ) ;	// line#=computer.cpp:681
assign	U_82 = ( U_61 & M_199 ) ;	// line#=computer.cpp:681
assign	U_85 = ( U_62 & M_213 ) ;	// line#=computer.cpp:692
assign	U_91 = ( U_62 & M_199 ) ;	// line#=computer.cpp:692
assign	U_95 = ( U_62 & M_240 ) ;	// line#=computer.cpp:706
assign	U_96 = ( U_63 & M_213 ) ;	// line#=computer.cpp:711
assign	M_214 = ~RL_addr_addr1_imm1_instr_next_pc [23] ;	// line#=computer.cpp:701,702,703,718,719
								// ,720
assign	U_106 = ( U_63 & M_240 ) ;	// line#=computer.cpp:725
assign	U_107 = ( U_66 & M_199 ) ;	// line#=computer.cpp:744
assign	U_108 = ( U_66 & M_219 ) ;	// line#=computer.cpp:744
assign	U_110 = ( U_107 & FF_take_1 ) ;	// line#=computer.cpp:747
assign	U_126 = ( ST1_07d & M_215 ) ;
assign	U_127 = ( ST1_07d & M_201 ) ;
assign	U_128 = ( ST1_07d & M_220 ) ;
assign	M_201 = ~|( RG_08 ^ 2'h1 ) ;
assign	M_215 = ~|RG_08 ;
assign	M_220 = ~|( RG_08 ^ 2'h2 ) ;
assign	U_129 = ( ST1_07d & ( ~( ( M_215 | M_201 ) | M_220 ) ) ) ;
always @ ( add32s1ot or M_206 )
	TR_12 = ( { 12{ M_206 } } & add32s1ot [13:2] )	// line#=computer.cpp:52,61,679
		 ;	// line#=computer.cpp:52,56,666
assign	M_248 = ( ST1_04d & U_57 ) ;	// line#=computer.cpp:616,692
always @ ( add32s1ot or M_248 or TR_12 or M_253 )
	TR_01 = ( ( { 30{ M_253 } } & { 18'h00000 , TR_12 } )	// line#=computer.cpp:52,56,61,666,679
		| ( { 30{ M_248 } } & add32s1ot [31:2] )	// line#=computer.cpp:52,75,642
		) ;
always @ ( RG_cols_op1_PC_result1_word_addr or M_125_t or U_59 or U_58 or RG_11 or 
	U_67 or U_66 or U_65 or M_238 or U_63 or U_62 or U_61 or U_60 or U_56 or 
	U_55 or ST1_04d or U_09 or U_08 or U_07 or U_06 or U_05 or U_13 or M_208 or 
	add32s1ot or TR_01 or M_248 or M_253 or imem_arg_MEMB32W65536_RD1 or M_210 or 
	M_229 or M_204 or M_212 or U_12 )	// line#=computer.cpp:616,631,692
	begin
	RL_addr_addr1_imm1_instr_next_pc_t_c1 = ( ( ( ( U_12 & M_212 ) | ( U_12 & 
		M_204 ) ) | ( U_12 & M_229 ) ) | ( U_12 & M_210 ) ) ;	// line#=computer.cpp:52,56,616,689
	RL_addr_addr1_imm1_instr_next_pc_t_c2 = ( M_253 | M_248 ) ;	// line#=computer.cpp:52,56,61,75,642,666
									// ,679
	RL_addr_addr1_imm1_instr_next_pc_t_c3 = ( ( ( ( ( ( ( U_12 & M_208 ) | U_13 ) | 
		U_05 ) | U_06 ) | U_07 ) | U_08 ) | U_09 ) ;	// line#=computer.cpp:616
	RL_addr_addr1_imm1_instr_next_pc_t_c4 = ( ST1_04d & ( ( ( ( ( ( ( ( ( U_55 | 
		U_56 ) | U_60 ) | U_61 ) | U_62 ) | U_63 ) | ( ST1_04d & M_238 ) ) | 
		U_65 ) | U_66 ) | U_67 ) ) ;	// line#=computer.cpp:629
	RL_addr_addr1_imm1_instr_next_pc_t_c5 = ( ST1_04d & U_58 ) ;	// line#=computer.cpp:52,56,646,648
	RL_addr_addr1_imm1_instr_next_pc_t_c6 = ( ST1_04d & U_59 ) ;
	RL_addr_addr1_imm1_instr_next_pc_t = ( ( { 32{ RL_addr_addr1_imm1_instr_next_pc_t_c1 } } & 
		...
		| ( { 32{ RL_addr_addr1_imm1_instr_next_pc_t_c4 } } & RG_11 )						// line#=computer.cpp:629
		| ( { 32{ RL_addr_addr1_imm1_instr_next_pc_t_c5 } } & { add32s1ot [31:1] , 
			1'h0 } )											// line#=computer.cpp:52,56,646,648
		| ( { 32{ RL_addr_addr1_imm1_instr_next_pc_t_c6 } } & { M_125_t , 
...
assign	RG_col_en = M_245 ;
always @ ( posedge CLOCK )
	if ( RESET )
		RG_col <= 32'h00000000 ;
	else if ( RG_col_en )
		RG_col <= RG_col_1 ;
assign	M_245 = ( M_246 | ST1_07d ) ;	// line#=computer.cpp:616,711
always @ ( RG_cols_3 or M_245 or regs_rd00 or ST1_03d )
	RG_cols_op2_t = ( ( { 32{ ST1_03d } } & regs_rd00 )	// line#=computer.cpp:710
		| ( { 32{ M_245 } } & RG_cols_3 ) ) ;
assign	RG_cols_op2_en = ( ST1_03d | M_245 ) ;
always @ ( posedge CLOCK )
	if ( RG_cols_op2_en )
		RG_cols_op2 <= RG_cols_op2_t ;	// line#=computer.cpp:710
always @ ( RG_cols_4 or M_245 or lsft32u1ot or U_44 or addsub32u1ot or U_32 or U_31 or 
	RL_addr_addr1_imm1_instr_next_pc or U_09 or U_07 or U_06 or regs_rd01 or 
	M_210 or M_229 or M_208 or M_204 or M_212 or U_13 )	// line#=computer.cpp:616,711
	begin
	RG_cols_op1_PC_result1_word_addr_t_c1 = ( ( ( ( ( U_13 & M_212 ) | ( U_13 & 
		M_204 ) ) | ( U_13 & M_208 ) ) | ( U_13 & M_229 ) ) | ( U_13 & M_210 ) ) ;	// line#=computer.cpp:710
...
assign	RG_cols_op1_PC_result1_word_addr_en = ( RG_cols_op1_PC_result1_word_addr_t_c1 | 
	...
	U_44 | M_245 ) ;	// line#=computer.cpp:616,711
always @ ( posedge CLOCK )	// line#=computer.cpp:616,711
	if ( RG_cols_op1_PC_result1_word_addr_en )
		RG_cols_op1_PC_result1_word_addr <= RG_cols_op1_PC_result1_word_addr_t ;	// line#=computer.cpp:113,117,124,128,616
												// ,710,711,713
assign	M_246 = ( ST1_04d | ST1_06d ) ;	// line#=computer.cpp:616,711
always @ ( M_180 or M_179 or M_178 or M_177 or ST1_07d or RG_cols_5 or M_246 or 
	...
	RG_cols_t = ( ( { 32{ RG_cols_t_c1 } } & { 29'h00000000 , imem_arg_MEMB32W65536_RD1 [14:12] } )	// line#=computer.cpp:616,654,668,681,692
													// ,711,744
		| ( { 32{ M_246 } } & RG_cols_5 )
		| ( { 32{ ST1_07d } } & { M_177 , M_178 , M_179 , M_180 } )				// line#=computer.cpp:164,165,166,167,170
													// ,171,172,173,175,188
		) ;
	end
assign	RG_cols_en = ( RG_cols_t_c1 | M_246 | ST1_07d ) ;
always @ ( posedge CLOCK )
	if ( RG_cols_en )
		RG_cols <= RG_cols_t ;	// line#=computer.cpp:164,165,166,167,170
					// ,171,172,173,175,188,616,654,668
					// ,681,692,711,744
always @ ( RG_cols_2 or M_245 or imem_arg_MEMB32W65536_RD1 or ST1_03d )
	RG_cols_1_t = ( ( { 32{ ST1_03d } } & { 25'h0000000 , imem_arg_MEMB32W65536_RD1 [6:0] } )	// line#=computer.cpp:616,623,631
		| ( { 32{ M_245 } } & RG_cols_2 ) ) ;
assign	RG_cols_1_en = ( ST1_03d | M_245 ) ;
always @ ( posedge CLOCK )
	if ( RG_cols_1_en )
		RG_cols_1 <= RG_cols_1_t ;	// line#=computer.cpp:616,623,631
assign	RG_06_en = M_247 ;
always @ ( posedge CLOCK )	// line#=computer.cpp:749
	if ( RG_06_en )
		RG_06 <= RG_rd ;
assign	M_247 = ( ST1_04d & U_110 ) ;
always @ ( incr3s1ot or ST1_05d )
	RG_i_t = ( { 3{ ST1_05d } } & incr3s1ot )	// line#=computer.cpp:290
		 ;	// line#=computer.cpp:290
assign	RG_i_en = ( M_247 | ST1_05d ) ;
always @ ( posedge CLOCK )
	if ( RG_i_en )
		RG_i <= RG_i_t ;	// line#=computer.cpp:290
always @ ( M_220 or U_128 or U_127 or U_126 or FF_take_1 or U_108 or ST1_04d )	// line#=computer.cpp:755
	begin
	RG_08_t_c1 = ( ( ST1_04d & ( U_108 & FF_take_1 ) ) | U_126 ) ;
	RG_08_t_c2 = ( U_127 | U_128 ) ;
	RG_08_t = ( ( { 2{ RG_08_t_c1 } } & { 1'h0 , U_126 } )
		| ( { 2{ RG_08_t_c2 } } & { 1'h1 , M_220 } ) ) ;
	end
assign	RG_08_en = ( RG_08_t_c1 | RG_08_t_c2 ) ;	// line#=computer.cpp:755
always @ ( posedge CLOCK )	// line#=computer.cpp:755
	if ( RESET )
		RG_08 <= 2'h0 ;
	else if ( RG_08_en )
		RG_08 <= RG_08_t ;	// line#=computer.cpp:755
assign	M_244 = ( regs_rd00 ^ regs_rd01 ) ;	// line#=computer.cpp:655,656
always @ ( B_01_t or ST1_04d or M_244 or U_09 )
	FF_take_t = ( ( { 1{ U_09 } } & ( ~|M_244 ) )	// line#=computer.cpp:655
		| ( { 1{ ST1_04d } } & B_01_t ) ) ;
assign	FF_take_en = ( U_09 | ST1_04d ) ;
always @ ( posedge CLOCK )
	if ( FF_take_en )
		FF_take <= FF_take_t ;	// line#=computer.cpp:655
always @ ( U_67 or M_269 or U_66 or U_108 or FF_take_1 or U_107 or U_65 or ST1_04d )	// line#=computer.cpp:744,747,755
	begin
	FF_halt_t_c1 = ( ST1_04d & ( ( ( ( U_65 | ( U_107 & ( ~FF_take_1 ) ) ) | 
		( U_108 & ( ~FF_take_1 ) ) ) | ( U_66 & M_269 ) ) | U_67 ) ) ;	// line#=computer.cpp:732,750,756,797,808
...
always @ ( posedge CLOCK )	// line#=computer.cpp:629
	if ( RG_11_en )
		RG_11 <= addsub32u1ot ;
always @ ( M_180 or M_179 or M_178 or M_177 or U_126 or RG_cols_1 or M_251 or regs_rg10 or 
	ST1_02d )
	RG_cols_2_t = ( ( { 32{ ST1_02d } } & regs_rg10 )			// line#=computer.cpp:179
		| ( { 32{ M_251 } } & RG_cols_1 )
		| ( { 32{ U_126 } } & { M_177 , M_178 , M_179 , M_180 } )	// line#=computer.cpp:164,165,166,167,170
										// ,171,172,173,175,188
		) ;
assign	RG_cols_2_en = ( ST1_02d | M_251 | U_126 ) ;
always @ ( posedge CLOCK )
	if ( RG_cols_2_en )
		RG_cols_2 <= RG_cols_2_t ;	// line#=computer.cpp:164,165,166,167,170
						// ,171,172,173,175,179,188
assign	M_251 = ( ( ( ( ( ( ( ( ( ( ( ( M_252 | U_08 ) | U_09 ) | U_10 ) | U_11 ) | 
	U_12 ) | U_13 ) | ( ST1_03d & M_237 ) ) | ( ST1_03d & M_225 ) ) | U_51 ) | 
	( U_52 & ( ~CT_02 ) ) ) | ( U_16 & ( ~( M_198 | M_218 ) ) ) ) | ( ST1_03d & ( 
	~( ( ( ( ( ( ( ( ( ( ( M_231 | M_223 ) | M_196 ) | M_202 ) | M_194 ) | M_233 ) | 
	M_206 ) | M_221 ) | M_216 ) | M_237 ) | M_225 ) | M_227 ) ) ) ) ;	// line#=computer.cpp:616,623,631,744,755
always @ ( M_180 or M_179 or M_178 or M_177 or U_127 or RG_cols_op2 or M_251 or 
	regs_rg11 or ST1_02d )
	RG_cols_3_t = ( ( { 32{ ST1_02d } } & regs_rg11 )			// line#=computer.cpp:179
		| ( { 32{ M_251 } } & RG_cols_op2 )
		| ( { 32{ U_127 } } & { M_177 , M_178 , M_179 , M_180 } )	// line#=computer.cpp:164,165,166,167,170
										// ,171,172,173,175,188
		) ;
assign	RG_cols_3_en = ( ST1_02d | M_251 | U_127 ) ;
always @ ( posedge CLOCK )
	if ( RG_cols_3_en )
		RG_cols_3 <= RG_cols_3_t ;	// line#=computer.cpp:164,165,166,167,170
						// ,171,172,173,175,179,188
always @ ( M_180 or M_179 or M_178 or M_177 or U_128 or RG_cols_op1_PC_result1_word_addr or 
	M_251 or regs_rg12 or ST1_02d )
	RG_cols_4_t = ( ( { 32{ ST1_02d } } & regs_rg12 )			// line#=computer.cpp:179
		| ( { 32{ M_251 } } & RG_cols_op1_PC_result1_word_addr )
		| ( { 32{ U_128 } } & { M_177 , M_178 , M_179 , M_180 } )	// line#=computer.cpp:164,165,166,167,170
										// ,171,172,173,175,188
		) ;
assign	RG_cols_4_en = ( ST1_02d | M_251 | U_128 ) ;
always @ ( posedge CLOCK )
	if ( RG_cols_4_en )
		RG_cols_4 <= RG_cols_4_t ;	// line#=computer.cpp:164,165,166,167,170
						// ,171,172,173,175,179,188
always @ ( RG_cols or M_251 or regs_rg13 or ST1_02d )
	RG_cols_5_t = ( ( { 32{ ST1_02d } } & regs_rg13 )	// line#=computer.cpp:179
		| ( { 32{ M_251 } } & RG_cols ) ) ;
assign	RG_cols_5_en = ( ST1_02d | M_251 ) ;
always @ ( posedge CLOCK )
	if ( RG_cols_5_en )
		RG_cols_5 <= RG_cols_5_t ;	// line#=computer.cpp:179
always @ ( RG_cols_5 or U_128 or RG_cols_4 or U_127 or RG_cols_3 or U_126 or RG_col or 
	M_251 or regs_rg10 or ST1_02d )
	RG_col_1_t = ( ( { 32{ ST1_02d } } & regs_rg10 )	// line#=computer.cpp:179,188
		| ( { 32{ M_251 } } & RG_col )
		| ( { 32{ U_126 } } & RG_cols_3 )		// line#=computer.cpp:188
		| ( { 32{ U_127 } } & RG_cols_4 )		// line#=computer.cpp:188
		| ( { 32{ U_128 } } & RG_cols_5 )		// line#=computer.cpp:188
		) ;
assign	RG_col_1_en = ( ST1_02d | M_251 | U_126 | U_127 | U_128 ) ;
always @ ( posedge CLOCK )
	if ( RESET )
		RG_col_1 <= 32'h00000000 ;
	else if ( RG_col_1_en )
		RG_col_1 <= RG_col_1_t ;	// line#=computer.cpp:179,188
assign	M_235 = ~|( { 29'h00000000 , imem_arg_MEMB32W65536_RD1 [14:12] } ^ 32'h00000003 ) ;	// line#=computer.cpp:616,692,711
assign	M_252 = ( ( U_05 | U_06 ) | U_07 ) ;	// line#=computer.cpp:616,711
always @ ( incr3s1ot or ST1_05d or U_52 or CT_02 or U_51 or comp32u_12ot or comp32s_11ot or 
	U_13 or comp32u_13ot or M_235 or comp32s_1_11ot or M_218 or U_12 or M_210 or 
	comp32u_11ot or M_229 or M_208 or comp32s_12ot or M_204 or M_244 or M_198 or 
	U_09 or imem_arg_MEMB32W65536_RD1 or M_252 )	// line#=computer.cpp:616,654,692,711
	begin
	FF_take_1_t_c1 = ( U_09 & M_198 ) ;	// line#=computer.cpp:656
	FF_take_1_t_c2 = ( U_09 & M_204 ) ;	// line#=computer.cpp:657
	FF_take_1_t_c3 = ( U_09 & M_208 ) ;	// line#=computer.cpp:658
	FF_take_1_t_c4 = ( U_09 & M_229 ) ;	// line#=computer.cpp:659
	FF_take_1_t_c5 = ( U_09 & M_210 ) ;	// line#=computer.cpp:660
	FF_take_1_t_c6 = ( U_12 & M_218 ) ;	// line#=computer.cpp:694
	FF_take_1_t_c7 = ( U_12 & M_235 ) ;	// line#=computer.cpp:695
	FF_take_1_t_c8 = ( U_13 & M_218 ) ;	// line#=computer.cpp:714
	FF_take_1_t_c9 = ( U_13 & M_235 ) ;	// line#=computer.cpp:715
	FF_take_1_t = ( ( { 1{ M_252 } } & ( |imem_arg_MEMB32W65536_RD1 [11:7] ) )	// line#=computer.cpp:616,624,633,637,641
		| ( { 1{ FF_take_1_t_c1 } } & ( |M_244 ) )				// line#=computer.cpp:656
		...
		| ( { 1{ U_51 } } & CT_02 )						// line#=computer.cpp:616,747
		| ( { 1{ U_52 } } & CT_02 )						// line#=computer.cpp:755
		| ( { 1{ ST1_05d } } & ( ~incr3s1ot [2] ) )				// line#=computer.cpp:290
		) ;
	end
always @ ( posedge CLOCK )	// line#=computer.cpp:616,654,692,711
	FF_take_1 <= FF_take_1_t ;	// line#=computer.cpp:290,616,624,633,637
					// ,641,656,657,658,659,660,694,695
					// ,714,715,747,755
assign	M_265 = ~( M_266 | M_228 ) ;	// line#=computer.cpp:631
assign	M_266 = ( ( ( ( ( ( ( ( ( ( M_232 | M_224 ) | M_197 ) | M_203 ) | M_195 ) | 
	M_234 ) | M_207 ) | M_222 ) | M_217 ) | M_238 ) | M_226 ) ;	// line#=computer.cpp:631
assign	M_269 = ~( M_199 | M_219 ) ;	// line#=computer.cpp:744
assign	M_273 = ( M_228 & M_199 ) ;
assign	M_239 = ( M_273 & FF_take_1 ) ;
assign	M_277 = ( M_228 & M_219 ) ;
always @ ( FF_take_1 or M_277 or FF_take or M_239 )
	begin
	B_01_t_c1 = ( M_277 & FF_take_1 ) ;
	B_01_t = ( ( { 1{ M_239 } } & FF_take )
		| ( { 1{ B_01_t_c1 } } & 1'h1 ) ) ;
	end
always @ ( RG_cols_op1_PC_result1_word_addr or RG_11 or add32s1ot or take_t1 )	// line#=computer.cpp:662
	begin
	M_125_t_c1 = ~take_t1 ;
	M_125_t = ( ( { 31{ take_t1 } } & add32s1ot [31:1] )	// line#=computer.cpp:662
		| ( { 31{ M_125_t_c1 } } & { RG_11 [31:2] , RG_cols_op1_PC_result1_word_addr [1] } ) ) ;
	end
assign	JF_02 = ( ( ~M_239 ) & ( ~B_01_t ) ) ;
assign	JF_03 = ( ( ~M_239 ) & B_01_t ) ;
assign	JF_04 = ~incr3s1ot [2] ;	// line#=computer.cpp:290
...
assign	M_253 = ( U_11 | U_10 ) ;	// line#=computer.cpp:616,692
always @ ( RG_cols_op1_PC_result1_word_addr or U_57 or U_72 or regs_rd02 or U_58 or 
	U_85 or regs_rd00 or M_253 )
	begin
...
always @ ( M_233 or imem_arg_MEMB32W65536_RD1 or M_206 )
	TR_04 = ( ( { 5{ M_206 } } & imem_arg_MEMB32W65536_RD1 [11:7] )		// line#=computer.cpp:52,60,61,616,624
										// ,628,679
		| ( { 5{ M_233 } } & imem_arg_MEMB32W65536_RD1 [24:20] )	// line#=computer.cpp:52,56,616,627,666
		) ;
always @ ( M_203 or RL_addr_addr1_imm1_instr_next_pc or M_242 )
	M_284 = ( ( { 6{ M_242 } } & { RL_addr_addr1_imm1_instr_next_pc [0] , RL_addr_addr1_imm1_instr_next_pc [4:1] , 
			1'h0 } )												// line#=computer.cpp:52,65,66,67,628,652
																// ,662
		| ( { 6{ M_203 } } & { RL_addr_addr1_imm1_instr_next_pc [24] , RL_addr_addr1_imm1_instr_next_pc [17:13] } )	// line#=computer.cpp:52,56,627,646
		) ;
assign	M_242 = ( M_195 & take_t1 ) ;
always @ ( M_197 or M_284 or RL_addr_addr1_imm1_instr_next_pc or M_203 or M_242 )
	begin
	M_285_c1 = ( M_242 | M_203 ) ;	// line#=computer.cpp:52,56,65,66,67,627
					// ,628,646,652,662
	M_285 = ( ( { 14{ M_285_c1 } } & { RL_addr_addr1_imm1_instr_next_pc [24] , 
			RL_addr_addr1_imm1_instr_next_pc [24] , RL_addr_addr1_imm1_instr_next_pc [24] , 
			RL_addr_addr1_imm1_instr_next_pc [24] , RL_addr_addr1_imm1_instr_next_pc [24] , 
			RL_addr_addr1_imm1_instr_next_pc [24] , RL_addr_addr1_imm1_instr_next_pc [24] , 
			RL_addr_addr1_imm1_instr_next_pc [24] , M_284 } )	// line#=computer.cpp:52,56,65,66,67,627
										// ,628,646,652,662
		| ( { 14{ M_197 } } & { RL_addr_addr1_imm1_instr_next_pc [12:5] , 
			RL_addr_addr1_imm1_instr_next_pc [13] , RL_addr_addr1_imm1_instr_next_pc [17:14] , 
			1'h0 } )						// line#=computer.cpp:52,73,74,75,625,627
										// ,642
		) ;
	end
always @ ( M_285 or U_57 or U_58 or U_72 or RL_addr_addr1_imm1_instr_next_pc or 
	U_85 or TR_04 or imem_arg_MEMB32W65536_RD1 or M_253 )
	begin
	...
	add32s1i2 = ( ( { 21{ M_253 } } & { imem_arg_MEMB32W65536_RD1 [31] , imem_arg_MEMB32W65536_RD1 [31] , 
		...
		| ( { 21{ add32s1i2_c1 } } & { RL_addr_addr1_imm1_instr_next_pc [24] , 
			M_285 [13:5] , RL_addr_addr1_imm1_instr_next_pc [23:18] , 
			M_285 [4:0] } )										// line#=computer.cpp:52,56,65,66,67,73
														// ,74,75,625,627,628,642,646,652
														// ,662
		) ;
	end
always @ ( regs_rd03 or M_199 )
	TR_13 = ( { 8{ M_199 } } & regs_rd03 [15:8] )	// line#=computer.cpp:131,683
		 ;	// line#=computer.cpp:120,682
always @ ( regs_rd03 or TR_13 or M_257 or regs_rd02 or U_91 or regs_rd01 or U_44 )
...
assign	M_257 = ( U_82 | U_81 ) ;
always @ ( RL_addr_addr1_imm1_instr_next_pc or M_257 or RG_rs2 or U_91 or regs_rd00 or 
	U_44 )
	lsft32u1i2 = ( ( { 5{ U_44 } } & regs_rd00 [4:0] )					// line#=computer.cpp:710,713
		| ( { 5{ U_91 } } & RG_rs2 )							// line#=computer.cpp:699
		| ( { 5{ M_257 } } & { RL_addr_addr1_imm1_instr_next_pc [1:0] , 3'h0 } )	// line#=computer.cpp:118,119,120,129,130
												// ,131,682,683
		) ;
always @ ( dmem_arg_MEMB32W4096_RD1 or M_271 or regs_rd02 or M_274 or RG_cols_op1_PC_result1_word_addr or 
	M_275 )
	rsft32u1i1 = ( ( { 32{ M_275 } } & RG_cols_op1_PC_result1_word_addr )	// line#=computer.cpp:718,719,720
		| ( { 32{ M_274 } } & regs_rd02 )				// line#=computer.cpp:701,702,703
		| ( { 32{ M_271 } } & dmem_arg_MEMB32W4096_RD1 )		// line#=computer.cpp:90,91,100,101,669
										// ,670,672,673
		) ;
assign	M_271 = ( ( ( ( M_234 & M_209 ) | ( M_234 & M_205 ) ) | ( M_234 & M_199 ) ) | 
	( M_234 & M_213 ) ) ;
assign	M_274 = ( ( M_222 & M_209 ) & M_214 ) ;
assign	M_275 = ( ( M_217 & M_209 ) & M_214 ) ;
always @ ( RL_addr_addr1_imm1_instr_next_pc or M_271 or RG_rs2 or M_274 or RG_cols_op2 or 
	M_275 )
	rsft32u1i2 = ( ( { 5{ M_275 } } & RG_cols_op2 [4:0] )					// line#=computer.cpp:718,719,720
		| ( { 5{ M_274 } } & RG_rs2 )							// line#=computer.cpp:701,702,703
		| ( { 5{ M_271 } } & { RL_addr_addr1_imm1_instr_next_pc [1:0] , 3'h0 } )	// line#=computer.cpp:90,91,100,101,669
												// ,670,672,673
		) ;
always @ ( regs_rd02 or M_222 or RG_cols_op1_PC_result1_word_addr or M_217 )
	rsft32s1i1 = ( ( { 32{ M_217 } } & RG_cols_op1_PC_result1_word_addr )	// line#=computer.cpp:718,719,720
		| ( { 32{ M_222 } } & regs_rd02 )				// line#=computer.cpp:701,702,703
		) ;
always @ ( RG_rs2 or M_222 or RG_cols_op2 or M_217 )
	rsft32s1i2 = ( ( { 5{ M_217 } } & RG_cols_op2 [4:0] )	// line#=computer.cpp:718,719,720
		| ( { 5{ M_222 } } & RG_rs2 )			// line#=computer.cpp:701,702,703
		) ;
always @ ( add32s1ot or U_25 or U_26 or U_28 or U_29 or M_255 or RL_addr_addr1_imm1_instr_next_pc or 
	U_01 or RG_cols_op1_PC_result1_word_addr or U_96 or U_69 )
	begin
	addsub32u1i1_c1 = ( U_69 | U_96 ) ;	// line#=computer.cpp:70,637,712
	addsub32u1i1_c2 = ( M_255 | ( ( ( U_29 | U_28 ) | U_26 ) | U_25 ) ) ;	// line#=computer.cpp:52,56,61,85,95,113
										// ,124,666,679
...
always @ ( M_254 or RL_addr_addr1_imm1_instr_next_pc or U_69 )
	TR_14 = ( ( { 20{ U_69 } } & RL_addr_addr1_imm1_instr_next_pc [24:5] )	// line#=computer.cpp:70,637
		| ( { 20{ M_254 } } & 20'h00040 )				// line#=computer.cpp:85,95,113,124
		) ;
always @ ( U_01 or TR_14 or M_254 or U_69 )
	begin
	M_286_c1 = ( U_69 | M_254 ) ;	// line#=computer.cpp:70,85,95,113,124
					// ,637
...
always @ ( RG_cols_op2 or U_96 or M_286 or M_254 or M_250 )
	begin
	addsub32u1i2_c1 = ( M_250 | M_254 ) ;	// line#=computer.cpp:70,85,95,113,124
						// ,629,637
	addsub32u1i2 = ( ( { 32{ addsub32u1i2_c1 } } & { M_286 [20:1] , 9'h000 , 
			M_286 [0] , 2'h0 } )		// line#=computer.cpp:70,85,95,113,124
							// ,629,637
		| ( { 32{ U_96 } } & RG_cols_op2 )	// line#=computer.cpp:712
		) ;
	end
assign	M_250 = ( U_69 | U_01 ) ;
...
always @ ( RL_addr_addr1_imm1_instr_next_pc )	// line#=computer.cpp:712
	...
	endcase
always @ ( addsub32u1_f_t1 or U_96 or M_254 or M_250 )
...
always @ ( M_199 )
	M_279 = ( { 8{ M_199 } } & 8'hff )	// line#=computer.cpp:130
		 ;	// line#=computer.cpp:119
assign	lsft32u_321i1 = { M_279 , 8'hff } ;
...
assign	M_272 = ( M_213 | M_199 ) ;	// line#=computer.cpp:668,681
always @ ( regs_rd03 or M_219 or lsft32u1ot or lsft32u_321ot or dmem_arg_MEMB32W4096_RD1 or 
	M_272 )
	dmem_arg_MEMB32W4096_WD2 = ( ( { 32{ M_272 } } & ( ( dmem_arg_MEMB32W4096_RD1 & ( 
			~lsft32u_321ot ) ) | lsft32u1ot ) )	// line#=computer.cpp:119,120,130,131,682
								// ,683
		| ( { 32{ M_219 } } & regs_rd03 )		// line#=computer.cpp:139
		) ;
always @ ( addsub32u1ot or M_206 or M_208 or M_204 or M_198 or M_212 or add32s1ot or 
	M_218 or M_233 )
	begin
	dmem_arg_MEMB32W4096_RA1_c1 = ( M_233 & M_218 ) ;	// line#=computer.cpp:52,56,105,109,666
								// ,671
	dmem_arg_MEMB32W4096_RA1_c2 = ( ( ( ( ( ( M_233 & M_212 ) | ( M_233 & M_198 ) ) | 
		( M_233 & M_204 ) ) | ( M_233 & M_208 ) ) | ( M_206 & M_212 ) ) | 
		( M_206 & M_198 ) ) ;	// line#=computer.cpp:85,89,91,95,99,101
...
always @ ( RL_addr_addr1_imm1_instr_next_pc or M_219 or RG_cols_op1_PC_result1_word_addr or 
	M_272 )
	dmem_arg_MEMB32W4096_WA2 = ( ( { 12{ M_272 } } & RG_cols_op1_PC_result1_word_addr [11:0] )	// line#=computer.cpp:119,120,130,131
		| ( { 12{ M_219 } } & RL_addr_addr1_imm1_instr_next_pc [13:2] )				// line#=computer.cpp:135,139
		) ;
assign	dmem_arg_MEMB32W4096_RE1 = ( ( ( ( ( ( ( U_10 & M_218 ) | U_25 ) | U_26 ) | 
	U_28 ) | U_29 ) | U_31 ) | U_32 ) ;	// line#=computer.cpp:91,101,109,120,131
						// ,616,668,669,670,671,672,673
assign	dmem_arg_MEMB32W4096_WE2 = ( ( U_81 | U_82 ) | ( U_61 & M_219 ) ) ;	// line#=computer.cpp:119,120,130,131,139
										// ,681
always @ ( M_258 or M_259 or M_260 or M_262 or M_263 or M_264 or M_233 or M_206 or 
	M_218 or M_235 or M_221 or imem_arg_MEMB32W65536_RD1 or M_216 )
	begin
	regs_ad00_c1 = ( ( ( ( ( ( ( ( ( ( M_221 & M_235 ) | ( M_221 & M_218 ) ) | 
		M_206 ) | M_233 ) | M_264 ) | M_263 ) | M_262 ) | M_260 ) | M_259 ) | 
		M_258 ) ;	// line#=computer.cpp:616,626
	regs_ad00 = ( ( { 5{ M_216 } } & imem_arg_MEMB32W65536_RD1 [24:20] )	// line#=computer.cpp:616,627
		| ( { 5{ regs_ad00_c1 } } & imem_arg_MEMB32W65536_RD1 [19:15] )	// line#=computer.cpp:616,626
		) ;
	end
assign	M_258 = ( M_194 & M_212 ) ;
assign	M_259 = ( M_194 & M_198 ) ;
assign	M_260 = ( M_194 & M_204 ) ;
assign	M_262 = ( M_194 & M_208 ) ;
assign	M_263 = ( M_194 & M_229 ) ;
assign	M_264 = ( M_194 & M_210 ) ;
always @ ( M_258 or M_259 or M_260 or M_262 or M_263 or M_264 or imem_arg_MEMB32W65536_RD1 or 
	M_216 )
	begin
	regs_ad01_c1 = ( ( ( ( ( M_264 | M_263 ) | M_262 ) | M_260 ) | M_259 ) | 
		M_258 ) ;	// line#=computer.cpp:616,627
	regs_ad01 = ( ( { 5{ M_216 } } & imem_arg_MEMB32W65536_RD1 [19:15] )	// line#=computer.cpp:616,626
		| ( { 5{ regs_ad01_c1 } } & imem_arg_MEMB32W65536_RD1 [24:20] )	// line#=computer.cpp:616,627
		) ;
	end
always @ ( RG_06 or ST1_06d or RG_rd or M_256 )
	regs_ad04 = ( ( { 5{ M_256 } } & RG_rd )	// line#=computer.cpp:70,633,637,641,647
							// ,675,706,725,748
		| ( { 5{ ST1_06d } } & RG_06 )		// line#=computer.cpp:292,293,294,295
		) ;
assign	M_211 = ~|( RG_cols ^ 32'h00000007 ) ;
assign	M_230 = ~|( RG_cols ^ 32'h00000006 ) ;
assign	M_236 = ~|( RG_cols ^ 32'h00000003 ) ;
always @ ( rsft32u1ot or rsft32s1ot or RL_addr_addr1_imm1_instr_next_pc )	// line#=computer.cpp:701,702,703
	...
	default :
		TR_16 = 32'hx ;
	endcase
always @ ( bytes_rg00 or bytes_rg01 or bytes_rg02 or bytes_rg03 or ST1_06d or U_68 or 
	RG_cols_op2 or RG_cols_op1_PC_result1_word_addr or M_199 or addsub32u1ot or 
	U_69 or U_96 or RG_11 or U_70 or U_71 or TR_16 or M_209 or lsft32u1ot or 
	U_91 or M_211 or M_230 or RL_addr_addr1_imm1_instr_next_pc or M_205 or TR_15 or 
	U_63 or U_106 or M_236 or M_219 or U_62 or add32s1ot or U_85 or U_95 or 
	regs_rd02 or U_110 or val2_t4 or U_80 )	// line#=computer.cpp:692,711
	begin
	regs_wd04_c1 = ( U_95 & U_85 ) ;	// line#=computer.cpp:693
	regs_wd04_c2 = ( ( ( ( U_95 & ( U_62 & M_219 ) ) | ( U_95 & ( U_62 & M_236 ) ) ) | 
		( U_106 & ( U_63 & M_219 ) ) ) | ( U_106 & ( U_63 & M_236 ) ) ) ;
	regs_wd04_c3 = ( U_95 & ( U_62 & M_205 ) ) ;	// line#=computer.cpp:696
	regs_wd04_c4 = ( U_95 & ( U_62 & M_230 ) ) ;	// line#=computer.cpp:697
	regs_wd04_c5 = ( U_95 & ( U_62 & M_211 ) ) ;	// line#=computer.cpp:698
	regs_wd04_c6 = ( U_95 & U_91 ) ;	// line#=computer.cpp:699
	regs_wd04_c7 = ( U_95 & ( U_62 & M_209 ) ) ;	// line#=computer.cpp:701,702,703
	regs_wd04_c8 = ( U_71 | U_70 ) ;	// line#=computer.cpp:641,647
	regs_wd04_c9 = ( ( U_106 & U_96 ) | U_69 ) ;	// line#=computer.cpp:70,637,712
	regs_wd04_c10 = ( U_106 & ( U_63 & M_199 ) ) ;	// line#=computer.cpp:713
	regs_wd04_c11 = ( U_106 & ( U_63 & M_205 ) ) ;	// line#=computer.cpp:716
	regs_wd04_c12 = ( U_106 & ( U_63 & M_230 ) ) ;	// line#=computer.cpp:722
	regs_wd04_c13 = ( U_106 & ( U_63 & M_211 ) ) ;	// line#=computer.cpp:723
	regs_wd04_c14 = ( U_106 & ( U_63 & M_209 ) ) ;	// line#=computer.cpp:718,719,720
	regs_wd04 = ( ( { 32{ U_80 } } & val2_t4 )								// line#=computer.cpp:675
		| ( { 32{ U_110 } } & regs_rd02 )								// line#=computer.cpp:748
		| ( { 32{ regs_wd04_c1 } } & add32s1ot )							// line#=computer.cpp:693
		| ( { 32{ regs_wd04_c2 } } & { 31'h00000000 , TR_15 } )
		| ( { 32{ regs_wd04_c3 } } & ( regs_rd02 ^ { RL_addr_addr1_imm1_instr_next_pc [11] , 
			RL_addr_addr1_imm1_instr_next_pc [11] , RL_addr_addr1_imm1_instr_next_pc [11] , 
			RL_addr_addr1_imm1_instr_next_pc [11] , RL_addr_addr1_imm1_instr_next_pc [11] , 
			RL_addr_addr1_imm1_instr_next_pc [11] , RL_addr_addr1_imm1_instr_next_pc [11] , 
			RL_addr_addr1_imm1_instr_next_pc [11] , RL_addr_addr1_imm1_instr_next_pc [11] , 
		...
		| ( { 32{ regs_wd04_c8 } } & RG_11 )								// line#=computer.cpp:641,647
		| ( { 32{ regs_wd04_c9 } } & addsub32u1ot )							// line#=computer.cpp:70,637,712
		| ( { 32{ regs_wd04_c10 } } & RG_cols_op1_PC_result1_word_addr )				// line#=computer.cpp:713
		| ( { 32{ regs_wd04_c11 } } & ( RG_cols_op1_PC_result1_word_addr ^ 
		...
		| ( { 32{ U_68 } } & { RL_addr_addr1_imm1_instr_next_pc [24:5] , 
			12'h000 } )										// line#=computer.cpp:70,633
		| ( { 32{ ST1_06d } } & { bytes_rg03 , bytes_rg02 , bytes_rg01 , 
			bytes_rg00 } )										// line#=computer.cpp:292,293,294,295
		) ;
	end
assign	M_256 = ( ( ( ( ( ( ( U_80 | U_110 ) | U_95 ) | U_71 ) | U_106 ) | U_69 ) | 
	U_70 ) | U_68 ) ;
