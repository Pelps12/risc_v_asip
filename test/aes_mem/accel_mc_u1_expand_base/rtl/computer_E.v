...
// bdlpars options:  -EE -DAES_MEM -DACCEL_MIX_COL -DACCEL_EXPAND_ENC_KEY -DACCEL_MIX_COL_U1 -info_base_name computer computer.cpp
// bdltran options:  -EE computer.IFF -c1000 -s -Zresource_fcnt=GENERATE -Zresource_mcnt=GENERATE -Zsync -Zdup_reset=YES -Zfolding_sharing=inter_stage -lb /proj/cad/cwb-6.1/packages/asic_45.BLIB -lfl /proj/cad/cwb-6.1/packages/asic_45.FLIB -o-P 
// timestamp_0: 20260604024943_93563_24704
// timestamp_5: 20260604024943_93577_01416
// timestamp_9: 20260604024943_93577_52147
// timestamp_C: 20260604024943_93577_66232
// timestamp_E: 20260604024944_93577_72557
// timestamp_V: 20260604024944_93591_86103
...
wire		RG_regs_1_en ;
wire		RG_words_5_en ;
wire		RG_op2_regs_word_addr_words_en ;
wire		RG_mask_op1_regs_result1_words_en ;
wire		RG_rs2_en ;
...
reg	[31:0]	RG_regs_2 ;	// line#=computer.cpp:20
reg	[31:0]	RG_imm1_instr_regs ;	// line#=computer.cpp:20,689
...
reg	[31:0]	RG_op2_regs_word_addr_words ;	// line#=computer.cpp:20,117,128,312,710
reg	[31:0]	RG_mask_op1_regs_result1_words ;	// line#=computer.cpp:20,119,312,710
...
reg	TR_02_c1 ;
reg	TR_02_c2 ;
reg	[31:0]	RG_imm1_instr_regs_t ;
reg	[31:0]	RG_imm1_instr_regs_t1 ;
reg	RG_imm1_instr_regs_t_c1 ;
reg	RG_imm1_instr_regs_t_c2 ;
reg	[31:0]	RG_words_5_t ;
reg	RG_words_5_t_c1 ;
reg	[31:0]	RG_op2_regs_word_addr_words_t ;
reg	RG_op2_regs_word_addr_words_t_c1 ;
reg	[31:0]	RG_mask_op1_regs_result1_words_t ;
reg	RG_mask_op1_regs_result1_words_t_c1 ;
reg	[7:0]	RG_rs1_t ;
reg	RG_rs1_t_c1 ;
reg	[7:0]	RG_rs2_t ;
reg	RG_rs2_t_c1 ;
...
always @ ( RG_rc_rd or M_01 or U_112 or regs_wd04 or regs_d04 or regs_we04 )	// line#=computer.cpp:20
	begin
	regs_rg05_t_c1 = ( regs_we04 & regs_d04 [26] ) ;
	regs_rg05_t_c2 = ( U_112 & M_01 ) ;	// line#=computer.cpp:338
...
always @ ( cols_rg00 or ST1_06d or RG_words_4 or M_02 or U_112 or regs_wd04 or regs_d04 or 
	regs_we04 )	// line#=computer.cpp:20
	begin
	regs_rg10_t_c1 = ( regs_we04 & regs_d04 [21] ) ;
	regs_rg10_t_c2 = ( U_112 & M_02 ) ;	// line#=computer.cpp:336
	regs_rg10_t_c3 = ( ST1_06d & M_02 ) ;	// line#=computer.cpp:189
	regs_rg10_t = ( ( { 32{ regs_rg10_t_c1 } } & regs_wd04 )
		| ( { 32{ regs_rg10_t_c2 } } & RG_words_4 )	// line#=computer.cpp:336
		| ( { 32{ regs_rg10_t_c3 } } & cols_rg00 )	// line#=computer.cpp:189
		) ;
	end
...
always @ ( cols_rg01 or ST1_06d or RG_words_5 or M_03 or U_112 or regs_wd04 or regs_d04 or 
	regs_we04 )	// line#=computer.cpp:20
	begin
	regs_rg11_t_c1 = ( regs_we04 & regs_d04 [20] ) ;
	regs_rg11_t_c2 = ( U_112 & M_03 ) ;	// line#=computer.cpp:336
	regs_rg11_t_c3 = ( ST1_06d & M_03 ) ;	// line#=computer.cpp:189
	regs_rg11_t = ( ( { 32{ regs_rg11_t_c1 } } & regs_wd04 )
		| ( { 32{ regs_rg11_t_c2 } } & RG_words_5 )	// line#=computer.cpp:336
		| ( { 32{ regs_rg11_t_c3 } } & cols_rg01 )	// line#=computer.cpp:189
		) ;
	end
...
always @ ( cols_rg02 or ST1_06d or RG_op2_regs_word_addr_words or M_04 or U_112 or 
	regs_wd04 or regs_d04 or regs_we04 )	// line#=computer.cpp:20
	begin
	regs_rg12_t_c1 = ( regs_we04 & regs_d04 [19] ) ;
	regs_rg12_t_c2 = ( U_112 & M_04 ) ;	// line#=computer.cpp:336
	regs_rg12_t_c3 = ( ST1_06d & M_04 ) ;	// line#=computer.cpp:189
	regs_rg12_t = ( ( { 32{ regs_rg12_t_c1 } } & regs_wd04 )
		| ( { 32{ regs_rg12_t_c2 } } & RG_op2_regs_word_addr_words )	// line#=computer.cpp:336
		| ( { 32{ regs_rg12_t_c3 } } & cols_rg02 )			// line#=computer.cpp:189
		) ;
	end
...
always @ ( cols_rg03 or ST1_06d or RG_mask_op1_regs_result1_words or M_05 or U_112 or 
	regs_wd04 or regs_d04 or regs_we04 )	// line#=computer.cpp:20
	begin
	regs_rg13_t_c1 = ( regs_we04 & regs_d04 [18] ) ;
	regs_rg13_t_c2 = ( U_112 & M_05 ) ;	// line#=computer.cpp:336
	regs_rg13_t_c3 = ( ST1_06d & M_05 ) ;	// line#=computer.cpp:189
	regs_rg13_t = ( ( { 32{ regs_rg13_t_c1 } } & regs_wd04 )
		| ( { 32{ regs_rg13_t_c2 } } & RG_mask_op1_regs_result1_words )	// line#=computer.cpp:336
		| ( { 32{ regs_rg13_t_c3 } } & cols_rg03 )			// line#=computer.cpp:189
		) ;
	end
...
always @ ( posedge CLOCK )	// line#=computer.cpp:20
	if ( RESET )
		...
		regs_rg13 <= regs_rg13_t ;	// line#=computer.cpp:20,189,336
assign	M_06 = ~( regs_we04 & regs_d04 [17] ) ;
always @ ( words_a04_t or M_06 or U_112 or regs_wd04 or regs_d04 or regs_we04 )	// line#=computer.cpp:20
	begin
	regs_rg14_t_c1 = ( regs_we04 & regs_d04 [17] ) ;
	regs_rg14_t_c2 = ( U_112 & M_06 ) ;	// line#=computer.cpp:337
	regs_rg14_t = ( ( { 32{ regs_rg14_t_c1 } } & regs_wd04 )
		| ( { 32{ regs_rg14_t_c2 } } & words_a04_t )	// line#=computer.cpp:337
		) ;
	end
...
always @ ( words_a05_t or M_07 or U_112 or regs_wd04 or regs_d04 or regs_we04 )	// line#=computer.cpp:20
	begin
	regs_rg15_t_c1 = ( regs_we04 & regs_d04 [16] ) ;
	regs_rg15_t_c2 = ( U_112 & M_07 ) ;	// line#=computer.cpp:337
	regs_rg15_t = ( ( { 32{ regs_rg15_t_c1 } } & regs_wd04 )
		| ( { 32{ regs_rg15_t_c2 } } & words_a05_t )	// line#=computer.cpp:337
		) ;
	end
...
always @ ( words_a06_t or M_08 or U_112 or regs_wd04 or regs_d04 or regs_we04 )	// line#=computer.cpp:20
	begin
	regs_rg16_t_c1 = ( regs_we04 & regs_d04 [15] ) ;
	regs_rg16_t_c2 = ( U_112 & M_08 ) ;	// line#=computer.cpp:337
	regs_rg16_t = ( ( { 32{ regs_rg16_t_c1 } } & regs_wd04 )
		| ( { 32{ regs_rg16_t_c2 } } & words_a06_t )	// line#=computer.cpp:337
		) ;
	end
...
always @ ( words_a06_t or RG_words_3 or M_09 or U_112 or regs_wd04 or regs_d04 or 
	regs_we04 )	// line#=computer.cpp:20
	begin
	regs_rg17_t_c1 = ( regs_we04 & regs_d04 [14] ) ;
	regs_rg17_t_c2 = ( U_112 & M_09 ) ;	// line#=computer.cpp:335,337
	regs_rg17_t = ( ( { 32{ regs_rg17_t_c1 } } & regs_wd04 )
		| ( { 32{ regs_rg17_t_c2 } } & ( RG_words_3 ^ words_a06_t ) )	// line#=computer.cpp:335,337
		) ;
	end
...
always @ ( cols_rg03 or cols_rg02 or cols_rg01 or cols_rg00 or RG_i )	// line#=computer.cpp:179
	...
	default :
		cols_rd00 = 32'hx ;
	endcase
assign	M_10 = ~( ST1_05d & cols_d01 [3] ) ;
always @ ( RG_regs or M_10 or U_110 or M_198 or M_197 or M_196 or M_195 or cols_d01 or 
	ST1_05d )	// line#=computer.cpp:164,170,171,172,173
			// ,175,179,188
	begin
	cols_rg00_t_c1 = ( ST1_05d & cols_d01 [3] ) ;	// line#=computer.cpp:164,165,166,167,170
							// ,171,172,173,175,188
	cols_rg00_t_c2 = ( U_110 & M_10 ) ;	// line#=computer.cpp:179
	cols_rg00_t = ( ( { 32{ cols_rg00_t_c1 } } & { M_195 , M_196 , M_197 , M_198 } )	// line#=computer.cpp:164,165,166,167,170
												// ,171,172,173,175,188
		| ( { 32{ cols_rg00_t_c2 } } & RG_regs )					// line#=computer.cpp:179
		) ;
	end
...
assign	M_11 = ~( ST1_05d & cols_d01 [2] ) ;
always @ ( RG_regs_1 or M_11 or U_110 or M_198 or M_197 or M_196 or M_195 or cols_d01 or 
	ST1_05d )	// line#=computer.cpp:164,170,171,172,173
			// ,175,179,188
	begin
	cols_rg01_t_c1 = ( ST1_05d & cols_d01 [2] ) ;	// line#=computer.cpp:164,165,166,167,170
							// ,171,172,173,175,188
	cols_rg01_t_c2 = ( U_110 & M_11 ) ;	// line#=computer.cpp:179
	cols_rg01_t = ( ( { 32{ cols_rg01_t_c1 } } & { M_195 , M_196 , M_197 , M_198 } )	// line#=computer.cpp:164,165,166,167,170
												// ,171,172,173,175,188
		| ( { 32{ cols_rg01_t_c2 } } & RG_regs_1 )					// line#=computer.cpp:179
		) ;
	end
...
always @ ( posedge CLOCK )	// line#=computer.cpp:164,170,171,172,173
	...
	if ( RESET )
		...
		cols_rg01 <= cols_rg01_t ;	// line#=computer.cpp:164,165,166,167,170
						// ,171,172,173,175,179,188
assign	M_12 = ~( ST1_05d & cols_d01 [1] ) ;
always @ ( RG_op2_regs_word_addr_words or M_12 or U_110 or M_198 or M_197 or M_196 or 
	M_195 or cols_d01 or ST1_05d )	// line#=computer.cpp:164,170,171,172,173
					// ,175,179,188
	begin
	cols_rg02_t_c1 = ( ST1_05d & cols_d01 [1] ) ;	// line#=computer.cpp:164,165,166,167,170
							// ,171,172,173,175,188
	cols_rg02_t_c2 = ( U_110 & M_12 ) ;	// line#=computer.cpp:179
	cols_rg02_t = ( ( { 32{ cols_rg02_t_c1 } } & { M_195 , M_196 , M_197 , M_198 } )	// line#=computer.cpp:164,165,166,167,170
												// ,171,172,173,175,188
		| ( { 32{ cols_rg02_t_c2 } } & RG_op2_regs_word_addr_words )			// line#=computer.cpp:179
		) ;
	end
...
always @ ( posedge CLOCK )	// line#=computer.cpp:164,170,171,172,173
	...
	if ( RESET )
		...
		cols_rg02 <= cols_rg02_t ;	// line#=computer.cpp:164,165,166,167,170
						// ,171,172,173,175,179,188
assign	M_13 = ~( ST1_05d & cols_d01 [0] ) ;
always @ ( RG_mask_op1_regs_result1_words or M_13 or U_110 or M_198 or M_197 or 
	M_196 or M_195 or cols_d01 or ST1_05d )	// line#=computer.cpp:164,170,171,172,173
						// ,175,179,188
	begin
	cols_rg03_t_c1 = ( ST1_05d & cols_d01 [0] ) ;	// line#=computer.cpp:164,165,166,167,170
							// ,171,172,173,175,188
	cols_rg03_t_c2 = ( U_110 & M_13 ) ;	// line#=computer.cpp:179
	cols_rg03_t = ( ( { 32{ cols_rg03_t_c1 } } & { M_195 , M_196 , M_197 , M_198 } )	// line#=computer.cpp:164,165,166,167,170
												// ,171,172,173,175,188
		| ( { 32{ cols_rg03_t_c2 } } & RG_mask_op1_regs_result1_words )			// line#=computer.cpp:179
		) ;
	end
...
always @ ( posedge CLOCK )	// line#=computer.cpp:164,170,171,172,173
	...
	if ( RESET )
		...
		cols_rg03 <= cols_rg03_t ;	// line#=computer.cpp:164,165,166,167,170
						// ,171,172,173,175,179,188
assign	words_a00_t = ( { regs_rg10 [31:8] , ( regs_rg10 [7:0] ^ regs_rg05 [7:0] ) } ^ 
	{ accel_sbox1ot , accel_sbox2ot , accel_sbox4ot , accel_sbox3ot } ) ;	// line#=computer.cpp:243,244,245,246,312
										// ,313,314,315
assign	words_a01_t = ( regs_rg11 ^ words_a00_t ) ;	// line#=computer.cpp:312,325
assign	words_a02_t = ( regs_rg12 ^ words_a01_t ) ;	// line#=computer.cpp:312,325
assign	words_a03_t = ( regs_rg13 ^ words_a02_t ) ;	// line#=computer.cpp:312,325
assign	CT_01 = ( ( ~FF_halt ) & ( ~|RG_addr_addr1_next_pc_PC [31:18] ) ) ;	// line#=computer.cpp:615
assign	CT_01_port = CT_01 ;
assign	CT_02 = ~|imem_arg_MEMB32W65536_RD1 [31:25] ;	// line#=computer.cpp:616,755,773
...
always @ ( dmem_arg_MEMB32W4096_RD1 or rsft32u1ot or RG_words_5 )	// line#=computer.cpp:668
	...
	endcase
assign	words_a04_t = ( RG_words ^ { accel_sbox2ot , RG_rs2 , accel_sbox1ot , RG_rs1 } ) ;	// line#=computer.cpp:243,244,245,246,326
assign	words_a05_t = ( RG_words_1 ^ words_a04_t ) ;	// line#=computer.cpp:335
assign	words_a06_t = ( RG_words_2 ^ words_a05_t ) ;	// line#=computer.cpp:335
always @ ( FF_take )	// line#=computer.cpp:694
	...
	default :
		TR_18 = 1'hx ;
	endcase
assign	e_t = ( M_141_t ^ M_139_t ) ;	// line#=computer.cpp:164,165,166,167,168
					// ,188
always @ ( M_145_t or M_141_t )	// line#=computer.cpp:164,170
	case ( M_141_t [7] )
	1'h1 :
		M_290 = { ~M_145_t [3:2] , ~M_145_t [0] , 1'h1 } ;	// line#=computer.cpp:164,170
	1'h0 :
		M_290 = { M_145_t [3:2] , M_145_t [0] , 1'h0 } ;	// line#=computer.cpp:164,165,170,188
	default :
		M_290 = 4'hx ;
	endcase
always @ ( M_144_t or M_140_t )	// line#=computer.cpp:171
	case ( M_140_t [7] )
	1'h1 :
		M_288 = { ~M_144_t [3:2] , ~M_144_t [0] , 1'h1 } ;	// line#=computer.cpp:171
	1'h0 :
		M_288 = { M_144_t [3:2] , M_144_t [0] , 1'h0 } ;	// line#=computer.cpp:165,166,171,188
	default :
		M_288 = 4'hx ;
	endcase
always @ ( M_143_t or M_139_t )	// line#=computer.cpp:172
	case ( M_139_t [7] )
	1'h1 :
		M_287 = { ~M_143_t [3:2] , ~M_143_t [0] , 1'h1 } ;	// line#=computer.cpp:172
	1'h0 :
		M_287 = { M_143_t [3:2] , M_143_t [0] , 1'h0 } ;	// line#=computer.cpp:166,167,172,188
	default :
		M_287 = 4'hx ;
	endcase
always @ ( M_142_t or M_138_t )	// line#=computer.cpp:164,173
	case ( M_138_t [7] )
	1'h1 :
		M_289 = { ~M_142_t [3:2] , ~M_142_t [0] , 1'h1 } ;	// line#=computer.cpp:164,173
	1'h0 :
		M_289 = { M_142_t [3:2] , M_142_t [0] , 1'h0 } ;	// line#=computer.cpp:164,167,173,188
	default :
		M_289 = 4'hx ;
	endcase
assign	M_138_t = ( cols_rd00 [31:24] ^ cols_rd00 [7:0] ) ;	// line#=computer.cpp:164,167,173,188
assign	M_139_t = ( cols_rd00 [23:16] ^ cols_rd00 [31:24] ) ;	// line#=computer.cpp:164,165,166,167,168
								// ,172,188
assign	M_140_t = ( cols_rd00 [15:8] ^ cols_rd00 [23:16] ) ;	// line#=computer.cpp:165,166,171,188
assign	M_141_t = ( cols_rd00 [7:0] ^ cols_rd00 [15:8] ) ;	// line#=computer.cpp:164,165,166,167,168
								// ,170,188
assign	M_142_t = ( cols_rd00 [30:24] ^ cols_rd00 [6:0] ) ;	// line#=computer.cpp:164,167,173,188
assign	M_143_t = ( cols_rd00 [22:16] ^ cols_rd00 [30:24] ) ;	// line#=computer.cpp:166,167,172,188
assign	M_144_t = ( cols_rd00 [14:8] ^ cols_rd00 [22:16] ) ;	// line#=computer.cpp:165,166,171,188
assign	M_145_t = ( cols_rd00 [6:0] ^ cols_rd00 [14:8] ) ;	// line#=computer.cpp:164,165,170,188
...
assign	accel_sbox4i1 = regs_rg17 [23:16] ;	// line#=computer.cpp:243,244,245,246,312
						// ,314,315
assign	accel_sbox5i1 = words_a03_t [23:16] ;	// line#=computer.cpp:243,244,245,246,326
...
assign	cols_ad01 = RG_i [1:0] ;	// line#=computer.cpp:164,170,171,172,173
					// ,175,188
assign	M_195 = ( ( cols_rd00 [31:24] ^ e_t ) ^ { M_142_t [6:4] , M_289 [3:2] , M_142_t [1] , 
	M_289 [1:0] } ) ;	// line#=computer.cpp:164,165,166,167,170
				// ,171,172,173,175,188
assign	M_196 = ( ( cols_rd00 [23:16] ^ e_t ) ^ { M_143_t [6:4] , M_287 [3:2] , M_143_t [1] , 
	M_287 [1:0] } ) ;	// line#=computer.cpp:164,165,166,167,170
				// ,171,172,173,175,188
assign	M_197 = ( ( cols_rd00 [15:8] ^ e_t ) ^ { M_144_t [6:4] , M_288 [3:2] , M_144_t [1] , 
	M_288 [1:0] } ) ;	// line#=computer.cpp:164,165,166,167,170
				// ,171,172,173,175,188
assign	M_198 = ( ( cols_rd00 [7:0] ^ e_t ) ^ { M_145_t [6:4] , M_290 [3:2] , M_145_t [1] , 
	M_290 [1:0] } ) ;	// line#=computer.cpp:164,165,166,167,170
				// ,171,172,173,175,188
assign	U_01 = ( ST1_02d & CT_01 ) ;	// line#=computer.cpp:615
assign	U_05 = ( ST1_03d & M_249 ) ;	// line#=computer.cpp:616,623,631
assign	U_06 = ( ST1_03d & M_241 ) ;	// line#=computer.cpp:616,623,631
assign	U_07 = ( ST1_03d & M_213 ) ;	// line#=computer.cpp:616,623,631
assign	U_08 = ( ST1_03d & M_219 ) ;	// line#=computer.cpp:616,623,631
assign	U_09 = ( ST1_03d & M_211 ) ;	// line#=computer.cpp:616,623,631
assign	U_10 = ( ST1_03d & M_252 ) ;	// line#=computer.cpp:616,623,631
assign	U_11 = ( ST1_03d & M_223 ) ;	// line#=computer.cpp:616,623,631
assign	U_12 = ( ST1_03d & M_239 ) ;	// line#=computer.cpp:616,623,631
assign	U_13 = ( ST1_03d & M_234 ) ;	// line#=computer.cpp:616,623,631
assign	U_16 = ( ST1_03d & M_245 ) ;	// line#=computer.cpp:616,623,631
assign	M_211 = ~|( { 25'h0000000 , imem_arg_MEMB32W65536_RD1 [6:0] } ^ 32'h00000063 ) ;	// line#=computer.cpp:616,623,631
assign	M_213 = ~|( { 25'h0000000 , imem_arg_MEMB32W65536_RD1 [6:0] } ^ 32'h0000006f ) ;	// line#=computer.cpp:616,623,631
assign	M_219 = ~|( { 25'h0000000 , imem_arg_MEMB32W65536_RD1 [6:0] } ^ 32'h00000067 ) ;	// line#=computer.cpp:616,623,631
assign	M_223 = ~|( { 25'h0000000 , imem_arg_MEMB32W65536_RD1 [6:0] } ^ 32'h00000023 ) ;	// line#=computer.cpp:616,623,631
assign	M_234 = ~|( { 25'h0000000 , imem_arg_MEMB32W65536_RD1 [6:0] } ^ 32'h00000033 ) ;	// line#=computer.cpp:616,623,631
assign	M_239 = ~|( { 25'h0000000 , imem_arg_MEMB32W65536_RD1 [6:0] } ^ 32'h00000013 ) ;	// line#=computer.cpp:616,623,631
assign	M_241 = ~|( { 25'h0000000 , imem_arg_MEMB32W65536_RD1 [6:0] } ^ 32'h00000017 ) ;	// line#=computer.cpp:616,623,631
assign	M_245 = ~|( { 25'h0000000 , imem_arg_MEMB32W65536_RD1 [6:0] } ^ 32'h0000000b ) ;	// line#=computer.cpp:616,623,631
assign	M_249 = ~|( { 25'h0000000 , imem_arg_MEMB32W65536_RD1 [6:0] } ^ 32'h00000037 ) ;	// line#=computer.cpp:616,623,631
assign	M_252 = ~|( { 25'h0000000 , imem_arg_MEMB32W65536_RD1 [6:0] } ^ 32'h00000003 ) ;	// line#=computer.cpp:616,623,631
assign	M_215 = ~|( { 29'h00000000 , imem_arg_MEMB32W65536_RD1 [14:12] } ^ 32'h00000001 ) ;	// line#=computer.cpp:616,654,668,681,692
												// ,711
assign	M_221 = ~|( { 29'h00000000 , imem_arg_MEMB32W65536_RD1 [14:12] } ^ 32'h00000004 ) ;	// line#=computer.cpp:616,654,668,692,711
assign	M_225 = ~|( { 29'h00000000 , imem_arg_MEMB32W65536_RD1 [14:12] } ^ 32'h00000005 ) ;	// line#=computer.cpp:616,654,668,692,711
												// ,744
assign	M_228 = ~|( { 29'h00000000 , imem_arg_MEMB32W65536_RD1 [14:12] } ^ 32'h00000007 ) ;	// line#=computer.cpp:616,654,692,711
assign	M_230 = ~|{ 29'h00000000 , imem_arg_MEMB32W65536_RD1 [14:12] } ;	// line#=computer.cpp:616,654,668,681,692
										// ,711
assign	M_247 = ~|( { 29'h00000000 , imem_arg_MEMB32W65536_RD1 [14:12] } ^ 32'h00000006 ) ;	// line#=computer.cpp:616,654,692,711
assign	U_25 = ( U_10 & M_230 ) ;	// line#=computer.cpp:616,668
assign	U_26 = ( U_10 & M_215 ) ;	// line#=computer.cpp:616,668
assign	U_28 = ( U_10 & M_221 ) ;	// line#=computer.cpp:616,668
assign	U_29 = ( U_10 & M_225 ) ;	// line#=computer.cpp:616,668
assign	M_236 = ~|( { 29'h00000000 , imem_arg_MEMB32W65536_RD1 [14:12] } ^ 32'h00000002 ) ;	// line#=computer.cpp:616,668,681,692,711
												// ,744
assign	U_31 = ( U_11 & M_230 ) ;	// line#=computer.cpp:616,681
assign	U_32 = ( U_11 & M_215 ) ;	// line#=computer.cpp:616,681
assign	U_44 = ( U_13 & M_215 ) ;	// line#=computer.cpp:616,711
assign	U_51 = ( U_16 & M_236 ) ;	// line#=computer.cpp:616,744
assign	U_52 = ( U_16 & M_225 ) ;	// line#=computer.cpp:616,744
assign	U_55 = ( ST1_04d & M_250 ) ;	// line#=computer.cpp:631
assign	U_56 = ( ST1_04d & M_242 ) ;	// line#=computer.cpp:631
assign	U_57 = ( ST1_04d & M_214 ) ;	// line#=computer.cpp:631
assign	U_58 = ( ST1_04d & M_220 ) ;	// line#=computer.cpp:631
assign	U_59 = ( ST1_04d & M_212 ) ;	// line#=computer.cpp:631
assign	U_60 = ( ST1_04d & M_253 ) ;	// line#=computer.cpp:631
assign	U_61 = ( ST1_04d & M_224 ) ;	// line#=computer.cpp:631
assign	U_62 = ( ST1_04d & M_240 ) ;	// line#=computer.cpp:631
assign	U_63 = ( ST1_04d & M_235 ) ;	// line#=computer.cpp:631
assign	U_65 = ( ST1_04d & M_244 ) ;	// line#=computer.cpp:631
assign	U_66 = ( ST1_04d & M_246 ) ;	// line#=computer.cpp:631
assign	M_212 = ~|( RG_regs_2 ^ 32'h00000063 ) ;	// line#=computer.cpp:631
assign	M_214 = ~|( RG_regs_2 ^ 32'h0000006f ) ;	// line#=computer.cpp:631
assign	M_220 = ~|( RG_regs_2 ^ 32'h00000067 ) ;	// line#=computer.cpp:631
assign	M_224 = ~|( RG_regs_2 ^ 32'h00000023 ) ;	// line#=computer.cpp:631
assign	M_235 = ~|( RG_regs_2 ^ 32'h00000033 ) ;	// line#=computer.cpp:631
assign	M_240 = ~|( RG_regs_2 ^ 32'h00000013 ) ;	// line#=computer.cpp:631
assign	M_242 = ~|( RG_regs_2 ^ 32'h00000017 ) ;	// line#=computer.cpp:631
assign	M_244 = ~|( RG_regs_2 ^ 32'h00000073 ) ;	// line#=computer.cpp:631
assign	M_246 = ~|( RG_regs_2 ^ 32'h0000000b ) ;	// line#=computer.cpp:631
assign	M_250 = ~|( RG_regs_2 ^ 32'h00000037 ) ;	// line#=computer.cpp:631
assign	M_253 = ~|( RG_regs_2 ^ 32'h00000003 ) ;	// line#=computer.cpp:631
assign	M_257 = ~|( RG_regs_2 ^ 32'h0000000f ) ;	// line#=computer.cpp:631
assign	U_67 = ( ST1_04d & ( ~( ( ( ( ( ( ( ( ( ( ( M_250 | M_242 ) | M_214 ) | M_220 ) | 
	M_212 ) | M_253 ) | M_224 ) | M_240 ) | M_235 ) | M_257 ) | M_244 ) | M_246 ) ) ) ;	// line#=computer.cpp:631
assign	U_69 = ( U_56 & FF_take ) ;	// line#=computer.cpp:637
assign	U_72 = ( U_59 & take_t1 ) ;	// line#=computer.cpp:662
assign	M_216 = ~|( RG_words_5 ^ 32'h00000001 ) ;	// line#=computer.cpp:668,692
assign	M_222 = ~|( RG_words_5 ^ 32'h00000004 ) ;	// line#=computer.cpp:668
assign	M_226 = ~|( RG_words_5 ^ 32'h00000005 ) ;	// line#=computer.cpp:668,692,711
assign	M_231 = ~|RG_words_5 ;	// line#=computer.cpp:668,692,711
assign	M_237 = ~|( RG_words_5 ^ 32'h00000002 ) ;	// line#=computer.cpp:668
assign	M_258 = |RG_rc_rd [4:0] ;	// line#=computer.cpp:647,675,706,725
assign	U_82 = ( U_61 & M_217 ) ;	// line#=computer.cpp:681
assign	M_217 = ~|( RG_imm1_instr_regs ^ 32'h00000001 ) ;	// line#=computer.cpp:681
assign	M_232 = ~|RG_imm1_instr_regs ;	// line#=computer.cpp:681
assign	M_238 = ~|( RG_imm1_instr_regs ^ 32'h00000002 ) ;	// line#=computer.cpp:681,744
assign	U_85 = ( U_62 & M_231 ) ;	// line#=computer.cpp:692
assign	U_91 = ( U_62 & M_216 ) ;	// line#=computer.cpp:692
assign	U_96 = ( U_63 & M_231 ) ;	// line#=computer.cpp:711
assign	M_233 = ~RG_imm1_instr_regs [23] ;	// line#=computer.cpp:701,702,703,718,719
						// ,720
assign	U_107 = ( U_66 & M_238 ) ;	// line#=computer.cpp:744
assign	U_108 = ( U_66 & M_227 ) ;	// line#=computer.cpp:744
assign	M_227 = ~|( RG_imm1_instr_regs ^ 32'h00000005 ) ;	// line#=computer.cpp:744
assign	U_110 = ( U_107 & FF_take ) ;	// line#=computer.cpp:755
assign	U_112 = ( U_108 & FF_take ) ;	// line#=computer.cpp:773
always @ ( add32s1ot or M_223 )
	TR_14 = ( { 12{ M_223 } } & add32s1ot [13:2] )	// line#=computer.cpp:52,61,679
		 ;	// line#=computer.cpp:52,56,666
assign	M_261 = ( ST1_04d & U_57 ) ;
always @ ( add32s1ot or M_261 or TR_14 or M_265 )
	TR_01 = ( ( { 30{ M_265 } } & { 18'h00000 , TR_14 } )	// line#=computer.cpp:52,56,61,666,679
		| ( { 30{ M_261 } } & add32s1ot [31:2] )	// line#=computer.cpp:52,75,642
		) ;
always @ ( RG_addr_addr1_next_pc_PC or M_133_t or U_59 or U_58 or RG_03 or U_67 or 
	U_66 or U_65 or M_257 or U_63 or U_62 or U_61 or U_60 or U_56 or U_55 or 
	ST1_04d or add32s1ot or TR_01 or M_261 or M_265 )	// line#=computer.cpp:631
	begin
	RG_addr_addr1_next_pc_PC_t_c1 = ( M_265 | M_261 ) ;	// line#=computer.cpp:52,56,61,75,642,666
								// ,679
	RG_addr_addr1_next_pc_PC_t_c2 = ( ST1_04d & ( ( ( ( ( ( ( ( ( U_55 | U_56 ) | 
		U_60 ) | U_61 ) | U_62 ) | U_63 ) | ( ST1_04d & M_257 ) ) | U_65 ) | 
	...
	RG_addr_addr1_next_pc_PC_t = ( ( { 32{ RG_addr_addr1_next_pc_PC_t_c1 } } & 
			{ TR_01 , add32s1ot [1:0] } )			// line#=computer.cpp:52,56,61,75,642,666
									// ,679
		| ( { 32{ RG_addr_addr1_next_pc_PC_t_c2 } } & RG_03 )	// line#=computer.cpp:629
		| ( { 32{ RG_addr_addr1_next_pc_PC_t_c3 } } & { add32s1ot [31:1] , 
			1'h0 } )					// line#=computer.cpp:52,56,646,648
		| ( { 32{ RG_addr_addr1_next_pc_PC_t_c4 } } & { M_133_t , RG_addr_addr1_next_pc_PC [0] } ) ) ;
	end
...
always @ ( U_67 or M_227 or M_238 or U_66 or U_108 or FF_take or U_107 or U_65 or 
	ST1_04d )	// line#=computer.cpp:744,755
	begin
	FF_halt_t_c1 = ( ST1_04d & ( ( ( ( U_65 | ( U_107 & ( ~FF_take ) ) ) | ( 
		U_108 & ( ~FF_take ) ) ) | ( U_66 & ( ~( M_238 | M_227 ) ) ) ) | 
		U_67 ) ) ;	// line#=computer.cpp:732,756,777,797,808
...
always @ ( posedge CLOCK )
	if ( RESET )
		...
		RG_regs <= RG_regs_t ;	// line#=computer.cpp:179
always @ ( regs_rg11 or U_01 )
	RG_regs_1_t1 = ( { 32{ U_01 } } & regs_rg11 )	// line#=computer.cpp:179
		 ;
...
always @ ( posedge CLOCK )
	if ( RESET )
		...
		RG_regs_1 <= RG_regs_1_t ;	// line#=computer.cpp:179
always @ ( regs_rg12 or U_01 )
	RG_regs_2_t1 = ( { 32{ U_01 } } & regs_rg12 )	// line#=computer.cpp:179
		 ;
always @ ( imem_arg_MEMB32W65536_RD1 or ST1_03d or RG_regs_2_t1 or ST1_02d )
...
always @ ( posedge CLOCK )
	if ( RESET )
		...
		RG_regs_2 <= RG_regs_2_t ;	// line#=computer.cpp:179,616,623,631
always @ ( M_245 or M_223 or imem_arg_MEMB32W65536_RD1 or M_211 or M_219 or M_213 or 
	M_241 or M_249 or M_234 or M_225 or M_239 )
	begin
	TR_02_c1 = ( ( ( ( ( ( ( M_239 & M_225 ) | M_234 ) | M_249 ) | M_241 ) | 
		M_213 ) | M_219 ) | M_211 ) ;	// line#=computer.cpp:616
	TR_02_c2 = ( M_223 | M_245 ) ;	// line#=computer.cpp:616,681,744
...
always @ ( regs_rg13 or U_01 )
	RG_imm1_instr_regs_t1 = ( { 32{ U_01 } } & regs_rg13 )	// line#=computer.cpp:179
		 ;
always @ ( TR_02 or U_16 or U_11 or U_09 or U_08 or U_07 or U_06 or U_05 or U_13 or 
	M_225 or imem_arg_MEMB32W65536_RD1 or M_228 or M_247 or M_221 or M_230 or 
	U_12 or RG_imm1_instr_regs_t1 or ST1_02d )	// line#=computer.cpp:616,692
	begin
	RG_imm1_instr_regs_t_c1 = ( ( ( ( U_12 & M_230 ) | ( U_12 & M_221 ) ) | ( 
		U_12 & M_247 ) ) | ( U_12 & M_228 ) ) ;	// line#=computer.cpp:52,56,616,689
	RG_imm1_instr_regs_t_c2 = ( ( ( ( ( ( ( ( U_12 & M_225 ) | U_13 ) | U_05 ) | 
		U_06 ) | U_07 ) | U_08 ) | U_09 ) | ( U_11 | U_16 ) ) ;	// line#=computer.cpp:616,681,744
	RG_imm1_instr_regs_t = ( ( { 32{ ST1_02d } } & RG_imm1_instr_regs_t1 )
		| ( { 32{ RG_imm1_instr_regs_t_c1 } } & { imem_arg_MEMB32W65536_RD1 [31] , 
		...
		| ( { 32{ RG_imm1_instr_regs_t_c2 } } & { 7'h00 , TR_02 } )			// line#=computer.cpp:616,681,744
		) ;
	end
always @ ( posedge CLOCK )	// line#=computer.cpp:616,692
	if ( RESET )
		RG_imm1_instr_regs <= 32'h00000000 ;
	else
		RG_imm1_instr_regs <= RG_imm1_instr_regs_t ;	// line#=computer.cpp:52,56,179,616,681
								// ,689,744
...
always @ ( posedge CLOCK )	// line#=computer.cpp:315
	if ( RG_words_4_en )
		RG_words_4 <= words_a00_t ;
always @ ( imem_arg_MEMB32W65536_RD1 or U_13 or U_12 or U_10 or U_09 or words_a01_t or 
	ST1_02d )
	begin
	RG_words_5_t_c1 = ( ( ( U_09 | U_10 ) | U_12 ) | U_13 ) ;	// line#=computer.cpp:616,654,668,692,711
	RG_words_5_t = ( ( { 32{ ST1_02d } } & words_a01_t )						// line#=computer.cpp:325
...
always @ ( posedge CLOCK )
	if ( RG_words_5_en )
		RG_words_5 <= RG_words_5_t ;	// line#=computer.cpp:325,616,654,668,692
						// ,711
always @ ( RG_regs_2 or U_51 or addsub32u1ot or U_32 or U_31 or regs_rd00 or U_13 or 
	words_a02_t or ST1_02d )
	begin
	RG_op2_regs_word_addr_words_t_c1 = ( U_31 | U_32 ) ;	// line#=computer.cpp:113,117,124,128
	RG_op2_regs_word_addr_words_t = ( ( { 32{ ST1_02d } } & words_a02_t )				// line#=computer.cpp:325
		| ( { 32{ U_13 } } & regs_rd00 )							// line#=computer.cpp:710
		| ( { 32{ RG_op2_regs_word_addr_words_t_c1 } } & { 20'h00000 , addsub32u1ot [13:2] } )	// line#=computer.cpp:113,117,124,128
		| ( { 32{ U_51 } } & RG_regs_2 ) ) ;
	end
assign	RG_op2_regs_word_addr_words_en = ( ST1_02d | U_13 | RG_op2_regs_word_addr_words_t_c1 | 
	U_51 ) ;
always @ ( posedge CLOCK )
	if ( RESET )
		RG_op2_regs_word_addr_words <= 32'h00000000 ;
	else if ( RG_op2_regs_word_addr_words_en )
		RG_op2_regs_word_addr_words <= RG_op2_regs_word_addr_words_t ;	// line#=computer.cpp:113,117,124,128,325
										// ,710
always @ ( RG_imm1_instr_regs or U_51 or U_44 or lsft32u1ot or U_11 or regs_rd01 or 
	M_228 or M_247 or M_225 or M_221 or M_230 or U_13 or words_a03_t or ST1_02d )	// line#=computer.cpp:616,711
	begin
	RG_mask_op1_regs_result1_words_t_c1 = ( ( ( ( ( U_13 & M_230 ) | ( U_13 & 
		M_221 ) ) | ( U_13 & M_225 ) ) | ( U_13 & M_247 ) ) | ( U_13 & M_228 ) ) ;	// line#=computer.cpp:710
	RG_mask_op1_regs_result1_words_t = ( ( { 32{ ST1_02d } } & words_a03_t )	// line#=computer.cpp:325
		| ( { 32{ RG_mask_op1_regs_result1_words_t_c1 } } & regs_rd01 )		// line#=computer.cpp:710
		| ( { 32{ U_11 } } & ( ~lsft32u1ot ) )					// line#=computer.cpp:119
		| ( { 32{ U_44 } } & lsft32u1ot )					// line#=computer.cpp:713
		| ( { 32{ U_51 } } & RG_imm1_instr_regs ) ) ;
	end
assign	RG_mask_op1_regs_result1_words_en = ( ST1_02d | RG_mask_op1_regs_result1_words_t_c1 | 
	U_11 | U_44 | U_51 ) ;	// line#=computer.cpp:616,711
always @ ( posedge CLOCK )	// line#=computer.cpp:616,711
	if ( RESET )
		RG_mask_op1_regs_result1_words <= 32'h00000000 ;
	else if ( RG_mask_op1_regs_result1_words_en )
		RG_mask_op1_regs_result1_words <= RG_mask_op1_regs_result1_words_t ;	// line#=computer.cpp:119,325,616,710,711
											// ,713
...
always @ ( posedge CLOCK )
	RG_rs1 <= RG_rs1_t ;	// line#=computer.cpp:243,244,245,246,316
				// ,326,616,626
always @ ( imem_arg_MEMB32W65536_RD1 or U_11 or U_12 or accel_sbox5ot or ST1_02d )
	begin
	RG_rs2_t_c1 = ( U_12 | U_11 ) ;	// line#=computer.cpp:616,627
	RG_rs2_t = ( ( { 8{ ST1_02d } } & accel_sbox5ot )					// line#=computer.cpp:243,244,245,246,326
...
always @ ( posedge CLOCK )
	if ( RG_rs2_en )
		RG_rs2 <= RG_rs2_t ;	// line#=computer.cpp:243,244,245,246,326
					// ,616,627
always @ ( add32s1ot or M_223 or imem_arg_MEMB32W65536_RD1 or M_234 or M_239 or 
	M_252 or M_219 or M_213 or M_241 or M_249 )	// line#=computer.cpp:616,623,631
	begin
	TR_15_c1 = ( ( ( M_249 | M_241 ) | M_213 ) | ( ( ( M_219 | M_252 ) | M_239 ) | 
		M_234 ) ) ;	// line#=computer.cpp:616,624
	TR_15 = ( ( { 5{ TR_15_c1 } } & imem_arg_MEMB32W65536_RD1 [11:7] )	// line#=computer.cpp:616,624
		| ( { 5{ M_223 } } & { add32s1ot [1:0] , 3'h0 } )		// line#=computer.cpp:52,61,118,119,679
		) ;
	end
assign	M_264 = ( M_263 | ( ( ( U_08 | U_10 ) | U_12 ) | U_13 ) ) ;
always @ ( TR_15 or U_11 or M_264 or regs_rg05 or ST1_02d )
	begin
	TR_03_c1 = ( M_264 | U_11 ) ;	// line#=computer.cpp:52,61,118,119,616
					// ,624,679
	TR_03 = ( ( { 7{ ST1_02d } } & regs_rg05 [6:0] )	// line#=computer.cpp:313
		| ( { 7{ TR_03_c1 } } & { 2'h0 , TR_15 } )	// line#=computer.cpp:52,61,118,119,616
								// ,624,679
		) ;
	end
always @ ( RG_rs1 or RG_rc_rd or U_16 or TR_03 or U_11 or M_264 or ST1_02d )
	begin
	RG_rc_rd_t_c1 = ( ( ST1_02d | M_264 ) | U_11 ) ;	// line#=computer.cpp:52,61,118,119,313
								// ,616,624,679
	RG_rc_rd_t = ( ( { 8{ RG_rc_rd_t_c1 } } & { 1'h0 , TR_03 } )				// line#=computer.cpp:52,61,118,119,313
												// ,616,624,679
...
always @ ( posedge CLOCK )
	RG_rc_rd <= RG_rc_rd_t ;	// line#=computer.cpp:52,61,118,119,313
					// ,316,616,624,679
assign	M_254 = ~|( { 29'h00000000 , imem_arg_MEMB32W65536_RD1 [14:12] } ^ 32'h00000003 ) ;	// line#=computer.cpp:616,692,711
assign	M_260 = ( regs_rd00 ^ regs_rd01 ) ;	// line#=computer.cpp:655,656
assign	M_263 = ( ( U_05 | U_06 ) | U_07 ) ;	// line#=computer.cpp:616,711
always @ ( incr3s1ot or ST1_05d or U_52 or CT_02 or U_51 or comp32u_12ot or comp32s_11ot or 
	U_13 or comp32u_13ot or M_254 or comp32s_1_11ot or M_236 or U_12 or M_228 or 
	comp32u_11ot or M_247 or M_225 or comp32s_12ot or M_221 or M_215 or M_260 or 
	M_230 or U_09 or imem_arg_MEMB32W65536_RD1 or M_263 )	// line#=computer.cpp:616,654,692,711
	begin
	FF_take_t_c1 = ( U_09 & M_230 ) ;	// line#=computer.cpp:655
	FF_take_t_c2 = ( U_09 & M_215 ) ;	// line#=computer.cpp:656
	FF_take_t_c3 = ( U_09 & M_221 ) ;	// line#=computer.cpp:657
	FF_take_t_c4 = ( U_09 & M_225 ) ;	// line#=computer.cpp:658
	FF_take_t_c5 = ( U_09 & M_247 ) ;	// line#=computer.cpp:659
	FF_take_t_c6 = ( U_09 & M_228 ) ;	// line#=computer.cpp:660
	FF_take_t_c7 = ( U_12 & M_236 ) ;	// line#=computer.cpp:694
	FF_take_t_c8 = ( U_12 & M_254 ) ;	// line#=computer.cpp:695
	FF_take_t_c9 = ( U_13 & M_236 ) ;	// line#=computer.cpp:714
	FF_take_t_c10 = ( U_13 & M_254 ) ;	// line#=computer.cpp:715
	FF_take_t = ( ( { 1{ M_263 } } & ( |imem_arg_MEMB32W65536_RD1 [11:7] ) )	// line#=computer.cpp:616,624,633,637,641
		| ( { 1{ FF_take_t_c1 } } & ( ~|M_260 ) )				// line#=computer.cpp:655
		| ( { 1{ FF_take_t_c2 } } & ( |M_260 ) )				// line#=computer.cpp:656
		...
		| ( { 1{ U_52 } } & CT_02 )						// line#=computer.cpp:773
...
always @ ( RG_addr_addr1_next_pc_PC or RG_03 or add32s1ot or take_t1 )	// line#=computer.cpp:662
	begin
	M_133_t_c1 = ~take_t1 ;
	M_133_t = ( ( { 31{ take_t1 } } & add32s1ot [31:1] )	// line#=computer.cpp:662
		| ( { 31{ M_133_t_c1 } } & { RG_03 [31:2] , RG_addr_addr1_next_pc_PC [1] } ) ) ;
	end
assign	JF_02 = ~( ( M_246 & M_238 ) & FF_take ) ;
...
always @ ( RG_addr_addr1_next_pc_PC or U_57 or U_72 or regs_rd02 or U_58 or U_85 or 
	...
	add32s1i1 = ( ( { 32{ M_265 } } & regs_rd00 )			// line#=computer.cpp:52,56,61,666,679
...
always @ ( M_252 or imem_arg_MEMB32W65536_RD1 or M_223 )
	TR_04 = ( ( { 5{ M_223 } } & imem_arg_MEMB32W65536_RD1 [11:7] )		// line#=computer.cpp:52,60,61,616,624
										// ,628,679
		| ( { 5{ M_252 } } & imem_arg_MEMB32W65536_RD1 [24:20] )	// line#=computer.cpp:52,56,616,627,666
		) ;
always @ ( M_220 or RG_imm1_instr_regs or M_259 )
	M_284 = ( ( { 6{ M_259 } } & { RG_imm1_instr_regs [0] , RG_imm1_instr_regs [4:1] , 
			1'h0 } )								// line#=computer.cpp:52,65,66,67,628,652
												// ,662
		| ( { 6{ M_220 } } & { RG_imm1_instr_regs [24] , RG_imm1_instr_regs [17:13] } )	// line#=computer.cpp:52,56,627,646
		) ;
assign	M_259 = ( M_212 & take_t1 ) ;
always @ ( M_214 or M_284 or RG_imm1_instr_regs or M_220 or M_259 )
	begin
	M_285_c1 = ( M_259 | M_220 ) ;	// line#=computer.cpp:52,56,65,66,67,627
					// ,628,646,652,662
	M_285 = ( ( { 14{ M_285_c1 } } & { RG_imm1_instr_regs [24] , RG_imm1_instr_regs [24] , 
			RG_imm1_instr_regs [24] , RG_imm1_instr_regs [24] , RG_imm1_instr_regs [24] , 
			RG_imm1_instr_regs [24] , RG_imm1_instr_regs [24] , RG_imm1_instr_regs [24] , 
			M_284 } )				// line#=computer.cpp:52,56,65,66,67,627
								// ,628,646,652,662
		| ( { 14{ M_214 } } & { RG_imm1_instr_regs [12:5] , RG_imm1_instr_regs [13] , 
			RG_imm1_instr_regs [17:14] , 1'h0 } )	// line#=computer.cpp:52,73,74,75,625,627
								// ,642
		) ;
	end
always @ ( M_285 or U_57 or U_58 or U_72 or RG_imm1_instr_regs or U_85 or TR_04 or 
	imem_arg_MEMB32W65536_RD1 or M_265 )
	begin
	add32s1i2_c1 = ( ( U_72 | U_58 ) | U_57 ) ;	// line#=computer.cpp:52,56,65,66,67,73
							// ,74,75,625,627,628,642,646,652
							// ,662
	add32s1i2 = ( ( { 21{ M_265 } } & { imem_arg_MEMB32W65536_RD1 [31] , imem_arg_MEMB32W65536_RD1 [31] , 
			imem_arg_MEMB32W65536_RD1 [31] , imem_arg_MEMB32W65536_RD1 [31] , 
			imem_arg_MEMB32W65536_RD1 [31] , imem_arg_MEMB32W65536_RD1 [31] , 
			imem_arg_MEMB32W65536_RD1 [31] , imem_arg_MEMB32W65536_RD1 [31] , 
			...
			TR_04 } )						// line#=computer.cpp:52,56,60,61,616,624
										// ,627,628,666,679
		| ( { 21{ U_85 } } & { RG_imm1_instr_regs [11] , RG_imm1_instr_regs [11] , 
			RG_imm1_instr_regs [11] , RG_imm1_instr_regs [11] , RG_imm1_instr_regs [11] , 
			RG_imm1_instr_regs [11] , RG_imm1_instr_regs [11] , RG_imm1_instr_regs [11] , 
			RG_imm1_instr_regs [11] , RG_imm1_instr_regs [11:0] } )	// line#=computer.cpp:693
		| ( { 21{ add32s1i2_c1 } } & { RG_imm1_instr_regs [24] , M_285 [13:5] , 
			RG_imm1_instr_regs [23:18] , M_285 [4:0] } )		// line#=computer.cpp:52,56,65,66,67,73
										// ,74,75,625,627,628,642,646,652
										// ,662
		) ;
	end
always @ ( U_82 )
	TR_16 = ( { 8{ U_82 } } & 8'hff )	// line#=computer.cpp:130
		 ;	// line#=computer.cpp:119
always @ ( regs_rd02 or U_91 or regs_rd01 or U_44 or TR_16 or M_267 )
	lsft32u1i1 = ( ( { 32{ M_267 } } & { 16'h0000 , TR_16 , 8'hff } )	// line#=computer.cpp:119,130
		| ( { 32{ U_44 } } & regs_rd01 )				// line#=computer.cpp:710,713
		| ( { 32{ U_91 } } & regs_rd02 )				// line#=computer.cpp:699
		) ;
always @ ( RG_addr_addr1_next_pc_PC or U_82 or add32s1ot or U_31 )
	TR_08 = ( ( { 2{ U_31 } } & add32s1ot [1:0] )			// line#=computer.cpp:52,61,118,119,679
		| ( { 2{ U_82 } } & RG_addr_addr1_next_pc_PC [1:0] )	// line#=computer.cpp:129,130
		) ;
assign	M_267 = ( U_31 | U_82 ) ;
always @ ( RG_rs2 or U_91 or regs_rd00 or U_44 or TR_08 or M_267 )
	lsft32u1i2 = ( ( { 5{ M_267 } } & { TR_08 , 3'h0 } )	// line#=computer.cpp:52,61,118,119,129
								// ,130,679
		| ( { 5{ U_44 } } & regs_rd00 [4:0] )		// line#=computer.cpp:710,713
		| ( { 5{ U_91 } } & RG_rs2 [4:0] )		// line#=computer.cpp:699
		) ;
always @ ( dmem_arg_MEMB32W4096_RD1 or M_275 or regs_rd02 or M_277 or RG_mask_op1_regs_result1_words or 
	M_278 )
	rsft32u1i1 = ( ( { 32{ M_278 } } & RG_mask_op1_regs_result1_words )	// line#=computer.cpp:718,719,720
		| ( { 32{ M_277 } } & regs_rd02 )				// line#=computer.cpp:701,702,703
		| ( { 32{ M_275 } } & dmem_arg_MEMB32W4096_RD1 )		// line#=computer.cpp:90,91,100,101,669
										// ,670,672,673
		) ;
assign	M_275 = ( ( ( ( M_253 & M_226 ) | ( M_253 & M_222 ) ) | ( M_253 & M_216 ) ) | 
	( M_253 & M_231 ) ) ;
assign	M_277 = ( ( M_240 & M_226 ) & M_233 ) ;
assign	M_278 = ( ( M_235 & M_226 ) & M_233 ) ;
always @ ( RG_addr_addr1_next_pc_PC or M_275 or RG_rs2 or M_277 or RG_op2_regs_word_addr_words or 
	M_278 )
	rsft32u1i2 = ( ( { 5{ M_278 } } & RG_op2_regs_word_addr_words [4:0] )		// line#=computer.cpp:718,719,720
		| ( { 5{ M_277 } } & RG_rs2 [4:0] )					// line#=computer.cpp:701,702,703
		| ( { 5{ M_275 } } & { RG_addr_addr1_next_pc_PC [1:0] , 3'h0 } )	// line#=computer.cpp:90,91,100,101,669
											// ,670,672,673
		) ;
always @ ( regs_rd02 or M_240 or RG_mask_op1_regs_result1_words or M_235 )
	rsft32s1i1 = ( ( { 32{ M_235 } } & RG_mask_op1_regs_result1_words )	// line#=computer.cpp:718,719,720
		| ( { 32{ M_240 } } & regs_rd02 )				// line#=computer.cpp:701,702,703
		) ;
always @ ( RG_rs2 or M_240 or RG_op2_regs_word_addr_words or M_235 )
	rsft32s1i2 = ( ( { 5{ M_235 } } & RG_op2_regs_word_addr_words [4:0] )	// line#=computer.cpp:718,719,720
		| ( { 5{ M_240 } } & RG_rs2 [4:0] )				// line#=computer.cpp:701,702,703
		) ;
always @ ( RG_mask_op1_regs_result1_words or U_96 or add32s1ot or U_25 or U_26 or 
	U_28 or U_29 or M_268 or RG_addr_addr1_next_pc_PC or M_262 )
	begin
	addsub32u1i1_c1 = ( M_268 | ( ( ( U_29 | U_28 ) | U_26 ) | U_25 ) ) ;	// line#=computer.cpp:52,56,61,85,95,113
										// ,124,666,679
	addsub32u1i1 = ( ( { 32{ M_262 } } & RG_addr_addr1_next_pc_PC )	// line#=computer.cpp:70,629,637
		| ( { 32{ addsub32u1i1_c1 } } & add32s1ot )		// line#=computer.cpp:52,56,61,85,95,113
									// ,124,666,679
		| ( { 32{ U_96 } } & RG_mask_op1_regs_result1_words )	// line#=computer.cpp:712
		) ;
	end
always @ ( M_266 or RG_imm1_instr_regs or U_69 )
	TR_17 = ( ( { 20{ U_69 } } & RG_imm1_instr_regs [24:5] )	// line#=computer.cpp:70,637
		| ( { 20{ M_266 } } & 20'h00040 )			// line#=computer.cpp:85,95,113,124
		) ;
always @ ( U_01 or TR_17 or M_266 or U_69 )
	begin
	M_286_c1 = ( U_69 | M_266 ) ;	// line#=computer.cpp:70,85,95,113,124
					// ,637
	M_286 = ( ( { 21{ M_286_c1 } } & { TR_17 , 1'h0 } )	// line#=computer.cpp:70,85,95,113,124
								// ,637
		| ( { 21{ U_01 } } & 21'h000001 )		// line#=computer.cpp:629
		) ;
	end
assign	M_262 = ( U_69 | U_01 ) ;
always @ ( RG_op2_regs_word_addr_words or U_96 or M_286 or M_266 or M_262 )
	begin
	addsub32u1i2_c1 = ( M_262 | M_266 ) ;	// line#=computer.cpp:70,85,95,113,124
						// ,629,637
	addsub32u1i2 = ( ( { 32{ addsub32u1i2_c1 } } & { M_286 [20:1] , 9'h000 , 
			M_286 [0] , 2'h0 } )				// line#=computer.cpp:70,85,95,113,124
									// ,629,637
		| ( { 32{ U_96 } } & RG_op2_regs_word_addr_words )	// line#=computer.cpp:712
		) ;
	end
assign	M_268 = ( U_32 | U_31 ) ;
assign	M_266 = ( ( ( ( M_268 | U_29 ) | U_28 ) | U_26 ) | U_25 ) ;
always @ ( RG_imm1_instr_regs )	// line#=computer.cpp:712
	case ( RG_imm1_instr_regs [23] )
	1'h1 :
	...
	endcase
always @ ( addsub32u1_f_t1 or U_96 or M_266 or M_262 )
	addsub32u1_f = ( ( { 2{ M_262 } } & 2'h1 )
		| ( { 2{ M_266 } } & 2'h2 )
...
always @ ( U_112 or regs_rg17 or U_01 or RG_mask_op1_regs_result1_words or CT_02 or 
	U_52 )	// line#=computer.cpp:773
	begin
	accel_sbox1i1_c1 = ( U_52 & CT_02 ) ;	// line#=computer.cpp:243,244,245,246,326
	accel_sbox1i1 = ( ( { 8{ accel_sbox1i1_c1 } } & RG_mask_op1_regs_result1_words [7:0] )	// line#=computer.cpp:243,244,245,246,326
		| ( { 8{ U_01 } } & regs_rg17 [7:0] )						// line#=computer.cpp:243,244,245,246,312
												// ,314,315
		| ( { 8{ U_112 } } & RG_mask_op1_regs_result1_words [15:8] )			// line#=computer.cpp:243,244,245,246,326
		) ;
	end
always @ ( RG_mask_op1_regs_result1_words or U_112 or regs_rg17 or U_01 )
	accel_sbox2i1 = ( ( { 8{ U_01 } } & regs_rg17 [31:24] )			// line#=computer.cpp:243,244,245,246,312
										// ,314,315
		| ( { 8{ U_112 } } & RG_mask_op1_regs_result1_words [31:24] )	// line#=computer.cpp:243,244,245,246,326
		) ;
always @ ( regs_rd03 or M_217 )
	TR_10 = ( { 8{ M_217 } } & regs_rd03 [15:8] )	// line#=computer.cpp:131,683
		 ;	// line#=computer.cpp:120,682
assign	lsft32u_321i1 = { TR_10 , regs_rd03 [7:0] } ;	// line#=computer.cpp:120,131,682,683
always @ ( RG_rc_rd or M_232 or RG_addr_addr1_next_pc_PC or M_217 )
	lsft32u_321i2 = ( ( { 5{ M_217 } } & { RG_addr_addr1_next_pc_PC [1:0] , 3'h0 } )	// line#=computer.cpp:129,130,131,683
		| ( { 5{ M_232 } } & RG_rc_rd [4:0] )						// line#=computer.cpp:120,682
		) ;
assign	imem_arg_MEMB32W65536_RE1 = U_01 ;	// line#=computer.cpp:616
always @ ( regs_rd03 or M_238 or lsft32u1ot or M_217 or lsft32u_321ot or RG_mask_op1_regs_result1_words or 
	dmem_arg_MEMB32W4096_RD1 or M_232 )
	dmem_arg_MEMB32W4096_WD2 = ( ( { 32{ M_232 } } & ( ( dmem_arg_MEMB32W4096_RD1 & 
			RG_mask_op1_regs_result1_words ) | lsft32u_321ot ) )	// line#=computer.cpp:120,682
		| ( { 32{ M_217 } } & ( ( dmem_arg_MEMB32W4096_RD1 & ( ~lsft32u1ot ) ) | 
			lsft32u_321ot ) )					// line#=computer.cpp:130,131,683
		| ( { 32{ M_238 } } & regs_rd03 )				// line#=computer.cpp:139
		) ;
always @ ( addsub32u1ot or M_223 or M_225 or M_221 or M_215 or M_230 or add32s1ot or 
	M_236 or M_252 )
	begin
	dmem_arg_MEMB32W4096_RA1_c1 = ( M_252 & M_236 ) ;	// line#=computer.cpp:52,56,105,109,666
								// ,671
	dmem_arg_MEMB32W4096_RA1_c2 = ( ( ( ( ( ( M_252 & M_230 ) | ( M_252 & M_215 ) ) | 
		( M_252 & M_221 ) ) | ( M_252 & M_225 ) ) | ( M_223 & M_230 ) ) | 
		( M_223 & M_215 ) ) ;	// line#=computer.cpp:85,89,91,95,99,101
...
always @ ( RG_addr_addr1_next_pc_PC or M_238 or RG_op2_regs_word_addr_words or M_217 or 
	M_232 )	// line#=computer.cpp:681
	begin
	dmem_arg_MEMB32W4096_WA2_c1 = ( M_232 | M_217 ) ;	// line#=computer.cpp:120,130,131
	dmem_arg_MEMB32W4096_WA2 = ( ( { 12{ dmem_arg_MEMB32W4096_WA2_c1 } } & RG_op2_regs_word_addr_words [11:0] )	// line#=computer.cpp:120,130,131
		| ( { 12{ M_238 } } & RG_addr_addr1_next_pc_PC [13:2] )							// line#=computer.cpp:135,139
		) ;
	end
assign	dmem_arg_MEMB32W4096_RE1 = ( ( ( ( ( ( ( U_10 & M_236 ) | U_25 ) | U_26 ) | 
	U_28 ) | U_29 ) | U_31 ) | U_32 ) ;	// line#=computer.cpp:91,101,109,120,131
						// ,616,668,669,670,671,672,673
assign	dmem_arg_MEMB32W4096_WE2 = ( ( ( U_61 & M_232 ) | U_82 ) | ( U_61 & M_238 ) ) ;	// line#=computer.cpp:120,130,131,139,681
always @ ( M_269 or M_252 or M_223 or M_236 or M_254 or M_239 or imem_arg_MEMB32W65536_RD1 or 
	M_234 )
	begin
	regs_ad00_c1 = ( ( ( ( M_239 & M_254 ) | ( M_239 & M_236 ) ) | ( M_223 | 
		M_252 ) ) | M_269 ) ;	// line#=computer.cpp:616,626
	regs_ad00 = ( ( { 5{ M_234 } } & imem_arg_MEMB32W65536_RD1 [24:20] )	// line#=computer.cpp:616
		| ( { 5{ regs_ad00_c1 } } & imem_arg_MEMB32W65536_RD1 [19:15] )	// line#=computer.cpp:616,626
		) ;
	end
assign	M_269 = ( ( ( ( ( ( M_211 & M_228 ) | ( M_211 & M_247 ) ) | ( M_211 & M_225 ) ) | 
	( M_211 & M_221 ) ) | ( M_211 & M_215 ) ) | ( M_211 & M_230 ) ) ;
always @ ( M_269 or imem_arg_MEMB32W65536_RD1 or M_234 )
	regs_ad01 = ( ( { 5{ M_234 } } & imem_arg_MEMB32W65536_RD1 [19:15] )	// line#=computer.cpp:616
		| ( { 5{ M_269 } } & imem_arg_MEMB32W65536_RD1 [24:20] )	// line#=computer.cpp:616
		) ;
assign	regs_ad04 = RG_rc_rd [4:0] ;	// line#=computer.cpp:70,633,637,641,647
					// ,675,706,725
assign	M_229 = ~|( RG_words_5 ^ 32'h00000007 ) ;
assign	M_248 = ~|( RG_words_5 ^ 32'h00000006 ) ;
assign	M_255 = ~|( RG_words_5 ^ 32'h00000003 ) ;
assign	M_280 = ( M_235 & M_258 ) ;
assign	M_283 = ( M_240 & M_258 ) ;
always @ ( rsft32u1ot or rsft32s1ot or RG_imm1_instr_regs )	// line#=computer.cpp:701,702,703
	case ( RG_imm1_instr_regs [23] )
	1'h1 :
	...
	default :
		TR_19 = 32'hx ;
	endcase
always @ ( M_250 or RG_op2_regs_word_addr_words or RG_mask_op1_regs_result1_words or 
	M_216 or addsub32u1ot or M_242 or U_96 or RG_03 or FF_take or M_214 or M_220 or 
	TR_19 or M_226 or lsft32u1ot or U_91 or M_229 or M_248 or RG_imm1_instr_regs or 
	regs_rd02 or M_222 or TR_18 or U_63 or M_280 or M_255 or M_237 or U_62 or 
	add32s1ot or U_85 or M_283 or val2_t4 or M_258 or M_253 )	// line#=computer.cpp:692,711
	begin
	regs_wd04_c1 = ( M_253 & M_258 ) ;	// line#=computer.cpp:675
	regs_wd04_c2 = ( M_283 & U_85 ) ;	// line#=computer.cpp:693
	regs_wd04_c3 = ( ( ( ( M_283 & ( U_62 & M_237 ) ) | ( M_283 & ( U_62 & M_255 ) ) ) | 
		( M_280 & ( U_63 & M_237 ) ) ) | ( M_280 & ( U_63 & M_255 ) ) ) ;
	regs_wd04_c4 = ( M_283 & ( U_62 & M_222 ) ) ;	// line#=computer.cpp:696
	regs_wd04_c5 = ( M_283 & ( U_62 & M_248 ) ) ;	// line#=computer.cpp:697
	regs_wd04_c6 = ( M_283 & ( U_62 & M_229 ) ) ;	// line#=computer.cpp:698
	regs_wd04_c7 = ( M_283 & U_91 ) ;	// line#=computer.cpp:699
	regs_wd04_c8 = ( M_283 & ( U_62 & M_226 ) ) ;	// line#=computer.cpp:701,702,703
	regs_wd04_c9 = ( ( M_220 & M_258 ) | ( M_214 & FF_take ) ) ;	// line#=computer.cpp:641,647
	regs_wd04_c10 = ( ( M_280 & U_96 ) | ( M_242 & FF_take ) ) ;	// line#=computer.cpp:70,637,712
	regs_wd04_c11 = ( M_280 & ( U_63 & M_216 ) ) ;	// line#=computer.cpp:713
	regs_wd04_c12 = ( M_280 & ( U_63 & M_222 ) ) ;	// line#=computer.cpp:716
	regs_wd04_c13 = ( M_280 & ( U_63 & M_248 ) ) ;	// line#=computer.cpp:722
	regs_wd04_c14 = ( M_280 & ( U_63 & M_229 ) ) ;	// line#=computer.cpp:723
	regs_wd04_c15 = ( M_280 & ( U_63 & M_226 ) ) ;	// line#=computer.cpp:718,719,720
	regs_wd04_c16 = ( M_250 & FF_take ) ;	// line#=computer.cpp:70,633
	regs_wd04 = ( ( { 32{ regs_wd04_c1 } } & val2_t4 )				// line#=computer.cpp:675
		| ( { 32{ regs_wd04_c2 } } & add32s1ot )				// line#=computer.cpp:693
		| ( { 32{ regs_wd04_c3 } } & { 31'h00000000 , TR_18 } )
		| ( { 32{ regs_wd04_c4 } } & ( regs_rd02 ^ { RG_imm1_instr_regs [11] , 
			RG_imm1_instr_regs [11] , RG_imm1_instr_regs [11] , RG_imm1_instr_regs [11] , 
			RG_imm1_instr_regs [11] , RG_imm1_instr_regs [11] , RG_imm1_instr_regs [11] , 
			RG_imm1_instr_regs [11] , RG_imm1_instr_regs [11] , RG_imm1_instr_regs [11] , 
			RG_imm1_instr_regs [11] , RG_imm1_instr_regs [11] , RG_imm1_instr_regs [11] , 
			RG_imm1_instr_regs [11] , RG_imm1_instr_regs [11] , RG_imm1_instr_regs [11] , 
			RG_imm1_instr_regs [11] , RG_imm1_instr_regs [11] , RG_imm1_instr_regs [11] , 
			RG_imm1_instr_regs [11] , RG_imm1_instr_regs [11:0] } ) )	// line#=computer.cpp:696
		| ( { 32{ regs_wd04_c5 } } & ( regs_rd02 | { RG_imm1_instr_regs [11] , 
			RG_imm1_instr_regs [11] , RG_imm1_instr_regs [11] , RG_imm1_instr_regs [11] , 
			RG_imm1_instr_regs [11] , RG_imm1_instr_regs [11] , RG_imm1_instr_regs [11] , 
			RG_imm1_instr_regs [11] , RG_imm1_instr_regs [11] , RG_imm1_instr_regs [11] , 
			RG_imm1_instr_regs [11] , RG_imm1_instr_regs [11] , RG_imm1_instr_regs [11] , 
			RG_imm1_instr_regs [11] , RG_imm1_instr_regs [11] , RG_imm1_instr_regs [11] , 
			RG_imm1_instr_regs [11] , RG_imm1_instr_regs [11] , RG_imm1_instr_regs [11] , 
			RG_imm1_instr_regs [11] , RG_imm1_instr_regs [11:0] } ) )	// line#=computer.cpp:697
		| ( { 32{ regs_wd04_c6 } } & ( regs_rd02 & { RG_imm1_instr_regs [11] , 
			RG_imm1_instr_regs [11] , RG_imm1_instr_regs [11] , RG_imm1_instr_regs [11] , 
			RG_imm1_instr_regs [11] , RG_imm1_instr_regs [11] , RG_imm1_instr_regs [11] , 
			RG_imm1_instr_regs [11] , RG_imm1_instr_regs [11] , RG_imm1_instr_regs [11] , 
			RG_imm1_instr_regs [11] , RG_imm1_instr_regs [11] , RG_imm1_instr_regs [11] , 
			RG_imm1_instr_regs [11] , RG_imm1_instr_regs [11] , RG_imm1_instr_regs [11] , 
			RG_imm1_instr_regs [11] , RG_imm1_instr_regs [11] , RG_imm1_instr_regs [11] , 
			RG_imm1_instr_regs [11] , RG_imm1_instr_regs [11:0] } ) )	// line#=computer.cpp:698
		| ( { 32{ regs_wd04_c7 } } & lsft32u1ot )				// line#=computer.cpp:699
		| ( { 32{ regs_wd04_c8 } } & TR_19 )					// line#=computer.cpp:701,702,703
		| ( { 32{ regs_wd04_c9 } } & RG_03 )					// line#=computer.cpp:641,647
		| ( { 32{ regs_wd04_c10 } } & addsub32u1ot )				// line#=computer.cpp:70,637,712
		| ( { 32{ regs_wd04_c11 } } & RG_mask_op1_regs_result1_words )		// line#=computer.cpp:713
		| ( { 32{ regs_wd04_c12 } } & ( RG_mask_op1_regs_result1_words ^ 
			RG_op2_regs_word_addr_words ) )					// line#=computer.cpp:716
		| ( { 32{ regs_wd04_c13 } } & ( RG_mask_op1_regs_result1_words | 
			RG_op2_regs_word_addr_words ) )					// line#=computer.cpp:722
		| ( { 32{ regs_wd04_c14 } } & ( RG_mask_op1_regs_result1_words & 
			RG_op2_regs_word_addr_words ) )					// line#=computer.cpp:723
		| ( { 32{ regs_wd04_c15 } } & TR_19 )					// line#=computer.cpp:718,719,720
		| ( { 32{ regs_wd04_c16 } } & { RG_imm1_instr_regs [24:5] , 12'h000 } )	// line#=computer.cpp:70,633
		) ;
	end
assign	regs_we04 = ( ( ( ( ( ( ( U_60 & M_258 ) | ( U_62 & M_258 ) ) | ( U_58 & 
	M_258 ) ) | ( U_63 & M_258 ) ) | U_69 ) | ( U_57 & FF_take ) ) | ( U_55 & 
