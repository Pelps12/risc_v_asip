...
// bdlpars options:  -EE -DAES_MEM -DACCEL_MIX_COL -DACCEL_EXPAND_ENC_KEY -DACCEL_MIX_COL_U1 -DACCEL_EXPAND_ENC_KEY_U4 -info_base_name computer computer.cpp
// bdltran options:  -EE computer.IFF -c1000 -s -Zresource_fcnt=GENERATE -Zresource_mcnt=GENERATE -Zsync -Zdup_reset=YES -Zfolding_sharing=inter_stage -lb /proj/cad/cwb-6.1/packages/asic_45.BLIB -lfl /proj/cad/cwb-6.1/packages/asic_45.FLIB -o-P 
// timestamp_0: 20260604024948_93745_75706
// timestamp_5: 20260604024949_93759_03081
// timestamp_9: 20260604024949_93759_76984
// timestamp_C: 20260604024949_93759_56290
// timestamp_E: 20260604024950_93759_64994
// timestamp_V: 20260604024950_93773_25560
...
always @ ( words_0_a01_t or M_06 or U_112 or regs_wd04 or regs_d04 or regs_we04 )	// line#=computer.cpp:20
	begin
...
always @ ( words_1_a01_t or M_07 or U_112 or regs_wd04 or regs_d04 or regs_we04 )	// line#=computer.cpp:20
	begin
...
always @ ( words_2_a01_t or M_08 or U_112 or regs_wd04 or regs_d04 or regs_we04 )	// line#=computer.cpp:20
	begin
...
always @ ( words_2_a01_t or RG_words_3 or M_09 or U_112 or regs_wd04 or regs_d04 or 
	regs_we04 )	// line#=computer.cpp:20
	begin
...
always @ ( dmem_arg_MEMB32W4096_RD1 or rsft32u1ot or RG_words_5 )	// line#=computer.cpp:668
	...
	endcase
assign	words_0_a01_t = ( RG_words ^ { accel_sbox2ot , RG_rs2 , accel_sbox1ot , RG_rs1 } ) ;	// line#=computer.cpp:243,244,245,246,326
...
always @ ( RG_regs_2 or U_51 or addsub32u1ot or U_32 or U_31 or regs_rd00 or U_13 or 
	words_2_a00_t or ST1_02d )
	begin
	RG_op2_regs_word_addr_words_t_c1 = ( U_31 | U_32 ) ;	// line#=computer.cpp:113,117,124,128
	RG_op2_regs_word_addr_words_t = ( ( { 32{ ST1_02d } } & words_2_a00_t )				// line#=computer.cpp:325
...
always @ ( RG_imm1_instr_regs or U_51 or U_44 or lsft32u1ot or U_11 or regs_rd01 or 
	M_228 or M_247 or M_225 or M_221 or M_230 or U_13 or words_3_a00_t or ST1_02d )	// line#=computer.cpp:616,711
	begin
	RG_mask_op1_regs_result1_words_t_c1 = ( ( ( ( ( U_13 & M_230 ) | ( U_13 & 
		M_221 ) ) | ( U_13 & M_225 ) ) | ( U_13 & M_247 ) ) | ( U_13 & M_228 ) ) ;	// line#=computer.cpp:710
	RG_mask_op1_regs_result1_words_t = ( ( { 32{ ST1_02d } } & words_3_a00_t )	// line#=computer.cpp:325
