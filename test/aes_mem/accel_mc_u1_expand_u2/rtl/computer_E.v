...
// bdlpars options:  -EE -DAES_MEM -DACCEL_MIX_COL -DACCEL_EXPAND_ENC_KEY -DACCEL_MIX_COL_U1 -DACCEL_EXPAND_ENC_KEY_U2 -info_base_name computer computer.cpp
// bdltran options:  -EE computer.IFF -c1000 -s -Zresource_fcnt=GENERATE -Zresource_mcnt=GENERATE -Zsync -Zdup_reset=YES -Zfolding_sharing=inter_stage -lb /proj/cad/cwb-6.1/packages/asic_45.BLIB -lfl /proj/cad/cwb-6.1/packages/asic_45.FLIB -o-P 
// timestamp_0: 20260604024946_93654_08415
// timestamp_5: 20260604024946_93668_65845
// timestamp_9: 20260604024946_93668_03283
// timestamp_C: 20260604024946_93668_91018
// timestamp_E: 20260604024947_93668_89903
// timestamp_V: 20260604024947_93682_34052
...
always @ ( words_0_a02_t or M_06 or U_112 or regs_wd04 or regs_d04 or regs_we04 )	// line#=computer.cpp:20
	begin
...
always @ ( words_1_a02_t or M_07 or U_112 or regs_wd04 or regs_d04 or regs_we04 )	// line#=computer.cpp:20
	begin
...
always @ ( words_0_a03_t or M_08 or U_112 or regs_wd04 or regs_d04 or regs_we04 )	// line#=computer.cpp:20
	begin
...
always @ ( words_0_a03_t or RG_words_3 or M_09 or U_112 or regs_wd04 or regs_d04 or 
	regs_we04 )	// line#=computer.cpp:20
	begin
...
always @ ( RG_regs or M_10 or U_110 or M_201 or M_200 or M_199 or M_198 or cols_d01 or 
	...
	cols_rg00_t = ( ( { 32{ cols_rg00_t_c1 } } & { M_198 , M_199 , M_200 , M_201 } )	// line#=computer.cpp:164,165,166,167,170
												// ,171,172,173,175,188
...
always @ ( RG_regs_1 or M_11 or U_110 or M_201 or M_200 or M_199 or M_198 or cols_d01 or 
	ST1_05d )	// line#=computer.cpp:164,170,171,172,173
			// ,175,179,188
	begin
	...
	cols_rg01_t = ( ( { 32{ cols_rg01_t_c1 } } & { M_198 , M_199 , M_200 , M_201 } )	// line#=computer.cpp:164,165,166,167,170
												// ,171,172,173,175,188
...
always @ ( RG_op2_regs_word_addr_words or M_12 or U_110 or M_201 or M_200 or M_199 or 
	M_198 or cols_d01 or ST1_05d )	// line#=computer.cpp:164,170,171,172,173
					// ,175,179,188
	begin
	cols_rg02_t_c1 = ( ST1_05d & cols_d01 [1] ) ;	// line#=computer.cpp:164,165,166,167,170
							// ,171,172,173,175,188
	cols_rg02_t_c2 = ( U_110 & M_12 ) ;	// line#=computer.cpp:179
	cols_rg02_t = ( ( { 32{ cols_rg02_t_c1 } } & { M_198 , M_199 , M_200 , M_201 } )	// line#=computer.cpp:164,165,166,167,170
												// ,171,172,173,175,188
...
always @ ( RG_mask_op1_regs_result1_words or M_13 or U_110 or M_201 or M_200 or 
	M_199 or M_198 or cols_d01 or ST1_05d )	// line#=computer.cpp:164,170,171,172,173
						// ,175,179,188
	begin
	cols_rg03_t_c1 = ( ST1_05d & cols_d01 [0] ) ;	// line#=computer.cpp:164,165,166,167,170
							// ,171,172,173,175,188
	cols_rg03_t_c2 = ( U_110 & M_13 ) ;	// line#=computer.cpp:179
	cols_rg03_t = ( ( { 32{ cols_rg03_t_c1 } } & { M_198 , M_199 , M_200 , M_201 } )	// line#=computer.cpp:164,165,166,167,170
												// ,171,172,173,175,188
...
always @ ( dmem_arg_MEMB32W4096_RD1 or rsft32u1ot or RG_words_5 )	// line#=computer.cpp:668
	...
	endcase
assign	words_0_a02_t = ( RG_words ^ { accel_sbox2ot , RG_rs2 , accel_sbox1ot , RG_rs1 } ) ;	// line#=computer.cpp:243,244,245,246,326
...
always @ ( FF_take )	// line#=computer.cpp:694
	...
	default :
		TR_18 = 1'hx ;
	endcase
assign	e_t = ( M_145_t ^ M_143_t ) ;	// line#=computer.cpp:164,165,166,167,168
					// ,188
always @ ( M_149_t or M_145_t )	// line#=computer.cpp:164,170
	case ( M_145_t [7] )
	1'h1 :
		M_293 = { ~M_149_t [3:2] , ~M_149_t [0] , 1'h1 } ;	// line#=computer.cpp:164,170
	1'h0 :
		M_293 = { M_149_t [3:2] , M_149_t [0] , 1'h0 } ;	// line#=computer.cpp:164,165,170,188
	default :
		M_293 = 4'hx ;
	endcase
always @ ( M_148_t or M_144_t )	// line#=computer.cpp:171
	case ( M_144_t [7] )
	1'h1 :
		M_290 = { ~M_148_t [3:2] , ~M_148_t [0] , 1'h1 } ;	// line#=computer.cpp:171
	1'h0 :
		M_290 = { M_148_t [3:2] , M_148_t [0] , 1'h0 } ;	// line#=computer.cpp:165,166,171,188
	default :
		M_290 = 4'hx ;
	endcase
always @ ( M_147_t or M_143_t )	// line#=computer.cpp:172
	case ( M_143_t [7] )
	1'h1 :
		M_289 = { ~M_147_t [3:2] , ~M_147_t [0] , 1'h1 } ;	// line#=computer.cpp:172
	1'h0 :
		M_289 = { M_147_t [3:2] , M_147_t [0] , 1'h0 } ;	// line#=computer.cpp:166,167,172,188
	default :
		M_289 = 4'hx ;
	endcase
always @ ( M_146_t or M_142_t )	// line#=computer.cpp:164,173
	case ( M_142_t [7] )
	1'h1 :
		M_292 = { ~M_146_t [3:2] , ~M_146_t [0] , 1'h1 } ;	// line#=computer.cpp:164,173
	1'h0 :
		M_292 = { M_146_t [3:2] , M_146_t [0] , 1'h0 } ;	// line#=computer.cpp:164,167,173,188
	default :
		M_292 = 4'hx ;
	endcase
assign	M_142_t = ( cols_rd00 [31:24] ^ cols_rd00 [7:0] ) ;	// line#=computer.cpp:164,167,173,188
assign	M_143_t = ( cols_rd00 [23:16] ^ cols_rd00 [31:24] ) ;	// line#=computer.cpp:164,165,166,167,168
								// ,172,188
assign	M_144_t = ( cols_rd00 [15:8] ^ cols_rd00 [23:16] ) ;	// line#=computer.cpp:165,166,171,188
assign	M_145_t = ( cols_rd00 [7:0] ^ cols_rd00 [15:8] ) ;	// line#=computer.cpp:164,165,166,167,168
								// ,170,188
assign	M_146_t = ( cols_rd00 [30:24] ^ cols_rd00 [6:0] ) ;	// line#=computer.cpp:164,167,173,188
assign	M_147_t = ( cols_rd00 [22:16] ^ cols_rd00 [30:24] ) ;	// line#=computer.cpp:166,167,172,188
assign	M_148_t = ( cols_rd00 [14:8] ^ cols_rd00 [22:16] ) ;	// line#=computer.cpp:165,166,171,188
assign	M_149_t = ( cols_rd00 [6:0] ^ cols_rd00 [14:8] ) ;	// line#=computer.cpp:164,165,170,188
...
assign	cols_ad01 = RG_i [1:0] ;	// line#=computer.cpp:164,170,171,172,173
					// ,175,188
assign	M_198 = ( ( cols_rd00 [31:24] ^ e_t ) ^ { M_146_t [6:4] , M_292 [3:2] , M_146_t [1] , 
	M_292 [1:0] } ) ;	// line#=computer.cpp:164,165,166,167,170
				// ,171,172,173,175,188
assign	M_199 = ( ( cols_rd00 [23:16] ^ e_t ) ^ { M_147_t [6:4] , M_289 [3:2] , M_147_t [1] , 
	M_289 [1:0] } ) ;	// line#=computer.cpp:164,165,166,167,170
				// ,171,172,173,175,188
assign	M_200 = ( ( cols_rd00 [15:8] ^ e_t ) ^ { M_148_t [6:4] , M_290 [3:2] , M_148_t [1] , 
	M_290 [1:0] } ) ;	// line#=computer.cpp:164,165,166,167,170
				// ,171,172,173,175,188
assign	M_201 = ( ( cols_rd00 [7:0] ^ e_t ) ^ { M_149_t [6:4] , M_293 [3:2] , M_149_t [1] , 
	M_293 [1:0] } ) ;	// line#=computer.cpp:164,165,166,167,170
				// ,171,172,173,175,188
assign	U_01 = ( ST1_02d & CT_01 ) ;	// line#=computer.cpp:615
assign	U_05 = ( ST1_03d & M_253 ) ;	// line#=computer.cpp:616,623,631
assign	U_06 = ( ST1_03d & M_245 ) ;	// line#=computer.cpp:616,623,631
assign	U_07 = ( ST1_03d & M_216 ) ;	// line#=computer.cpp:616,623,631
assign	U_08 = ( ST1_03d & M_222 ) ;	// line#=computer.cpp:616,623,631
assign	U_09 = ( ST1_03d & M_214 ) ;	// line#=computer.cpp:616,623,631
assign	U_10 = ( ST1_03d & M_255 ) ;	// line#=computer.cpp:616,623,631
assign	U_11 = ( ST1_03d & M_226 ) ;	// line#=computer.cpp:616,623,631
assign	U_12 = ( ST1_03d & M_243 ) ;	// line#=computer.cpp:616,623,631
assign	U_13 = ( ST1_03d & M_238 ) ;	// line#=computer.cpp:616,623,631
assign	U_16 = ( ST1_03d & M_249 ) ;	// line#=computer.cpp:616,623,631
assign	M_214 = ~|( { 25'h0000000 , imem_arg_MEMB32W65536_RD1 [6:0] } ^ 32'h00000063 ) ;	// line#=computer.cpp:616,623,631
assign	M_216 = ~|( { 25'h0000000 , imem_arg_MEMB32W65536_RD1 [6:0] } ^ 32'h0000006f ) ;	// line#=computer.cpp:616,623,631
assign	M_222 = ~|( { 25'h0000000 , imem_arg_MEMB32W65536_RD1 [6:0] } ^ 32'h00000067 ) ;	// line#=computer.cpp:616,623,631
assign	M_226 = ~|( { 25'h0000000 , imem_arg_MEMB32W65536_RD1 [6:0] } ^ 32'h00000023 ) ;	// line#=computer.cpp:616,623,631
assign	M_238 = ~|( { 25'h0000000 , imem_arg_MEMB32W65536_RD1 [6:0] } ^ 32'h00000033 ) ;	// line#=computer.cpp:616,623,631
assign	M_243 = ~|( { 25'h0000000 , imem_arg_MEMB32W65536_RD1 [6:0] } ^ 32'h00000013 ) ;	// line#=computer.cpp:616,623,631
assign	M_245 = ~|( { 25'h0000000 , imem_arg_MEMB32W65536_RD1 [6:0] } ^ 32'h00000017 ) ;	// line#=computer.cpp:616,623,631
assign	M_249 = ~|( { 25'h0000000 , imem_arg_MEMB32W65536_RD1 [6:0] } ^ 32'h0000000b ) ;	// line#=computer.cpp:616,623,631
assign	M_253 = ~|( { 25'h0000000 , imem_arg_MEMB32W65536_RD1 [6:0] } ^ 32'h00000037 ) ;	// line#=computer.cpp:616,623,631
assign	M_255 = ~|( { 25'h0000000 , imem_arg_MEMB32W65536_RD1 [6:0] } ^ 32'h00000003 ) ;	// line#=computer.cpp:616,623,631
assign	M_218 = ~|( { 29'h00000000 , imem_arg_MEMB32W65536_RD1 [14:12] } ^ 32'h00000001 ) ;	// line#=computer.cpp:616,654,668,681,692
												// ,711
assign	M_224 = ~|( { 29'h00000000 , imem_arg_MEMB32W65536_RD1 [14:12] } ^ 32'h00000004 ) ;	// line#=computer.cpp:616,654,668,692,711
assign	M_228 = ~|( { 29'h00000000 , imem_arg_MEMB32W65536_RD1 [14:12] } ^ 32'h00000005 ) ;	// line#=computer.cpp:616,654,668,692,711
												// ,744
assign	M_232 = ~|( { 29'h00000000 , imem_arg_MEMB32W65536_RD1 [14:12] } ^ 32'h00000007 ) ;	// line#=computer.cpp:616,654,692,711
assign	M_234 = ~|{ 29'h00000000 , imem_arg_MEMB32W65536_RD1 [14:12] } ;	// line#=computer.cpp:616,654,668,681,692
										// ,711
assign	M_251 = ~|( { 29'h00000000 , imem_arg_MEMB32W65536_RD1 [14:12] } ^ 32'h00000006 ) ;	// line#=computer.cpp:616,654,692,711
assign	U_25 = ( U_10 & M_234 ) ;	// line#=computer.cpp:616,668
assign	U_26 = ( U_10 & M_218 ) ;	// line#=computer.cpp:616,668
assign	U_28 = ( U_10 & M_224 ) ;	// line#=computer.cpp:616,668
assign	U_29 = ( U_10 & M_228 ) ;	// line#=computer.cpp:616,668
assign	M_240 = ~|( { 29'h00000000 , imem_arg_MEMB32W65536_RD1 [14:12] } ^ 32'h00000002 ) ;	// line#=computer.cpp:616,668,681,692,711
												// ,744
assign	U_31 = ( U_11 & M_234 ) ;	// line#=computer.cpp:616,681
assign	U_32 = ( U_11 & M_218 ) ;	// line#=computer.cpp:616,681
assign	U_44 = ( U_13 & M_218 ) ;	// line#=computer.cpp:616,711
assign	U_51 = ( U_16 & M_240 ) ;	// line#=computer.cpp:616,744
assign	U_52 = ( U_16 & M_228 ) ;	// line#=computer.cpp:616,744
assign	U_55 = ( ST1_04d & M_254 ) ;	// line#=computer.cpp:631
assign	U_56 = ( ST1_04d & M_246 ) ;	// line#=computer.cpp:631
assign	U_57 = ( ST1_04d & M_217 ) ;	// line#=computer.cpp:631
assign	U_58 = ( ST1_04d & M_223 ) ;	// line#=computer.cpp:631
assign	U_59 = ( ST1_04d & M_215 ) ;	// line#=computer.cpp:631
assign	U_60 = ( ST1_04d & M_256 ) ;	// line#=computer.cpp:631
assign	U_61 = ( ST1_04d & M_227 ) ;	// line#=computer.cpp:631
assign	U_62 = ( ST1_04d & M_244 ) ;	// line#=computer.cpp:631
assign	U_63 = ( ST1_04d & M_239 ) ;	// line#=computer.cpp:631
assign	U_65 = ( ST1_04d & M_248 ) ;	// line#=computer.cpp:631
assign	U_66 = ( ST1_04d & M_250 ) ;	// line#=computer.cpp:631
assign	M_215 = ~|( RG_regs_2 ^ 32'h00000063 ) ;	// line#=computer.cpp:631
assign	M_217 = ~|( RG_regs_2 ^ 32'h0000006f ) ;	// line#=computer.cpp:631
assign	M_223 = ~|( RG_regs_2 ^ 32'h00000067 ) ;	// line#=computer.cpp:631
assign	M_227 = ~|( RG_regs_2 ^ 32'h00000023 ) ;	// line#=computer.cpp:631
assign	M_239 = ~|( RG_regs_2 ^ 32'h00000033 ) ;	// line#=computer.cpp:631
assign	M_244 = ~|( RG_regs_2 ^ 32'h00000013 ) ;	// line#=computer.cpp:631
assign	M_246 = ~|( RG_regs_2 ^ 32'h00000017 ) ;	// line#=computer.cpp:631
assign	M_248 = ~|( RG_regs_2 ^ 32'h00000073 ) ;	// line#=computer.cpp:631
assign	M_250 = ~|( RG_regs_2 ^ 32'h0000000b ) ;	// line#=computer.cpp:631
assign	M_254 = ~|( RG_regs_2 ^ 32'h00000037 ) ;	// line#=computer.cpp:631
assign	M_256 = ~|( RG_regs_2 ^ 32'h00000003 ) ;	// line#=computer.cpp:631
assign	M_260 = ~|( RG_regs_2 ^ 32'h0000000f ) ;	// line#=computer.cpp:631
assign	U_67 = ( ST1_04d & ( ~( ( ( ( ( ( ( ( ( ( ( M_254 | M_246 ) | M_217 ) | M_223 ) | 
	M_215 ) | M_256 ) | M_227 ) | M_244 ) | M_239 ) | M_260 ) | M_248 ) | M_250 ) ) ) ;	// line#=computer.cpp:631
assign	U_69 = ( U_56 & FF_take ) ;	// line#=computer.cpp:637
assign	U_72 = ( U_59 & take_t1 ) ;	// line#=computer.cpp:662
assign	M_219 = ~|( RG_words_5 ^ 32'h00000001 ) ;	// line#=computer.cpp:668,692
assign	M_225 = ~|( RG_words_5 ^ 32'h00000004 ) ;	// line#=computer.cpp:668
assign	M_229 = ~|( RG_words_5 ^ 32'h00000005 ) ;	// line#=computer.cpp:668,692,711
assign	M_235 = ~|RG_words_5 ;	// line#=computer.cpp:668,692,711
assign	M_241 = ~|( RG_words_5 ^ 32'h00000002 ) ;	// line#=computer.cpp:668
assign	M_261 = |RG_rc_rd [4:0] ;	// line#=computer.cpp:647,675,706,725
assign	U_82 = ( U_61 & M_220 ) ;	// line#=computer.cpp:681
assign	M_220 = ~|( RG_imm1_instr_regs ^ 32'h00000001 ) ;	// line#=computer.cpp:681
assign	M_236 = ~|RG_imm1_instr_regs ;	// line#=computer.cpp:681
assign	M_242 = ~|( RG_imm1_instr_regs ^ 32'h00000002 ) ;	// line#=computer.cpp:681,744
assign	U_85 = ( U_62 & M_235 ) ;	// line#=computer.cpp:692
assign	U_91 = ( U_62 & M_219 ) ;	// line#=computer.cpp:692
assign	U_96 = ( U_63 & M_235 ) ;	// line#=computer.cpp:711
assign	M_237 = ~RG_imm1_instr_regs [23] ;	// line#=computer.cpp:701,702,703,718,719
						// ,720
assign	U_107 = ( U_66 & M_242 ) ;	// line#=computer.cpp:744
assign	U_108 = ( U_66 & M_230 ) ;	// line#=computer.cpp:744
assign	M_230 = ~|( RG_imm1_instr_regs ^ 32'h00000005 ) ;	// line#=computer.cpp:744
...
always @ ( add32s1ot or M_226 )
	TR_14 = ( { 12{ M_226 } } & add32s1ot [13:2] )	// line#=computer.cpp:52,61,679
		 ;	// line#=computer.cpp:52,56,666
assign	M_264 = ( ST1_04d & U_57 ) ;
always @ ( add32s1ot or M_264 or TR_14 or M_268 )
	TR_01 = ( ( { 30{ M_268 } } & { 18'h00000 , TR_14 } )	// line#=computer.cpp:52,56,61,666,679
		| ( { 30{ M_264 } } & add32s1ot [31:2] )	// line#=computer.cpp:52,75,642
		) ;
always @ ( RG_addr_addr1_next_pc_PC or M_137_t or U_59 or U_58 or RG_03 or U_67 or 
	U_66 or U_65 or M_260 or U_63 or U_62 or U_61 or U_60 or U_56 or U_55 or 
	ST1_04d or add32s1ot or TR_01 or M_264 or M_268 )	// line#=computer.cpp:631
	begin
	RG_addr_addr1_next_pc_PC_t_c1 = ( M_268 | M_264 ) ;	// line#=computer.cpp:52,56,61,75,642,666
								// ,679
	RG_addr_addr1_next_pc_PC_t_c2 = ( ST1_04d & ( ( ( ( ( ( ( ( ( U_55 | U_56 ) | 
		U_60 ) | U_61 ) | U_62 ) | U_63 ) | ( ST1_04d & M_260 ) ) | U_65 ) | 
	...
	RG_addr_addr1_next_pc_PC_t = ( ( { 32{ RG_addr_addr1_next_pc_PC_t_c1 } } & 
		...
		| ( { 32{ RG_addr_addr1_next_pc_PC_t_c4 } } & { M_137_t , RG_addr_addr1_next_pc_PC [0] } ) ) ;
	end
...
always @ ( U_67 or M_230 or M_242 or U_66 or U_108 or FF_take or U_107 or U_65 or 
	ST1_04d )	// line#=computer.cpp:744,755
	begin
	FF_halt_t_c1 = ( ST1_04d & ( ( ( ( U_65 | ( U_107 & ( ~FF_take ) ) ) | ( 
		U_108 & ( ~FF_take ) ) ) | ( U_66 & ( ~( M_242 | M_230 ) ) ) ) | 
...
always @ ( M_249 or M_226 or imem_arg_MEMB32W65536_RD1 or M_214 or M_222 or M_216 or 
	M_245 or M_253 or M_238 or M_228 or M_243 )
	begin
	TR_02_c1 = ( ( ( ( ( ( ( M_243 & M_228 ) | M_238 ) | M_253 ) | M_245 ) | 
		M_216 ) | M_222 ) | M_214 ) ;	// line#=computer.cpp:616
	TR_02_c2 = ( M_226 | M_249 ) ;	// line#=computer.cpp:616,681,744
...
always @ ( TR_02 or U_16 or U_11 or U_09 or U_08 or U_07 or U_06 or U_05 or U_13 or 
	M_228 or imem_arg_MEMB32W65536_RD1 or M_232 or M_251 or M_224 or M_234 or 
	U_12 or RG_imm1_instr_regs_t1 or ST1_02d )	// line#=computer.cpp:616,692
	begin
	RG_imm1_instr_regs_t_c1 = ( ( ( ( U_12 & M_234 ) | ( U_12 & M_224 ) ) | ( 
		U_12 & M_251 ) ) | ( U_12 & M_232 ) ) ;	// line#=computer.cpp:52,56,616,689
	RG_imm1_instr_regs_t_c2 = ( ( ( ( ( ( ( ( U_12 & M_228 ) | U_13 ) | U_05 ) | 
...
always @ ( RG_regs_2 or U_51 or addsub32u1ot or U_32 or U_31 or regs_rd00 or U_13 or 
	words_0_a01_t or ST1_02d )
	begin
	RG_op2_regs_word_addr_words_t_c1 = ( U_31 | U_32 ) ;	// line#=computer.cpp:113,117,124,128
	RG_op2_regs_word_addr_words_t = ( ( { 32{ ST1_02d } } & words_0_a01_t )				// line#=computer.cpp:325
...
always @ ( RG_imm1_instr_regs or U_51 or U_44 or lsft32u1ot or U_11 or regs_rd01 or 
	M_232 or M_251 or M_228 or M_224 or M_234 or U_13 or words_1_a01_t or ST1_02d )	// line#=computer.cpp:616,711
	begin
	RG_mask_op1_regs_result1_words_t_c1 = ( ( ( ( ( U_13 & M_234 ) | ( U_13 & 
		M_224 ) ) | ( U_13 & M_228 ) ) | ( U_13 & M_251 ) ) | ( U_13 & M_232 ) ) ;	// line#=computer.cpp:710
	RG_mask_op1_regs_result1_words_t = ( ( { 32{ ST1_02d } } & words_1_a01_t )	// line#=computer.cpp:325
...
always @ ( posedge CLOCK )
	if ( RG_rs2_en )
		RG_rs2 <= RG_rs2_t ;	// line#=computer.cpp:243,244,245,246,326
					// ,616,627
always @ ( add32s1ot or M_226 or imem_arg_MEMB32W65536_RD1 or M_238 or M_243 or 
	M_255 or M_222 or M_216 or M_245 or M_253 )	// line#=computer.cpp:616,623,631
	begin
	TR_15_c1 = ( ( ( M_253 | M_245 ) | M_216 ) | ( ( ( M_222 | M_255 ) | M_243 ) | 
		M_238 ) ) ;	// line#=computer.cpp:616,624
	TR_15 = ( ( { 5{ TR_15_c1 } } & imem_arg_MEMB32W65536_RD1 [11:7] )	// line#=computer.cpp:616,624
		| ( { 5{ M_226 } } & { add32s1ot [1:0] , 3'h0 } )		// line#=computer.cpp:52,61,118,119,679
		) ;
	end
assign	M_267 = ( M_266 | ( ( ( U_08 | U_10 ) | U_12 ) | U_13 ) ) ;
always @ ( TR_15 or U_11 or M_267 or regs_rg05 or ST1_02d )
	begin
	TR_03_c1 = ( M_267 | U_11 ) ;	// line#=computer.cpp:52,61,118,119,616
					// ,624,679
...
always @ ( RG_rs1 or RG_rc_rd or U_16 or TR_03 or U_11 or M_267 or ST1_02d )
	begin
	RG_rc_rd_t_c1 = ( ( ST1_02d | M_267 ) | U_11 ) ;	// line#=computer.cpp:52,61,118,119,313
								// ,616,624,679
...
always @ ( posedge CLOCK )
	RG_rc_rd <= RG_rc_rd_t ;	// line#=computer.cpp:52,61,118,119,313
					// ,316,616,624,679
assign	M_257 = ~|( { 29'h00000000 , imem_arg_MEMB32W65536_RD1 [14:12] } ^ 32'h00000003 ) ;	// line#=computer.cpp:616,692,711
assign	M_263 = ( regs_rd00 ^ regs_rd01 ) ;	// line#=computer.cpp:655,656
assign	M_266 = ( ( U_05 | U_06 ) | U_07 ) ;	// line#=computer.cpp:616,711
always @ ( incr3s1ot or ST1_05d or U_52 or CT_02 or U_51 or comp32u_12ot or comp32s_11ot or 
	U_13 or comp32u_13ot or M_257 or comp32s_1_11ot or M_240 or U_12 or M_232 or 
	comp32u_11ot or M_251 or M_228 or comp32s_12ot or M_224 or M_218 or M_263 or 
	M_234 or U_09 or imem_arg_MEMB32W65536_RD1 or M_266 )	// line#=computer.cpp:616,654,692,711
	begin
	FF_take_t_c1 = ( U_09 & M_234 ) ;	// line#=computer.cpp:655
	FF_take_t_c2 = ( U_09 & M_218 ) ;	// line#=computer.cpp:656
	FF_take_t_c3 = ( U_09 & M_224 ) ;	// line#=computer.cpp:657
	FF_take_t_c4 = ( U_09 & M_228 ) ;	// line#=computer.cpp:658
	FF_take_t_c5 = ( U_09 & M_251 ) ;	// line#=computer.cpp:659
	FF_take_t_c6 = ( U_09 & M_232 ) ;	// line#=computer.cpp:660
	FF_take_t_c7 = ( U_12 & M_240 ) ;	// line#=computer.cpp:694
	FF_take_t_c8 = ( U_12 & M_257 ) ;	// line#=computer.cpp:695
	FF_take_t_c9 = ( U_13 & M_240 ) ;	// line#=computer.cpp:714
	FF_take_t_c10 = ( U_13 & M_257 ) ;	// line#=computer.cpp:715
	FF_take_t = ( ( { 1{ M_266 } } & ( |imem_arg_MEMB32W65536_RD1 [11:7] ) )	// line#=computer.cpp:616,624,633,637,641
		| ( { 1{ FF_take_t_c1 } } & ( ~|M_263 ) )				// line#=computer.cpp:655
		| ( { 1{ FF_take_t_c2 } } & ( |M_263 ) )				// line#=computer.cpp:656
...
always @ ( RG_addr_addr1_next_pc_PC or RG_03 or add32s1ot or take_t1 )	// line#=computer.cpp:662
	...
	M_137_t = ( ( { 31{ take_t1 } } & add32s1ot [31:1] )	// line#=computer.cpp:662
		| ( { 31{ M_137_t_c1 } } & { RG_03 [31:2] , RG_addr_addr1_next_pc_PC [1] } ) ) ;
	end
assign	JF_02 = ~( ( M_250 & M_242 ) & FF_take ) ;
...
always @ ( RG_addr_addr1_next_pc_PC or U_57 or U_72 or regs_rd02 or U_58 or U_85 or 
	...
	add32s1i1 = ( ( { 32{ M_268 } } & regs_rd00 )			// line#=computer.cpp:52,56,61,666,679
...
always @ ( M_255 or imem_arg_MEMB32W65536_RD1 or M_226 )
	TR_04 = ( ( { 5{ M_226 } } & imem_arg_MEMB32W65536_RD1 [11:7] )		// line#=computer.cpp:52,60,61,616,624
										// ,628,679
		| ( { 5{ M_255 } } & imem_arg_MEMB32W65536_RD1 [24:20] )	// line#=computer.cpp:52,56,616,627,666
		) ;
always @ ( M_223 or RG_imm1_instr_regs or M_262 )
	M_286 = ( ( { 6{ M_262 } } & { RG_imm1_instr_regs [0] , RG_imm1_instr_regs [4:1] , 
			1'h0 } )								// line#=computer.cpp:52,65,66,67,628,652
												// ,662
		| ( { 6{ M_223 } } & { RG_imm1_instr_regs [24] , RG_imm1_instr_regs [17:13] } )	// line#=computer.cpp:52,56,627,646
		) ;
assign	M_262 = ( M_215 & take_t1 ) ;
always @ ( M_217 or M_286 or RG_imm1_instr_regs or M_223 or M_262 )
	begin
	M_287_c1 = ( M_262 | M_223 ) ;	// line#=computer.cpp:52,56,65,66,67,627
					// ,628,646,652,662
	M_287 = ( ( { 14{ M_287_c1 } } & { RG_imm1_instr_regs [24] , RG_imm1_instr_regs [24] , 
			RG_imm1_instr_regs [24] , RG_imm1_instr_regs [24] , RG_imm1_instr_regs [24] , 
			RG_imm1_instr_regs [24] , RG_imm1_instr_regs [24] , RG_imm1_instr_regs [24] , 
			M_286 } )				// line#=computer.cpp:52,56,65,66,67,627
								// ,628,646,652,662
		| ( { 14{ M_217 } } & { RG_imm1_instr_regs [12:5] , RG_imm1_instr_regs [13] , 
			RG_imm1_instr_regs [17:14] , 1'h0 } )	// line#=computer.cpp:52,73,74,75,625,627
								// ,642
		) ;
	end
always @ ( M_287 or U_57 or U_58 or U_72 or RG_imm1_instr_regs or U_85 or TR_04 or 
	imem_arg_MEMB32W65536_RD1 or M_268 )
	begin
	add32s1i2_c1 = ( ( U_72 | U_58 ) | U_57 ) ;	// line#=computer.cpp:52,56,65,66,67,73
							// ,74,75,625,627,628,642,646,652
							// ,662
	add32s1i2 = ( ( { 21{ M_268 } } & { imem_arg_MEMB32W65536_RD1 [31] , imem_arg_MEMB32W65536_RD1 [31] , 
			imem_arg_MEMB32W65536_RD1 [31] , imem_arg_MEMB32W65536_RD1 [31] , 
			imem_arg_MEMB32W65536_RD1 [31] , imem_arg_MEMB32W65536_RD1 [31] , 
			imem_arg_MEMB32W65536_RD1 [31] , imem_arg_MEMB32W65536_RD1 [31] , 
		...
		| ( { 21{ add32s1i2_c1 } } & { RG_imm1_instr_regs [24] , M_287 [13:5] , 
			RG_imm1_instr_regs [23:18] , M_287 [4:0] } )		// line#=computer.cpp:52,56,65,66,67,73
										// ,74,75,625,627,628,642,646,652
										// ,662
		) ;
	end
...
always @ ( regs_rd02 or U_91 or regs_rd01 or U_44 or TR_16 or M_270 )
	lsft32u1i1 = ( ( { 32{ M_270 } } & { 16'h0000 , TR_16 , 8'hff } )	// line#=computer.cpp:119,130
...
assign	M_270 = ( U_31 | U_82 ) ;
always @ ( RG_rs2 or U_91 or regs_rd00 or U_44 or TR_08 or M_270 )
	lsft32u1i2 = ( ( { 5{ M_270 } } & { TR_08 , 3'h0 } )	// line#=computer.cpp:52,61,118,119,129
								// ,130,679
		| ( { 5{ U_44 } } & regs_rd00 [4:0] )		// line#=computer.cpp:710,713
		| ( { 5{ U_91 } } & RG_rs2 [4:0] )		// line#=computer.cpp:699
		) ;
always @ ( dmem_arg_MEMB32W4096_RD1 or M_277 or regs_rd02 or M_279 or RG_mask_op1_regs_result1_words or 
	M_280 )
	rsft32u1i1 = ( ( { 32{ M_280 } } & RG_mask_op1_regs_result1_words )	// line#=computer.cpp:718,719,720
		| ( { 32{ M_279 } } & regs_rd02 )				// line#=computer.cpp:701,702,703
		| ( { 32{ M_277 } } & dmem_arg_MEMB32W4096_RD1 )		// line#=computer.cpp:90,91,100,101,669
										// ,670,672,673
		) ;
assign	M_277 = ( ( ( ( M_256 & M_229 ) | ( M_256 & M_225 ) ) | ( M_256 & M_219 ) ) | 
	( M_256 & M_235 ) ) ;
assign	M_279 = ( ( M_244 & M_229 ) & M_237 ) ;
assign	M_280 = ( ( M_239 & M_229 ) & M_237 ) ;
always @ ( RG_addr_addr1_next_pc_PC or M_277 or RG_rs2 or M_279 or RG_op2_regs_word_addr_words or 
	M_280 )
	rsft32u1i2 = ( ( { 5{ M_280 } } & RG_op2_regs_word_addr_words [4:0] )		// line#=computer.cpp:718,719,720
		| ( { 5{ M_279 } } & RG_rs2 [4:0] )					// line#=computer.cpp:701,702,703
		| ( { 5{ M_277 } } & { RG_addr_addr1_next_pc_PC [1:0] , 3'h0 } )	// line#=computer.cpp:90,91,100,101,669
											// ,670,672,673
		) ;
always @ ( regs_rd02 or M_244 or RG_mask_op1_regs_result1_words or M_239 )
	rsft32s1i1 = ( ( { 32{ M_239 } } & RG_mask_op1_regs_result1_words )	// line#=computer.cpp:718,719,720
		| ( { 32{ M_244 } } & regs_rd02 )				// line#=computer.cpp:701,702,703
		) ;
always @ ( RG_rs2 or M_244 or RG_op2_regs_word_addr_words or M_239 )
	rsft32s1i2 = ( ( { 5{ M_239 } } & RG_op2_regs_word_addr_words [4:0] )	// line#=computer.cpp:718,719,720
		| ( { 5{ M_244 } } & RG_rs2 [4:0] )				// line#=computer.cpp:701,702,703
		) ;
always @ ( RG_mask_op1_regs_result1_words or U_96 or add32s1ot or U_25 or U_26 or 
	U_28 or U_29 or M_271 or RG_addr_addr1_next_pc_PC or M_265 )
	begin
	addsub32u1i1_c1 = ( M_271 | ( ( ( U_29 | U_28 ) | U_26 ) | U_25 ) ) ;	// line#=computer.cpp:52,56,61,85,95,113
										// ,124,666,679
	addsub32u1i1 = ( ( { 32{ M_265 } } & RG_addr_addr1_next_pc_PC )	// line#=computer.cpp:70,629,637
...
always @ ( M_269 or RG_imm1_instr_regs or U_69 )
	TR_17 = ( ( { 20{ U_69 } } & RG_imm1_instr_regs [24:5] )	// line#=computer.cpp:70,637
		| ( { 20{ M_269 } } & 20'h00040 )			// line#=computer.cpp:85,95,113,124
		) ;
always @ ( U_01 or TR_17 or M_269 or U_69 )
	begin
	M_288_c1 = ( U_69 | M_269 ) ;	// line#=computer.cpp:70,85,95,113,124
					// ,637
	M_288 = ( ( { 21{ M_288_c1 } } & { TR_17 , 1'h0 } )	// line#=computer.cpp:70,85,95,113,124
								// ,637
		| ( { 21{ U_01 } } & 21'h000001 )		// line#=computer.cpp:629
		) ;
	end
assign	M_265 = ( U_69 | U_01 ) ;
always @ ( RG_op2_regs_word_addr_words or U_96 or M_288 or M_269 or M_265 )
	begin
	addsub32u1i2_c1 = ( M_265 | M_269 ) ;	// line#=computer.cpp:70,85,95,113,124
						// ,629,637
	addsub32u1i2 = ( ( { 32{ addsub32u1i2_c1 } } & { M_288 [20:1] , 9'h000 , 
			M_288 [0] , 2'h0 } )				// line#=computer.cpp:70,85,95,113,124
									// ,629,637
		| ( { 32{ U_96 } } & RG_op2_regs_word_addr_words )	// line#=computer.cpp:712
		) ;
	end
assign	M_271 = ( U_32 | U_31 ) ;
assign	M_269 = ( ( ( ( M_271 | U_29 ) | U_28 ) | U_26 ) | U_25 ) ;
always @ ( RG_imm1_instr_regs )	// line#=computer.cpp:712
	...
	endcase
always @ ( addsub32u1_f_t1 or U_96 or M_269 or M_265 )
	addsub32u1_f = ( ( { 2{ M_265 } } & 2'h1 )
		| ( { 2{ M_269 } } & 2'h2 )
...
always @ ( regs_rd03 or M_220 )
	TR_10 = ( { 8{ M_220 } } & regs_rd03 [15:8] )	// line#=computer.cpp:131,683
		 ;	// line#=computer.cpp:120,682
assign	lsft32u_321i1 = { TR_10 , regs_rd03 [7:0] } ;	// line#=computer.cpp:120,131,682,683
always @ ( RG_rc_rd or M_236 or RG_addr_addr1_next_pc_PC or M_220 )
	lsft32u_321i2 = ( ( { 5{ M_220 } } & { RG_addr_addr1_next_pc_PC [1:0] , 3'h0 } )	// line#=computer.cpp:129,130,131,683
		| ( { 5{ M_236 } } & RG_rc_rd [4:0] )						// line#=computer.cpp:120,682
		) ;
assign	imem_arg_MEMB32W65536_RE1 = U_01 ;	// line#=computer.cpp:616
always @ ( regs_rd03 or M_242 or lsft32u1ot or M_220 or lsft32u_321ot or RG_mask_op1_regs_result1_words or 
	dmem_arg_MEMB32W4096_RD1 or M_236 )
	dmem_arg_MEMB32W4096_WD2 = ( ( { 32{ M_236 } } & ( ( dmem_arg_MEMB32W4096_RD1 & 
			RG_mask_op1_regs_result1_words ) | lsft32u_321ot ) )	// line#=computer.cpp:120,682
		| ( { 32{ M_220 } } & ( ( dmem_arg_MEMB32W4096_RD1 & ( ~lsft32u1ot ) ) | 
			lsft32u_321ot ) )					// line#=computer.cpp:130,131,683
		| ( { 32{ M_242 } } & regs_rd03 )				// line#=computer.cpp:139
		) ;
always @ ( addsub32u1ot or M_226 or M_228 or M_224 or M_218 or M_234 or add32s1ot or 
	M_240 or M_255 )
	begin
	dmem_arg_MEMB32W4096_RA1_c1 = ( M_255 & M_240 ) ;	// line#=computer.cpp:52,56,105,109,666
								// ,671
	dmem_arg_MEMB32W4096_RA1_c2 = ( ( ( ( ( ( M_255 & M_234 ) | ( M_255 & M_218 ) ) | 
		( M_255 & M_224 ) ) | ( M_255 & M_228 ) ) | ( M_226 & M_234 ) ) | 
		( M_226 & M_218 ) ) ;	// line#=computer.cpp:85,89,91,95,99,101
...
always @ ( RG_addr_addr1_next_pc_PC or M_242 or RG_op2_regs_word_addr_words or M_220 or 
	M_236 )	// line#=computer.cpp:681
	begin
	dmem_arg_MEMB32W4096_WA2_c1 = ( M_236 | M_220 ) ;	// line#=computer.cpp:120,130,131
	dmem_arg_MEMB32W4096_WA2 = ( ( { 12{ dmem_arg_MEMB32W4096_WA2_c1 } } & RG_op2_regs_word_addr_words [11:0] )	// line#=computer.cpp:120,130,131
		| ( { 12{ M_242 } } & RG_addr_addr1_next_pc_PC [13:2] )							// line#=computer.cpp:135,139
		) ;
	end
...
assign	dmem_arg_MEMB32W4096_WE2 = ( ( ( U_61 & M_236 ) | U_82 ) | ( U_61 & M_242 ) ) ;	// line#=computer.cpp:120,130,131,139,681
always @ ( M_272 or M_255 or M_226 or M_240 or M_257 or M_243 or imem_arg_MEMB32W65536_RD1 or 
	M_238 )
	begin
	regs_ad00_c1 = ( ( ( ( M_243 & M_257 ) | ( M_243 & M_240 ) ) | ( M_226 | 
		M_255 ) ) | M_272 ) ;	// line#=computer.cpp:616,626
...
assign	M_272 = ( ( ( ( ( ( M_214 & M_232 ) | ( M_214 & M_251 ) ) | ( M_214 & M_228 ) ) | 
	( M_214 & M_224 ) ) | ( M_214 & M_218 ) ) | ( M_214 & M_234 ) ) ;
always @ ( M_272 or imem_arg_MEMB32W65536_RD1 or M_238 )
	regs_ad01 = ( ( { 5{ M_238 } } & imem_arg_MEMB32W65536_RD1 [19:15] )	// line#=computer.cpp:616
		| ( { 5{ M_272 } } & imem_arg_MEMB32W65536_RD1 [24:20] )	// line#=computer.cpp:616
		) ;
assign	regs_ad04 = RG_rc_rd [4:0] ;	// line#=computer.cpp:70,633,637,641,647
					// ,675,706,725
assign	M_233 = ~|( RG_words_5 ^ 32'h00000007 ) ;
assign	M_252 = ~|( RG_words_5 ^ 32'h00000006 ) ;
assign	M_258 = ~|( RG_words_5 ^ 32'h00000003 ) ;
assign	M_282 = ( M_239 & M_261 ) ;
assign	M_285 = ( M_244 & M_261 ) ;
always @ ( rsft32u1ot or rsft32s1ot or RG_imm1_instr_regs )	// line#=computer.cpp:701,702,703
	...
	default :
		TR_19 = 32'hx ;
	endcase
always @ ( M_254 or RG_op2_regs_word_addr_words or RG_mask_op1_regs_result1_words or 
	M_219 or addsub32u1ot or M_246 or U_96 or RG_03 or FF_take or M_217 or M_223 or 
	TR_19 or M_229 or lsft32u1ot or U_91 or M_233 or M_252 or RG_imm1_instr_regs or 
	regs_rd02 or M_225 or TR_18 or U_63 or M_282 or M_258 or M_241 or U_62 or 
	add32s1ot or U_85 or M_285 or val2_t4 or M_261 or M_256 )	// line#=computer.cpp:692,711
	begin
	regs_wd04_c1 = ( M_256 & M_261 ) ;	// line#=computer.cpp:675
	regs_wd04_c2 = ( M_285 & U_85 ) ;	// line#=computer.cpp:693
	regs_wd04_c3 = ( ( ( ( M_285 & ( U_62 & M_241 ) ) | ( M_285 & ( U_62 & M_258 ) ) ) | 
		( M_282 & ( U_63 & M_241 ) ) ) | ( M_282 & ( U_63 & M_258 ) ) ) ;
	regs_wd04_c4 = ( M_285 & ( U_62 & M_225 ) ) ;	// line#=computer.cpp:696
	regs_wd04_c5 = ( M_285 & ( U_62 & M_252 ) ) ;	// line#=computer.cpp:697
	regs_wd04_c6 = ( M_285 & ( U_62 & M_233 ) ) ;	// line#=computer.cpp:698
	regs_wd04_c7 = ( M_285 & U_91 ) ;	// line#=computer.cpp:699
	regs_wd04_c8 = ( M_285 & ( U_62 & M_229 ) ) ;	// line#=computer.cpp:701,702,703
	regs_wd04_c9 = ( ( M_223 & M_261 ) | ( M_217 & FF_take ) ) ;	// line#=computer.cpp:641,647
	regs_wd04_c10 = ( ( M_282 & U_96 ) | ( M_246 & FF_take ) ) ;	// line#=computer.cpp:70,637,712
	regs_wd04_c11 = ( M_282 & ( U_63 & M_219 ) ) ;	// line#=computer.cpp:713
	regs_wd04_c12 = ( M_282 & ( U_63 & M_225 ) ) ;	// line#=computer.cpp:716
	regs_wd04_c13 = ( M_282 & ( U_63 & M_252 ) ) ;	// line#=computer.cpp:722
	regs_wd04_c14 = ( M_282 & ( U_63 & M_233 ) ) ;	// line#=computer.cpp:723
	regs_wd04_c15 = ( M_282 & ( U_63 & M_229 ) ) ;	// line#=computer.cpp:718,719,720
	regs_wd04_c16 = ( M_254 & FF_take ) ;	// line#=computer.cpp:70,633
...
assign	regs_we04 = ( ( ( ( ( ( ( U_60 & M_261 ) | ( U_62 & M_261 ) ) | ( U_58 & 
	M_261 ) ) | ( U_63 & M_261 ) ) | U_69 ) | ( U_57 & FF_take ) ) | ( U_55 & 
