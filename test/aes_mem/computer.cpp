...
// ============================================================================
// Main Processor Loop
// aes_mem uses the RAM pragma on dmem_arg so the regenerated RTL exposes a
// standard memory interface for both baseline and accelerated variants.
// ============================================================================

// Cyber func=process
bool computer(uint32_t imem_arg[MEM_SIZE]/* Cyber array=ROM */
  , uint32_t dmem_arg[DMEM_SIZE]/*Cyber array=RAM */
#ifdef C
  , ofstream &rpt
#endif
) {
