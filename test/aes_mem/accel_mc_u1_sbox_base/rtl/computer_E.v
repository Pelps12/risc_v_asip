...
// bdlpars options:  -EE -DAES_MEM -DACCEL_MIX_COL -DACCEL_SBOX_WORD -DACCEL_MIX_COL_U1 -info_base_name computer computer.cpp
// bdltran options:  -EE computer.IFF -c1000 -s -Zresource_fcnt=GENERATE -Zresource_mcnt=GENERATE -Zsync -Zdup_reset=YES -Zfolding_sharing=inter_stage -lb /proj/cad/cwb-6.1/packages/asic_45.BLIB -lfl /proj/cad/cwb-6.1/packages/asic_45.FLIB -o-P 
// timestamp_0: 20260604024954_93917_73792
// timestamp_5: 20260604024954_93931_62476
// timestamp_9: 20260604024955_93931_79378
// timestamp_C: 20260604024955_93931_48914
// timestamp_E: 20260604024955_93931_82488
// timestamp_V: 20260604024955_93945_19778
...
wire		RG_i_en ;
wire		FF_halt_en ;
wire		RG_bytes_regs_en ;
wire		RG_addr_addr1_bytes_op2_regs_en ;
wire		RG_imm1_op1_regs_rs2_en ;
...
reg	[31:0]	RG_03 ;
reg	[31:0]	RG_instr_regs ;	// line#=computer.cpp:20
reg	[31:0]	RG_bytes_regs ;	// line#=computer.cpp:20,277
reg	[31:0]	RG_addr_addr1_bytes_op2_regs ;	// line#=computer.cpp:20,277,710
reg	[31:0]	RG_imm1_op1_regs_rs2 ;	// line#=computer.cpp:20,627,689,710
reg	[4:0]	RG_rs1 ;	// line#=computer.cpp:626
reg	[31:0]	RG_PC_regs_word_addr ;	// line#=computer.cpp:20,21,117,128
...
reg	TR_02_c1 ;
reg	TR_02_c2 ;
reg	[31:0]	RG_instr_regs_t ;
reg	[31:0]	RG_instr_regs_t1 ;
reg	RG_instr_regs_t_c1 ;
reg	[31:0]	RG_bytes_regs_t ;
reg	[31:0]	RG_bytes_regs_t1 ;
reg	[11:0]	TR_15 ;
reg	[31:0]	RG_addr_addr1_bytes_op2_regs_t ;
reg	[31:0]	RG_addr_addr1_bytes_op2_regs_t1 ;
reg	[26:0]	TR_04 ;
reg	TR_04_c1 ;
reg	[23:0]	TR_05 ;
reg	[31:0]	RG_imm1_op1_regs_rs2_t ;
reg	[31:0]	RG_imm1_op1_regs_rs2_t1 ;
reg	RG_imm1_op1_regs_rs2_t_c1 ;
reg	RG_imm1_op1_regs_rs2_t_c2 ;
reg	[11:0]	TR_06 ;
reg	[31:0]	RG_PC_regs_word_addr_t ;
reg	RG_PC_regs_word_addr_t_c1 ;
reg	RG_PC_regs_word_addr_t_c2 ;
reg	FF_take_t ;
reg	FF_take_t_c1 ;
reg	FF_take_t_c2 ;
reg	FF_take_t_c3 ;
...
always @ ( regs_rg31 or regs_rg30 or regs_rg29 or regs_rg28 or regs_rg27 or regs_rg26 or 
	...
	regs_rg13 or regs_rg12 or regs_rg11 or regs_rg10 or regs_rg09 or regs_rg08 or 
	regs_rg07 or regs_rg06 or regs_rg05 or regs_rg04 or regs_rg03 or regs_rg02 or 
	regs_rg01 or regs_rg00 or RG_imm1_op1_regs_rs2 )	// line#=computer.cpp:20
	case ( RG_imm1_op1_regs_rs2 [4:0] )
	5'h00 :
		regs_rd03 = regs_rg00 ;
	5'h01 :
		regs_rd03 = regs_rg01 ;
...
always @ ( RG_PC_regs_word_addr or M_05 or U_112 or M_179 or M_178 or M_177 or M_176 or 
	cols_d01 or ST1_05d )	// line#=computer.cpp:164,170,171,172,173
				// ,175,179,188
	begin
	cols_rg00_t_c1 = ( ST1_05d & cols_d01 [3] ) ;	// line#=computer.cpp:164,165,166,167,170
							// ,171,172,173,175,188
	cols_rg00_t_c2 = ( U_112 & M_05 ) ;	// line#=computer.cpp:179
	cols_rg00_t = ( ( { 32{ cols_rg00_t_c1 } } & { M_176 , M_177 , M_178 , M_179 } )	// line#=computer.cpp:164,165,166,167,170
												// ,171,172,173,175,188
		| ( { 32{ cols_rg00_t_c2 } } & RG_PC_regs_word_addr )				// line#=computer.cpp:179
		) ;
	end
...
always @ ( RG_bytes_regs or M_06 or U_112 or M_179 or M_178 or M_177 or M_176 or 
	cols_d01 or ST1_05d )	// line#=computer.cpp:164,170,171,172,173
				// ,175,179,188
	begin
	cols_rg01_t_c1 = ( ST1_05d & cols_d01 [2] ) ;	// line#=computer.cpp:164,165,166,167,170
							// ,171,172,173,175,188
	cols_rg01_t_c2 = ( U_112 & M_06 ) ;	// line#=computer.cpp:179
	cols_rg01_t = ( ( { 32{ cols_rg01_t_c1 } } & { M_176 , M_177 , M_178 , M_179 } )	// line#=computer.cpp:164,165,166,167,170
												// ,171,172,173,175,188
		| ( { 32{ cols_rg01_t_c2 } } & RG_bytes_regs )					// line#=computer.cpp:179
		) ;
	end
...
always @ ( RG_addr_addr1_bytes_op2_regs or M_07 or U_112 or M_179 or M_178 or M_177 or 
	M_176 or cols_d01 or ST1_05d )	// line#=computer.cpp:164,170,171,172,173
					// ,175,179,188
	begin
	cols_rg02_t_c1 = ( ST1_05d & cols_d01 [1] ) ;	// line#=computer.cpp:164,165,166,167,170
							// ,171,172,173,175,188
	cols_rg02_t_c2 = ( U_112 & M_07 ) ;	// line#=computer.cpp:179
	cols_rg02_t = ( ( { 32{ cols_rg02_t_c1 } } & { M_176 , M_177 , M_178 , M_179 } )	// line#=computer.cpp:164,165,166,167,170
												// ,171,172,173,175,188
		| ( { 32{ cols_rg02_t_c2 } } & RG_addr_addr1_bytes_op2_regs )			// line#=computer.cpp:179
		) ;
	end
...
always @ ( RG_imm1_op1_regs_rs2 or M_08 or U_112 or M_179 or M_178 or M_177 or M_176 or 
	cols_d01 or ST1_05d )	// line#=computer.cpp:164,170,171,172,173
				// ,175,179,188
	begin
	cols_rg03_t_c1 = ( ST1_05d & cols_d01 [0] ) ;	// line#=computer.cpp:164,165,166,167,170
							// ,171,172,173,175,188
	cols_rg03_t_c2 = ( U_112 & M_08 ) ;	// line#=computer.cpp:179
	cols_rg03_t = ( ( { 32{ cols_rg03_t_c1 } } & { M_176 , M_177 , M_178 , M_179 } )	// line#=computer.cpp:164,165,166,167,170
												// ,171,172,173,175,188
		| ( { 32{ cols_rg03_t_c2 } } & RG_imm1_op1_regs_rs2 )				// line#=computer.cpp:179
		) ;
	end
...
always @ ( FF_take or RG_imm1_op1_regs_rs2 )	// line#=computer.cpp:654
	case ( RG_imm1_op1_regs_rs2 )
	32'h00000000 :
	...
	endcase
always @ ( dmem_arg_MEMB32W4096_RD1 or rsft32u1ot or RG_PC_regs_word_addr )	// line#=computer.cpp:668
	case ( RG_PC_regs_word_addr )
	32'h00000000 :
...
always @ ( FF_take )	// line#=computer.cpp:694
	...
	default :
		TR_18 = 1'hx ;
	endcase
assign	e_t = ( M_127_t ^ M_125_t ) ;	// line#=computer.cpp:164,165,166,167,168
					// ,188
always @ ( M_131_t or M_127_t )	// line#=computer.cpp:164,170
	case ( M_127_t [7] )
	1'h1 :
		M_277 = { ~M_131_t [3:2] , ~M_131_t [0] , 1'h1 } ;	// line#=computer.cpp:164,170
	1'h0 :
		M_277 = { M_131_t [3:2] , M_131_t [0] , 1'h0 } ;	// line#=computer.cpp:164,165,170,188
	default :
		M_277 = 4'hx ;
	endcase
always @ ( M_130_t or M_126_t )	// line#=computer.cpp:171
	case ( M_126_t [7] )
	1'h1 :
		M_275 = { ~M_130_t [3:2] , ~M_130_t [0] , 1'h1 } ;	// line#=computer.cpp:171
	1'h0 :
		M_275 = { M_130_t [3:2] , M_130_t [0] , 1'h0 } ;	// line#=computer.cpp:165,166,171,188
	default :
		M_275 = 4'hx ;
	endcase
always @ ( M_129_t or M_125_t )	// line#=computer.cpp:172
	case ( M_125_t [7] )
	1'h1 :
		M_274 = { ~M_129_t [3:2] , ~M_129_t [0] , 1'h1 } ;	// line#=computer.cpp:172
	1'h0 :
		M_274 = { M_129_t [3:2] , M_129_t [0] , 1'h0 } ;	// line#=computer.cpp:166,167,172,188
	default :
		M_274 = 4'hx ;
	endcase
always @ ( M_128_t or M_124_t )	// line#=computer.cpp:164,173
	case ( M_124_t [7] )
	1'h1 :
		M_276 = { ~M_128_t [3:2] , ~M_128_t [0] , 1'h1 } ;	// line#=computer.cpp:164,173
	1'h0 :
		M_276 = { M_128_t [3:2] , M_128_t [0] , 1'h0 } ;	// line#=computer.cpp:164,167,173,188
	default :
		M_276 = 4'hx ;
	endcase
assign	M_124_t = ( cols_rd00 [31:24] ^ cols_rd00 [7:0] ) ;	// line#=computer.cpp:164,167,173,188
assign	M_125_t = ( cols_rd00 [23:16] ^ cols_rd00 [31:24] ) ;	// line#=computer.cpp:164,165,166,167,168
								// ,172,188
assign	M_126_t = ( cols_rd00 [15:8] ^ cols_rd00 [23:16] ) ;	// line#=computer.cpp:165,166,171,188
assign	M_127_t = ( cols_rd00 [7:0] ^ cols_rd00 [15:8] ) ;	// line#=computer.cpp:164,165,166,167,168
								// ,170,188
assign	M_128_t = ( cols_rd00 [30:24] ^ cols_rd00 [6:0] ) ;	// line#=computer.cpp:164,167,173,188
assign	M_129_t = ( cols_rd00 [22:16] ^ cols_rd00 [30:24] ) ;	// line#=computer.cpp:166,167,172,188
assign	M_130_t = ( cols_rd00 [14:8] ^ cols_rd00 [22:16] ) ;	// line#=computer.cpp:165,166,171,188
assign	M_131_t = ( cols_rd00 [6:0] ^ cols_rd00 [14:8] ) ;	// line#=computer.cpp:164,165,170,188
...
assign	cols_ad01 = RG_i [1:0] ;	// line#=computer.cpp:164,170,171,172,173
					// ,175,188
assign	M_176 = ( ( cols_rd00 [31:24] ^ e_t ) ^ { M_128_t [6:4] , M_276 [3:2] , M_128_t [1] , 
	M_276 [1:0] } ) ;	// line#=computer.cpp:164,165,166,167,170
				// ,171,172,173,175,188
assign	M_177 = ( ( cols_rd00 [23:16] ^ e_t ) ^ { M_129_t [6:4] , M_274 [3:2] , M_129_t [1] , 
	M_274 [1:0] } ) ;	// line#=computer.cpp:164,165,166,167,170
				// ,171,172,173,175,188
assign	M_178 = ( ( cols_rd00 [15:8] ^ e_t ) ^ { M_130_t [6:4] , M_275 [3:2] , M_130_t [1] , 
	M_275 [1:0] } ) ;	// line#=computer.cpp:164,165,166,167,170
				// ,171,172,173,175,188
assign	M_179 = ( ( cols_rd00 [7:0] ^ e_t ) ^ { M_131_t [6:4] , M_277 [3:2] , M_131_t [1] , 
	M_277 [1:0] } ) ;	// line#=computer.cpp:164,165,166,167,170
				// ,171,172,173,175,188
assign	U_01 = ( ST1_02d & CT_01 ) ;	// line#=computer.cpp:615
assign	U_05 = ( ST1_03d & M_229 ) ;	// line#=computer.cpp:616,623,631
assign	U_06 = ( ST1_03d & M_221 ) ;	// line#=computer.cpp:616,623,631
assign	U_07 = ( ST1_03d & M_194 ) ;	// line#=computer.cpp:616,623,631
assign	U_09 = ( ST1_03d & M_192 ) ;	// line#=computer.cpp:616,623,631
assign	U_10 = ( ST1_03d & M_232 ) ;	// line#=computer.cpp:616,623,631
assign	U_11 = ( ST1_03d & M_204 ) ;	// line#=computer.cpp:616,623,631
assign	U_12 = ( ST1_03d & M_219 ) ;	// line#=computer.cpp:616,623,631
assign	U_13 = ( ST1_03d & M_214 ) ;	// line#=computer.cpp:616,623,631
assign	U_16 = ( ST1_03d & M_225 ) ;	// line#=computer.cpp:616,623,631
assign	M_192 = ~|( { 25'h0000000 , imem_arg_MEMB32W65536_RD1 [6:0] } ^ 32'h00000063 ) ;	// line#=computer.cpp:616,623,631
assign	M_194 = ~|( { 25'h0000000 , imem_arg_MEMB32W65536_RD1 [6:0] } ^ 32'h0000006f ) ;	// line#=computer.cpp:616,623,631
assign	M_204 = ~|( { 25'h0000000 , imem_arg_MEMB32W65536_RD1 [6:0] } ^ 32'h00000023 ) ;	// line#=computer.cpp:616,623,631
assign	M_214 = ~|( { 25'h0000000 , imem_arg_MEMB32W65536_RD1 [6:0] } ^ 32'h00000033 ) ;	// line#=computer.cpp:616,623,631
assign	M_219 = ~|( { 25'h0000000 , imem_arg_MEMB32W65536_RD1 [6:0] } ^ 32'h00000013 ) ;	// line#=computer.cpp:616,623,631
assign	M_221 = ~|( { 25'h0000000 , imem_arg_MEMB32W65536_RD1 [6:0] } ^ 32'h00000017 ) ;	// line#=computer.cpp:616,623,631
assign	M_225 = ~|( { 25'h0000000 , imem_arg_MEMB32W65536_RD1 [6:0] } ^ 32'h0000000b ) ;	// line#=computer.cpp:616,623,631
assign	M_229 = ~|( { 25'h0000000 , imem_arg_MEMB32W65536_RD1 [6:0] } ^ 32'h00000037 ) ;	// line#=computer.cpp:616,623,631
assign	M_232 = ~|( { 25'h0000000 , imem_arg_MEMB32W65536_RD1 [6:0] } ^ 32'h00000003 ) ;	// line#=computer.cpp:616,623,631
assign	M_196 = ~|( { 29'h00000000 , imem_arg_MEMB32W65536_RD1 [14:12] } ^ 32'h00000001 ) ;	// line#=computer.cpp:616,654,668,681,692
												// ,711,744
assign	M_202 = ~|( { 29'h00000000 , imem_arg_MEMB32W65536_RD1 [14:12] } ^ 32'h00000004 ) ;	// line#=computer.cpp:616,654,668,692,711
assign	M_206 = ~|( { 29'h00000000 , imem_arg_MEMB32W65536_RD1 [14:12] } ^ 32'h00000005 ) ;	// line#=computer.cpp:616,654,668,692,711
assign	M_208 = ~|( { 29'h00000000 , imem_arg_MEMB32W65536_RD1 [14:12] } ^ 32'h00000007 ) ;	// line#=computer.cpp:616,654,692,711
assign	M_210 = ~|{ 29'h00000000 , imem_arg_MEMB32W65536_RD1 [14:12] } ;	// line#=computer.cpp:616,654,668,681,692
										// ,711
assign	M_227 = ~|( { 29'h00000000 , imem_arg_MEMB32W65536_RD1 [14:12] } ^ 32'h00000006 ) ;	// line#=computer.cpp:616,654,692,711
assign	U_25 = ( U_10 & M_210 ) ;	// line#=computer.cpp:616,668
assign	U_26 = ( U_10 & M_196 ) ;	// line#=computer.cpp:616,668
assign	U_28 = ( U_10 & M_202 ) ;	// line#=computer.cpp:616,668
assign	U_29 = ( U_10 & M_206 ) ;	// line#=computer.cpp:616,668
assign	M_216 = ~|( { 29'h00000000 , imem_arg_MEMB32W65536_RD1 [14:12] } ^ 32'h00000002 ) ;	// line#=computer.cpp:616,668,681,692,711
												// ,744
assign	U_31 = ( U_11 & M_210 ) ;	// line#=computer.cpp:616,681
assign	U_32 = ( U_11 & M_196 ) ;	// line#=computer.cpp:616,681
assign	U_51 = ( U_16 & M_196 ) ;	// line#=computer.cpp:616,744
assign	U_54 = ( U_51 & CT_03 ) ;	// line#=computer.cpp:747
assign	U_55 = ( ST1_04d & M_230 ) ;	// line#=computer.cpp:631
assign	U_56 = ( ST1_04d & M_222 ) ;	// line#=computer.cpp:631
assign	U_57 = ( ST1_04d & M_195 ) ;	// line#=computer.cpp:631
assign	U_58 = ( ST1_04d & M_200 ) ;	// line#=computer.cpp:631
assign	U_59 = ( ST1_04d & M_193 ) ;	// line#=computer.cpp:631
assign	U_60 = ( ST1_04d & M_233 ) ;	// line#=computer.cpp:631
assign	U_61 = ( ST1_04d & M_205 ) ;	// line#=computer.cpp:631
assign	U_62 = ( ST1_04d & M_220 ) ;	// line#=computer.cpp:631
assign	U_63 = ( ST1_04d & M_215 ) ;	// line#=computer.cpp:631
assign	U_65 = ( ST1_04d & M_224 ) ;	// line#=computer.cpp:631
assign	U_66 = ( ST1_04d & M_226 ) ;	// line#=computer.cpp:631
assign	M_193 = ~|( RG_next_pc_PC ^ 32'h00000063 ) ;	// line#=computer.cpp:631
assign	M_195 = ~|( RG_next_pc_PC ^ 32'h0000006f ) ;	// line#=computer.cpp:631
assign	M_200 = ~|( RG_next_pc_PC ^ 32'h00000067 ) ;	// line#=computer.cpp:631
assign	M_205 = ~|( RG_next_pc_PC ^ 32'h00000023 ) ;	// line#=computer.cpp:631
assign	M_215 = ~|( RG_next_pc_PC ^ 32'h00000033 ) ;	// line#=computer.cpp:631
assign	M_220 = ~|( RG_next_pc_PC ^ 32'h00000013 ) ;	// line#=computer.cpp:631
assign	M_222 = ~|( RG_next_pc_PC ^ 32'h00000017 ) ;	// line#=computer.cpp:631
assign	M_224 = ~|( RG_next_pc_PC ^ 32'h00000073 ) ;	// line#=computer.cpp:631
assign	M_226 = ~|( RG_next_pc_PC ^ 32'h0000000b ) ;	// line#=computer.cpp:631
assign	M_230 = ~|( RG_next_pc_PC ^ 32'h00000037 ) ;	// line#=computer.cpp:631
assign	M_233 = ~|( RG_next_pc_PC ^ 32'h00000003 ) ;	// line#=computer.cpp:631
assign	M_237 = ~|( RG_next_pc_PC ^ 32'h0000000f ) ;	// line#=computer.cpp:631
assign	U_67 = ( ST1_04d & ( ~( ( ( ( ( ( ( ( ( ( ( M_230 | M_222 ) | M_195 ) | M_200 ) | 
	M_193 ) | M_233 ) | M_205 ) | M_220 ) | M_215 ) | M_237 ) | M_224 ) | M_226 ) ) ) ;	// line#=computer.cpp:631
assign	U_68 = ( U_55 & FF_take ) ;	// line#=computer.cpp:633
assign	U_69 = ( U_56 & FF_take ) ;	// line#=computer.cpp:637
assign	U_70 = ( U_57 & FF_take ) ;	// line#=computer.cpp:641
assign	U_71 = ( U_58 & M_238 ) ;	// line#=computer.cpp:647
assign	U_72 = ( U_59 & take_t1 ) ;	// line#=computer.cpp:662
assign	M_197 = ~|( RG_PC_regs_word_addr ^ 32'h00000001 ) ;	// line#=computer.cpp:668,692,711
assign	M_203 = ~|( RG_PC_regs_word_addr ^ 32'h00000004 ) ;	// line#=computer.cpp:668
assign	M_207 = ~|( RG_PC_regs_word_addr ^ 32'h00000005 ) ;	// line#=computer.cpp:668,692,711
assign	M_211 = ~|RG_PC_regs_word_addr ;	// line#=computer.cpp:668,692,711
assign	M_217 = ~|( RG_PC_regs_word_addr ^ 32'h00000002 ) ;	// line#=computer.cpp:668
assign	M_238 = |RG_rd ;	// line#=computer.cpp:647,675,706,725
assign	U_80 = ( U_60 & M_238 ) ;	// line#=computer.cpp:675
assign	M_198 = ~|( RG_instr_regs ^ 32'h00000001 ) ;	// line#=computer.cpp:681,744
assign	M_212 = ~|RG_instr_regs ;	// line#=computer.cpp:681
assign	M_218 = ~|( RG_instr_regs ^ 32'h00000002 ) ;	// line#=computer.cpp:681,744
assign	U_85 = ( U_62 & M_211 ) ;	// line#=computer.cpp:692
assign	U_95 = ( U_62 & M_238 ) ;	// line#=computer.cpp:706
assign	U_96 = ( U_63 & M_211 ) ;	// line#=computer.cpp:711
assign	M_213 = ~RG_instr_regs [23] ;	// line#=computer.cpp:701,702,703,718,719
					// ,720
assign	U_106 = ( U_63 & M_238 ) ;	// line#=computer.cpp:725
assign	U_107 = ( U_66 & M_198 ) ;	// line#=computer.cpp:744
assign	U_108 = ( U_66 & M_218 ) ;	// line#=computer.cpp:744
assign	U_110 = ( U_107 & FF_take ) ;	// line#=computer.cpp:747
assign	U_112 = ( U_108 & FF_take ) ;	// line#=computer.cpp:755
always @ ( RG_PC_regs_word_addr or M_119_t or U_59 or M_195 or add32s1ot or U_58 or 
	U_57 or RG_03 or U_67 or U_66 or U_65 or M_237 or U_63 or U_62 or U_61 or 
	U_60 or U_56 or U_55 or ST1_04d or imem_arg_MEMB32W65536_RD1 or ST1_03d )	// line#=computer.cpp:631
	begin
	RG_next_pc_PC_t_c1 = ( ST1_04d & ( ( ( ( ( ( ( ( ( U_55 | U_56 ) | U_60 ) | 
		U_61 ) | U_62 ) | U_63 ) | ( ST1_04d & M_237 ) ) | U_65 ) | U_66 ) | 
		U_67 ) ) ;	// line#=computer.cpp:629
	RG_next_pc_PC_t_c2 = ( ( ST1_04d & U_57 ) | ( ST1_04d & U_58 ) ) ;	// line#=computer.cpp:52,56,75,642,646
										// ,648
	...
	RG_next_pc_PC_t = ( ( { 32{ ST1_03d } } & { 25'h0000000 , imem_arg_MEMB32W65536_RD1 [6:0] } )	// line#=computer.cpp:616,623,631
		| ( { 32{ RG_next_pc_PC_t_c1 } } & RG_03 )						// line#=computer.cpp:629
		| ( { 32{ RG_next_pc_PC_t_c2 } } & { add32s1ot [31:1] , ( M_195 & 
			add32s1ot [0] ) } )								// line#=computer.cpp:52,56,75,642,646
													// ,648
		| ( { 32{ RG_next_pc_PC_t_c3 } } & { M_119_t , RG_PC_regs_word_addr [0] } ) ) ;
	end
...
always @ ( incr3s1ot or ST1_05d or U_112 or ST1_04d )
	begin
	RG_i_t_c1 = ( ST1_04d & U_112 ) ;	// line#=computer.cpp:187
...
always @ ( U_67 or M_218 or M_198 or U_66 or U_108 or FF_take or U_107 or U_65 or 
	ST1_04d )	// line#=computer.cpp:744,755
	begin
	FF_halt_t_c1 = ( ST1_04d & ( ( ( ( U_65 | ( U_107 & ( ~FF_take ) ) ) | ( 
		U_108 & ( ~FF_take ) ) ) | ( U_66 & ( ~( M_198 | M_218 ) ) ) ) | 
		U_67 ) ) ;	// line#=computer.cpp:732,750,756,797,808
...
always @ ( posedge CLOCK )	// line#=computer.cpp:629
	if ( RG_03_en )
		RG_03 <= addsub32u1ot ;
always @ ( M_225 or M_204 or imem_arg_MEMB32W65536_RD1 or M_192 or M_201 or M_194 or 
	M_221 or M_229 or M_214 or M_219 )
	begin
	TR_02_c1 = ( ( ( ( ( ( M_219 | M_214 ) | M_229 ) | M_221 ) | M_194 ) | M_201 ) | 
		M_192 ) ;	// line#=computer.cpp:616
	TR_02_c2 = ( M_204 | M_225 ) ;	// line#=computer.cpp:616,681,744
...
assign	M_201 = ~|( { 25'h0000000 , imem_arg_MEMB32W65536_RD1 [6:0] } ^ 32'h00000067 ) ;	// line#=computer.cpp:616,623,631
always @ ( regs_rg10 or U_01 )
	RG_instr_regs_t1 = ( { 32{ U_01 } } & regs_rg10 )	// line#=computer.cpp:179
		 ;
always @ ( TR_02 or U_16 or U_11 or U_09 or M_201 or ST1_03d or U_07 or U_06 or 
	U_05 or U_13 or U_12 or RG_instr_regs_t1 or ST1_02d )	// line#=computer.cpp:616,623,631
	begin
	RG_instr_regs_t_c1 = ( ( ( ( ( ( ( U_12 | U_13 ) | U_05 ) | U_06 ) | U_07 ) | 
		( ST1_03d & M_201 ) ) | U_09 ) | ( U_11 | U_16 ) ) ;	// line#=computer.cpp:616,681,744
	RG_instr_regs_t = ( ( { 32{ ST1_02d } } & RG_instr_regs_t1 )
		| ( { 32{ RG_instr_regs_t_c1 } } & { 7'h00 , TR_02 } )	// line#=computer.cpp:616,681,744
		) ;
	end
always @ ( posedge CLOCK )	// line#=computer.cpp:616,623,631
	if ( RESET )
		RG_instr_regs <= 32'h00000000 ;
	else
		RG_instr_regs <= RG_instr_regs_t ;	// line#=computer.cpp:179,616,681,744
always @ ( regs_rg11 or U_01 )
	RG_bytes_regs_t1 = ( { 32{ U_01 } } & regs_rg11 )	// line#=computer.cpp:179
		 ;
always @ ( accel_sbox1ot or U_51 or RG_bytes_regs_t1 or ST1_02d )
	RG_bytes_regs_t = ( ( { 32{ ST1_02d } } & RG_bytes_regs_t1 )
		| ( { 32{ U_51 } } & { 24'h000000 , accel_sbox1ot } )	// line#=computer.cpp:277,278,279,280,281
									// ,291,749
		) ;
assign	RG_bytes_regs_en = ( ST1_02d | U_51 ) ;
always @ ( posedge CLOCK )
	if ( RESET )
		RG_bytes_regs <= 32'h00000000 ;
	else if ( RG_bytes_regs_en )
		RG_bytes_regs <= RG_bytes_regs_t ;	// line#=computer.cpp:179,277,278,279,280
							// ,281,291,749
always @ ( add32s1ot or M_204 )
	TR_15 = ( { 12{ M_204 } } & add32s1ot [13:2] )	// line#=computer.cpp:52,61,679
		 ;	// line#=computer.cpp:52,56,666
always @ ( regs_rg12 or U_01 )
	RG_addr_addr1_bytes_op2_regs_t1 = ( { 32{ U_01 } } & regs_rg12 )	// line#=computer.cpp:179
		 ;
always @ ( accel_sbox2ot or U_51 or add32s1ot or TR_15 or M_242 or regs_rd00 or 
	U_13 or RG_addr_addr1_bytes_op2_regs_t1 or ST1_02d )
	RG_addr_addr1_bytes_op2_regs_t = ( ( { 32{ ST1_02d } } & RG_addr_addr1_bytes_op2_regs_t1 )
		| ( { 32{ U_13 } } & regs_rd00 )				// line#=computer.cpp:710
		| ( { 32{ M_242 } } & { 18'h00000 , TR_15 , add32s1ot [1:0] } )	// line#=computer.cpp:52,56,61,666,679
		| ( { 32{ U_51 } } & { 24'h000000 , accel_sbox2ot } )		// line#=computer.cpp:277,278,279,280,281
										// ,291,749
		) ;
assign	RG_addr_addr1_bytes_op2_regs_en = ( ST1_02d | U_13 | M_242 | U_51 ) ;
always @ ( posedge CLOCK )
	if ( RESET )
		RG_addr_addr1_bytes_op2_regs <= 32'h00000000 ;
	else if ( RG_addr_addr1_bytes_op2_regs_en )
		RG_addr_addr1_bytes_op2_regs <= RG_addr_addr1_bytes_op2_regs_t ;	// line#=computer.cpp:52,56,61,179,277
											// ,278,279,280,281,291,666,679,710
											// ,749
always @ ( imem_arg_MEMB32W65536_RD1 or M_208 or M_227 or M_202 or M_210 or M_219 )
	begin
	TR_04_c1 = ( ( ( ( M_219 & M_210 ) | ( M_219 & M_202 ) ) | ( M_219 & M_227 ) ) | 
		( M_219 & M_208 ) ) ;	// line#=computer.cpp:52,56,616,689
	TR_04 = ( { 27{ TR_04_c1 } } & { imem_arg_MEMB32W65536_RD1 [31] , imem_arg_MEMB32W65536_RD1 [31] , 
...
assign	M_256 = ( M_225 & M_196 ) ;
always @ ( regs_rd00 or M_256 or imem_arg_MEMB32W65536_RD1 or M_192 )
	TR_05 = ( ( { 24{ M_192 } } & { 21'h000000 , imem_arg_MEMB32W65536_RD1 [14:12] } )	// line#=computer.cpp:616,654
		| ( { 24{ M_256 } } & regs_rd00 [31:8] )					// line#=computer.cpp:748
		) ;
always @ ( regs_rg13 or U_01 )
	RG_imm1_op1_regs_rs2_t1 = ( { 32{ U_01 } } & regs_rg13 )	// line#=computer.cpp:179
		 ;
always @ ( TR_05 or U_51 or U_09 or imem_arg_MEMB32W65536_RD1 or TR_04 or U_11 or 
	M_206 or M_196 or M_208 or M_227 or M_202 or M_210 or U_12 or regs_rd01 or 
	U_13 or RG_imm1_op1_regs_rs2_t1 or ST1_02d )	// line#=computer.cpp:616,692
	begin
	RG_imm1_op1_regs_rs2_t_c1 = ( ( ( ( ( U_12 & M_210 ) | ( U_12 & M_202 ) ) | 
		( U_12 & M_227 ) ) | ( U_12 & M_208 ) ) | ( ( ( U_12 & M_196 ) | 
		( U_12 & M_206 ) ) | U_11 ) ) ;	// line#=computer.cpp:52,56,616,627,689
	RG_imm1_op1_regs_rs2_t_c2 = ( U_09 | U_51 ) ;	// line#=computer.cpp:616,654,748
	RG_imm1_op1_regs_rs2_t = ( ( { 32{ ST1_02d } } & RG_imm1_op1_regs_rs2_t1 )
		| ( { 32{ U_13 } } & regs_rd01 )								// line#=computer.cpp:710
		| ( { 32{ RG_imm1_op1_regs_rs2_t_c1 } } & { TR_04 , imem_arg_MEMB32W65536_RD1 [24:20] } )	// line#=computer.cpp:52,56,616,627,689
		| ( { 32{ RG_imm1_op1_regs_rs2_t_c2 } } & { 8'h00 , TR_05 } )					// line#=computer.cpp:616,654,748
		) ;
	end
assign	RG_imm1_op1_regs_rs2_en = ( ST1_02d | U_13 | RG_imm1_op1_regs_rs2_t_c1 | 
	RG_imm1_op1_regs_rs2_t_c2 ) ;	// line#=computer.cpp:616,692
always @ ( posedge CLOCK )	// line#=computer.cpp:616,692
	if ( RESET )
		RG_imm1_op1_regs_rs2 <= 32'h00000000 ;
	else if ( RG_imm1_op1_regs_rs2_en )
		RG_imm1_op1_regs_rs2 <= RG_imm1_op1_regs_rs2_t ;	// line#=computer.cpp:52,56,179,616,627
									// ,654,689,692,710,748
assign	M_266 = ( ( M_232 | M_219 ) | M_214 ) ;
assign	M_269 = ( M_263 | M_255 ) ;
always @ ( addsub32u1ot or M_269 or imem_arg_MEMB32W65536_RD1 or M_266 )
	TR_06 = ( ( { 12{ M_266 } } & { 9'h000 , imem_arg_MEMB32W65536_RD1 [14:12] } )	// line#=computer.cpp:616,668,692,711
		| ( { 12{ M_269 } } & addsub32u1ot [13:2] )				// line#=computer.cpp:113,117,124,128
		) ;
always @ ( RG_instr_regs or M_225 or TR_06 or M_269 or M_266 or RG_next_pc_PC or 
	M_192 or M_194 or M_221 )
	begin
	RG_PC_regs_word_addr_t_c1 = ( ( M_221 | M_194 ) | M_192 ) ;
	RG_PC_regs_word_addr_t_c2 = ( M_266 | M_269 ) ;	// line#=computer.cpp:113,117,124,128,616
							// ,668,692,711
	RG_PC_regs_word_addr_t = ( ( { 32{ RG_PC_regs_word_addr_t_c1 } } & RG_next_pc_PC )
		| ( { 32{ RG_PC_regs_word_addr_t_c2 } } & { 20'h00000 , TR_06 } )	// line#=computer.cpp:113,117,124,128,616
											// ,668,692,711
		| ( { 32{ M_225 } } & RG_instr_regs ) ) ;
	end
always @ ( posedge CLOCK )
	if ( RESET )
		RG_PC_regs_word_addr <= 32'h00000000 ;
	else
		RG_PC_regs_word_addr <= RG_PC_regs_word_addr_t ;	// line#=computer.cpp:113,117,124,128,616
									// ,668,692,711
assign	M_234 = ~|( { 29'h00000000 , imem_arg_MEMB32W65536_RD1 [14:12] } ^ 32'h00000003 ) ;	// line#=computer.cpp:616,692,711,744
assign	M_240 = ( regs_rd00 ^ regs_rd01 ) ;	// line#=computer.cpp:655,656
always @ ( incr3s1ot or ST1_05d or U_16 or CT_03 or U_51 or comp32u_12ot or comp32s_11ot or 
	U_13 or comp32u_13ot or M_234 or comp32s_1_11ot or M_216 or U_12 or M_208 or 
	comp32u_11ot or M_227 or M_206 or comp32s_12ot or M_202 or M_196 or M_240 or 
	M_210 or U_09 or imem_arg_MEMB32W65536_RD1 or U_07 or U_06 or U_05 )	// line#=computer.cpp:616,654,692,711,744
	begin
	FF_take_t_c1 = ( ( U_05 | U_06 ) | U_07 ) ;	// line#=computer.cpp:616,624,633,637,641
	FF_take_t_c2 = ( U_09 & M_210 ) ;	// line#=computer.cpp:655
	FF_take_t_c3 = ( U_09 & M_196 ) ;	// line#=computer.cpp:656
	FF_take_t_c4 = ( U_09 & M_202 ) ;	// line#=computer.cpp:657
	FF_take_t_c5 = ( U_09 & M_206 ) ;	// line#=computer.cpp:658
	FF_take_t_c6 = ( U_09 & M_227 ) ;	// line#=computer.cpp:659
	FF_take_t_c7 = ( U_09 & M_208 ) ;	// line#=computer.cpp:660
	FF_take_t_c8 = ( U_12 & M_216 ) ;	// line#=computer.cpp:694
	FF_take_t_c9 = ( U_12 & M_234 ) ;	// line#=computer.cpp:695
	FF_take_t_c10 = ( U_13 & M_216 ) ;	// line#=computer.cpp:714
	FF_take_t_c11 = ( U_13 & M_234 ) ;	// line#=computer.cpp:715
	FF_take_t_c12 = ( U_16 & M_216 ) ;	// line#=computer.cpp:616,755
	FF_take_t = ( ( { 1{ FF_take_t_c1 } } & ( |imem_arg_MEMB32W65536_RD1 [11:7] ) )	// line#=computer.cpp:616,624,633,637,641
		| ( { 1{ FF_take_t_c2 } } & ( ~|M_240 ) )				// line#=computer.cpp:655
		| ( { 1{ FF_take_t_c3 } } & ( |M_240 ) )				// line#=computer.cpp:656
		...
		| ( { 1{ U_51 } } & CT_03 )						// line#=computer.cpp:747
		| ( { 1{ FF_take_t_c12 } } & CT_03 )					// line#=computer.cpp:616,755
		| ( { 1{ ST1_05d } } & ( ~incr3s1ot [2] ) )				// line#=computer.cpp:187
		) ;
	end
always @ ( posedge CLOCK )	// line#=computer.cpp:616,654,692,711,744
	FF_take <= FF_take_t ;	// line#=computer.cpp:187,616,624,633,637
				// ,641,655,656,657,658,659,660,694
				// ,695,714,715,747,755
always @ ( RG_PC_regs_word_addr or RG_03 or add32s1ot or take_t1 )	// line#=computer.cpp:662
	begin
	M_119_t_c1 = ~take_t1 ;
	M_119_t = ( ( { 31{ take_t1 } } & add32s1ot [31:1] )	// line#=computer.cpp:662
		| ( { 31{ M_119_t_c1 } } & { RG_03 [31:2] , RG_PC_regs_word_addr [1] } ) ) ;
	end
assign	JF_02 = ~( ( M_226 & M_218 ) & FF_take ) ;
...
assign	M_242 = ( U_11 | U_10 ) ;
always @ ( RG_PC_regs_word_addr or U_57 or U_72 or regs_rd02 or U_58 or U_85 or 
	regs_rd00 or M_242 )
	begin
	add32s1i1_c1 = ( U_85 | U_58 ) ;	// line#=computer.cpp:52,56,646,693
	add32s1i1_c2 = ( U_72 | U_57 ) ;	// line#=computer.cpp:52,75,642,662
	add32s1i1 = ( ( { 32{ M_242 } } & regs_rd00 )			// line#=computer.cpp:52,56,61,666,679
		| ( { 32{ add32s1i1_c1 } } & regs_rd02 )		// line#=computer.cpp:52,56,646,693
		| ( { 32{ add32s1i1_c2 } } & RG_PC_regs_word_addr )	// line#=computer.cpp:52,75,642,662
		) ;
	end
always @ ( M_232 or imem_arg_MEMB32W65536_RD1 or M_204 )
	TR_07 = ( ( { 5{ M_204 } } & imem_arg_MEMB32W65536_RD1 [11:7] )		// line#=computer.cpp:52,60,61,616,624
										// ,628,679
		| ( { 5{ M_232 } } & imem_arg_MEMB32W65536_RD1 [24:20] )	// line#=computer.cpp:52,56,616,627,666
		) ;
always @ ( M_200 or RG_instr_regs or M_239 )
	M_271 = ( ( { 6{ M_239 } } & { RG_instr_regs [0] , RG_instr_regs [4:1] , 
			1'h0 } )							// line#=computer.cpp:52,65,66,67,628,652
											// ,662
		| ( { 6{ M_200 } } & { RG_instr_regs [24] , RG_instr_regs [17:13] } )	// line#=computer.cpp:52,56,627,646
		) ;
assign	M_239 = ( M_193 & take_t1 ) ;
always @ ( M_195 or M_271 or RG_instr_regs or M_200 or M_239 )
	begin
	M_272_c1 = ( M_239 | M_200 ) ;	// line#=computer.cpp:52,56,65,66,67,627
					// ,628,646,652,662
	M_272 = ( ( { 14{ M_272_c1 } } & { RG_instr_regs [24] , RG_instr_regs [24] , 
			RG_instr_regs [24] , RG_instr_regs [24] , RG_instr_regs [24] , 
			RG_instr_regs [24] , RG_instr_regs [24] , RG_instr_regs [24] , 
			M_271 } )				// line#=computer.cpp:52,56,65,66,67,627
								// ,628,646,652,662
		| ( { 14{ M_195 } } & { RG_instr_regs [12:5] , RG_instr_regs [13] , 
			RG_instr_regs [17:14] , 1'h0 } )	// line#=computer.cpp:52,73,74,75,625,627
								// ,642
		) ;
	end
always @ ( M_272 or RG_instr_regs or U_57 or U_58 or U_72 or RG_imm1_op1_regs_rs2 or 
	U_85 or TR_07 or imem_arg_MEMB32W65536_RD1 or M_242 )
	begin
	add32s1i2_c1 = ( ( U_72 | U_58 ) | U_57 ) ;	// line#=computer.cpp:52,56,65,66,67,73
							// ,74,75,625,627,628,642,646,652
							// ,662
	add32s1i2 = ( ( { 21{ M_242 } } & { imem_arg_MEMB32W65536_RD1 [31] , imem_arg_MEMB32W65536_RD1 [31] , 
			imem_arg_MEMB32W65536_RD1 [31] , imem_arg_MEMB32W65536_RD1 [31] , 
			imem_arg_MEMB32W65536_RD1 [31] , imem_arg_MEMB32W65536_RD1 [31] , 
			imem_arg_MEMB32W65536_RD1 [31] , imem_arg_MEMB32W65536_RD1 [31] , 
			...
			TR_07 } )							// line#=computer.cpp:52,56,60,61,616,624
											// ,627,628,666,679
		| ( { 21{ U_85 } } & { RG_imm1_op1_regs_rs2 [11] , RG_imm1_op1_regs_rs2 [11] , 
			RG_imm1_op1_regs_rs2 [11] , RG_imm1_op1_regs_rs2 [11] , RG_imm1_op1_regs_rs2 [11] , 
			RG_imm1_op1_regs_rs2 [11] , RG_imm1_op1_regs_rs2 [11] , RG_imm1_op1_regs_rs2 [11] , 
			RG_imm1_op1_regs_rs2 [11] , RG_imm1_op1_regs_rs2 [11:0] } )	// line#=computer.cpp:693
		| ( { 21{ add32s1i2_c1 } } & { RG_instr_regs [24] , M_272 [13:5] , 
			RG_instr_regs [23:18] , M_272 [4:0] } )				// line#=computer.cpp:52,56,65,66,67,73
											// ,74,75,625,627,628,642,646,652
											// ,662
		) ;
	end
...
always @ ( regs_rd03 or TR_16 or M_261 or regs_rd02 or M_257 or RG_imm1_op1_regs_rs2 or 
	M_258 )
	lsft32u1i1 = ( ( { 32{ M_258 } } & RG_imm1_op1_regs_rs2 )		// line#=computer.cpp:713
		| ( { 32{ M_257 } } & regs_rd02 )				// line#=computer.cpp:699
		| ( { 32{ M_261 } } & { 16'h0000 , TR_16 , regs_rd03 [7:0] } )	// line#=computer.cpp:120,131,682,683
		) ;
assign	M_257 = ( M_220 & M_197 ) ;
assign	M_258 = ( M_215 & M_197 ) ;
assign	M_261 = ( ( M_205 & M_198 ) | ( M_205 & M_212 ) ) ;
always @ ( M_261 or RG_imm1_op1_regs_rs2 or M_257 or RG_addr_addr1_bytes_op2_regs or 
	M_258 )
	lsft32u1i2 = ( ( { 5{ M_258 } } & RG_addr_addr1_bytes_op2_regs [4:0] )		// line#=computer.cpp:713
		| ( { 5{ M_257 } } & RG_imm1_op1_regs_rs2 [4:0] )			// line#=computer.cpp:699
		| ( { 5{ M_261 } } & { RG_addr_addr1_bytes_op2_regs [1:0] , 3'h0 } )	// line#=computer.cpp:118,119,120,129,130
											// ,131,682,683
		) ;
always @ ( dmem_arg_MEMB32W4096_RD1 or M_259 or regs_rd02 or M_264 or RG_imm1_op1_regs_rs2 or 
	M_265 )
	rsft32u1i1 = ( ( { 32{ M_265 } } & RG_imm1_op1_regs_rs2 )	// line#=computer.cpp:718,719,720
		| ( { 32{ M_264 } } & regs_rd02 )			// line#=computer.cpp:701,702,703
		| ( { 32{ M_259 } } & dmem_arg_MEMB32W4096_RD1 )	// line#=computer.cpp:90,91,100,101,669
									// ,670,672,673
		) ;
assign	M_259 = ( ( ( ( M_233 & M_207 ) | ( M_233 & M_203 ) ) | ( M_233 & M_197 ) ) | 
	( M_233 & M_211 ) ) ;
assign	M_264 = ( ( M_220 & M_207 ) & M_213 ) ;
assign	M_265 = ( ( M_215 & M_207 ) & M_213 ) ;
always @ ( M_259 or RG_imm1_op1_regs_rs2 or M_264 or RG_addr_addr1_bytes_op2_regs or 
	M_265 )
	rsft32u1i2 = ( ( { 5{ M_265 } } & RG_addr_addr1_bytes_op2_regs [4:0] )		// line#=computer.cpp:718,719,720
		| ( { 5{ M_264 } } & RG_imm1_op1_regs_rs2 [4:0] )			// line#=computer.cpp:701,702,703
		| ( { 5{ M_259 } } & { RG_addr_addr1_bytes_op2_regs [1:0] , 3'h0 } )	// line#=computer.cpp:90,91,100,101,669
											// ,670,672,673
		) ;
always @ ( regs_rd02 or M_220 or RG_imm1_op1_regs_rs2 or M_215 )
	rsft32s1i1 = ( ( { 32{ M_215 } } & RG_imm1_op1_regs_rs2 )	// line#=computer.cpp:718,719,720
		| ( { 32{ M_220 } } & regs_rd02 )			// line#=computer.cpp:701,702,703
		) ;
always @ ( RG_imm1_op1_regs_rs2 or M_220 or RG_addr_addr1_bytes_op2_regs or M_215 )
	rsft32s1i2 = ( ( { 5{ M_215 } } & RG_addr_addr1_bytes_op2_regs [4:0] )	// line#=computer.cpp:718,719,720
		| ( { 5{ M_220 } } & RG_imm1_op1_regs_rs2 [4:0] )		// line#=computer.cpp:701,702,703
		) ;
always @ ( RG_imm1_op1_regs_rs2 or U_96 or add32s1ot or U_25 or U_26 or U_28 or 
	U_29 or M_244 or RG_next_pc_PC or U_01 or RG_PC_regs_word_addr or U_69 )
	begin
	addsub32u1i1_c1 = ( M_244 | ( ( ( U_29 | U_28 ) | U_26 ) | U_25 ) ) ;	// line#=computer.cpp:52,56,61,85,95,113
										// ,124,666,679
	addsub32u1i1 = ( ( { 32{ U_69 } } & RG_PC_regs_word_addr )	// line#=computer.cpp:70,637
		| ( { 32{ U_01 } } & RG_next_pc_PC )			// line#=computer.cpp:629
		| ( { 32{ addsub32u1i1_c1 } } & add32s1ot )		// line#=computer.cpp:52,56,61,85,95,113
									// ,124,666,679
		| ( { 32{ U_96 } } & RG_imm1_op1_regs_rs2 )		// line#=computer.cpp:712
		) ;
	end
always @ ( M_243 or RG_instr_regs or U_69 )
	TR_17 = ( ( { 20{ U_69 } } & RG_instr_regs [24:5] )	// line#=computer.cpp:70,637
		| ( { 20{ M_243 } } & 20'h00040 )		// line#=computer.cpp:85,95,113,124
		) ;
always @ ( U_01 or TR_17 or M_243 or U_69 )
	begin
	M_273_c1 = ( U_69 | M_243 ) ;	// line#=computer.cpp:70,85,95,113,124
					// ,637
	M_273 = ( ( { 21{ M_273_c1 } } & { TR_17 , 1'h0 } )	// line#=computer.cpp:70,85,95,113,124
								// ,637
		| ( { 21{ U_01 } } & 21'h000001 )		// line#=computer.cpp:629
		) ;
	end
always @ ( RG_addr_addr1_bytes_op2_regs or U_96 or M_273 or M_243 or M_241 )
	begin
	addsub32u1i2_c1 = ( M_241 | M_243 ) ;	// line#=computer.cpp:70,85,95,113,124
						// ,629,637
	addsub32u1i2 = ( ( { 32{ addsub32u1i2_c1 } } & { M_273 [20:1] , 9'h000 , 
			M_273 [0] , 2'h0 } )				// line#=computer.cpp:70,85,95,113,124
									// ,629,637
		| ( { 32{ U_96 } } & RG_addr_addr1_bytes_op2_regs )	// line#=computer.cpp:712
		) ;
	end
assign	M_241 = ( U_69 | U_01 ) ;
assign	M_244 = ( U_32 | U_31 ) ;
assign	M_243 = ( ( ( ( M_244 | U_29 ) | U_28 ) | U_26 ) | U_25 ) ;
always @ ( RG_instr_regs )	// line#=computer.cpp:712
	case ( RG_instr_regs [23] )
	1'h1 :
	...
	endcase
always @ ( addsub32u1_f_t1 or U_96 or M_243 or M_241 )
	addsub32u1_f = ( ( { 2{ M_241 } } & 2'h1 )
		| ( { 2{ M_243 } } & 2'h2 )
...
always @ ( RG_imm1_op1_regs_rs2 or U_110 or regs_rd00 or U_54 )
	accel_sbox1i1 = ( ( { 8{ U_54 } } & regs_rd00 [7:0] )		// line#=computer.cpp:277,278,279,280,281
									// ,291,748,749
		| ( { 8{ U_110 } } & RG_imm1_op1_regs_rs2 [23:16] )	// line#=computer.cpp:277,278,279,280,281
									// ,291,292,293,294,295,749
		) ;
always @ ( RG_imm1_op1_regs_rs2 or U_110 or regs_rd00 or U_54 )
	accel_sbox2i1 = ( ( { 8{ U_54 } } & regs_rd00 [23:16] )		// line#=computer.cpp:277,278,279,280,281
									// ,291,748,749
		| ( { 8{ U_110 } } & RG_imm1_op1_regs_rs2 [7:0] )	// line#=computer.cpp:277,278,279,280,281
									// ,291,292,293,294,295,749
		) ;
always @ ( M_198 )
	M_270 = ( { 8{ M_198 } } & 8'hff )	// line#=computer.cpp:130
		 ;	// line#=computer.cpp:119
assign	lsft32u_321i1 = { M_270 , 8'hff } ;
assign	lsft32u_321i2 = { RG_addr_addr1_bytes_op2_regs [1:0] , 3'h0 } ;	// line#=computer.cpp:118,119,129,130
assign	imem_arg_MEMB32W65536_RE1 = U_01 ;	// line#=computer.cpp:616
assign	M_262 = ( M_212 | M_198 ) ;	// line#=computer.cpp:681
always @ ( regs_rd03 or M_218 or lsft32u1ot or lsft32u_321ot or dmem_arg_MEMB32W4096_RD1 or 
	M_262 )
	dmem_arg_MEMB32W4096_WD2 = ( ( { 32{ M_262 } } & ( ( dmem_arg_MEMB32W4096_RD1 & ( 
			~lsft32u_321ot ) ) | lsft32u1ot ) )	// line#=computer.cpp:119,120,130,131,682
								// ,683
		| ( { 32{ M_218 } } & regs_rd03 )		// line#=computer.cpp:139
		) ;
assign	M_255 = ( M_204 & M_196 ) ;
assign	M_263 = ( M_204 & M_210 ) ;
always @ ( addsub32u1ot or M_255 or M_263 or M_206 or M_202 or M_196 or M_210 or 
	add32s1ot or M_216 or M_232 )
	begin
	dmem_arg_MEMB32W4096_RA1_c1 = ( M_232 & M_216 ) ;	// line#=computer.cpp:52,56,105,109,666
								// ,671
	dmem_arg_MEMB32W4096_RA1_c2 = ( ( ( ( ( ( M_232 & M_210 ) | ( M_232 & M_196 ) ) | 
		( M_232 & M_202 ) ) | ( M_232 & M_206 ) ) | M_263 ) | M_255 ) ;	// line#=computer.cpp:85,89,91,95,99,101
...
always @ ( RG_addr_addr1_bytes_op2_regs or M_218 or RG_PC_regs_word_addr or M_262 )
	dmem_arg_MEMB32W4096_WA2 = ( ( { 12{ M_262 } } & RG_PC_regs_word_addr [11:0] )	// line#=computer.cpp:119,120,130,131
		| ( { 12{ M_218 } } & RG_addr_addr1_bytes_op2_regs [13:2] )		// line#=computer.cpp:135,139
		) ;
assign	dmem_arg_MEMB32W4096_RE1 = ( ( ( ( ( ( ( U_10 & M_216 ) | U_25 ) | U_26 ) | 
	U_28 ) | U_29 ) | U_31 ) | U_32 ) ;	// line#=computer.cpp:91,101,109,120,131
						// ,616,668,669,670,671,672,673
assign	dmem_arg_MEMB32W4096_WE2 = ( ( ( U_61 & M_212 ) | ( U_61 & M_198 ) ) | ( 
	U_61 & M_218 ) ) ;	// line#=computer.cpp:119,120,130,131,139
				// ,681
always @ ( M_214 or imem_arg_MEMB32W65536_RD1 or M_245 or M_246 or M_247 or M_248 or 
	M_249 or M_250 or M_232 or M_204 or M_216 or M_234 or M_219 or M_256 )
	begin
	regs_ad00_c1 = ( ( ( ( ( ( ( ( ( ( M_256 | ( M_219 & M_234 ) ) | ( M_219 & 
		M_216 ) ) | M_204 ) | M_232 ) | M_250 ) | M_249 ) | M_248 ) | M_247 ) | 
		M_246 ) | M_245 ) ;	// line#=computer.cpp:616,626
	regs_ad00 = ( ( { 5{ regs_ad00_c1 } } & imem_arg_MEMB32W65536_RD1 [19:15] )	// line#=computer.cpp:616,626
		| ( { 5{ M_214 } } & imem_arg_MEMB32W65536_RD1 [24:20] )		// line#=computer.cpp:616
		) ;
	end
assign	M_245 = ( M_192 & M_210 ) ;
assign	M_246 = ( M_192 & M_196 ) ;
assign	M_247 = ( M_192 & M_202 ) ;
assign	M_248 = ( M_192 & M_206 ) ;
assign	M_249 = ( M_192 & M_227 ) ;
assign	M_250 = ( M_192 & M_208 ) ;
always @ ( M_245 or M_246 or M_247 or M_248 or M_249 or M_250 or imem_arg_MEMB32W65536_RD1 or 
	M_214 )
	begin
	regs_ad01_c1 = ( ( ( ( ( M_250 | M_249 ) | M_248 ) | M_247 ) | M_246 ) | 
		M_245 ) ;	// line#=computer.cpp:616
	regs_ad01 = ( ( { 5{ M_214 } } & imem_arg_MEMB32W65536_RD1 [19:15] )	// line#=computer.cpp:616,626
		| ( { 5{ regs_ad01_c1 } } & imem_arg_MEMB32W65536_RD1 [24:20] )	// line#=computer.cpp:616
		) ;
	end
always @ ( RG_rd or U_68 or U_70 or U_69 or U_106 or U_71 or U_95 or U_80 or U_110 or 
	imem_arg_MEMB32W65536_RD1 or U_54 )
	begin
	regs_ad04_c1 = ( ( ( ( ( ( ( U_110 | U_80 ) | U_95 ) | U_71 ) | U_106 ) | 
		U_69 ) | U_70 ) | U_68 ) ;	// line#=computer.cpp:70,277,278,279,280
...
assign	M_209 = ~|( RG_PC_regs_word_addr ^ 32'h00000007 ) ;
assign	M_228 = ~|( RG_PC_regs_word_addr ^ 32'h00000006 ) ;
assign	M_235 = ~|( RG_PC_regs_word_addr ^ 32'h00000003 ) ;
always @ ( rsft32u1ot or rsft32s1ot or RG_instr_regs )	// line#=computer.cpp:701,702,703
	case ( RG_instr_regs [23] )
	1'h1 :
	...
	default :
		TR_19 = 32'hx ;
	endcase
always @ ( RG_instr_regs or U_68 or addsub32u1ot or U_69 or U_96 or RG_03 or U_70 or 
	U_71 or TR_19 or M_207 or lsft32u1ot or M_197 or M_209 or M_228 or RG_imm1_op1_regs_rs2 or 
	regs_rd02 or M_203 or TR_18 or U_63 or U_106 or M_235 or M_217 or U_62 or 
	add32s1ot or U_85 or U_95 or val2_t4 or U_80 or RG_bytes_regs or accel_sbox2ot or 
	RG_addr_addr1_bytes_op2_regs or accel_sbox1ot or U_110 or regs_rd00 or U_54 )	// line#=computer.cpp:692,711
	begin
	regs_wd04_c1 = ( U_95 & U_85 ) ;	// line#=computer.cpp:693
	regs_wd04_c2 = ( ( ( ( U_95 & ( U_62 & M_217 ) ) | ( U_95 & ( U_62 & M_235 ) ) ) | 
		( U_106 & ( U_63 & M_217 ) ) ) | ( U_106 & ( U_63 & M_235 ) ) ) ;
	regs_wd04_c3 = ( U_95 & ( U_62 & M_203 ) ) ;	// line#=computer.cpp:696
	regs_wd04_c4 = ( U_95 & ( U_62 & M_228 ) ) ;	// line#=computer.cpp:697
	regs_wd04_c5 = ( U_95 & ( U_62 & M_209 ) ) ;	// line#=computer.cpp:698
	regs_wd04_c6 = ( ( U_95 & ( U_62 & M_197 ) ) | ( U_106 & ( U_63 & M_197 ) ) ) ;	// line#=computer.cpp:699,713
	regs_wd04_c7 = ( U_95 & ( U_62 & M_207 ) ) ;	// line#=computer.cpp:701,702,703
	regs_wd04_c8 = ( U_71 | U_70 ) ;	// line#=computer.cpp:641,647
	regs_wd04_c9 = ( ( U_106 & U_96 ) | U_69 ) ;	// line#=computer.cpp:70,637,712
	regs_wd04_c10 = ( U_106 & ( U_63 & M_203 ) ) ;	// line#=computer.cpp:716
	regs_wd04_c11 = ( U_106 & ( U_63 & M_228 ) ) ;	// line#=computer.cpp:722
	regs_wd04_c12 = ( U_106 & ( U_63 & M_209 ) ) ;	// line#=computer.cpp:723
	regs_wd04_c13 = ( U_106 & ( U_63 & M_207 ) ) ;	// line#=computer.cpp:718,719,720
	regs_wd04 = ( ( { 32{ U_54 } } & regs_rd00 )							// line#=computer.cpp:748
		| ( { 32{ U_110 } } & { accel_sbox1ot , RG_addr_addr1_bytes_op2_regs [7:0] , 
			accel_sbox2ot , RG_bytes_regs [7:0] } )						// line#=computer.cpp:277,278,279,280,281
													// ,291,292,293,294,295,749
		| ( { 32{ U_80 } } & val2_t4 )								// line#=computer.cpp:675
		| ( { 32{ regs_wd04_c1 } } & add32s1ot )						// line#=computer.cpp:693
		| ( { 32{ regs_wd04_c2 } } & { 31'h00000000 , TR_18 } )
		| ( { 32{ regs_wd04_c3 } } & ( regs_rd02 ^ { RG_imm1_op1_regs_rs2 [11] , 
			RG_imm1_op1_regs_rs2 [11] , RG_imm1_op1_regs_rs2 [11] , RG_imm1_op1_regs_rs2 [11] , 
			RG_imm1_op1_regs_rs2 [11] , RG_imm1_op1_regs_rs2 [11] , RG_imm1_op1_regs_rs2 [11] , 
			RG_imm1_op1_regs_rs2 [11] , RG_imm1_op1_regs_rs2 [11] , RG_imm1_op1_regs_rs2 [11] , 
			RG_imm1_op1_regs_rs2 [11] , RG_imm1_op1_regs_rs2 [11] , RG_imm1_op1_regs_rs2 [11] , 
			RG_imm1_op1_regs_rs2 [11] , RG_imm1_op1_regs_rs2 [11] , RG_imm1_op1_regs_rs2 [11] , 
			RG_imm1_op1_regs_rs2 [11] , RG_imm1_op1_regs_rs2 [11] , RG_imm1_op1_regs_rs2 [11] , 
			RG_imm1_op1_regs_rs2 [11] , RG_imm1_op1_regs_rs2 [11:0] } ) )			// line#=computer.cpp:696
		| ( { 32{ regs_wd04_c4 } } & ( regs_rd02 | { RG_imm1_op1_regs_rs2 [11] , 
			RG_imm1_op1_regs_rs2 [11] , RG_imm1_op1_regs_rs2 [11] , RG_imm1_op1_regs_rs2 [11] , 
			RG_imm1_op1_regs_rs2 [11] , RG_imm1_op1_regs_rs2 [11] , RG_imm1_op1_regs_rs2 [11] , 
			RG_imm1_op1_regs_rs2 [11] , RG_imm1_op1_regs_rs2 [11] , RG_imm1_op1_regs_rs2 [11] , 
			RG_imm1_op1_regs_rs2 [11] , RG_imm1_op1_regs_rs2 [11] , RG_imm1_op1_regs_rs2 [11] , 
			RG_imm1_op1_regs_rs2 [11] , RG_imm1_op1_regs_rs2 [11] , RG_imm1_op1_regs_rs2 [11] , 
			RG_imm1_op1_regs_rs2 [11] , RG_imm1_op1_regs_rs2 [11] , RG_imm1_op1_regs_rs2 [11] , 
			RG_imm1_op1_regs_rs2 [11] , RG_imm1_op1_regs_rs2 [11:0] } ) )			// line#=computer.cpp:697
		| ( { 32{ regs_wd04_c5 } } & ( regs_rd02 & { RG_imm1_op1_regs_rs2 [11] , 
			RG_imm1_op1_regs_rs2 [11] , RG_imm1_op1_regs_rs2 [11] , RG_imm1_op1_regs_rs2 [11] , 
			RG_imm1_op1_regs_rs2 [11] , RG_imm1_op1_regs_rs2 [11] , RG_imm1_op1_regs_rs2 [11] , 
			RG_imm1_op1_regs_rs2 [11] , RG_imm1_op1_regs_rs2 [11] , RG_imm1_op1_regs_rs2 [11] , 
			RG_imm1_op1_regs_rs2 [11] , RG_imm1_op1_regs_rs2 [11] , RG_imm1_op1_regs_rs2 [11] , 
			RG_imm1_op1_regs_rs2 [11] , RG_imm1_op1_regs_rs2 [11] , RG_imm1_op1_regs_rs2 [11] , 
			RG_imm1_op1_regs_rs2 [11] , RG_imm1_op1_regs_rs2 [11] , RG_imm1_op1_regs_rs2 [11] , 
			RG_imm1_op1_regs_rs2 [11] , RG_imm1_op1_regs_rs2 [11:0] } ) )			// line#=computer.cpp:698
		| ( { 32{ regs_wd04_c6 } } & lsft32u1ot )						// line#=computer.cpp:699,713
		| ( { 32{ regs_wd04_c7 } } & TR_19 )							// line#=computer.cpp:701,702,703
		| ( { 32{ regs_wd04_c8 } } & RG_03 )							// line#=computer.cpp:641,647
		| ( { 32{ regs_wd04_c9 } } & addsub32u1ot )						// line#=computer.cpp:70,637,712
		| ( { 32{ regs_wd04_c10 } } & ( RG_imm1_op1_regs_rs2 ^ RG_addr_addr1_bytes_op2_regs ) )	// line#=computer.cpp:716
		| ( { 32{ regs_wd04_c11 } } & ( RG_imm1_op1_regs_rs2 | RG_addr_addr1_bytes_op2_regs ) )	// line#=computer.cpp:722
		| ( { 32{ regs_wd04_c12 } } & ( RG_imm1_op1_regs_rs2 & RG_addr_addr1_bytes_op2_regs ) )	// line#=computer.cpp:723
		| ( { 32{ regs_wd04_c13 } } & TR_19 )							// line#=computer.cpp:718,719,720
		| ( { 32{ U_68 } } & { RG_instr_regs [24:5] , 12'h000 } )				// line#=computer.cpp:70,633
		) ;
	end
assign	regs_we04 = ( ( ( ( ( ( ( ( U_54 | U_110 ) | U_80 ) | U_95 ) | U_71 ) | U_106 ) | 
	U_69 ) | U_70 ) | U_68 ) ;	// line#=computer.cpp:70,277,278,279,280
					// ,281,291,292,293,294,295,633,637
