...
// bdlpars options:  -EE -DAES_MEM -DACCEL_MIX_COL -DACCEL_SBOX_WORD -DACCEL_MIX_COL_U4 -DACCEL_SBOX_WORD_U4 -info_base_name computer computer.cpp
// bdltran options:  -EE computer.IFF -c1000 -s -Zresource_fcnt=GENERATE -Zresource_mcnt=GENERATE -Zsync -Zdup_reset=YES -Zfolding_sharing=inter_stage -lb /proj/cad/cwb-6.1/packages/asic_45.BLIB -lfl /proj/cad/cwb-6.1/packages/asic_45.FLIB -o-P 
// timestamp_0: 20260604025027_94993_52093
// timestamp_5: 20260604025028_95007_52503
// timestamp_9: 20260604025028_95007_58348
// timestamp_C: 20260604025028_95007_60781
// timestamp_E: 20260604025028_95007_92406
// timestamp_V: 20260604025029_95021_96109
...
reg	[31:0]	RG_addr_addr1_next_pc_op1_PC ;	// line#=computer.cpp:21,629,710
reg	[31:0]	RG_col_op2 ;	// line#=computer.cpp:163,710
reg	[31:0]	RG_cols_word_addr ;	// line#=computer.cpp:117,128,179
reg	[31:0]	RG_cols_rs2 ;	// line#=computer.cpp:179,627
...
reg	[7:0]	RG_bytes ;	// line#=computer.cpp:277
reg	[7:0]	RG_bytes_rs1 ;	// line#=computer.cpp:277,626
...
reg	[31:0]	RG_col_op2_t ;
reg	[11:0]	TR_02 ;
reg	TR_02_c1 ;
reg	[31:0]	RG_cols_word_addr_t ;
reg	RG_cols_word_addr_t_c1 ;
reg	[4:0]	TR_03 ;
reg	TR_03_c1 ;
reg	TR_03_c2 ;
reg	[31:0]	RG_cols_rs2_t ;
reg	RG_cols_rs2_t_c1 ;
reg	[31:0]	RG_cols_t ;
reg	RG_cols_t_c1 ;
...
reg	[31:0]	RG_col_t ;
reg	[7:0]	RG_bytes_rs1_t ;
reg	RG_bytes_rs1_t_c1 ;
reg	FF_take_t ;
reg	FF_take_t_c1 ;
reg	FF_take_t_c2 ;
reg	FF_take_t_c3 ;
...
always @ ( accel_sbox1i1 )	// line#=computer.cpp:277,278,279,280,281
				// ,291,292,293,294,295,749
	case ( accel_sbox1i1 )
	8'h00 :
	...
	default :
		accel_sbox1ot = 8'hx ;
	endcase
always @ ( accel_sbox2i1 )	// line#=computer.cpp:277,278,279,280,281
				// ,291,292,293,294,295,749
	case ( accel_sbox2i1 )
	8'h00 :
...
always @ ( regs_rg31 or regs_rg30 or regs_rg29 or regs_rg28 or regs_rg27 or regs_rg26 or 
	...
	regs_rg13 or regs_rg12 or regs_rg11 or regs_rg10 or regs_rg09 or regs_rg08 or 
	regs_rg07 or regs_rg06 or regs_rg05 or regs_rg04 or regs_rg03 or regs_rg02 or 
	regs_rg01 or regs_rg00 or RG_bytes_rs1 )	// line#=computer.cpp:20
	case ( RG_bytes_rs1 [4:0] )
	5'h00 :
		regs_rd02 = regs_rg00 ;
	5'h01 :
		regs_rd02 = regs_rg01 ;
...
always @ ( regs_rg31 or regs_rg30 or regs_rg29 or regs_rg28 or regs_rg27 or regs_rg26 or 
	...
	regs_rg13 or regs_rg12 or regs_rg11 or regs_rg10 or regs_rg09 or regs_rg08 or 
	regs_rg07 or regs_rg06 or regs_rg05 or regs_rg04 or regs_rg03 or regs_rg02 or 
	regs_rg01 or regs_rg00 or RG_cols_rs2 )	// line#=computer.cpp:20
	case ( RG_cols_rs2 [4:0] )
	5'h00 :
		regs_rd03 = regs_rg00 ;
	5'h01 :
		regs_rd03 = regs_rg01 ;
...
always @ ( RG_cols_2 or M_01 or U_123 or regs_wd04 or regs_d04 or regs_we04 )	// line#=computer.cpp:20
	begin
	regs_rg10_t_c1 = ( regs_we04 & regs_d04 [21] ) ;
	regs_rg10_t_c2 = ( U_123 & M_01 ) ;	// line#=computer.cpp:189
...
always @ ( RG_cols_3 or M_02 or U_123 or regs_wd04 or regs_d04 or regs_we04 )	// line#=computer.cpp:20
	begin
	regs_rg11_t_c1 = ( regs_we04 & regs_d04 [20] ) ;
	regs_rg11_t_c2 = ( U_123 & M_02 ) ;	// line#=computer.cpp:189
...
always @ ( RG_cols_4 or M_03 or U_123 or regs_wd04 or regs_d04 or regs_we04 )	// line#=computer.cpp:20
	begin
	regs_rg12_t_c1 = ( regs_we04 & regs_d04 [19] ) ;
	regs_rg12_t_c2 = ( U_123 & M_03 ) ;	// line#=computer.cpp:189
...
always @ ( M_184 or M_183 or M_182 or M_181 or M_04 or U_123 or regs_wd04 or regs_d04 or 
	regs_we04 )	// line#=computer.cpp:20
	begin
	regs_rg13_t_c1 = ( regs_we04 & regs_d04 [18] ) ;
	regs_rg13_t_c2 = ( U_123 & M_04 ) ;	// line#=computer.cpp:164,165,166,167,170
						// ,171,172,173,175,189
	regs_rg13_t = ( ( { 32{ regs_rg13_t_c1 } } & regs_wd04 )
		| ( { 32{ regs_rg13_t_c2 } } & { M_181 , M_182 , M_183 , M_184 } )	// line#=computer.cpp:164,165,166,167,170
											// ,171,172,173,175,189
		) ;
	end
...
always @ ( posedge CLOCK )	// line#=computer.cpp:20
	if ( RESET )
		...
		regs_rg31 <= regs_wd04 ;
always @ ( posedge CLOCK )	// line#=computer.cpp:277,278,279,280,281
				// ,291,749
	RG_bytes <= accel_sbox1ot ;
always @ ( posedge CLOCK )	// line#=computer.cpp:616,624
	RG_rd <= imem_arg_MEMB32W65536_RD1 [11:7] ;
assign	CT_01 = ( ( ~FF_halt ) & ( ~|RG_addr_addr1_next_pc_op1_PC [31:18] ) ) ;	// line#=computer.cpp:615
assign	CT_01_port = CT_01 ;
assign	CT_03 = ~|imem_arg_MEMB32W65536_RD1 [31:25] ;	// line#=computer.cpp:616,747,755
always @ ( FF_take or RG_cols_rs2 )	// line#=computer.cpp:654
	case ( RG_cols_rs2 )
	32'h00000000 :
	...
	endcase
always @ ( dmem_arg_MEMB32W4096_RD1 or rsft32u1ot or RG_cols_imm1_instr )	// line#=computer.cpp:668
	case ( RG_cols_imm1_instr )
	32'h00000000 :
...
always @ ( FF_take )	// line#=computer.cpp:694
	...
	default :
		TR_18 = 1'hx ;
	endcase
assign	e_1_t = ( M_135_t ^ M_133_t ) ;	// line#=computer.cpp:164,165,166,167,168
always @ ( M_139_t or M_135_t )	// line#=computer.cpp:164,170
	case ( M_135_t [7] )
	1'h1 :
		M_292 = { ~M_139_t [3:2] , ~M_139_t [0] , 1'h1 } ;	// line#=computer.cpp:164,170
	1'h0 :
		M_292 = { M_139_t [3:2] , M_139_t [0] , 1'h0 } ;	// line#=computer.cpp:164,165,170
	default :
		M_292 = 4'hx ;
	endcase
always @ ( M_138_t or M_134_t )	// line#=computer.cpp:171
	case ( M_134_t [7] )
	1'h1 :
		M_291 = { ~M_138_t [3:2] , ~M_138_t [0] , 1'h1 } ;	// line#=computer.cpp:171
	1'h0 :
		M_291 = { M_138_t [3:2] , M_138_t [0] , 1'h0 } ;	// line#=computer.cpp:165,166,171
	default :
		M_291 = 4'hx ;
	endcase
always @ ( M_137_t or M_133_t )	// line#=computer.cpp:172
	case ( M_133_t [7] )
	1'h1 :
		M_290 = { ~M_137_t [3:2] , ~M_137_t [0] , 1'h1 } ;	// line#=computer.cpp:172
	1'h0 :
		M_290 = { M_137_t [3:2] , M_137_t [0] , 1'h0 } ;	// line#=computer.cpp:166,167,172
	default :
		M_290 = 4'hx ;
	endcase
always @ ( M_136_t or M_132_t )	// line#=computer.cpp:164,173
	case ( M_132_t [7] )
	1'h1 :
		M_289 = { ~M_136_t [3:2] , ~M_136_t [0] , 1'h1 } ;	// line#=computer.cpp:164,173
	1'h0 :
		M_289 = { M_136_t [3:2] , M_136_t [0] , 1'h0 } ;	// line#=computer.cpp:164,167,173
	default :
		M_289 = 4'hx ;
	endcase
assign	M_181 = ( ( RG_col [31:24] ^ e_1_t ) ^ { M_136_t [6:4] , M_289 [3:2] , M_136_t [1] , 
	M_289 [1:0] } ) ;	// line#=computer.cpp:164,165,166,167,170
				// ,171,172,173,175
assign	M_182 = ( ( RG_col [23:16] ^ e_1_t ) ^ { M_137_t [6:4] , M_290 [3:2] , M_137_t [1] , 
	M_290 [1:0] } ) ;	// line#=computer.cpp:164,165,166,167,170
				// ,171,172,173,175
assign	M_183 = ( ( RG_col [15:8] ^ e_1_t ) ^ { M_138_t [6:4] , M_291 [3:2] , M_138_t [1] , 
	M_291 [1:0] } ) ;	// line#=computer.cpp:164,165,166,167,170
				// ,171,172,173,175
assign	M_184 = ( ( RG_col [7:0] ^ e_1_t ) ^ { M_139_t [6:4] , M_292 [3:2] , M_139_t [1] , 
	M_292 [1:0] } ) ;	// line#=computer.cpp:164,165,166,167,170
				// ,171,172,173,175
assign	M_132_t = ( RG_col [31:24] ^ RG_col [7:0] ) ;	// line#=computer.cpp:164,167,173
assign	M_133_t = ( RG_col [23:16] ^ RG_col [31:24] ) ;	// line#=computer.cpp:164,165,166,167,168
							// ,172
assign	M_134_t = ( RG_col [15:8] ^ RG_col [23:16] ) ;	// line#=computer.cpp:165,166,171
assign	M_135_t = ( RG_col [7:0] ^ RG_col [15:8] ) ;	// line#=computer.cpp:164,165,166,167,168
							// ,170
assign	M_136_t = ( RG_col [30:24] ^ RG_col [6:0] ) ;	// line#=computer.cpp:164,167,173
assign	M_137_t = ( RG_col [22:16] ^ RG_col [30:24] ) ;	// line#=computer.cpp:166,167,172
assign	M_138_t = ( RG_col [14:8] ^ RG_col [22:16] ) ;	// line#=computer.cpp:165,166,171
assign	M_139_t = ( RG_col [6:0] ^ RG_col [14:8] ) ;	// line#=computer.cpp:164,165,170
...
assign	imem_arg_MEMB32W65536_RA1 = RG_addr_addr1_next_pc_op1_PC [17:2] ;	// line#=computer.cpp:616
assign	U_01 = ( ST1_02d & CT_01 ) ;	// line#=computer.cpp:615
assign	U_05 = ( ST1_03d & M_238 ) ;	// line#=computer.cpp:616,623,631
assign	U_06 = ( ST1_03d & M_231 ) ;	// line#=computer.cpp:616,623,631
assign	U_07 = ( ST1_03d & M_199 ) ;	// line#=computer.cpp:616,623,631
assign	U_08 = ( ST1_03d & M_207 ) ;	// line#=computer.cpp:616,623,631
assign	U_09 = ( ST1_03d & M_197 ) ;	// line#=computer.cpp:616,623,631
assign	U_10 = ( ST1_03d & M_240 ) ;	// line#=computer.cpp:616,623,631
assign	U_11 = ( ST1_03d & M_211 ) ;	// line#=computer.cpp:616,623,631
assign	U_12 = ( ST1_03d & M_229 ) ;	// line#=computer.cpp:616,623,631
assign	U_13 = ( ST1_03d & M_222 ) ;	// line#=computer.cpp:616,623,631
assign	U_16 = ( ST1_03d & M_235 ) ;	// line#=computer.cpp:616,623,631
assign	M_197 = ~|( { 25'h0000000 , imem_arg_MEMB32W65536_RD1 [6:0] } ^ 32'h00000063 ) ;	// line#=computer.cpp:616,623,631,711
assign	M_199 = ~|( { 25'h0000000 , imem_arg_MEMB32W65536_RD1 [6:0] } ^ 32'h0000006f ) ;	// line#=computer.cpp:616,623,631,711
assign	M_207 = ~|( { 25'h0000000 , imem_arg_MEMB32W65536_RD1 [6:0] } ^ 32'h00000067 ) ;	// line#=computer.cpp:616,623,631
assign	M_211 = ~|( { 25'h0000000 , imem_arg_MEMB32W65536_RD1 [6:0] } ^ 32'h00000023 ) ;	// line#=computer.cpp:616,623,631
assign	M_222 = ~|( { 25'h0000000 , imem_arg_MEMB32W65536_RD1 [6:0] } ^ 32'h00000033 ) ;	// line#=computer.cpp:616,623,631,711
assign	M_229 = ~|( { 25'h0000000 , imem_arg_MEMB32W65536_RD1 [6:0] } ^ 32'h00000013 ) ;	// line#=computer.cpp:616,623,631,711
assign	M_231 = ~|( { 25'h0000000 , imem_arg_MEMB32W65536_RD1 [6:0] } ^ 32'h00000017 ) ;	// line#=computer.cpp:616,623,631,711
assign	M_233 = ~|( { 25'h0000000 , imem_arg_MEMB32W65536_RD1 [6:0] } ^ 32'h00000073 ) ;	// line#=computer.cpp:616,623,631
assign	M_235 = ~|( { 25'h0000000 , imem_arg_MEMB32W65536_RD1 [6:0] } ^ 32'h0000000b ) ;	// line#=computer.cpp:616,623,631,711
assign	M_238 = ~|( { 25'h0000000 , imem_arg_MEMB32W65536_RD1 [6:0] } ^ 32'h00000037 ) ;	// line#=computer.cpp:616,623,631,711
assign	M_240 = ~|( { 25'h0000000 , imem_arg_MEMB32W65536_RD1 [6:0] } ^ 32'h00000003 ) ;	// line#=computer.cpp:616,623,631
assign	M_245 = ~|( { 25'h0000000 , imem_arg_MEMB32W65536_RD1 [6:0] } ^ 32'h0000000f ) ;	// line#=computer.cpp:616,623,631
assign	M_201 = ~|( { 29'h00000000 , imem_arg_MEMB32W65536_RD1 [14:12] } ^ 32'h00000001 ) ;	// line#=computer.cpp:616,654,668,681,692
												// ,711,744
assign	M_209 = ~|( { 29'h00000000 , imem_arg_MEMB32W65536_RD1 [14:12] } ^ 32'h00000004 ) ;	// line#=computer.cpp:616,654,668,692,711
assign	M_213 = ~|( { 29'h00000000 , imem_arg_MEMB32W65536_RD1 [14:12] } ^ 32'h00000005 ) ;	// line#=computer.cpp:616,654,668,692,711
assign	M_217 = ~|( { 29'h00000000 , imem_arg_MEMB32W65536_RD1 [14:12] } ^ 32'h00000007 ) ;	// line#=computer.cpp:616,654,692,711
assign	M_218 = ~|{ 29'h00000000 , imem_arg_MEMB32W65536_RD1 [14:12] } ;	// line#=computer.cpp:616,654,668,681,692
										// ,711
assign	M_237 = ~|( { 29'h00000000 , imem_arg_MEMB32W65536_RD1 [14:12] } ^ 32'h00000006 ) ;	// line#=computer.cpp:616,654,692,711
assign	U_25 = ( U_10 & M_218 ) ;	// line#=computer.cpp:616,668
assign	U_26 = ( U_10 & M_201 ) ;	// line#=computer.cpp:616,668
assign	U_28 = ( U_10 & M_209 ) ;	// line#=computer.cpp:616,668
assign	U_29 = ( U_10 & M_213 ) ;	// line#=computer.cpp:616,668
assign	M_224 = ~|( { 29'h00000000 , imem_arg_MEMB32W65536_RD1 [14:12] } ^ 32'h00000002 ) ;	// line#=computer.cpp:616,668,681,692,711
												// ,744
assign	U_31 = ( U_11 & M_218 ) ;	// line#=computer.cpp:616,681
assign	U_32 = ( U_11 & M_201 ) ;	// line#=computer.cpp:616,681
assign	U_51 = ( U_16 & M_201 ) ;	// line#=computer.cpp:616,744
assign	U_52 = ( U_16 & M_224 ) ;	// line#=computer.cpp:616,744
assign	U_54 = ( U_51 & CT_03 ) ;	// line#=computer.cpp:747
assign	U_57 = ( ST1_04d & M_239 ) ;	// line#=computer.cpp:631
assign	U_58 = ( ST1_04d & M_232 ) ;	// line#=computer.cpp:631
assign	U_59 = ( ST1_04d & M_200 ) ;	// line#=computer.cpp:631
assign	U_60 = ( ST1_04d & M_208 ) ;	// line#=computer.cpp:631
assign	U_61 = ( ST1_04d & M_198 ) ;	// line#=computer.cpp:631
assign	U_62 = ( ST1_04d & M_241 ) ;	// line#=computer.cpp:631
assign	U_63 = ( ST1_04d & M_212 ) ;	// line#=computer.cpp:631
assign	U_64 = ( ST1_04d & M_230 ) ;	// line#=computer.cpp:631
assign	U_65 = ( ST1_04d & M_223 ) ;	// line#=computer.cpp:631
assign	U_67 = ( ST1_04d & M_234 ) ;	// line#=computer.cpp:631
assign	U_68 = ( ST1_04d & M_236 ) ;	// line#=computer.cpp:631
assign	M_198 = ~|( RG_cols_1 ^ 32'h00000063 ) ;	// line#=computer.cpp:631
assign	M_200 = ~|( RG_cols_1 ^ 32'h0000006f ) ;	// line#=computer.cpp:631
assign	M_208 = ~|( RG_cols_1 ^ 32'h00000067 ) ;	// line#=computer.cpp:631
assign	M_212 = ~|( RG_cols_1 ^ 32'h00000023 ) ;	// line#=computer.cpp:631
assign	M_223 = ~|( RG_cols_1 ^ 32'h00000033 ) ;	// line#=computer.cpp:631
assign	M_230 = ~|( RG_cols_1 ^ 32'h00000013 ) ;	// line#=computer.cpp:631
assign	M_232 = ~|( RG_cols_1 ^ 32'h00000017 ) ;	// line#=computer.cpp:631
assign	M_234 = ~|( RG_cols_1 ^ 32'h00000073 ) ;	// line#=computer.cpp:631
assign	M_236 = ~|( RG_cols_1 ^ 32'h0000000b ) ;	// line#=computer.cpp:631
assign	M_239 = ~|( RG_cols_1 ^ 32'h00000037 ) ;	// line#=computer.cpp:631
assign	M_241 = ~|( RG_cols_1 ^ 32'h00000003 ) ;	// line#=computer.cpp:631
assign	M_246 = ~|( RG_cols_1 ^ 32'h0000000f ) ;	// line#=computer.cpp:631
assign	U_69 = ( ST1_04d & ( ~( ( ( ( ( ( ( ( ( ( ( M_239 | M_232 ) | M_200 ) | M_208 ) | 
	M_198 ) | M_241 ) | M_212 ) | M_230 ) | M_223 ) | M_246 ) | M_234 ) | M_236 ) ) ) ;	// line#=computer.cpp:631
assign	U_70 = ( U_57 & FF_take ) ;	// line#=computer.cpp:633
assign	U_71 = ( U_58 & FF_take ) ;	// line#=computer.cpp:637
assign	U_72 = ( U_59 & FF_take ) ;	// line#=computer.cpp:641
assign	U_73 = ( U_60 & M_247 ) ;	// line#=computer.cpp:647
assign	U_74 = ( U_61 & take_t1 ) ;	// line#=computer.cpp:662
assign	M_202 = ~|( RG_cols_imm1_instr ^ 32'h00000001 ) ;	// line#=computer.cpp:668,681,744
assign	M_219 = ~|RG_cols_imm1_instr ;	// line#=computer.cpp:668,681
assign	M_225 = ~|( RG_cols_imm1_instr ^ 32'h00000002 ) ;	// line#=computer.cpp:668,681,744
assign	M_247 = |RG_rd ;	// line#=computer.cpp:647,675,706,725
assign	U_82 = ( U_62 & M_247 ) ;	// line#=computer.cpp:675
assign	U_87 = ( U_64 & ( ~|RG_cols_word_addr ) ) ;	// line#=computer.cpp:692
assign	U_97 = ( U_64 & M_247 ) ;	// line#=computer.cpp:706
assign	U_98 = ( U_65 & ( ~|RG_cols_rs2 ) ) ;	// line#=computer.cpp:711
assign	M_220 = ~RG_cols_imm1_instr [23] ;	// line#=computer.cpp:701,702,703,718,719
						// ,720
assign	U_108 = ( U_65 & M_247 ) ;	// line#=computer.cpp:725
assign	U_109 = ( U_68 & M_202 ) ;	// line#=computer.cpp:744
assign	U_110 = ( U_68 & M_225 ) ;	// line#=computer.cpp:744
assign	U_112 = ( U_109 & FF_take ) ;	// line#=computer.cpp:747
assign	U_120 = ( ST1_05d & M_221 ) ;
assign	U_121 = ( ST1_05d & M_204 ) ;
assign	U_122 = ( ST1_05d & M_226 ) ;
assign	M_204 = ~|( RG_06 ^ 2'h1 ) ;
assign	M_221 = ~|RG_06 ;
assign	M_226 = ~|( RG_06 ^ 2'h2 ) ;
assign	U_123 = ( ST1_05d & ( ~( ( M_221 | M_204 ) | M_226 ) ) ) ;
always @ ( add32s1ot or M_211 )
	TR_15 = ( { 12{ M_211 } } & add32s1ot [13:2] )	// line#=computer.cpp:52,61,679
		 ;	// line#=computer.cpp:52,56,666
assign	M_252 = ( ST1_04d & U_59 ) ;
always @ ( add32s1ot or M_252 or TR_15 or M_256 )
	TR_01 = ( ( { 30{ M_256 } } & { 18'h00000 , TR_15 } )	// line#=computer.cpp:52,56,61,666,679
		| ( { 30{ M_252 } } & add32s1ot [31:2] )	// line#=computer.cpp:52,75,642
		) ;
always @ ( RG_addr_addr1_next_pc_op1_PC or M_127_t or U_61 or U_60 or RG_08 or U_69 or 
	U_68 or U_67 or M_246 or U_65 or U_64 or U_63 or U_62 or U_58 or U_57 or 
	ST1_04d or regs_rd00 or U_16 or add32s1ot or TR_01 or M_252 or M_256 or 
	regs_rd01 or U_13 )	// line#=computer.cpp:631
	begin
	RG_addr_addr1_next_pc_op1_PC_t_c1 = ( M_256 | M_252 ) ;	// line#=computer.cpp:52,56,61,75,642,666
								// ,679
	RG_addr_addr1_next_pc_op1_PC_t_c2 = ( ST1_04d & ( ( ( ( ( ( ( ( ( U_57 | 
		U_58 ) | U_62 ) | U_63 ) | U_64 ) | U_65 ) | ( ST1_04d & M_246 ) ) | 
		U_67 ) | U_68 ) | U_69 ) ) ;	// line#=computer.cpp:629
	RG_addr_addr1_next_pc_op1_PC_t_c3 = ( ST1_04d & U_60 ) ;	// line#=computer.cpp:52,56,646,648
	RG_addr_addr1_next_pc_op1_PC_t_c4 = ( ST1_04d & U_61 ) ;
	RG_addr_addr1_next_pc_op1_PC_t = ( ( { 32{ U_13 } } & regs_rd01 )			// line#=computer.cpp:710
		| ( { 32{ RG_addr_addr1_next_pc_op1_PC_t_c1 } } & { TR_01 , add32s1ot [1:0] } )	// line#=computer.cpp:52,56,61,75,642,666
												// ,679
		| ( { 32{ U_16 } } & { 8'h00 , regs_rd00 [31:8] } )				// line#=computer.cpp:748
		| ( { 32{ RG_addr_addr1_next_pc_op1_PC_t_c2 } } & RG_08 )			// line#=computer.cpp:629
		| ( { 32{ RG_addr_addr1_next_pc_op1_PC_t_c3 } } & { add32s1ot [31:1] , 
			1'h0 } )								// line#=computer.cpp:52,56,646,648
		| ( { 32{ RG_addr_addr1_next_pc_op1_PC_t_c4 } } & { M_127_t , RG_addr_addr1_next_pc_op1_PC [0] } ) ) ;
	end
assign	RG_addr_addr1_next_pc_op1_PC_en = ( U_13 | RG_addr_addr1_next_pc_op1_PC_t_c1 | 
	U_16 | RG_addr_addr1_next_pc_op1_PC_t_c2 | RG_addr_addr1_next_pc_op1_PC_t_c3 | 
	RG_addr_addr1_next_pc_op1_PC_t_c4 ) ;	// line#=computer.cpp:631
always @ ( posedge CLOCK )	// line#=computer.cpp:631
	if ( RESET )
		...
		RG_addr_addr1_next_pc_op1_PC <= RG_addr_addr1_next_pc_op1_PC_t ;	// line#=computer.cpp:52,56,61,75,629,631
											// ,642,646,648,666,679,710,748
always @ ( RG_col or M_250 or regs_rd00 or ST1_03d )
	RG_col_op2_t = ( ( { 32{ ST1_03d } } & regs_rd00 )	// line#=computer.cpp:710
		| ( { 32{ M_250 } } & RG_col ) ) ;
assign	RG_col_op2_en = ( ST1_03d | M_250 ) ;
always @ ( posedge CLOCK )
	if ( RESET )
		RG_col_op2 <= 32'h00000000 ;
	else if ( RG_col_op2_en )
		RG_col_op2 <= RG_col_op2_t ;	// line#=computer.cpp:710
assign	M_270 = ( M_211 & M_201 ) ;
assign	M_278 = ( M_211 & M_218 ) ;
always @ ( imem_arg_MEMB32W65536_RD1 or M_229 or addsub32u1ot or M_270 or M_278 )
	begin
	TR_02_c1 = ( M_278 | M_270 ) ;	// line#=computer.cpp:113,117,124,128
	TR_02 = ( ( { 12{ TR_02_c1 } } & addsub32u1ot [13:2] )				// line#=computer.cpp:113,117,124,128
		| ( { 12{ M_229 } } & { 9'h000 , imem_arg_MEMB32W65536_RD1 [14:12] } )	// line#=computer.cpp:616,692
		) ;
	end
assign	M_250 = ( ST1_04d | ST1_05d ) ;
always @ ( RG_cols_3 or M_250 or TR_02 or U_12 or U_32 or U_31 )
	begin
	RG_cols_word_addr_t_c1 = ( ( U_31 | U_32 ) | U_12 ) ;	// line#=computer.cpp:113,117,124,128,616
								// ,692
	RG_cols_word_addr_t = ( ( { 32{ RG_cols_word_addr_t_c1 } } & { 20'h00000 , 
			TR_02 } )	// line#=computer.cpp:113,117,124,128,616
					// ,692
		| ( { 32{ M_250 } } & RG_cols_3 ) ) ;
	end
assign	RG_cols_word_addr_en = ( RG_cols_word_addr_t_c1 | M_250 ) ;
always @ ( posedge CLOCK )
	if ( RG_cols_word_addr_en )
		RG_cols_word_addr <= RG_cols_word_addr_t ;	// line#=computer.cpp:113,117,124,128,616
								// ,692
always @ ( M_222 or M_197 or imem_arg_MEMB32W65536_RD1 or M_211 or M_229 )
	begin
	TR_03_c1 = ( M_229 | M_211 ) ;	// line#=computer.cpp:616,627
	TR_03_c2 = ( M_197 | M_222 ) ;	// line#=computer.cpp:616,654,711
	TR_03 = ( ( { 5{ TR_03_c1 } } & imem_arg_MEMB32W65536_RD1 [24:20] )		// line#=computer.cpp:616,627
		| ( { 5{ TR_03_c2 } } & { 2'h0 , imem_arg_MEMB32W65536_RD1 [14:12] } )	// line#=computer.cpp:616,654,711
		) ;
	end
always @ ( RG_cols_4 or M_250 or TR_03 or U_13 or U_09 or U_11 or U_12 )
	begin
	RG_cols_rs2_t_c1 = ( ( U_12 | U_11 ) | ( U_09 | U_13 ) ) ;	// line#=computer.cpp:616,627,654,711
	RG_cols_rs2_t = ( ( { 32{ RG_cols_rs2_t_c1 } } & { 27'h0000000 , TR_03 } )	// line#=computer.cpp:616,627,654,711
		| ( { 32{ M_250 } } & RG_cols_4 ) ) ;
	end
assign	RG_cols_rs2_en = ( RG_cols_rs2_t_c1 | M_250 ) ;
always @ ( posedge CLOCK )
	if ( RG_cols_rs2_en )
		RG_cols_rs2 <= RG_cols_rs2_t ;	// line#=computer.cpp:616,627,654,711
always @ ( M_184 or M_183 or M_182 or M_181 or U_123 or RG_cols_imm1_instr or CT_03 or 
	U_52 )	// line#=computer.cpp:616,755
	begin
	RG_cols_t_c1 = ( U_52 & CT_03 ) ;	// line#=computer.cpp:179
	RG_cols_t = ( ( { 32{ RG_cols_t_c1 } } & RG_cols_imm1_instr )		// line#=computer.cpp:179
		| ( { 32{ U_123 } } & { M_181 , M_182 , M_183 , M_184 } )	// line#=computer.cpp:164,165,166,167,170
										// ,171,172,173,175,188
		) ;
	end
assign	RG_cols_en = ( RG_cols_t_c1 | U_123 ) ;	// line#=computer.cpp:616,755
always @ ( posedge CLOCK )	// line#=computer.cpp:616,755
	if ( RG_cols_en )
		RG_cols <= RG_cols_t ;	// line#=computer.cpp:164,165,166,167,170
					// ,171,172,173,175,179,188,616,755
always @ ( RG_cols_2 or M_250 or imem_arg_MEMB32W65536_RD1 or ST1_03d )
	RG_cols_1_t = ( ( { 32{ ST1_03d } } & { 25'h0000000 , imem_arg_MEMB32W65536_RD1 [6:0] } )	// line#=computer.cpp:616,623,631
		| ( { 32{ M_250 } } & RG_cols_2 ) ) ;
assign	RG_cols_1_en = ( ST1_03d | M_250 ) ;
always @ ( posedge CLOCK )
	if ( RG_cols_1_en )
		RG_cols_1 <= RG_cols_1_t ;	// line#=computer.cpp:616,623,631
always @ ( M_226 or U_122 or U_121 or U_120 or FF_take or U_110 or ST1_04d )	// line#=computer.cpp:755
	begin
	RG_06_t_c1 = ( ( ST1_04d & ( U_110 & FF_take ) ) | U_120 ) ;
	RG_06_t_c2 = ( U_121 | U_122 ) ;
	RG_06_t = ( ( { 2{ RG_06_t_c1 } } & { 1'h0 , U_120 } )
		| ( { 2{ RG_06_t_c2 } } & { 1'h1 , M_226 } ) ) ;
	end
...
always @ ( U_69 or M_225 or M_202 or U_68 or U_110 or FF_take or U_109 or U_67 or 
	ST1_04d )	// line#=computer.cpp:744,755
	begin
	FF_halt_t_c1 = ( ST1_04d & ( ( ( ( U_67 | ( U_109 & ( ~FF_take ) ) ) | ( 
		U_110 & ( ~FF_take ) ) ) | ( U_68 & ( ~( M_202 | M_225 ) ) ) ) | 
		U_69 ) ) ;	// line#=computer.cpp:732,750,756,797,808
...
always @ ( posedge CLOCK )	// line#=computer.cpp:744,755
	if ( FF_halt_en )
		FF_halt <= FF_halt_t ;	// line#=computer.cpp:613,732,744,750,755
					// ,756,797,808
assign	RG_08_en = ST1_02d ;
always @ ( posedge CLOCK )	// line#=computer.cpp:629
	if ( RG_08_en )
		RG_08 <= addsub32u1ot ;
always @ ( M_184 or M_183 or M_182 or M_181 or U_120 or RG_cols_1 or M_255 or regs_rg10 or 
	ST1_02d )
	RG_cols_2_t = ( ( { 32{ ST1_02d } } & regs_rg10 )			// line#=computer.cpp:179
		| ( { 32{ M_255 } } & RG_cols_1 )
		| ( { 32{ U_120 } } & { M_181 , M_182 , M_183 , M_184 } )	// line#=computer.cpp:164,165,166,167,170
										// ,171,172,173,175,188
		) ;
assign	RG_cols_2_en = ( ST1_02d | M_255 | U_120 ) ;
always @ ( posedge CLOCK )
	if ( RG_cols_2_en )
		RG_cols_2 <= RG_cols_2_t ;	// line#=computer.cpp:164,165,166,167,170
						// ,171,172,173,175,179,188
assign	M_255 = ( ( ( ( ( ( ( ( ( ( ( ( ( ( U_05 | U_06 ) | U_07 ) | U_08 ) | U_09 ) | 
	U_10 ) | U_11 ) | U_12 ) | U_13 ) | ( ST1_03d & M_245 ) ) | ( ST1_03d & M_233 ) ) | 
	U_51 ) | ( U_52 & ( ~CT_03 ) ) ) | ( U_16 & ( ~( M_201 | M_224 ) ) ) ) | 
	( ST1_03d & ( ~( ( ( ( ( ( ( ( ( M_267 | M_207 ) | M_197 ) | M_240 ) | M_211 ) | 
	M_229 ) | M_222 ) | M_245 ) | M_233 ) | M_235 ) ) ) ) ;	// line#=computer.cpp:616,623,631,744,755
always @ ( M_184 or M_183 or M_182 or M_181 or U_121 or RG_cols_word_addr or M_255 or 
	regs_rg11 or ST1_02d )
	RG_cols_3_t = ( ( { 32{ ST1_02d } } & regs_rg11 )			// line#=computer.cpp:179
		| ( { 32{ M_255 } } & RG_cols_word_addr )
		| ( { 32{ U_121 } } & { M_181 , M_182 , M_183 , M_184 } )	// line#=computer.cpp:164,165,166,167,170
										// ,171,172,173,175,188
		) ;
assign	RG_cols_3_en = ( ST1_02d | M_255 | U_121 ) ;
always @ ( posedge CLOCK )
	if ( RG_cols_3_en )
		RG_cols_3 <= RG_cols_3_t ;	// line#=computer.cpp:164,165,166,167,170
						// ,171,172,173,175,179,188
always @ ( M_184 or M_183 or M_182 or M_181 or U_122 or RG_cols_rs2 or M_255 or 
	regs_rg12 or ST1_02d )
	RG_cols_4_t = ( ( { 32{ ST1_02d } } & regs_rg12 )			// line#=computer.cpp:179
		| ( { 32{ M_255 } } & RG_cols_rs2 )
		| ( { 32{ U_122 } } & { M_181 , M_182 , M_183 , M_184 } )	// line#=computer.cpp:164,165,166,167,170
										// ,171,172,173,175,188
		) ;
assign	RG_cols_4_en = ( ST1_02d | M_255 | U_122 ) ;
always @ ( posedge CLOCK )
	if ( RG_cols_4_en )
		RG_cols_4 <= RG_cols_4_t ;	// line#=computer.cpp:164,165,166,167,170
						// ,171,172,173,175,179,188
always @ ( M_235 or M_211 or M_240 or imem_arg_MEMB32W65536_RD1 or M_197 or M_207 or 
	M_199 or M_231 or M_238 or M_222 or M_213 or M_229 )
	begin
	TR_06_c1 = ( ( ( ( ( ( ( M_229 & M_213 ) | M_222 ) | M_238 ) | M_231 ) | 
		M_199 ) | M_207 ) | M_197 ) ;	// line#=computer.cpp:616
	TR_06_c2 = ( ( M_240 | M_211 ) | M_235 ) ;	// line#=computer.cpp:616,668,681,744
	TR_06 = ( ( { 25{ TR_06_c1 } } & imem_arg_MEMB32W65536_RD1 [31:7] )			// line#=computer.cpp:616
		| ( { 25{ TR_06_c2 } } & { 22'h000000 , imem_arg_MEMB32W65536_RD1 [14:12] } )	// line#=computer.cpp:616,668,681,744
		) ;
	end
always @ ( TR_06 or U_16 or U_11 or U_10 or U_09 or U_08 or U_07 or U_06 or U_05 or 
	U_13 or M_213 or imem_arg_MEMB32W65536_RD1 or M_217 or M_237 or M_209 or 
	M_218 or U_12 or regs_rg13 or ST1_02d )	// line#=computer.cpp:616,692
	begin
	RG_cols_imm1_instr_t_c1 = ( ( ( ( U_12 & M_218 ) | ( U_12 & M_209 ) ) | ( 
		U_12 & M_237 ) ) | ( U_12 & M_217 ) ) ;	// line#=computer.cpp:52,56,616,689
	RG_cols_imm1_instr_t_c2 = ( ( ( ( ( ( ( ( U_12 & M_213 ) | U_13 ) | U_05 ) | 
		U_06 ) | U_07 ) | U_08 ) | U_09 ) | ( ( U_10 | U_11 ) | U_16 ) ) ;	// line#=computer.cpp:616,668,681,744
	RG_cols_imm1_instr_t = ( ( { 32{ ST1_02d } } & regs_rg13 )				// line#=computer.cpp:179
		| ( { 32{ RG_cols_imm1_instr_t_c1 } } & { imem_arg_MEMB32W65536_RD1 [31] , 
		...
		| ( { 32{ RG_cols_imm1_instr_t_c2 } } & { 7'h00 , TR_06 } )			// line#=computer.cpp:616,668,681,744
		) ;
	end
always @ ( posedge CLOCK )	// line#=computer.cpp:616,692
	RG_cols_imm1_instr <= RG_cols_imm1_instr_t ;	// line#=computer.cpp:52,56,179,616,668
							// ,681,689,744
always @ ( RG_cols or U_122 or RG_cols_4 or U_121 or RG_cols_3 or U_120 or RG_col_op2 or 
	M_255 or regs_rg10 or ST1_02d )
	RG_col_t = ( ( { 32{ ST1_02d } } & regs_rg10 )	// line#=computer.cpp:179,188
		| ( { 32{ M_255 } } & RG_col_op2 )
		| ( { 32{ U_120 } } & RG_cols_3 )	// line#=computer.cpp:188
		| ( { 32{ U_121 } } & RG_cols_4 )	// line#=computer.cpp:188
		| ( { 32{ U_122 } } & RG_cols )		// line#=computer.cpp:188
		) ;
assign	RG_col_en = ( ST1_02d | M_255 | U_120 | U_121 | U_122 ) ;
always @ ( posedge CLOCK )
	if ( RESET )
		RG_col <= 32'h00000000 ;
	else if ( RG_col_en )
		RG_col <= RG_col_t ;	// line#=computer.cpp:179,188
always @ ( accel_sbox2ot or M_235 or imem_arg_MEMB32W65536_RD1 or M_207 or M_229 )
	begin
	RG_bytes_rs1_t_c1 = ( M_229 | M_207 ) ;	// line#=computer.cpp:616,626
	RG_bytes_rs1_t = ( ( { 8{ RG_bytes_rs1_t_c1 } } & { 3'h0 , imem_arg_MEMB32W65536_RD1 [19:15] } )	// line#=computer.cpp:616,626
		| ( { 8{ M_235 } } & accel_sbox2ot )								// line#=computer.cpp:277,278,279,280,281
														// ,291,749
		) ;
	end
always @ ( posedge CLOCK )
	RG_bytes_rs1 <= RG_bytes_rs1_t ;	// line#=computer.cpp:277,278,279,280,281
						// ,291,616,626,749
assign	M_242 = ~|( { 29'h00000000 , imem_arg_MEMB32W65536_RD1 [14:12] } ^ 32'h00000003 ) ;	// line#=computer.cpp:616,692,711
assign	M_249 = ( regs_rd00 ^ regs_rd01 ) ;	// line#=computer.cpp:655,656
assign	M_267 = ( ( M_238 | M_231 ) | M_199 ) ;	// line#=computer.cpp:616,623,631,711
always @ ( M_235 or CT_03 or M_269 or comp32u_12ot or M_242 or comp32s_11ot or M_224 or 
	M_222 or comp32u_13ot or M_286 or comp32s_1_11ot or M_284 or M_264 or comp32u_11ot or 
	M_263 or M_262 or comp32s_12ot or M_261 or M_260 or M_249 or M_259 or imem_arg_MEMB32W65536_RD1 or 
	M_267 )	// line#=computer.cpp:616,711
	begin
	FF_take_t_c1 = ( M_222 & M_224 ) ;	// line#=computer.cpp:714
	FF_take_t_c2 = ( M_222 & M_242 ) ;	// line#=computer.cpp:715
	FF_take_t_c3 = ( M_235 & M_224 ) ;	// line#=computer.cpp:616,755
	FF_take_t = ( ( { 1{ M_267 } } & ( |imem_arg_MEMB32W65536_RD1 [11:7] ) )	// line#=computer.cpp:616,624,633,637,641
		| ( { 1{ M_259 } } & ( ~|M_249 ) )					// line#=computer.cpp:655
		| ( { 1{ M_260 } } & ( |M_249 ) )					// line#=computer.cpp:656
		| ( { 1{ M_261 } } & comp32s_12ot [3] )					// line#=computer.cpp:657
		| ( { 1{ M_262 } } & comp32s_12ot [0] )					// line#=computer.cpp:658
		| ( { 1{ M_263 } } & comp32u_11ot [3] )					// line#=computer.cpp:659
		| ( { 1{ M_264 } } & comp32u_11ot [0] )					// line#=computer.cpp:660
		| ( { 1{ M_284 } } & comp32s_1_11ot [3] )				// line#=computer.cpp:694
		| ( { 1{ M_286 } } & comp32u_13ot [3] )					// line#=computer.cpp:695
		| ( { 1{ FF_take_t_c1 } } & comp32s_11ot [3] )				// line#=computer.cpp:714
		| ( { 1{ FF_take_t_c2 } } & comp32u_12ot [3] )				// line#=computer.cpp:715
		| ( { 1{ M_269 } } & CT_03 )						// line#=computer.cpp:747
		| ( { 1{ FF_take_t_c3 } } & CT_03 )					// line#=computer.cpp:616,755
		) ;
	end
always @ ( posedge CLOCK )	// line#=computer.cpp:616,711
	FF_take <= FF_take_t ;	// line#=computer.cpp:616,624,633,637,641
				...
				// ,714,715,747,755
always @ ( RG_addr_addr1_next_pc_op1_PC or RG_08 or add32s1ot or take_t1 )	// line#=computer.cpp:662
	begin
	M_127_t_c1 = ~take_t1 ;
	M_127_t = ( ( { 31{ take_t1 } } & add32s1ot [31:1] )	// line#=computer.cpp:662
		| ( { 31{ M_127_t_c1 } } & { RG_08 [31:2] , RG_addr_addr1_next_pc_op1_PC [1] } ) ) ;
	end
assign	JF_02 = ~( ( M_236 & M_225 ) & FF_take ) ;
...
assign	M_256 = ( U_11 | U_10 ) ;
always @ ( RG_addr_addr1_next_pc_op1_PC or U_59 or U_74 or regs_rd02 or U_60 or 
	U_87 or regs_rd00 or M_256 )
	begin
	add32s1i1_c1 = ( U_87 | U_60 ) ;	// line#=computer.cpp:52,56,646,693
	add32s1i1_c2 = ( U_74 | U_59 ) ;	// line#=computer.cpp:52,75,642,662
	add32s1i1 = ( ( { 32{ M_256 } } & regs_rd00 )				// line#=computer.cpp:52,56,61,666,679
		| ( { 32{ add32s1i1_c1 } } & regs_rd02 )			// line#=computer.cpp:52,56,646,693
		| ( { 32{ add32s1i1_c2 } } & RG_addr_addr1_next_pc_op1_PC )	// line#=computer.cpp:52,75,642,662
		) ;
	end
always @ ( M_240 or imem_arg_MEMB32W65536_RD1 or M_211 )
	TR_07 = ( ( { 5{ M_211 } } & imem_arg_MEMB32W65536_RD1 [11:7] )		// line#=computer.cpp:52,60,61,616,624
										// ,628,679
		| ( { 5{ M_240 } } & imem_arg_MEMB32W65536_RD1 [24:20] )	// line#=computer.cpp:52,56,616,627,666
		) ;
always @ ( M_208 or RG_cols_imm1_instr or M_248 )
	M_293 = ( ( { 6{ M_248 } } & { RG_cols_imm1_instr [0] , RG_cols_imm1_instr [4:1] , 
			1'h0 } )								// line#=computer.cpp:52,65,66,67,628,652
												// ,662
		| ( { 6{ M_208 } } & { RG_cols_imm1_instr [24] , RG_cols_imm1_instr [17:13] } )	// line#=computer.cpp:52,56,627,646
		) ;
assign	M_248 = ( M_198 & take_t1 ) ;
always @ ( M_200 or M_293 or RG_cols_imm1_instr or M_208 or M_248 )
	begin
	M_294_c1 = ( M_248 | M_208 ) ;	// line#=computer.cpp:52,56,65,66,67,627
					// ,628,646,652,662
	M_294 = ( ( { 14{ M_294_c1 } } & { RG_cols_imm1_instr [24] , RG_cols_imm1_instr [24] , 
			RG_cols_imm1_instr [24] , RG_cols_imm1_instr [24] , RG_cols_imm1_instr [24] , 
			RG_cols_imm1_instr [24] , RG_cols_imm1_instr [24] , RG_cols_imm1_instr [24] , 
			M_293 } )				// line#=computer.cpp:52,56,65,66,67,627
								// ,628,646,652,662
		| ( { 14{ M_200 } } & { RG_cols_imm1_instr [12:5] , RG_cols_imm1_instr [13] , 
			RG_cols_imm1_instr [17:14] , 1'h0 } )	// line#=computer.cpp:52,73,74,75,625,627
								// ,642
		) ;
	end
always @ ( M_294 or U_59 or U_60 or U_74 or RG_cols_imm1_instr or U_87 or TR_07 or 
	imem_arg_MEMB32W65536_RD1 or M_256 )
	begin
	add32s1i2_c1 = ( ( U_74 | U_60 ) | U_59 ) ;	// line#=computer.cpp:52,56,65,66,67,73
							// ,74,75,625,627,628,642,646,652
							// ,662
	add32s1i2 = ( ( { 21{ M_256 } } & { imem_arg_MEMB32W65536_RD1 [31] , imem_arg_MEMB32W65536_RD1 [31] , 
			imem_arg_MEMB32W65536_RD1 [31] , imem_arg_MEMB32W65536_RD1 [31] , 
			imem_arg_MEMB32W65536_RD1 [31] , imem_arg_MEMB32W65536_RD1 [31] , 
			imem_arg_MEMB32W65536_RD1 [31] , imem_arg_MEMB32W65536_RD1 [31] , 
			...
			TR_07 } )						// line#=computer.cpp:52,56,60,61,616,624
										// ,627,628,666,679
		| ( { 21{ U_87 } } & { RG_cols_imm1_instr [11] , RG_cols_imm1_instr [11] , 
		...
		| ( { 21{ add32s1i2_c1 } } & { RG_cols_imm1_instr [24] , M_294 [13:5] , 
			RG_cols_imm1_instr [23:18] , M_294 [4:0] } )		// line#=computer.cpp:52,56,65,66,67,73
										// ,74,75,625,627,628,642,646,652
										// ,662
		) ;
	end
always @ ( regs_rd03 or M_202 )
	TR_16 = ( { 8{ M_202 } } & regs_rd03 [15:8] )	// line#=computer.cpp:131,683
		 ;	// line#=computer.cpp:120,682
assign	M_205 = ~|( RG_cols_word_addr ^ 32'h00000001 ) ;	// line#=computer.cpp:692
assign	M_206 = ~|( RG_cols_rs2 ^ 32'h00000001 ) ;	// line#=computer.cpp:711
always @ ( regs_rd03 or TR_16 or M_273 or regs_rd02 or M_276 or RG_addr_addr1_next_pc_op1_PC or 
	M_277 )
	lsft32u1i1 = ( ( { 32{ M_277 } } & RG_addr_addr1_next_pc_op1_PC )	// line#=computer.cpp:713
		| ( { 32{ M_276 } } & regs_rd02 )				// line#=computer.cpp:699
		| ( { 32{ M_273 } } & { 16'h0000 , TR_16 , regs_rd03 [7:0] } )	// line#=computer.cpp:120,131,682,683
		) ;
assign	M_273 = ( ( M_212 & M_202 ) | ( M_212 & M_219 ) ) ;
assign	M_276 = ( M_230 & M_205 ) ;
assign	M_277 = ( M_223 & M_206 ) ;
always @ ( RG_addr_addr1_next_pc_op1_PC or M_273 or RG_cols_rs2 or M_276 or RG_col_op2 or 
	M_277 )
	lsft32u1i2 = ( ( { 5{ M_277 } } & RG_col_op2 [4:0] )				// line#=computer.cpp:713
		| ( { 5{ M_276 } } & RG_cols_rs2 [4:0] )				// line#=computer.cpp:699
		| ( { 5{ M_273 } } & { RG_addr_addr1_next_pc_op1_PC [1:0] , 3'h0 } )	// line#=computer.cpp:118,119,120,129,130
											// ,131,682,683
		) ;
assign	M_215 = ~|( RG_cols_word_addr ^ 32'h00000005 ) ;	// line#=computer.cpp:692
assign	M_216 = ~|( RG_cols_rs2 ^ 32'h00000005 ) ;	// line#=computer.cpp:711
always @ ( dmem_arg_MEMB32W4096_RD1 or M_274 or regs_rd02 or M_279 or RG_addr_addr1_next_pc_op1_PC or 
	M_281 )
	rsft32u1i1 = ( ( { 32{ M_281 } } & RG_addr_addr1_next_pc_op1_PC )	// line#=computer.cpp:718,719,720
		| ( { 32{ M_279 } } & regs_rd02 )				// line#=computer.cpp:701,702,703
		| ( { 32{ M_274 } } & dmem_arg_MEMB32W4096_RD1 )		// line#=computer.cpp:90,91,100,101,669
										// ,670,672,673
		) ;
assign	M_274 = ( ( ( ( M_241 & ( ~|( RG_cols_imm1_instr ^ 32'h00000005 ) ) ) | ( 
	M_241 & ( ~|( RG_cols_imm1_instr ^ 32'h00000004 ) ) ) ) | ( M_241 & M_202 ) ) | 
	( M_241 & M_219 ) ) ;	// line#=computer.cpp:668
assign	M_279 = ( M_280 & M_220 ) ;
assign	M_281 = ( M_282 & M_220 ) ;
always @ ( RG_addr_addr1_next_pc_op1_PC or M_274 or RG_cols_rs2 or M_279 or RG_col_op2 or 
	M_281 )
	rsft32u1i2 = ( ( { 5{ M_281 } } & RG_col_op2 [4:0] )				// line#=computer.cpp:718,719,720
		| ( { 5{ M_279 } } & RG_cols_rs2 [4:0] )				// line#=computer.cpp:701,702,703
		| ( { 5{ M_274 } } & { RG_addr_addr1_next_pc_op1_PC [1:0] , 3'h0 } )	// line#=computer.cpp:90,91,100,101,669
											// ,670,672,673
		) ;
assign	M_280 = ( M_230 & M_215 ) ;
assign	M_282 = ( M_223 & M_216 ) ;
always @ ( regs_rd02 or M_280 or RG_addr_addr1_next_pc_op1_PC or M_282 )
	rsft32s1i1 = ( ( { 32{ M_282 } } & RG_addr_addr1_next_pc_op1_PC )	// line#=computer.cpp:718,719,720
		| ( { 32{ M_280 } } & regs_rd02 )				// line#=computer.cpp:701,702,703
		) ;
always @ ( RG_cols_rs2 or M_280 or RG_col_op2 or M_282 )
	rsft32s1i2 = ( ( { 5{ M_282 } } & RG_col_op2 [4:0] )	// line#=computer.cpp:718,719,720
		| ( { 5{ M_280 } } & RG_cols_rs2 [4:0] )	// line#=computer.cpp:701,702,703
		) ;
always @ ( add32s1ot or U_25 or U_26 or U_28 or U_29 or M_258 or RG_addr_addr1_next_pc_op1_PC or 
	U_98 or M_254 )
	begin
	addsub32u1i1_c1 = ( M_254 | U_98 ) ;	// line#=computer.cpp:70,629,637,712
	addsub32u1i1_c2 = ( M_258 | ( ( ( U_29 | U_28 ) | U_26 ) | U_25 ) ) ;	// line#=computer.cpp:52,56,61,85,95,113
										// ,124,666,679
	addsub32u1i1 = ( ( { 32{ addsub32u1i1_c1 } } & RG_addr_addr1_next_pc_op1_PC )	// line#=computer.cpp:70,629,637,712
		| ( { 32{ addsub32u1i1_c2 } } & add32s1ot )				// line#=computer.cpp:52,56,61,85,95,113
											// ,124,666,679
		) ;
	end
always @ ( M_257 or RG_cols_imm1_instr or U_71 )
	TR_17 = ( ( { 20{ U_71 } } & RG_cols_imm1_instr [24:5] )	// line#=computer.cpp:70,637
		| ( { 20{ M_257 } } & 20'h00040 )			// line#=computer.cpp:85,95,113,124
		) ;
always @ ( U_01 or TR_17 or M_257 or U_71 )
	begin
	M_295_c1 = ( U_71 | M_257 ) ;	// line#=computer.cpp:70,85,95,113,124
					// ,637
	M_295 = ( ( { 21{ M_295_c1 } } & { TR_17 , 1'h0 } )	// line#=computer.cpp:70,85,95,113,124
								// ,637
		| ( { 21{ U_01 } } & 21'h000001 )		// line#=computer.cpp:629
		) ;
	end
assign	M_254 = ( U_71 | U_01 ) ;
always @ ( RG_col_op2 or U_98 or M_295 or M_257 or M_254 )
	begin
	addsub32u1i2_c1 = ( M_254 | M_257 ) ;	// line#=computer.cpp:70,85,95,113,124
						// ,629,637
	addsub32u1i2 = ( ( { 32{ addsub32u1i2_c1 } } & { M_295 [20:1] , 9'h000 , 
			M_295 [0] , 2'h0 } )		// line#=computer.cpp:70,85,95,113,124
							// ,629,637
		| ( { 32{ U_98 } } & RG_col_op2 )	// line#=computer.cpp:712
		) ;
	end
assign	M_258 = ( U_32 | U_31 ) ;
assign	M_257 = ( ( ( ( M_258 | U_29 ) | U_28 ) | U_26 ) | U_25 ) ;
always @ ( RG_cols_imm1_instr )	// line#=computer.cpp:712
	...
	endcase
always @ ( addsub32u1_f_t1 or U_98 or M_257 or M_254 )
	addsub32u1_f = ( ( { 2{ M_254 } } & 2'h1 )
		| ( { 2{ M_257 } } & 2'h2 )
		| ( { 2{ U_98 } } & addsub32u1_f_t1 )	// line#=computer.cpp:712
		) ;
...
always @ ( RG_addr_addr1_next_pc_op1_PC or U_112 or regs_rd00 or U_54 )
	accel_sbox1i1 = ( ( { 8{ U_54 } } & regs_rd00 [23:16] )			// line#=computer.cpp:277,278,279,280,281
										// ,291,748,749
		| ( { 8{ U_112 } } & RG_addr_addr1_next_pc_op1_PC [23:16] )	// line#=computer.cpp:277,278,279,280,281
										// ,291,292,293,294,295,749
		) ;
always @ ( RG_addr_addr1_next_pc_op1_PC or U_112 or regs_rd00 or U_54 )
	accel_sbox2i1 = ( ( { 8{ U_54 } } & regs_rd00 [7:0] )			// line#=computer.cpp:277,278,279,280,281
										// ,291,748,749
		| ( { 8{ U_112 } } & RG_addr_addr1_next_pc_op1_PC [7:0] )	// line#=computer.cpp:277,278,279,280,281
										// ,291,292,293,294,295,749
		) ;
always @ ( M_202 )
	M_288 = ( { 8{ M_202 } } & 8'hff )	// line#=computer.cpp:130
		 ;	// line#=computer.cpp:119
assign	lsft32u_321i1 = { M_288 , 8'hff } ;
assign	lsft32u_321i2 = { RG_addr_addr1_next_pc_op1_PC [1:0] , 3'h0 } ;	// line#=computer.cpp:118,119,129,130
assign	imem_arg_MEMB32W65536_RE1 = U_01 ;	// line#=computer.cpp:616
assign	M_275 = ( M_219 | M_202 ) ;	// line#=computer.cpp:668,681
always @ ( regs_rd03 or M_225 or lsft32u1ot or lsft32u_321ot or dmem_arg_MEMB32W4096_RD1 or 
	M_275 )
	dmem_arg_MEMB32W4096_WD2 = ( ( { 32{ M_275 } } & ( ( dmem_arg_MEMB32W4096_RD1 & ( 
			~lsft32u_321ot ) ) | lsft32u1ot ) )	// line#=computer.cpp:119,120,130,131,682
								// ,683
		| ( { 32{ M_225 } } & regs_rd03 )		// line#=computer.cpp:139
		) ;
always @ ( addsub32u1ot or M_270 or M_278 or M_213 or M_209 or M_201 or M_218 or 
	add32s1ot or M_224 or M_240 )
	begin
	dmem_arg_MEMB32W4096_RA1_c1 = ( M_240 & M_224 ) ;	// line#=computer.cpp:52,56,105,109,666
								// ,671
	dmem_arg_MEMB32W4096_RA1_c2 = ( ( ( ( ( ( M_240 & M_218 ) | ( M_240 & M_201 ) ) | 
		( M_240 & M_209 ) ) | ( M_240 & M_213 ) ) | M_278 ) | M_270 ) ;	// line#=computer.cpp:85,89,91,95,99,101
...
always @ ( RG_addr_addr1_next_pc_op1_PC or M_225 or RG_cols_word_addr or M_275 )
	dmem_arg_MEMB32W4096_WA2 = ( ( { 12{ M_275 } } & RG_cols_word_addr [11:0] )	// line#=computer.cpp:119,120,130,131
		| ( { 12{ M_225 } } & RG_addr_addr1_next_pc_op1_PC [13:2] )		// line#=computer.cpp:135,139
		) ;
assign	dmem_arg_MEMB32W4096_RE1 = ( ( ( ( ( ( ( U_10 & M_224 ) | U_25 ) | U_26 ) | 
	U_28 ) | U_29 ) | U_31 ) | U_32 ) ;	// line#=computer.cpp:91,101,109,120,131
						// ,616,668,669,670,671,672,673
assign	dmem_arg_MEMB32W4096_WE2 = ( ( ( U_63 & M_219 ) | ( U_63 & M_202 ) ) | ( 
	U_63 & M_225 ) ) ;	// line#=computer.cpp:119,120,130,131,139
				// ,681
assign	M_259 = ( M_197 & M_218 ) ;	// line#=computer.cpp:616,711
assign	M_260 = ( M_197 & M_201 ) ;	// line#=computer.cpp:616,711
assign	M_261 = ( M_197 & M_209 ) ;	// line#=computer.cpp:616,711
assign	M_262 = ( M_197 & M_213 ) ;	// line#=computer.cpp:616,711
assign	M_263 = ( M_197 & M_237 ) ;	// line#=computer.cpp:616,711
assign	M_264 = ( M_197 & M_217 ) ;	// line#=computer.cpp:616,711
assign	M_269 = ( M_235 & M_201 ) ;	// line#=computer.cpp:616,711
assign	M_284 = ( M_229 & M_224 ) ;	// line#=computer.cpp:616,711
assign	M_286 = ( M_229 & M_242 ) ;	// line#=computer.cpp:616,711
always @ ( M_222 or imem_arg_MEMB32W65536_RD1 or M_287 or M_284 or M_286 or M_240 or 
	M_211 or M_269 )
	begin
	regs_ad00_c1 = ( ( ( ( M_269 | M_211 ) | M_240 ) | ( M_286 | M_284 ) ) | 
		M_287 ) ;	// line#=computer.cpp:616,626
	regs_ad00 = ( ( { 5{ regs_ad00_c1 } } & imem_arg_MEMB32W65536_RD1 [19:15] )	// line#=computer.cpp:616,626
		| ( { 5{ M_222 } } & imem_arg_MEMB32W65536_RD1 [24:20] )		// line#=computer.cpp:616
		) ;
	end
assign	M_287 = ( ( ( ( ( M_264 | M_263 ) | M_262 ) | M_261 ) | M_260 ) | M_259 ) ;
always @ ( M_287 or imem_arg_MEMB32W65536_RD1 or M_222 )
	regs_ad01 = ( ( { 5{ M_222 } } & imem_arg_MEMB32W65536_RD1 [19:15] )	// line#=computer.cpp:616
		| ( { 5{ M_287 } } & imem_arg_MEMB32W65536_RD1 [24:20] )	// line#=computer.cpp:616
		) ;
always @ ( RG_rd or U_70 or U_72 or U_71 or U_108 or U_73 or U_97 or U_82 or U_112 or 
	imem_arg_MEMB32W65536_RD1 or U_54 )
	begin
	regs_ad04_c1 = ( ( ( ( ( ( ( U_112 | U_82 ) | U_97 ) | U_73 ) | U_108 ) | 
		U_71 ) | U_72 ) | U_70 ) ;	// line#=computer.cpp:70,277,278,279,280
						// ,281,291,292,293,294,295,633,637
						// ,641,647,675,706,725,749
	regs_ad04 = ( ( { 5{ U_54 } } & imem_arg_MEMB32W65536_RD1 [11:7] )	// line#=computer.cpp:616,624,748
		| ( { 5{ regs_ad04_c1 } } & RG_rd )				// line#=computer.cpp:70,277,278,279,280
										// ,281,291,292,293,294,295,633,637
										// ,641,647,675,706,725,749
		) ;
	end
always @ ( rsft32u1ot or rsft32s1ot or RG_cols_imm1_instr )	// line#=computer.cpp:701,702,703
	case ( RG_cols_imm1_instr [23] )
	1'h1 :
		TR_19 = rsft32s1ot ;	// line#=computer.cpp:701,702,703
	1'h0 :
		TR_19 = rsft32u1ot ;	// line#=computer.cpp:701,702,703
	default :
		TR_19 = 32'hx ;
	endcase
always @ ( U_70 or M_216 or RG_col_op2 or RG_addr_addr1_next_pc_op1_PC or addsub32u1ot or 
	U_71 or U_98 or RG_08 or U_72 or U_73 or TR_19 or M_215 or lsft32u1ot or 
	M_206 or M_205 or RG_cols_imm1_instr or regs_rd02 or TR_18 or RG_cols_rs2 or 
	U_65 or U_108 or RG_cols_word_addr or U_64 or add32s1ot or U_87 or U_97 or 
	val2_t4 or U_82 or RG_bytes_rs1 or accel_sbox2ot or RG_bytes or accel_sbox1ot or 
	U_112 or regs_rd00 or U_54 )	// line#=computer.cpp:692,711
	begin
	regs_wd04_c1 = ( U_97 & U_87 ) ;	// line#=computer.cpp:693
	regs_wd04_c2 = ( ( ( ( U_97 & ( U_64 & ( ~|( RG_cols_word_addr ^ 32'h00000002 ) ) ) ) | 
		( U_97 & ( U_64 & ( ~|( RG_cols_word_addr ^ 32'h00000003 ) ) ) ) ) | 
		( U_108 & ( U_65 & ( ~|( RG_cols_rs2 ^ 32'h00000002 ) ) ) ) ) | ( 
		U_108 & ( U_65 & ( ~|( RG_cols_rs2 ^ 32'h00000003 ) ) ) ) ) ;
	regs_wd04_c3 = ( U_97 & ( U_64 & ( ~|( RG_cols_word_addr ^ 32'h00000004 ) ) ) ) ;	// line#=computer.cpp:696
	regs_wd04_c4 = ( U_97 & ( U_64 & ( ~|( RG_cols_word_addr ^ 32'h00000006 ) ) ) ) ;	// line#=computer.cpp:697
	regs_wd04_c5 = ( U_97 & ( U_64 & ( ~|( RG_cols_word_addr ^ 32'h00000007 ) ) ) ) ;	// line#=computer.cpp:698
	regs_wd04_c6 = ( ( U_97 & ( U_64 & M_205 ) ) | ( U_108 & ( U_65 & M_206 ) ) ) ;	// line#=computer.cpp:699,713
	regs_wd04_c7 = ( U_97 & ( U_64 & M_215 ) ) ;	// line#=computer.cpp:701,702,703
	regs_wd04_c8 = ( U_73 | U_72 ) ;	// line#=computer.cpp:641,647
	regs_wd04_c9 = ( ( U_108 & U_98 ) | U_71 ) ;	// line#=computer.cpp:70,637,712
	regs_wd04_c10 = ( U_108 & ( U_65 & ( ~|( RG_cols_rs2 ^ 32'h00000004 ) ) ) ) ;	// line#=computer.cpp:716
	regs_wd04_c11 = ( U_108 & ( U_65 & ( ~|( RG_cols_rs2 ^ 32'h00000006 ) ) ) ) ;	// line#=computer.cpp:722
	regs_wd04_c12 = ( U_108 & ( U_65 & ( ~|( RG_cols_rs2 ^ 32'h00000007 ) ) ) ) ;	// line#=computer.cpp:723
	regs_wd04_c13 = ( U_108 & ( U_65 & M_216 ) ) ;	// line#=computer.cpp:718,719,720
	regs_wd04 = ( ( { 32{ U_54 } } & regs_rd00 )						// line#=computer.cpp:748
		| ( { 32{ U_112 } } & { accel_sbox1ot , RG_bytes , accel_sbox2ot , 
			RG_bytes_rs1 } )							// line#=computer.cpp:277,278,279,280,281
												// ,291,292,293,294,295,749
		| ( { 32{ U_82 } } & val2_t4 )							// line#=computer.cpp:675
		| ( { 32{ regs_wd04_c1 } } & add32s1ot )					// line#=computer.cpp:693
		| ( { 32{ regs_wd04_c2 } } & { 31'h00000000 , TR_18 } )
		| ( { 32{ regs_wd04_c3 } } & ( regs_rd02 ^ { RG_cols_imm1_instr [11] , 
			RG_cols_imm1_instr [11] , RG_cols_imm1_instr [11] , RG_cols_imm1_instr [11] , 
			RG_cols_imm1_instr [11] , RG_cols_imm1_instr [11] , RG_cols_imm1_instr [11] , 
			RG_cols_imm1_instr [11] , RG_cols_imm1_instr [11] , RG_cols_imm1_instr [11] , 
			RG_cols_imm1_instr [11] , RG_cols_imm1_instr [11] , RG_cols_imm1_instr [11] , 
		...
		| ( { 32{ regs_wd04_c6 } } & lsft32u1ot )					// line#=computer.cpp:699,713
		| ( { 32{ regs_wd04_c7 } } & TR_19 )						// line#=computer.cpp:701,702,703
		| ( { 32{ regs_wd04_c8 } } & RG_08 )						// line#=computer.cpp:641,647
		| ( { 32{ regs_wd04_c9 } } & addsub32u1ot )					// line#=computer.cpp:70,637,712
		| ( { 32{ regs_wd04_c10 } } & ( RG_addr_addr1_next_pc_op1_PC ^ RG_col_op2 ) )	// line#=computer.cpp:716
		| ( { 32{ regs_wd04_c11 } } & ( RG_addr_addr1_next_pc_op1_PC | RG_col_op2 ) )	// line#=computer.cpp:722
		| ( { 32{ regs_wd04_c12 } } & ( RG_addr_addr1_next_pc_op1_PC & RG_col_op2 ) )	// line#=computer.cpp:723
		| ( { 32{ regs_wd04_c13 } } & TR_19 )						// line#=computer.cpp:718,719,720
		| ( { 32{ U_70 } } & { RG_cols_imm1_instr [24:5] , 12'h000 } )			// line#=computer.cpp:70,633
		) ;
	end
assign	regs_we04 = ( ( ( ( ( ( ( ( U_54 | U_112 ) | U_82 ) | U_97 ) | U_73 ) | U_108 ) | 
	U_71 ) | U_72 ) | U_70 ) ;	// line#=computer.cpp:70,277,278,279,280
					// ,281,291,292,293,294,295,633,637
					// ,641,647,675,706,725,748,749
