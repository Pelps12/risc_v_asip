...
// bdlpars options:  -EE -DAES_MEM -DACCEL_MIX_COL -DACCEL_SBOX_WORD -DACCEL_MIX_COL_U1 -DACCEL_SBOX_WORD_U1 -info_base_name computer computer.cpp
// bdltran options:  -EE computer.IFF -c1000 -s -Zresource_fcnt=GENERATE -Zresource_mcnt=GENERATE -Zsync -Zdup_reset=YES -Zfolding_sharing=inter_stage -lb /proj/cad/cwb-6.1/packages/asic_45.BLIB -lfl /proj/cad/cwb-6.1/packages/asic_45.FLIB -o-P 
// timestamp_0: 20260604024956_94008_99115
// timestamp_5: 20260604024957_94022_55776
// timestamp_9: 20260604024957_94022_92254
// timestamp_C: 20260604024957_94022_40728
// timestamp_E: 20260604024957_94022_16504
// timestamp_V: 20260604024958_94036_54481
...
reg	[2:0]	RG_i_1 ;	// line#=computer.cpp:290
...
computer_addsub32u INST_addsub32u_1 ( .i1(addsub32u1i1) ,.i2(addsub32u1i2) ,.i3(addsub32u1_f) ,
	.o1(addsub32u1ot) );	// line#=computer.cpp:70,85,95,113,124
				// ,629,637,712
computer_incr3s INST_incr3s_1 ( .i1(incr3s1i1) ,.o1(incr3s1ot) );	// line#=computer.cpp:187,290
...
always @ ( RG_op1_regs_word_addr or M_05 or U_111 or M_179 or M_178 or M_177 or 
	M_176 or cols_d01 or ST1_07d )	// line#=computer.cpp:164,170,171,172,173
					// ,175,179,188
	begin
...
always @ ( RL_addr_addr1_next_pc_op2_PC or M_06 or U_111 or M_179 or M_178 or M_177 or 
	M_176 or cols_d01 or ST1_07d )	// line#=computer.cpp:164,170,171,172,173
					// ,175,179,188
	begin
...
always @ ( RG_regs_1 or M_07 or U_111 or M_179 or M_178 or M_177 or M_176 or cols_d01 or 
...
always @ ( RG_instr_regs_result1 or M_08 or U_111 or M_179 or M_178 or M_177 or 
	M_176 or cols_d01 or ST1_07d )	// line#=computer.cpp:164,170,171,172,173
					// ,175,179,188
	begin
...
always @ ( posedge CLOCK )	// line#=computer.cpp:164,170,171,172,173
	...
	if ( RESET )
		...
		cols_rg03 <= cols_rg03_t ;	// line#=computer.cpp:164,165,166,167,170
						// ,171,172,173,175,179,188
computer_decoder_2to4 INST_decoder_2to4_2 ( .DECODER_in(bytes_ad01) ,.DECODER_out(bytes_d01) );	// line#=computer.cpp:277
always @ ( bytes_rg03 or bytes_rg02 or bytes_rg01 or bytes_rg00 or RG_i_1 )	// line#=computer.cpp:277
	case ( RG_i_1 [1:0] )
	2'h0 :
	...
	default :
		bytes_rd00 = 8'hx ;
	endcase
assign	M_09 = ~( ST1_05d & bytes_d01 [3] ) ;
always @ ( regs_rd02 or M_09 or U_109 or accel_sbox1ot or bytes_d01 or ST1_05d )	// line#=computer.cpp:277,291
	begin
	bytes_rg00_t_c1 = ( ST1_05d & bytes_d01 [3] ) ;	// line#=computer.cpp:291
	bytes_rg00_t_c2 = ( U_109 & M_09 ) ;	// line#=computer.cpp:277,278,279,280,281
						// ,748,749
...
always @ ( posedge CLOCK )	// line#=computer.cpp:277,291
	if ( RESET )
		...
		bytes_rg00 <= bytes_rg00_t ;	// line#=computer.cpp:277,278,279,280,281
						// ,291,748,749
assign	M_10 = ~( ST1_05d & bytes_d01 [2] ) ;
always @ ( regs_rd02 or M_10 or U_109 or accel_sbox1ot or bytes_d01 or ST1_05d )	// line#=computer.cpp:277,291
	begin
	bytes_rg01_t_c1 = ( ST1_05d & bytes_d01 [2] ) ;	// line#=computer.cpp:291
	bytes_rg01_t_c2 = ( U_109 & M_10 ) ;	// line#=computer.cpp:277,278,279,280,281
						// ,748,749
...
always @ ( posedge CLOCK )	// line#=computer.cpp:277,291
	if ( RESET )
		...
		bytes_rg01 <= bytes_rg01_t ;	// line#=computer.cpp:277,278,279,280,281
						// ,291,748,749
assign	M_11 = ~( ST1_05d & bytes_d01 [1] ) ;
always @ ( regs_rd02 or M_11 or U_109 or accel_sbox1ot or bytes_d01 or ST1_05d )	// line#=computer.cpp:277,291
	begin
	bytes_rg02_t_c1 = ( ST1_05d & bytes_d01 [1] ) ;	// line#=computer.cpp:291
	bytes_rg02_t_c2 = ( U_109 & M_11 ) ;	// line#=computer.cpp:277,278,279,280,281
						// ,748,749
...
always @ ( posedge CLOCK )	// line#=computer.cpp:277,291
	if ( RESET )
		...
		bytes_rg02 <= bytes_rg02_t ;	// line#=computer.cpp:277,278,279,280,281
						// ,291,748,749
assign	M_12 = ~( ST1_05d & bytes_d01 [0] ) ;
always @ ( regs_rd02 or M_12 or U_109 or accel_sbox1ot or bytes_d01 or ST1_05d )	// line#=computer.cpp:277,291
	begin
	bytes_rg03_t_c1 = ( ST1_05d & bytes_d01 [0] ) ;	// line#=computer.cpp:291
	bytes_rg03_t_c2 = ( U_109 & M_12 ) ;	// line#=computer.cpp:277,278,279,280,281
						// ,748,749
...
always @ ( FF_take_1 )	// line#=computer.cpp:694
	...
	default :
		TR_15 = 1'hx ;
	endcase
assign	e_t = ( M_129_t ^ M_127_t ) ;	// line#=computer.cpp:164,165,166,167,168
					// ,188
always @ ( M_133_t or M_129_t )	// line#=computer.cpp:164,170
	case ( M_129_t [7] )
	1'h1 :
		M_285 = { ~M_133_t [3:2] , ~M_133_t [0] , 1'h1 } ;	// line#=computer.cpp:164,170
	1'h0 :
		M_285 = { M_133_t [3:2] , M_133_t [0] , 1'h0 } ;	// line#=computer.cpp:164,165,170,188
	default :
		M_285 = 4'hx ;
	endcase
always @ ( M_132_t or M_128_t )	// line#=computer.cpp:171
	case ( M_128_t [7] )
	1'h1 :
		M_283 = { ~M_132_t [3:2] , ~M_132_t [0] , 1'h1 } ;	// line#=computer.cpp:171
	1'h0 :
		M_283 = { M_132_t [3:2] , M_132_t [0] , 1'h0 } ;	// line#=computer.cpp:165,166,171,188
	default :
		M_283 = 4'hx ;
	endcase
always @ ( M_131_t or M_127_t )	// line#=computer.cpp:172
	case ( M_127_t [7] )
	1'h1 :
		M_282 = { ~M_131_t [3:2] , ~M_131_t [0] , 1'h1 } ;	// line#=computer.cpp:172
	1'h0 :
		M_282 = { M_131_t [3:2] , M_131_t [0] , 1'h0 } ;	// line#=computer.cpp:166,167,172,188
	default :
		M_282 = 4'hx ;
	endcase
always @ ( M_130_t or M_126_t )	// line#=computer.cpp:164,173
	case ( M_126_t [7] )
	1'h1 :
		M_284 = { ~M_130_t [3:2] , ~M_130_t [0] , 1'h1 } ;	// line#=computer.cpp:164,173
	1'h0 :
		M_284 = { M_130_t [3:2] , M_130_t [0] , 1'h0 } ;	// line#=computer.cpp:164,167,173,188
	default :
		M_284 = 4'hx ;
	endcase
assign	M_126_t = ( cols_rd00 [31:24] ^ cols_rd00 [7:0] ) ;	// line#=computer.cpp:164,167,173,188
assign	M_127_t = ( cols_rd00 [23:16] ^ cols_rd00 [31:24] ) ;	// line#=computer.cpp:164,165,166,167,168
								// ,172,188
assign	M_128_t = ( cols_rd00 [15:8] ^ cols_rd00 [23:16] ) ;	// line#=computer.cpp:165,166,171,188
assign	M_129_t = ( cols_rd00 [7:0] ^ cols_rd00 [15:8] ) ;	// line#=computer.cpp:164,165,166,167,168
								// ,170,188
assign	M_130_t = ( cols_rd00 [30:24] ^ cols_rd00 [6:0] ) ;	// line#=computer.cpp:164,167,173,188
assign	M_131_t = ( cols_rd00 [22:16] ^ cols_rd00 [30:24] ) ;	// line#=computer.cpp:166,167,172,188
assign	M_132_t = ( cols_rd00 [14:8] ^ cols_rd00 [22:16] ) ;	// line#=computer.cpp:165,166,171,188
assign	M_133_t = ( cols_rd00 [6:0] ^ cols_rd00 [14:8] ) ;	// line#=computer.cpp:164,165,170,188
...
assign	cols_ad01 = RG_i [1:0] ;	// line#=computer.cpp:164,170,171,172,173
					// ,175,188
assign	M_176 = ( ( cols_rd00 [31:24] ^ e_t ) ^ { M_130_t [6:4] , M_284 [3:2] , M_130_t [1] , 
	M_284 [1:0] } ) ;	// line#=computer.cpp:164,165,166,167,170
				// ,171,172,173,175,188
assign	M_177 = ( ( cols_rd00 [23:16] ^ e_t ) ^ { M_131_t [6:4] , M_282 [3:2] , M_131_t [1] , 
	M_282 [1:0] } ) ;	// line#=computer.cpp:164,165,166,167,170
				// ,171,172,173,175,188
assign	M_178 = ( ( cols_rd00 [15:8] ^ e_t ) ^ { M_132_t [6:4] , M_283 [3:2] , M_132_t [1] , 
	M_283 [1:0] } ) ;	// line#=computer.cpp:164,165,166,167,170
				// ,171,172,173,175,188
assign	M_179 = ( ( cols_rd00 [7:0] ^ e_t ) ^ { M_133_t [6:4] , M_285 [3:2] , M_133_t [1] , 
	M_285 [1:0] } ) ;	// line#=computer.cpp:164,165,166,167,170
				// ,171,172,173,175,188
assign	bytes_ad01 = RG_i_1 [1:0] ;	// line#=computer.cpp:291
assign	U_01 = ( ST1_02d & CT_01 ) ;	// line#=computer.cpp:615
assign	U_05 = ( ST1_03d & M_231 ) ;	// line#=computer.cpp:616,623,631
assign	U_06 = ( ST1_03d & M_224 ) ;	// line#=computer.cpp:616,623,631
...
assign	U_12 = ( ST1_03d & M_222 ) ;	// line#=computer.cpp:616,623,631
assign	U_13 = ( ST1_03d & M_215 ) ;	// line#=computer.cpp:616,623,631
assign	U_16 = ( ST1_03d & M_228 ) ;	// line#=computer.cpp:616,623,631
assign	M_192 = ~|( { 25'h0000000 , imem_arg_MEMB32W65536_RD1 [6:0] } ^ 32'h00000063 ) ;	// line#=computer.cpp:616,623,631,692
assign	M_194 = ~|( { 25'h0000000 , imem_arg_MEMB32W65536_RD1 [6:0] } ^ 32'h0000006f ) ;	// line#=computer.cpp:616,623,631
assign	M_205 = ~|( { 25'h0000000 , imem_arg_MEMB32W65536_RD1 [6:0] } ^ 32'h00000023 ) ;	// line#=computer.cpp:616,623,631,692
assign	M_215 = ~|( { 25'h0000000 , imem_arg_MEMB32W65536_RD1 [6:0] } ^ 32'h00000033 ) ;	// line#=computer.cpp:616,623,631,692
assign	M_222 = ~|( { 25'h0000000 , imem_arg_MEMB32W65536_RD1 [6:0] } ^ 32'h00000013 ) ;	// line#=computer.cpp:616,623,631,692
assign	M_224 = ~|( { 25'h0000000 , imem_arg_MEMB32W65536_RD1 [6:0] } ^ 32'h00000017 ) ;	// line#=computer.cpp:616,623,631
assign	M_228 = ~|( { 25'h0000000 , imem_arg_MEMB32W65536_RD1 [6:0] } ^ 32'h0000000b ) ;	// line#=computer.cpp:616,623,631,692
assign	M_231 = ~|( { 25'h0000000 , imem_arg_MEMB32W65536_RD1 [6:0] } ^ 32'h00000037 ) ;	// line#=computer.cpp:616,623,631
assign	M_233 = ~|( { 25'h0000000 , imem_arg_MEMB32W65536_RD1 [6:0] } ^ 32'h00000003 ) ;	// line#=computer.cpp:616,623,631,692
...
assign	M_207 = ~|( { 29'h00000000 , imem_arg_MEMB32W65536_RD1 [14:12] } ^ 32'h00000005 ) ;	// line#=computer.cpp:616,623,631,654,668
												// ,692,711
assign	M_210 = ~|( { 29'h00000000 , imem_arg_MEMB32W65536_RD1 [14:12] } ^ 32'h00000007 ) ;	// line#=computer.cpp:616,654,692,711
assign	M_211 = ~|{ 29'h00000000 , imem_arg_MEMB32W65536_RD1 [14:12] } ;	// line#=computer.cpp:616,623,631,654,668
										// ,681,692,711
assign	M_230 = ~|( { 29'h00000000 , imem_arg_MEMB32W65536_RD1 [14:12] } ^ 32'h00000006 ) ;	// line#=computer.cpp:616,654,692,711
assign	U_25 = ( U_10 & M_211 ) ;	// line#=computer.cpp:616,668
...
assign	M_217 = ~|( { 29'h00000000 , imem_arg_MEMB32W65536_RD1 [14:12] } ^ 32'h00000002 ) ;	// line#=computer.cpp:616,668,681,692,711
												// ,744
assign	U_31 = ( U_11 & M_211 ) ;	// line#=computer.cpp:616,681
assign	U_32 = ( U_11 & M_196 ) ;	// line#=computer.cpp:616,681
assign	U_44 = ( U_13 & M_196 ) ;	// line#=computer.cpp:616,711
assign	U_54 = ( ST1_04d & M_232 ) ;	// line#=computer.cpp:631
assign	U_55 = ( ST1_04d & M_225 ) ;	// line#=computer.cpp:631
assign	U_56 = ( ST1_04d & M_195 ) ;	// line#=computer.cpp:631
assign	U_57 = ( ST1_04d & M_200 ) ;	// line#=computer.cpp:631
assign	U_58 = ( ST1_04d & M_193 ) ;	// line#=computer.cpp:631
assign	U_59 = ( ST1_04d & M_234 ) ;	// line#=computer.cpp:631
assign	U_60 = ( ST1_04d & M_206 ) ;	// line#=computer.cpp:631
assign	U_61 = ( ST1_04d & M_223 ) ;	// line#=computer.cpp:631
assign	U_62 = ( ST1_04d & M_216 ) ;	// line#=computer.cpp:631
assign	U_64 = ( ST1_04d & M_227 ) ;	// line#=computer.cpp:631
assign	U_65 = ( ST1_04d & M_229 ) ;	// line#=computer.cpp:631
assign	M_193 = ~|( RG_regs ^ 32'h00000063 ) ;	// line#=computer.cpp:631
assign	M_195 = ~|( RG_regs ^ 32'h0000006f ) ;	// line#=computer.cpp:631
assign	M_200 = ~|( RG_regs ^ 32'h00000067 ) ;	// line#=computer.cpp:631
assign	M_206 = ~|( RG_regs ^ 32'h00000023 ) ;	// line#=computer.cpp:631
assign	M_216 = ~|( RG_regs ^ 32'h00000033 ) ;	// line#=computer.cpp:631
assign	M_223 = ~|( RG_regs ^ 32'h00000013 ) ;	// line#=computer.cpp:631
assign	M_225 = ~|( RG_regs ^ 32'h00000017 ) ;	// line#=computer.cpp:631
assign	M_227 = ~|( RG_regs ^ 32'h00000073 ) ;	// line#=computer.cpp:631
assign	M_229 = ~|( RG_regs ^ 32'h0000000b ) ;	// line#=computer.cpp:631
assign	M_232 = ~|( RG_regs ^ 32'h00000037 ) ;	// line#=computer.cpp:631
assign	M_234 = ~|( RG_regs ^ 32'h00000003 ) ;	// line#=computer.cpp:631
assign	M_239 = ~|( RG_regs ^ 32'h0000000f ) ;	// line#=computer.cpp:631
...
assign	U_70 = ( U_57 & M_241 ) ;	// line#=computer.cpp:647
assign	U_71 = ( U_58 & take_t1 ) ;	// line#=computer.cpp:662
assign	M_197 = ~|( RG_imm1_rs2 ^ 32'h00000001 ) ;	// line#=computer.cpp:668,744
assign	M_204 = ~|( RG_imm1_rs2 ^ 32'h00000004 ) ;	// line#=computer.cpp:668
assign	M_208 = ~|( RG_imm1_rs2 ^ 32'h00000005 ) ;	// line#=computer.cpp:668,711
assign	M_212 = ~|RG_imm1_rs2 ;	// line#=computer.cpp:668,711
assign	M_218 = ~|( RG_imm1_rs2 ^ 32'h00000002 ) ;	// line#=computer.cpp:668,744
assign	M_241 = |RG_rd ;	// line#=computer.cpp:647,675,706,725
assign	U_79 = ( U_59 & M_241 ) ;	// line#=computer.cpp:675
assign	U_80 = ( U_60 & M_213 ) ;	// line#=computer.cpp:681
assign	U_81 = ( U_60 & M_198 ) ;	// line#=computer.cpp:681
assign	M_198 = ~|( RG_instr_regs_result1 ^ 32'h00000001 ) ;	// line#=computer.cpp:681
assign	M_213 = ~|RG_instr_regs_result1 ;	// line#=computer.cpp:681
assign	M_219 = ~|( RG_instr_regs_result1 ^ 32'h00000002 ) ;	// line#=computer.cpp:681
assign	U_84 = ( U_61 & ( ~|RG_regs_1 ) ) ;	// line#=computer.cpp:692
assign	U_90 = ( U_61 & ( ~|( RG_regs_1 ^ 32'h00000001 ) ) ) ;	// line#=computer.cpp:692
assign	U_94 = ( U_61 & M_241 ) ;	// line#=computer.cpp:706
assign	U_95 = ( U_62 & M_212 ) ;	// line#=computer.cpp:711
assign	M_214 = ~RG_instr_regs_result1 [23] ;	// line#=computer.cpp:701,702,703,718,719
						// ,720
assign	U_105 = ( U_62 & M_241 ) ;	// line#=computer.cpp:725
assign	U_106 = ( U_65 & M_197 ) ;	// line#=computer.cpp:744
assign	U_107 = ( U_65 & M_218 ) ;	// line#=computer.cpp:744
assign	U_109 = ( U_106 & FF_take_1 ) ;	// line#=computer.cpp:747
assign	U_111 = ( U_107 & FF_take ) ;	// line#=computer.cpp:755
always @ ( add32s1ot or M_205 )
	TR_12 = ( { 12{ M_205 } } & add32s1ot [13:2] )	// line#=computer.cpp:52,61,679
		 ;	// line#=computer.cpp:52,56,666
assign	M_247 = ( ST1_04d & U_56 ) ;
always @ ( add32s1ot or M_247 or TR_12 or M_249 )
	TR_01 = ( ( { 30{ M_249 } } & { 18'h00000 , TR_12 } )	// line#=computer.cpp:52,56,61,666,679
		| ( { 30{ M_247 } } & add32s1ot [31:2] )	// line#=computer.cpp:52,75,642
		) ;
always @ ( RL_addr_addr1_next_pc_op2_PC or M_121_t or U_58 or U_57 or RG_06 or U_66 or 
	U_65 or U_64 or M_239 or U_62 or U_61 or U_60 or U_59 or U_55 or U_54 or 
	ST1_04d or RG_regs or U_16 or add32s1ot or TR_01 or M_247 or M_249 or regs_rd00 or 
	U_13 )	// line#=computer.cpp:631
	begin
	RL_addr_addr1_next_pc_op2_PC_t_c1 = ( M_249 | M_247 ) ;	// line#=computer.cpp:52,56,61,75,642,666
								// ,679
	RL_addr_addr1_next_pc_op2_PC_t_c2 = ( ST1_04d & ( ( ( ( ( ( ( ( ( U_54 | 
		U_55 ) | U_59 ) | U_60 ) | U_61 ) | U_62 ) | ( ST1_04d & M_239 ) ) | 
	...
	RL_addr_addr1_next_pc_op2_PC_t = ( ( { 32{ U_13 } } & regs_rd00 )			// line#=computer.cpp:710
		...
		| ( { 32{ RL_addr_addr1_next_pc_op2_PC_t_c4 } } & { M_121_t , RL_addr_addr1_next_pc_op2_PC [0] } ) ) ;
	end
...
assign	M_246 = ( ST1_04d & U_109 ) ;
always @ ( incr3s1ot or ST1_05d )
	RG_i_1_t = ( { 3{ ST1_05d } } & incr3s1ot )	// line#=computer.cpp:290
		 ;	// line#=computer.cpp:290
assign	RG_i_1_en = ( M_246 | ST1_05d ) ;
always @ ( posedge CLOCK )
	if ( RG_i_1_en )
		RG_i_1 <= RG_i_1_t ;	// line#=computer.cpp:290
assign	M_245 = ( regs_rd00 ^ regs_rd01 ) ;	// line#=computer.cpp:655,656
always @ ( B_01_t or ST1_04d or M_244 or M_217 or U_16 or M_245 or U_09 )	// line#=computer.cpp:616,744
	begin
	FF_take_t_c1 = ( U_16 & M_217 ) ;	// line#=computer.cpp:616,755
	FF_take_t = ( ( { 1{ U_09 } } & ( ~|M_245 ) )	// line#=computer.cpp:655
		| ( { 1{ FF_take_t_c1 } } & M_244 )	// line#=computer.cpp:616,755
		| ( { 1{ ST1_04d } } & B_01_t ) ) ;
	end
...
always @ ( U_66 or M_265 or U_65 or FF_take or U_107 or FF_take_1 or U_106 or U_64 or 
	ST1_04d )	// line#=computer.cpp:744,747,755
	begin
	FF_halt_t_c1 = ( ST1_04d & ( ( ( ( U_64 | ( U_106 & ( ~FF_take_1 ) ) ) | 
		( U_107 & ( ~FF_take ) ) ) | ( U_65 & M_265 ) ) | U_66 ) ) ;	// line#=computer.cpp:732,750,756,797,808
...
always @ ( M_205 or imem_arg_MEMB32W65536_RD1 or M_192 or M_202 or M_194 or M_224 or 
	M_231 or M_207 or M_211 or M_215 or M_222 )
	begin
	TR_02_c1 = ( ( ( ( ( ( ( M_222 | ( M_215 & M_211 ) ) | ( M_215 & M_207 ) ) | 
		M_231 ) | M_224 ) | M_194 ) | M_202 ) | M_192 ) ;	// line#=computer.cpp:616
	TR_02 = ( ( { 25{ TR_02_c1 } } & imem_arg_MEMB32W65536_RD1 [31:7] )			// line#=computer.cpp:616
		| ( { 25{ M_205 } } & { 22'h000000 , imem_arg_MEMB32W65536_RD1 [14:12] } )	// line#=computer.cpp:616,681
		) ;
	end
assign	M_202 = ~|( { 25'h0000000 , imem_arg_MEMB32W65536_RD1 [6:0] } ^ 32'h00000067 ) ;	// line#=computer.cpp:616,623,631,711
always @ ( regs_rg13 or U_01 )
	RG_instr_regs_result1_t1 = ( { 32{ U_01 } } & regs_rg13 )	// line#=computer.cpp:179
		 ;
always @ ( lsft32u1ot or U_44 or TR_02 or U_11 or U_09 or M_202 or ST1_03d or U_07 or 
	U_06 or U_05 or M_207 or M_211 or U_13 or U_12 or RG_instr_regs_result1_t1 or 
	ST1_02d )	// line#=computer.cpp:616,623,631,711
	begin
	RG_instr_regs_result1_t_c1 = ( ( ( ( ( ( ( ( U_12 | ( U_13 & M_211 ) ) | 
		( U_13 & M_207 ) ) | U_05 ) | U_06 ) | U_07 ) | ( ST1_03d & M_202 ) ) | 
...
assign	M_244 = ~|imem_arg_MEMB32W65536_RD1 [31:25] ;	// line#=computer.cpp:616,747,755
always @ ( ST1_07d or incr3s1ot or ST1_05d or M_244 or U_16 or comp32u_12ot or comp32s_11ot or 
	U_13 or comp32u_13ot or M_235 or comp32s_1_11ot or M_217 or U_12 or M_210 or 
	comp32u_11ot or M_230 or M_207 or comp32s_12ot or M_203 or M_245 or M_196 or 
	U_09 or imem_arg_MEMB32W65536_RD1 or U_07 or U_06 or U_05 )	// line#=computer.cpp:616,654,692,711
	begin
	FF_take_1_t_c1 = ( ( U_05 | U_06 ) | U_07 ) ;	// line#=computer.cpp:616,624,633,637,641
	FF_take_1_t_c2 = ( U_09 & M_196 ) ;	// line#=computer.cpp:656
	FF_take_1_t_c3 = ( U_09 & M_203 ) ;	// line#=computer.cpp:657
	FF_take_1_t_c4 = ( U_09 & M_207 ) ;	// line#=computer.cpp:658
	FF_take_1_t_c5 = ( U_09 & M_230 ) ;	// line#=computer.cpp:659
	FF_take_1_t_c6 = ( U_09 & M_210 ) ;	// line#=computer.cpp:660
	FF_take_1_t_c7 = ( U_12 & M_217 ) ;	// line#=computer.cpp:694
	FF_take_1_t_c8 = ( U_12 & M_235 ) ;	// line#=computer.cpp:695
	FF_take_1_t_c9 = ( U_13 & M_217 ) ;	// line#=computer.cpp:714
	FF_take_1_t_c10 = ( U_13 & M_235 ) ;	// line#=computer.cpp:715
	FF_take_1_t = ( ( { 1{ FF_take_1_t_c1 } } & ( |imem_arg_MEMB32W65536_RD1 [11:7] ) )	// line#=computer.cpp:616,624,633,637,641
		| ( { 1{ FF_take_1_t_c2 } } & ( |M_245 ) )					// line#=computer.cpp:656
		...
		| ( { 1{ U_16 } } & M_244 )							// line#=computer.cpp:616,747
...
always @ ( posedge CLOCK )	// line#=computer.cpp:616,654,692,711
	FF_take_1 <= FF_take_1_t ;	// line#=computer.cpp:187,290,616,624,633
					...
					// ,695,714,715,747
assign	M_264 = ( ( ( M_222 & M_196 ) | ( M_222 & M_207 ) ) | M_205 ) ;	// line#=computer.cpp:616,692
assign	M_270 = ( ( ( ( M_222 & M_211 ) | ( M_222 & M_203 ) ) | ( M_222 & M_230 ) ) | 
	( M_222 & M_210 ) ) ;	// line#=computer.cpp:616,692
always @ ( imem_arg_MEMB32W65536_RD1 or M_270 )
	TR_03 = ( { 27{ M_270 } } & { imem_arg_MEMB32W65536_RD1 [31] , imem_arg_MEMB32W65536_RD1 [31] , 
...
always @ ( M_228 or M_215 or M_233 or M_192 or imem_arg_MEMB32W65536_RD1 or TR_03 or 
	M_264 or M_270 )	// line#=computer.cpp:616,692
	begin
	RG_imm1_rs2_t_c1 = ( M_270 | M_264 ) ;	// line#=computer.cpp:52,56,616,627,689
	RG_imm1_rs2_t_c2 = ( ( ( M_192 | M_233 ) | M_215 ) | M_228 ) ;	// line#=computer.cpp:616,654,668,711,744
...
always @ ( posedge CLOCK )	// line#=computer.cpp:616,692
	RG_imm1_rs2 <= RG_imm1_rs2_t ;	// line#=computer.cpp:52,56,616,627,654
					// ,668,689,711,744
assign	M_261 = ~( M_262 | M_229 ) ;	// line#=computer.cpp:631
assign	M_262 = ( ( ( ( ( ( ( ( ( ( M_232 | M_225 ) | M_195 ) | M_200 ) | M_193 ) | 
	M_234 ) | M_206 ) | M_223 ) | M_216 ) | M_239 ) | M_227 ) ;	// line#=computer.cpp:631
assign	M_265 = ~( M_197 | M_218 ) ;	// line#=computer.cpp:744
assign	M_268 = ( M_229 & M_197 ) ;
assign	M_240 = ( M_268 & FF_take_1 ) ;
assign	M_276 = ( M_229 & M_218 ) ;
always @ ( M_276 or FF_take or M_240 )
	begin
	B_01_t_c1 = ( M_276 & FF_take ) ;
	B_01_t = ( ( { 1{ M_240 } } & FF_take )
		| ( { 1{ B_01_t_c1 } } & 1'h1 ) ) ;
	end
always @ ( RL_addr_addr1_next_pc_op2_PC or RG_06 or add32s1ot or take_t1 )	// line#=computer.cpp:662
	begin
	M_121_t_c1 = ~take_t1 ;
	M_121_t = ( ( { 31{ take_t1 } } & add32s1ot [31:1] )	// line#=computer.cpp:662
		| ( { 31{ M_121_t_c1 } } & { RG_06 [31:2] , RL_addr_addr1_next_pc_op2_PC [1] } ) ) ;
	end
...
always @ ( M_233 or imem_arg_MEMB32W65536_RD1 or M_205 )
	TR_04 = ( ( { 5{ M_205 } } & imem_arg_MEMB32W65536_RD1 [11:7] )		// line#=computer.cpp:52,60,61,616,624
										// ,628,679
		| ( { 5{ M_233 } } & imem_arg_MEMB32W65536_RD1 [24:20] )	// line#=computer.cpp:52,56,616,627,666
		) ;
always @ ( M_200 or RG_instr_regs_result1 or M_242 )
	M_279 = ( ( { 6{ M_242 } } & { RG_instr_regs_result1 [0] , RG_instr_regs_result1 [4:1] , 
			1'h0 } )									// line#=computer.cpp:52,65,66,67,628,652
													// ,662
		| ( { 6{ M_200 } } & { RG_instr_regs_result1 [24] , RG_instr_regs_result1 [17:13] } )	// line#=computer.cpp:52,56,627,646
		) ;
assign	M_242 = ( M_193 & take_t1 ) ;
always @ ( M_195 or M_279 or RG_instr_regs_result1 or M_200 or M_242 )
	begin
	M_280_c1 = ( M_242 | M_200 ) ;	// line#=computer.cpp:52,56,65,66,67,627
					// ,628,646,652,662
	M_280 = ( ( { 14{ M_280_c1 } } & { RG_instr_regs_result1 [24] , RG_instr_regs_result1 [24] , 
			RG_instr_regs_result1 [24] , RG_instr_regs_result1 [24] , 
			RG_instr_regs_result1 [24] , RG_instr_regs_result1 [24] , 
			RG_instr_regs_result1 [24] , RG_instr_regs_result1 [24] , 
			M_279 } )					// line#=computer.cpp:52,56,65,66,67,627
									// ,628,646,652,662
		| ( { 14{ M_195 } } & { RG_instr_regs_result1 [12:5] , RG_instr_regs_result1 [13] , 
			RG_instr_regs_result1 [17:14] , 1'h0 } )	// line#=computer.cpp:52,73,74,75,625,627
									// ,642
		) ;
	end
always @ ( M_280 or RG_instr_regs_result1 or U_56 or U_57 or U_71 or RG_imm1_rs2 or 
	U_84 or TR_04 or imem_arg_MEMB32W65536_RD1 or M_249 )
	begin
	add32s1i2_c1 = ( ( U_71 | U_57 ) | U_56 ) ;	// line#=computer.cpp:52,56,65,66,67,73
							// ,74,75,625,627,628,642,646,652
							// ,662
	add32s1i2 = ( ( { 21{ M_249 } } & { imem_arg_MEMB32W65536_RD1 [31] , imem_arg_MEMB32W65536_RD1 [31] , 
			imem_arg_MEMB32W65536_RD1 [31] , imem_arg_MEMB32W65536_RD1 [31] , 
			imem_arg_MEMB32W65536_RD1 [31] , imem_arg_MEMB32W65536_RD1 [31] , 
			imem_arg_MEMB32W65536_RD1 [31] , imem_arg_MEMB32W65536_RD1 [31] , 
		...
		| ( { 21{ add32s1i2_c1 } } & { RG_instr_regs_result1 [24] , M_280 [13:5] , 
			RG_instr_regs_result1 [23:18] , M_280 [4:0] } )	// line#=computer.cpp:52,56,65,66,67,73
									// ,74,75,625,627,628,642,646,652
									// ,662
		) ;
	end
always @ ( regs_rd03 or M_198 )
	TR_13 = ( { 8{ M_198 } } & regs_rd03 [15:8] )	// line#=computer.cpp:131,683
		 ;	// line#=computer.cpp:120,682
always @ ( regs_rd03 or TR_13 or M_254 or regs_rd02 or U_90 or regs_rd01 or U_44 )
	lsft32u1i1 = ( ( { 32{ U_44 } } & regs_rd01 )				// line#=computer.cpp:710,713
		| ( { 32{ U_90 } } & regs_rd02 )				// line#=computer.cpp:699
		| ( { 32{ M_254 } } & { 16'h0000 , TR_13 , regs_rd03 [7:0] } )	// line#=computer.cpp:120,131,682,683
		) ;
assign	M_254 = ( U_81 | U_80 ) ;
always @ ( RL_addr_addr1_next_pc_op2_PC or M_254 or RG_imm1_rs2 or U_90 or regs_rd00 or 
	U_44 )
	lsft32u1i2 = ( ( { 5{ U_44 } } & regs_rd00 [4:0] )				// line#=computer.cpp:710,713
		| ( { 5{ U_90 } } & RG_imm1_rs2 [4:0] )					// line#=computer.cpp:699
		| ( { 5{ M_254 } } & { RL_addr_addr1_next_pc_op2_PC [1:0] , 3'h0 } )	// line#=computer.cpp:118,119,120,129,130
											// ,131,682,683
		) ;
assign	M_209 = ~|( RG_regs_1 ^ 32'h00000005 ) ;	// line#=computer.cpp:692
always @ ( dmem_arg_MEMB32W4096_RD1 or M_267 or regs_rd02 or M_273 or RG_op1_regs_word_addr or 
	M_271 )
	rsft32u1i1 = ( ( { 32{ M_271 } } & RG_op1_regs_word_addr )	// line#=computer.cpp:718,719,720
		| ( { 32{ M_273 } } & regs_rd02 )			// line#=computer.cpp:701,702,703
		| ( { 32{ M_267 } } & dmem_arg_MEMB32W4096_RD1 )	// line#=computer.cpp:90,91,100,101,669
									// ,670,672,673
		) ;
assign	M_267 = ( ( ( ( M_234 & M_208 ) | ( M_234 & M_204 ) ) | ( M_234 & M_197 ) ) | 
	( M_234 & M_212 ) ) ;
assign	M_271 = ( M_272 & M_214 ) ;
assign	M_273 = ( M_274 & M_214 ) ;
always @ ( M_267 or RG_imm1_rs2 or M_273 or RL_addr_addr1_next_pc_op2_PC or M_271 )
	rsft32u1i2 = ( ( { 5{ M_271 } } & RL_addr_addr1_next_pc_op2_PC [4:0] )		// line#=computer.cpp:718,719,720
		| ( { 5{ M_273 } } & RG_imm1_rs2 [4:0] )				// line#=computer.cpp:701,702,703
		| ( { 5{ M_267 } } & { RL_addr_addr1_next_pc_op2_PC [1:0] , 3'h0 } )	// line#=computer.cpp:90,91,100,101,669
											// ,670,672,673
		) ;
assign	M_272 = ( M_216 & M_208 ) ;
assign	M_274 = ( M_223 & M_209 ) ;
always @ ( regs_rd02 or M_274 or RG_op1_regs_word_addr or M_272 )
	rsft32s1i1 = ( ( { 32{ M_272 } } & RG_op1_regs_word_addr )	// line#=computer.cpp:718,719,720
		| ( { 32{ M_274 } } & regs_rd02 )			// line#=computer.cpp:701,702,703
		) ;
always @ ( RG_imm1_rs2 or M_274 or RL_addr_addr1_next_pc_op2_PC or M_272 )
	rsft32s1i2 = ( ( { 5{ M_272 } } & RL_addr_addr1_next_pc_op2_PC [4:0] )	// line#=computer.cpp:718,719,720
		| ( { 5{ M_274 } } & RG_imm1_rs2 [4:0] )			// line#=computer.cpp:701,702,703
		) ;
always @ ( RG_i or ST1_07d or RG_i_1 or ST1_05d )
	incr3s1i1 = ( ( { 3{ ST1_05d } } & RG_i_1 )	// line#=computer.cpp:290
		| ( { 3{ ST1_07d } } & RG_i )		// line#=computer.cpp:187
		) ;
always @ ( RG_op1_regs_word_addr or U_95 or add32s1ot or U_25 or U_26 or U_28 or 
	U_29 or M_252 or RL_addr_addr1_next_pc_op2_PC or M_248 )
	begin
	addsub32u1i1_c1 = ( M_252 | ( ( ( U_29 | U_28 ) | U_26 ) | U_25 ) ) ;	// line#=computer.cpp:52,56,61,85,95,113
										// ,124,666,679
	addsub32u1i1 = ( ( { 32{ M_248 } } & RL_addr_addr1_next_pc_op2_PC )	// line#=computer.cpp:70,629,637
		| ( { 32{ addsub32u1i1_c1 } } & add32s1ot )			// line#=computer.cpp:52,56,61,85,95,113
										// ,124,666,679
		| ( { 32{ U_95 } } & RG_op1_regs_word_addr )			// line#=computer.cpp:712
		) ;
	end
always @ ( M_250 or RG_instr_regs_result1 or U_68 )
	TR_14 = ( ( { 20{ U_68 } } & RG_instr_regs_result1 [24:5] )	// line#=computer.cpp:70,637
		| ( { 20{ M_250 } } & 20'h00040 )			// line#=computer.cpp:85,95,113,124
		) ;
always @ ( U_01 or TR_14 or M_250 or U_68 )
	begin
	M_281_c1 = ( U_68 | M_250 ) ;	// line#=computer.cpp:70,85,95,113,124
					// ,637
	M_281 = ( ( { 21{ M_281_c1 } } & { TR_14 , 1'h0 } )	// line#=computer.cpp:70,85,95,113,124
								// ,637
		| ( { 21{ U_01 } } & 21'h000001 )		// line#=computer.cpp:629
		) ;
	end
assign	M_248 = ( U_68 | U_01 ) ;
always @ ( RL_addr_addr1_next_pc_op2_PC or U_95 or M_281 or M_250 or M_248 )
	begin
	addsub32u1i2_c1 = ( M_248 | M_250 ) ;	// line#=computer.cpp:70,85,95,113,124
						// ,629,637
	addsub32u1i2 = ( ( { 32{ addsub32u1i2_c1 } } & { M_281 [20:1] , 9'h000 , 
			M_281 [0] , 2'h0 } )				// line#=computer.cpp:70,85,95,113,124
									// ,629,637
...
always @ ( RG_instr_regs_result1 )	// line#=computer.cpp:712
	...
	endcase
always @ ( addsub32u1_f_t1 or U_95 or M_250 or M_248 )
	addsub32u1_f = ( ( { 2{ M_248 } } & 2'h1 )
		| ( { 2{ M_250 } } & 2'h2 )
...
always @ ( M_198 )
	M_278 = ( { 8{ M_198 } } & 8'hff )	// line#=computer.cpp:130
		 ;	// line#=computer.cpp:119
assign	lsft32u_321i1 = { M_278 , 8'hff } ;
...
assign	M_269 = ( M_213 | M_198 ) ;	// line#=computer.cpp:681
always @ ( regs_rd03 or M_219 or lsft32u1ot or lsft32u_321ot or dmem_arg_MEMB32W4096_RD1 or 
	M_269 )
	dmem_arg_MEMB32W4096_WD2 = ( ( { 32{ M_269 } } & ( ( dmem_arg_MEMB32W4096_RD1 & ( 
			~lsft32u_321ot ) ) | lsft32u1ot ) )	// line#=computer.cpp:119,120,130,131,682
								// ,683
		| ( { 32{ M_219 } } & regs_rd03 )		// line#=computer.cpp:139
		) ;
always @ ( addsub32u1ot or M_205 or M_207 or M_203 or M_196 or M_211 or add32s1ot or 
	M_217 or M_233 )
	begin
	dmem_arg_MEMB32W4096_RA1_c1 = ( M_233 & M_217 ) ;	// line#=computer.cpp:52,56,105,109,666
								// ,671
	dmem_arg_MEMB32W4096_RA1_c2 = ( ( ( ( ( ( M_233 & M_211 ) | ( M_233 & M_196 ) ) | 
		( M_233 & M_203 ) ) | ( M_233 & M_207 ) ) | ( M_205 & M_211 ) ) | 
		( M_205 & M_196 ) ) ;	// line#=computer.cpp:85,89,91,95,99,101
...
always @ ( RL_addr_addr1_next_pc_op2_PC or M_219 or RG_op1_regs_word_addr or M_269 )
	dmem_arg_MEMB32W4096_WA2 = ( ( { 12{ M_269 } } & RG_op1_regs_word_addr [11:0] )	// line#=computer.cpp:119,120,130,131
		| ( { 12{ M_219 } } & RL_addr_addr1_next_pc_op2_PC [13:2] )		// line#=computer.cpp:135,139
		) ;
assign	dmem_arg_MEMB32W4096_RE1 = ( ( ( ( ( ( ( U_10 & M_217 ) | U_25 ) | U_26 ) | 
	U_28 ) | U_29 ) | U_31 ) | U_32 ) ;	// line#=computer.cpp:91,101,109,120,131
						// ,616,668,669,670,671,672,673
assign	dmem_arg_MEMB32W4096_WE2 = ( ( U_80 | U_81 ) | ( U_60 & M_219 ) ) ;	// line#=computer.cpp:119,120,130,131,139
										// ,681
always @ ( M_255 or M_256 or M_257 or M_258 or M_259 or M_260 or M_233 or M_205 or 
	M_217 or M_235 or M_222 or imem_arg_MEMB32W65536_RD1 or M_215 )
	begin
	regs_ad00_c1 = ( ( ( ( ( ( ( ( ( ( M_222 & M_235 ) | ( M_222 & M_217 ) ) | 
		M_205 ) | M_233 ) | M_260 ) | M_259 ) | M_258 ) | M_257 ) | M_256 ) | 
		M_255 ) ;	// line#=computer.cpp:616,626
	regs_ad00 = ( ( { 5{ M_215 } } & imem_arg_MEMB32W65536_RD1 [24:20] )	// line#=computer.cpp:616
		| ( { 5{ regs_ad00_c1 } } & imem_arg_MEMB32W65536_RD1 [19:15] )	// line#=computer.cpp:616,626
		) ;
	end
assign	M_255 = ( M_192 & M_211 ) ;
assign	M_256 = ( M_192 & M_196 ) ;
assign	M_257 = ( M_192 & M_203 ) ;
assign	M_258 = ( M_192 & M_207 ) ;
assign	M_259 = ( M_192 & M_230 ) ;
assign	M_260 = ( M_192 & M_210 ) ;
always @ ( M_255 or M_256 or M_257 or M_258 or M_259 or M_260 or imem_arg_MEMB32W65536_RD1 or 
	...
	regs_ad01_c1 = ( ( ( ( ( M_260 | M_259 ) | M_258 ) | M_257 ) | M_256 ) | 
		M_255 ) ;	// line#=computer.cpp:616
	regs_ad01 = ( ( { 5{ M_215 } } & imem_arg_MEMB32W65536_RD1 [19:15] )	// line#=computer.cpp:616,626
		| ( { 5{ regs_ad01_c1 } } & imem_arg_MEMB32W65536_RD1 [24:20] )	// line#=computer.cpp:616
		) ;
	end
always @ ( RG_01 or ST1_06d or RG_rd or M_253 )
	regs_ad04 = ( ( { 5{ M_253 } } & RG_rd )	// line#=computer.cpp:70,633,637,641,647
							// ,675,706,725,748
...
always @ ( rsft32u1ot or rsft32s1ot or RG_instr_regs_result1 )	// line#=computer.cpp:701,702,703
	...
	default :
		TR_16 = 32'hx ;
	endcase
always @ ( bytes_rg00 or bytes_rg01 or bytes_rg02 or bytes_rg03 or ST1_06d or U_67 or 
	M_208 or RL_addr_addr1_next_pc_op2_PC or RG_op1_regs_word_addr or M_204 or 
	RG_instr_regs_result1 or M_197 or addsub32u1ot or U_68 or U_95 or RG_06 or 
	U_69 or U_70 or TR_16 or M_209 or lsft32u1ot or U_90 or TR_15 or RG_imm1_rs2 or 
	M_218 or U_62 or U_105 or RG_regs_1 or U_61 or add32s1ot or U_84 or U_94 or 
	regs_rd02 or U_109 or val2_t4 or U_79 )	// line#=computer.cpp:692,711
	begin
	...
	regs_wd04_c2 = ( ( ( ( U_94 & ( U_61 & ( ~|( RG_regs_1 ^ 32'h00000002 ) ) ) ) | 
		...
		( U_62 & M_218 ) ) ) | ( U_105 & ( U_62 & ( ~|( RG_imm1_rs2 ^ 32'h00000003 ) ) ) ) ) ;
	...
	regs_wd04_c7 = ( U_94 & ( U_61 & M_209 ) ) ;	// line#=computer.cpp:701,702,703
	regs_wd04_c8 = ( U_70 | U_69 ) ;	// line#=computer.cpp:641,647
	regs_wd04_c9 = ( ( U_105 & U_95 ) | U_68 ) ;	// line#=computer.cpp:70,637,712
	regs_wd04_c10 = ( U_105 & ( U_62 & M_197 ) ) ;	// line#=computer.cpp:713
	regs_wd04_c11 = ( U_105 & ( U_62 & M_204 ) ) ;	// line#=computer.cpp:716
	...
	regs_wd04_c14 = ( U_105 & ( U_62 & M_208 ) ) ;	// line#=computer.cpp:718,719,720
...
assign	M_253 = ( ( ( ( ( ( ( U_79 | U_109 ) | U_94 ) | U_70 ) | U_105 ) | U_68 ) | 
	U_69 ) | U_67 ) ;
assign	regs_we04 = ( M_253 | ST1_06d ) ;	// line#=computer.cpp:70,292,293,294,295
