...
// bdlpars options:  -EE -DAES_MEM -DACCEL_SBOX_WORD -DACCEL_SBOX_WORD_U1 -info_base_name computer computer.cpp
// bdltran options:  -EE computer.IFF -c1000 -s -Zresource_fcnt=GENERATE -Zresource_mcnt=GENERATE -Zsync -Zdup_reset=YES -Zfolding_sharing=inter_stage -lb /proj/cad/cwb-6.1/packages/asic_45.BLIB -lfl /proj/cad/cwb-6.1/packages/asic_45.FLIB -o-P 
// timestamp_0: 20260604025036_95245_23850
// timestamp_5: 20260604025036_95259_96129
// timestamp_9: 20260604025036_95259_39814
// timestamp_C: 20260604025036_95259_43829
// timestamp_E: 20260604025036_95259_87839
// timestamp_V: 20260604025037_95273_46693
...
always @ ( bytes_rg03 or bytes_rg02 or bytes_rg01 or bytes_rg00 or RG_i )	// line#=computer.cpp:277
	...
	default :
		bytes_rd00 = 8'hx ;
	endcase
assign	M_01 = ~( ST1_05d & bytes_d01 [3] ) ;
always @ ( regs_rd02 or M_01 or U_107 or accel_sbox1ot or bytes_d01 or ST1_05d )	// line#=computer.cpp:277,291
	begin
	bytes_rg00_t_c1 = ( ST1_05d & bytes_d01 [3] ) ;	// line#=computer.cpp:291
	bytes_rg00_t_c2 = ( U_107 & M_01 ) ;	// line#=computer.cpp:277,278,279,280,281
						// ,748,749
...
always @ ( posedge CLOCK )	// line#=computer.cpp:277,291
	if ( RESET )
		...
		bytes_rg00 <= bytes_rg00_t ;	// line#=computer.cpp:277,278,279,280,281
						// ,291,748,749
assign	M_02 = ~( ST1_05d & bytes_d01 [2] ) ;
always @ ( regs_rd02 or M_02 or U_107 or accel_sbox1ot or bytes_d01 or ST1_05d )	// line#=computer.cpp:277,291
	begin
	bytes_rg01_t_c1 = ( ST1_05d & bytes_d01 [2] ) ;	// line#=computer.cpp:291
	bytes_rg01_t_c2 = ( U_107 & M_02 ) ;	// line#=computer.cpp:277,278,279,280,281
						// ,748,749
...
always @ ( posedge CLOCK )	// line#=computer.cpp:277,291
	if ( RESET )
		...
		bytes_rg01 <= bytes_rg01_t ;	// line#=computer.cpp:277,278,279,280,281
						// ,291,748,749
assign	M_03 = ~( ST1_05d & bytes_d01 [1] ) ;
always @ ( regs_rd02 or M_03 or U_107 or accel_sbox1ot or bytes_d01 or ST1_05d )	// line#=computer.cpp:277,291
	begin
	bytes_rg02_t_c1 = ( ST1_05d & bytes_d01 [1] ) ;	// line#=computer.cpp:291
	bytes_rg02_t_c2 = ( U_107 & M_03 ) ;	// line#=computer.cpp:277,278,279,280,281
						// ,748,749
...
always @ ( posedge CLOCK )	// line#=computer.cpp:277,291
	if ( RESET )
		...
		bytes_rg02 <= bytes_rg02_t ;	// line#=computer.cpp:277,278,279,280,281
						// ,291,748,749
assign	M_04 = ~( ST1_05d & bytes_d01 [0] ) ;
always @ ( regs_rd02 or M_04 or U_107 or accel_sbox1ot or bytes_d01 or ST1_05d )	// line#=computer.cpp:277,291
	begin
	bytes_rg03_t_c1 = ( ST1_05d & bytes_d01 [0] ) ;	// line#=computer.cpp:291
	bytes_rg03_t_c2 = ( U_107 & M_04 ) ;	// line#=computer.cpp:277,278,279,280,281
						// ,748,749
...
assign	U_09 = ( ST1_03d & M_153 ) ;	// line#=computer.cpp:616,623,631
assign	U_10 = ( ST1_03d & M_194 ) ;	// line#=computer.cpp:616,623,631
assign	U_11 = ( ST1_03d & M_166 ) ;	// line#=computer.cpp:616,623,631
assign	U_12 = ( ST1_03d & M_182 ) ;	// line#=computer.cpp:616,623,631
assign	U_13 = ( ST1_03d & M_176 ) ;	// line#=computer.cpp:616,623,631
assign	U_16 = ( ST1_03d & M_188 ) ;	// line#=computer.cpp:616,623,631
assign	M_153 = ~|( { 25'h0000000 , imem_arg_MEMB32W65536_RD1 [6:0] } ^ 32'h00000063 ) ;	// line#=computer.cpp:616,623,631,692
assign	M_155 = ~|( { 25'h0000000 , imem_arg_MEMB32W65536_RD1 [6:0] } ^ 32'h0000006f ) ;	// line#=computer.cpp:616,623,631,692
assign	M_162 = ~|( { 25'h0000000 , imem_arg_MEMB32W65536_RD1 [6:0] } ^ 32'h00000067 ) ;	// line#=computer.cpp:616,623,631,692
assign	M_166 = ~|( { 25'h0000000 , imem_arg_MEMB32W65536_RD1 [6:0] } ^ 32'h00000023 ) ;	// line#=computer.cpp:616,623,631,692
assign	M_176 = ~|( { 25'h0000000 , imem_arg_MEMB32W65536_RD1 [6:0] } ^ 32'h00000033 ) ;	// line#=computer.cpp:616,623,631,692
assign	M_182 = ~|( { 25'h0000000 , imem_arg_MEMB32W65536_RD1 [6:0] } ^ 32'h00000013 ) ;	// line#=computer.cpp:616,623,631,692
assign	M_184 = ~|( { 25'h0000000 , imem_arg_MEMB32W65536_RD1 [6:0] } ^ 32'h00000017 ) ;	// line#=computer.cpp:616,623,631,692
assign	M_188 = ~|( { 25'h0000000 , imem_arg_MEMB32W65536_RD1 [6:0] } ^ 32'h0000000b ) ;	// line#=computer.cpp:616,623,631
assign	M_192 = ~|( { 25'h0000000 , imem_arg_MEMB32W65536_RD1 [6:0] } ^ 32'h00000037 ) ;	// line#=computer.cpp:616,623,631,692
assign	M_194 = ~|( { 25'h0000000 , imem_arg_MEMB32W65536_RD1 [6:0] } ^ 32'h00000003 ) ;	// line#=computer.cpp:616,623,631
assign	M_157 = ~|( { 29'h00000000 , imem_arg_MEMB32W65536_RD1 [14:12] } ^ 32'h00000001 ) ;	// line#=computer.cpp:616,654,668,681,692
												// ,711,744
assign	M_164 = ~|( { 29'h00000000 , imem_arg_MEMB32W65536_RD1 [14:12] } ^ 32'h00000004 ) ;	// line#=computer.cpp:616,654,668,692,711
assign	M_168 = ~|( { 29'h00000000 , imem_arg_MEMB32W65536_RD1 [14:12] } ^ 32'h00000005 ) ;	// line#=computer.cpp:616,654,668,692,711
assign	M_170 = ~|( { 29'h00000000 , imem_arg_MEMB32W65536_RD1 [14:12] } ^ 32'h00000007 ) ;	// line#=computer.cpp:616,654,692,711
assign	M_172 = ~|{ 29'h00000000 , imem_arg_MEMB32W65536_RD1 [14:12] } ;	// line#=computer.cpp:616,654,668,681,692
										// ,711
assign	M_190 = ~|( { 29'h00000000 , imem_arg_MEMB32W65536_RD1 [14:12] } ^ 32'h00000006 ) ;	// line#=computer.cpp:616,654,692,711
assign	U_25 = ( U_10 & M_172 ) ;	// line#=computer.cpp:616,668
assign	U_26 = ( U_10 & M_157 ) ;	// line#=computer.cpp:616,668
assign	U_28 = ( U_10 & M_164 ) ;	// line#=computer.cpp:616,668
assign	U_29 = ( U_10 & M_168 ) ;	// line#=computer.cpp:616,668
assign	M_178 = ~|( { 29'h00000000 , imem_arg_MEMB32W65536_RD1 [14:12] } ^ 32'h00000002 ) ;	// line#=computer.cpp:616,668,681,692,711
assign	U_31 = ( U_11 & M_172 ) ;	// line#=computer.cpp:616,681
assign	U_32 = ( U_11 & M_157 ) ;	// line#=computer.cpp:616,681
assign	U_44 = ( U_13 & M_157 ) ;	// line#=computer.cpp:616,711
assign	U_53 = ( ST1_04d & M_193 ) ;	// line#=computer.cpp:631
assign	U_54 = ( ST1_04d & M_185 ) ;	// line#=computer.cpp:631
assign	U_55 = ( ST1_04d & M_156 ) ;	// line#=computer.cpp:631
assign	U_56 = ( ST1_04d & M_163 ) ;	// line#=computer.cpp:631
assign	U_57 = ( ST1_04d & M_154 ) ;	// line#=computer.cpp:631
assign	U_58 = ( ST1_04d & M_195 ) ;	// line#=computer.cpp:631
assign	U_59 = ( ST1_04d & M_167 ) ;	// line#=computer.cpp:631
assign	U_60 = ( ST1_04d & M_183 ) ;	// line#=computer.cpp:631
assign	U_61 = ( ST1_04d & M_177 ) ;	// line#=computer.cpp:631
assign	U_63 = ( ST1_04d & M_187 ) ;	// line#=computer.cpp:631
assign	U_64 = ( ST1_04d & M_189 ) ;	// line#=computer.cpp:631
assign	M_154 = ~|( RG_09 ^ 32'h00000063 ) ;	// line#=computer.cpp:631
assign	M_156 = ~|( RG_09 ^ 32'h0000006f ) ;	// line#=computer.cpp:631
assign	M_163 = ~|( RG_09 ^ 32'h00000067 ) ;	// line#=computer.cpp:631
assign	M_167 = ~|( RG_09 ^ 32'h00000023 ) ;	// line#=computer.cpp:631
assign	M_177 = ~|( RG_09 ^ 32'h00000033 ) ;	// line#=computer.cpp:631
assign	M_183 = ~|( RG_09 ^ 32'h00000013 ) ;	// line#=computer.cpp:631
assign	M_185 = ~|( RG_09 ^ 32'h00000017 ) ;	// line#=computer.cpp:631
assign	M_187 = ~|( RG_09 ^ 32'h00000073 ) ;	// line#=computer.cpp:631
assign	M_189 = ~|( RG_09 ^ 32'h0000000b ) ;	// line#=computer.cpp:631
assign	M_193 = ~|( RG_09 ^ 32'h00000037 ) ;	// line#=computer.cpp:631
assign	M_195 = ~|( RG_09 ^ 32'h00000003 ) ;	// line#=computer.cpp:631
assign	M_199 = ~|( RG_09 ^ 32'h0000000f ) ;	// line#=computer.cpp:631
assign	U_65 = ( ST1_04d & ( ~( ( ( ( ( ( ( ( ( ( ( M_193 | M_185 ) | M_156 ) | M_163 ) | 
	M_154 ) | M_195 ) | M_167 ) | M_183 ) | M_177 ) | M_199 ) | M_187 ) | M_189 ) ) ) ;	// line#=computer.cpp:631
...
assign	U_69 = ( U_56 & M_200 ) ;	// line#=computer.cpp:647
assign	U_70 = ( U_57 & take_t1 ) ;	// line#=computer.cpp:662
assign	M_158 = ~|( RG_addr1_next_pc_PC ^ 32'h00000001 ) ;	// line#=computer.cpp:668,692,744
assign	M_165 = ~|( RG_addr1_next_pc_PC ^ 32'h00000004 ) ;	// line#=computer.cpp:668
assign	M_169 = ~|( RG_addr1_next_pc_PC ^ 32'h00000005 ) ;	// line#=computer.cpp:668,692,711
assign	M_173 = ~|RG_addr1_next_pc_PC ;	// line#=computer.cpp:668,692,711
assign	M_179 = ~|( RG_addr1_next_pc_PC ^ 32'h00000002 ) ;	// line#=computer.cpp:668
assign	M_200 = |RG_rd [4:0] ;	// line#=computer.cpp:647,675,706,725
assign	U_78 = ( U_58 & M_200 ) ;	// line#=computer.cpp:675
assign	U_79 = ( U_59 & M_174 ) ;	// line#=computer.cpp:681
assign	U_80 = ( U_59 & M_159 ) ;	// line#=computer.cpp:681
assign	M_159 = ~|( RG_rd ^ 32'h00000001 ) ;	// line#=computer.cpp:681
assign	M_174 = ~|RG_rd ;	// line#=computer.cpp:681
assign	M_180 = ~|( RG_rd ^ 32'h00000002 ) ;	// line#=computer.cpp:681
assign	U_83 = ( U_60 & M_173 ) ;	// line#=computer.cpp:692
assign	U_89 = ( U_60 & M_158 ) ;	// line#=computer.cpp:692
assign	U_93 = ( U_60 & M_200 ) ;	// line#=computer.cpp:706
assign	U_94 = ( U_61 & M_173 ) ;	// line#=computer.cpp:711
assign	M_175 = ~RG_imm1_instr_word_addr [23] ;	// line#=computer.cpp:701,702,703,718,719
						// ,720
assign	U_104 = ( U_61 & M_200 ) ;	// line#=computer.cpp:725
assign	U_105 = ( U_64 & M_158 ) ;	// line#=computer.cpp:744
assign	U_107 = ( U_105 & FF_take ) ;	// line#=computer.cpp:747
always @ ( imem_arg_MEMB32W65536_RD1 or M_188 or M_176 or M_182 or M_194 or add32s1ot or 
	M_166 )
	begin
	TR_01_c1 = ( ( ( M_194 | M_182 ) | M_176 ) | M_188 ) ;	// line#=computer.cpp:616,668,692,711,744
	TR_01 = ( ( { 14{ M_166 } } & add32s1ot [13:0] )					// line#=computer.cpp:52,61,679
		| ( { 14{ TR_01_c1 } } & { 11'h000 , imem_arg_MEMB32W65536_RD1 [14:12] } )	// line#=computer.cpp:616,668,692,711,744
		) ;
	end
always @ ( RG_addr1_next_pc_PC or M_110_t or U_57 or M_156 or add32s1ot or U_56 or 
	U_55 or RG_05 or U_65 or U_64 or U_63 or M_199 or U_61 or U_60 or U_59 or 
	...
	RG_addr1_next_pc_PC_t_c2 = ( ST1_04d & ( ( ( ( ( ( ( ( ( U_53 | U_54 ) | 
		U_58 ) | U_59 ) | U_60 ) | U_61 ) | ( ST1_04d & M_199 ) ) | U_63 ) | 
	...
	RG_addr1_next_pc_PC_t = ( ( { 32{ RG_addr1_next_pc_PC_t_c1 } } & { 18'h00000 , 
		...
		| ( { 32{ RG_addr1_next_pc_PC_t_c3 } } & { add32s1ot [31:1] , ( M_156 & 
			add32s1ot [0] ) } )				// line#=computer.cpp:52,56,75,642,646
									// ,648
		| ( { 32{ RG_addr1_next_pc_PC_t_c4 } } & { M_110_t , RG_addr1_next_pc_PC [0] } ) ) ;
	end
...
always @ ( posedge CLOCK )	// line#=computer.cpp:629
	if ( RG_05_en )
		RG_05 <= addsub32u1ot ;
always @ ( lsft32u1ot or M_157 or regs_rd01 or M_170 or M_190 or M_168 or M_164 or 
	M_172 )	// line#=computer.cpp:616,711
	begin
	RG_op1_result1_t_c1 = ( ( ( ( M_172 | M_164 ) | M_168 ) | M_190 ) | M_170 ) ;	// line#=computer.cpp:710
	RG_op1_result1_t = ( ( { 32{ RG_op1_result1_t_c1 } } & regs_rd01 )	// line#=computer.cpp:710
		| ( { 32{ M_157 } } & lsft32u1ot )				// line#=computer.cpp:713
		) ;
	end
always @ ( posedge CLOCK )	// line#=computer.cpp:616,711
	RG_op1_result1 <= RG_op1_result1_t ;	// line#=computer.cpp:710,713
assign	M_196 = ~|( { 29'h00000000 , imem_arg_MEMB32W65536_RD1 [14:12] } ^ 32'h00000003 ) ;	// line#=computer.cpp:616,692,711
assign	M_202 = ( regs_rd00 ^ regs_rd01 ) ;	// line#=computer.cpp:655,656
always @ ( incr3s1ot or ST1_05d or U_16 or comp32u_12ot or comp32s_11ot or U_13 or 
	comp32u_13ot or M_196 or comp32s_1_11ot or M_178 or U_12 or M_170 or comp32u_11ot or 
	M_190 or M_168 or comp32s_12ot or M_164 or M_157 or M_202 or M_172 or U_09 or 
	imem_arg_MEMB32W65536_RD1 or M_155 or M_184 or M_192 or ST1_03d )	// line#=computer.cpp:616,623,631,654,692
										// ,711
	begin
	FF_take_t_c1 = ( ( ( ST1_03d & M_192 ) | ( ST1_03d & M_184 ) ) | ( ST1_03d & 
		M_155 ) ) ;	// line#=computer.cpp:616,624,633,637,641
	FF_take_t_c2 = ( U_09 & M_172 ) ;	// line#=computer.cpp:655
	FF_take_t_c3 = ( U_09 & M_157 ) ;	// line#=computer.cpp:656
	FF_take_t_c4 = ( U_09 & M_164 ) ;	// line#=computer.cpp:657
	FF_take_t_c5 = ( U_09 & M_168 ) ;	// line#=computer.cpp:658
	FF_take_t_c6 = ( U_09 & M_190 ) ;	// line#=computer.cpp:659
	FF_take_t_c7 = ( U_09 & M_170 ) ;	// line#=computer.cpp:660
	FF_take_t_c8 = ( U_12 & M_178 ) ;	// line#=computer.cpp:694
	FF_take_t_c9 = ( U_12 & M_196 ) ;	// line#=computer.cpp:695
	FF_take_t_c10 = ( U_13 & M_178 ) ;	// line#=computer.cpp:714
	FF_take_t_c11 = ( U_13 & M_196 ) ;	// line#=computer.cpp:715
	FF_take_t = ( ( { 1{ FF_take_t_c1 } } & ( |imem_arg_MEMB32W65536_RD1 [11:7] ) )	// line#=computer.cpp:616,624,633,637,641
		| ( { 1{ FF_take_t_c2 } } & ( ~|M_202 ) )				// line#=computer.cpp:655
		| ( { 1{ FF_take_t_c3 } } & ( |M_202 ) )				// line#=computer.cpp:656
...
always @ ( posedge CLOCK )	// line#=computer.cpp:616,623,631,654,692
	...
	FF_take <= FF_take_t ;	// line#=computer.cpp:290,616,624,628,633
				...
				// ,694,695,714,715,747
assign	M_217 = ( ( ( ( ( ( ( M_182 & M_168 ) | M_176 ) | M_192 ) | M_184 ) | M_155 ) | 
	M_162 ) | M_153 ) ;	// line#=computer.cpp:616,692
assign	M_226 = ( ( ( ( M_182 & M_172 ) | ( M_182 & M_164 ) ) | ( M_182 & M_190 ) ) | 
	( M_182 & M_170 ) ) ;	// line#=computer.cpp:616,692
always @ ( M_217 or imem_arg_MEMB32W65536_RD1 or M_226 )
	TR_03 = ( ( { 24{ M_226 } } & { imem_arg_MEMB32W65536_RD1 [31] , imem_arg_MEMB32W65536_RD1 [31] , 
		...
		| ( { 24{ M_217 } } & imem_arg_MEMB32W65536_RD1 [30:7] )	// line#=computer.cpp:616
		) ;
always @ ( addsub32u1ot or M_222 or M_227 or TR_03 or imem_arg_MEMB32W65536_RD1 or 
	M_217 or M_226 )	// line#=computer.cpp:616,692
	begin
	RG_imm1_instr_word_addr_t_c1 = ( M_226 | M_217 ) ;	// line#=computer.cpp:52,56,616,689
	RG_imm1_instr_word_addr_t_c2 = ( M_227 | M_222 ) ;	// line#=computer.cpp:113,117,124,128
...
always @ ( posedge CLOCK )	// line#=computer.cpp:616,692
	RG_imm1_instr_word_addr <= RG_imm1_instr_word_addr_t ;	// line#=computer.cpp:52,56,113,117,124
								// ,128,616,689
always @ ( imem_arg_MEMB32W65536_RD1 or M_166 or M_182 or add32s1ot or M_194 )
	begin
	RG_addr_rs2_t_c1 = ( M_182 | M_166 ) ;	// line#=computer.cpp:616,627
	RG_addr_rs2_t = ( ( { 5{ M_194 } } & { 3'h0 , add32s1ot [1:0] } )		// line#=computer.cpp:52,56,666
...
always @ ( M_166 or M_153 or imem_arg_MEMB32W65536_RD1 or M_188 or M_176 or M_182 or 
	M_194 or M_162 or M_155 or M_184 or M_192 )	// line#=computer.cpp:616,623,631
	begin
	TR_04_c1 = ( ( ( ( M_192 | M_184 ) | M_155 ) | ( ( ( M_162 | M_194 ) | M_182 ) | 
		M_176 ) ) | M_188 ) ;	// line#=computer.cpp:616,624
	TR_04_c2 = ( M_153 | M_166 ) ;	// line#=computer.cpp:616,654,681
...
always @ ( RG_addr1_next_pc_PC or RG_05 or add32s1ot or take_t1 )	// line#=computer.cpp:662
	begin
	M_110_t_c1 = ~take_t1 ;
	M_110_t = ( ( { 31{ take_t1 } } & add32s1ot [31:1] )	// line#=computer.cpp:662
		| ( { 31{ M_110_t_c1 } } & { RG_05 [31:2] , RG_addr1_next_pc_PC [1] } ) ) ;
	end
assign	JF_02 = ~( ( M_189 & M_158 ) & FF_take ) ;
assign	JF_03 = ~incr3s1ot [2] ;	// line#=computer.cpp:290
...
always @ ( RG_addr1_next_pc_PC or U_55 or U_70 or regs_rd02 or U_56 or U_83 or regs_rd00 or 
	...
	add32s1i1 = ( ( { 32{ M_205 } } & regs_rd00 )			// line#=computer.cpp:52,56,61,666,679
...
always @ ( M_194 or imem_arg_MEMB32W65536_RD1 or M_166 )
	TR_05 = ( ( { 5{ M_166 } } & imem_arg_MEMB32W65536_RD1 [11:7] )		// line#=computer.cpp:52,60,61,616,624
										// ,628,679
		| ( { 5{ M_194 } } & imem_arg_MEMB32W65536_RD1 [24:20] )	// line#=computer.cpp:52,56,616,627,666
		) ;
always @ ( M_163 or RG_imm1_instr_word_addr or M_201 )
	M_232 = ( ( { 6{ M_201 } } & { RG_imm1_instr_word_addr [0] , RG_imm1_instr_word_addr [4:1] , 
			1'h0 } )										// line#=computer.cpp:52,65,66,67,628,652
														// ,662
		| ( { 6{ M_163 } } & { RG_imm1_instr_word_addr [24] , RG_imm1_instr_word_addr [17:13] } )	// line#=computer.cpp:52,56,627,646
		) ;
assign	M_201 = ( M_154 & take_t1 ) ;
always @ ( M_156 or M_232 or RG_imm1_instr_word_addr or M_163 or M_201 )
	begin
	M_233_c1 = ( M_201 | M_163 ) ;	// line#=computer.cpp:52,56,65,66,67,627
					// ,628,646,652,662
	M_233 = ( ( { 14{ M_233_c1 } } & { RG_imm1_instr_word_addr [24] , RG_imm1_instr_word_addr [24] , 
			RG_imm1_instr_word_addr [24] , RG_imm1_instr_word_addr [24] , 
			RG_imm1_instr_word_addr [24] , RG_imm1_instr_word_addr [24] , 
			RG_imm1_instr_word_addr [24] , RG_imm1_instr_word_addr [24] , 
			M_232 } )					// line#=computer.cpp:52,56,65,66,67,627
									// ,628,646,652,662
		| ( { 14{ M_156 } } & { RG_imm1_instr_word_addr [12:5] , RG_imm1_instr_word_addr [13] , 
			RG_imm1_instr_word_addr [17:14] , 1'h0 } )	// line#=computer.cpp:52,73,74,75,625,627
									// ,642
		) ;
	end
assign	M_205 = ( U_11 | U_10 ) ;
always @ ( M_233 or U_55 or U_56 or U_70 or RG_imm1_instr_word_addr or U_83 or TR_05 or 
	imem_arg_MEMB32W65536_RD1 or M_205 )
	begin
	add32s1i2_c1 = ( ( U_70 | U_56 ) | U_55 ) ;	// line#=computer.cpp:52,56,65,66,67,73
							// ,74,75,625,627,628,642,646,652
							// ,662
	add32s1i2 = ( ( { 21{ M_205 } } & { imem_arg_MEMB32W65536_RD1 [31] , imem_arg_MEMB32W65536_RD1 [31] , 
			imem_arg_MEMB32W65536_RD1 [31] , imem_arg_MEMB32W65536_RD1 [31] , 
			imem_arg_MEMB32W65536_RD1 [31] , imem_arg_MEMB32W65536_RD1 [31] , 
			imem_arg_MEMB32W65536_RD1 [31] , imem_arg_MEMB32W65536_RD1 [31] , 
		...
		| ( { 21{ add32s1i2_c1 } } & { RG_imm1_instr_word_addr [24] , M_233 [13:5] , 
			RG_imm1_instr_word_addr [23:18] , M_233 [4:0] } )			// line#=computer.cpp:52,56,65,66,67,73
												// ,74,75,625,627,628,642,646,652
												// ,662
		) ;
	end
always @ ( regs_rd03 or M_159 )
	TR_13 = ( { 8{ M_159 } } & regs_rd03 [15:8] )	// line#=computer.cpp:131,683
		 ;	// line#=computer.cpp:120,682
always @ ( regs_rd03 or TR_13 or M_209 or regs_rd02 or U_89 or regs_rd01 or U_44 )
	lsft32u1i1 = ( ( { 32{ U_44 } } & regs_rd01 )				// line#=computer.cpp:710,713
		| ( { 32{ U_89 } } & regs_rd02 )				// line#=computer.cpp:699
		| ( { 32{ M_209 } } & { 16'h0000 , TR_13 , regs_rd03 [7:0] } )	// line#=computer.cpp:120,131,682,683
		) ;
assign	M_209 = ( U_80 | U_79 ) ;
always @ ( RG_addr1_next_pc_PC or M_209 or RG_addr_rs2 or U_89 or regs_rd00 or U_44 )
	lsft32u1i2 = ( ( { 5{ U_44 } } & regs_rd00 [4:0] )			// line#=computer.cpp:710,713
		| ( { 5{ U_89 } } & RG_addr_rs2 )				// line#=computer.cpp:699
		| ( { 5{ M_209 } } & { RG_addr1_next_pc_PC [1:0] , 3'h0 } )	// line#=computer.cpp:118,119,120,129,130
										// ,131,682,683
		) ;
always @ ( dmem_arg_MEMB32W4096_RD1 or M_224 or regs_rd02 or M_228 or RG_op1_result1 or 
	M_229 )
	rsft32u1i1 = ( ( { 32{ M_229 } } & RG_op1_result1 )		// line#=computer.cpp:718,719,720
		| ( { 32{ M_228 } } & regs_rd02 )			// line#=computer.cpp:701,702,703
		| ( { 32{ M_224 } } & dmem_arg_MEMB32W4096_RD1 )	// line#=computer.cpp:90,91,100,101,669
									// ,670,672,673
		) ;
assign	M_224 = ( ( ( ( M_195 & M_169 ) | ( M_195 & M_165 ) ) | ( M_195 & M_158 ) ) | 
	( M_195 & M_173 ) ) ;
assign	M_228 = ( ( M_183 & M_169 ) & M_175 ) ;
assign	M_229 = ( ( M_177 & M_169 ) & M_175 ) ;
always @ ( M_224 or RG_addr_rs2 or M_228 or RG_op2 or M_229 )
	rsft32u1i2 = ( ( { 5{ M_229 } } & RG_op2 [4:0] )		// line#=computer.cpp:718,719,720
		| ( { 5{ M_228 } } & RG_addr_rs2 )			// line#=computer.cpp:701,702,703
		| ( { 5{ M_224 } } & { RG_addr_rs2 [1:0] , 3'h0 } )	// line#=computer.cpp:90,91,100,101,669
									// ,670,672,673
		) ;
always @ ( regs_rd02 or M_183 or RG_op1_result1 or M_177 )
	rsft32s1i1 = ( ( { 32{ M_177 } } & RG_op1_result1 )	// line#=computer.cpp:718,719,720
		| ( { 32{ M_183 } } & regs_rd02 )		// line#=computer.cpp:701,702,703
		) ;
always @ ( RG_addr_rs2 or M_183 or RG_op2 or M_177 )
	rsft32s1i2 = ( ( { 5{ M_177 } } & RG_op2 [4:0] )	// line#=computer.cpp:718,719,720
		| ( { 5{ M_183 } } & RG_addr_rs2 )		// line#=computer.cpp:701,702,703
		) ;
always @ ( RG_op1_result1 or U_94 or add32s1ot or U_25 or U_26 or U_28 or U_29 or 
	M_207 or RG_addr1_next_pc_PC or M_204 )
	begin
	addsub32u1i1_c1 = ( M_207 | ( ( ( U_29 | U_28 ) | U_26 ) | U_25 ) ) ;	// line#=computer.cpp:52,56,61,85,95,113
										// ,124,666,679
	addsub32u1i1 = ( ( { 32{ M_204 } } & RG_addr1_next_pc_PC )	// line#=computer.cpp:70,629,637
		| ( { 32{ addsub32u1i1_c1 } } & add32s1ot )		// line#=computer.cpp:52,56,61,85,95,113
									// ,124,666,679
		| ( { 32{ U_94 } } & RG_op1_result1 )			// line#=computer.cpp:712
		) ;
	end
always @ ( M_206 or RG_imm1_instr_word_addr or U_67 )
	TR_14 = ( ( { 20{ U_67 } } & RG_imm1_instr_word_addr [24:5] )	// line#=computer.cpp:70,637
		| ( { 20{ M_206 } } & 20'h00040 )			// line#=computer.cpp:85,95,113,124
		) ;
always @ ( U_01 or TR_14 or M_206 or U_67 )
	begin
	M_234_c1 = ( U_67 | M_206 ) ;	// line#=computer.cpp:70,85,95,113,124
					// ,637
	M_234 = ( ( { 21{ M_234_c1 } } & { TR_14 , 1'h0 } )	// line#=computer.cpp:70,85,95,113,124
								// ,637
		| ( { 21{ U_01 } } & 21'h000001 )		// line#=computer.cpp:629
		) ;
	end
assign	M_204 = ( U_67 | U_01 ) ;
always @ ( RG_op2 or U_94 or M_234 or M_206 or M_204 )
	begin
	addsub32u1i2_c1 = ( M_204 | M_206 ) ;	// line#=computer.cpp:70,85,95,113,124
						// ,629,637
	addsub32u1i2 = ( ( { 32{ addsub32u1i2_c1 } } & { M_234 [20:1] , 9'h000 , 
			M_234 [0] , 2'h0 } )	// line#=computer.cpp:70,85,95,113,124
						// ,629,637
		| ( { 32{ U_94 } } & RG_op2 )	// line#=computer.cpp:712
		) ;
	end
assign	M_207 = ( U_32 | U_31 ) ;
assign	M_206 = ( ( ( ( M_207 | U_29 ) | U_28 ) | U_26 ) | U_25 ) ;
always @ ( RG_imm1_instr_word_addr )	// line#=computer.cpp:712
	...
	endcase
always @ ( addsub32u1_f_t1 or U_94 or M_206 or M_204 )
	addsub32u1_f = ( ( { 2{ M_204 } } & 2'h1 )
		| ( { 2{ M_206 } } & 2'h2 )
...
always @ ( M_159 )
	M_231 = ( { 8{ M_159 } } & 8'hff )	// line#=computer.cpp:130
		 ;	// line#=computer.cpp:119
assign	lsft32u_321i1 = { M_231 , 8'hff } ;
...
assign	M_225 = ( M_174 | M_159 ) ;	// line#=computer.cpp:681
always @ ( regs_rd03 or M_180 or lsft32u1ot or lsft32u_321ot or dmem_arg_MEMB32W4096_RD1 or 
	M_225 )
	dmem_arg_MEMB32W4096_WD2 = ( ( { 32{ M_225 } } & ( ( dmem_arg_MEMB32W4096_RD1 & ( 
			~lsft32u_321ot ) ) | lsft32u1ot ) )	// line#=computer.cpp:119,120,130,131,682
								// ,683
		| ( { 32{ M_180 } } & regs_rd03 )		// line#=computer.cpp:139
		) ;
assign	M_222 = ( M_166 & M_157 ) ;	// line#=computer.cpp:616,692
assign	M_227 = ( M_166 & M_172 ) ;	// line#=computer.cpp:616,692
always @ ( addsub32u1ot or M_222 or M_227 or M_168 or M_164 or M_157 or M_172 or 
	add32s1ot or M_178 or M_194 )
	begin
	dmem_arg_MEMB32W4096_RA1_c1 = ( M_194 & M_178 ) ;	// line#=computer.cpp:52,56,105,109,666
								// ,671
	dmem_arg_MEMB32W4096_RA1_c2 = ( ( ( ( ( ( M_194 & M_172 ) | ( M_194 & M_157 ) ) | 
		( M_194 & M_164 ) ) | ( M_194 & M_168 ) ) | M_227 ) | M_222 ) ;	// line#=computer.cpp:85,89,91,95,99,101
...
always @ ( RG_addr1_next_pc_PC or M_180 or RG_imm1_instr_word_addr or M_225 )
	dmem_arg_MEMB32W4096_WA2 = ( ( { 12{ M_225 } } & RG_imm1_instr_word_addr [11:0] )	// line#=computer.cpp:119,120,130,131
		| ( { 12{ M_180 } } & RG_addr1_next_pc_PC [13:2] )				// line#=computer.cpp:135,139
		) ;
assign	dmem_arg_MEMB32W4096_RE1 = ( ( ( ( ( ( ( U_10 & M_178 ) | U_25 ) | U_26 ) | 
	U_28 ) | U_29 ) | U_31 ) | U_32 ) ;	// line#=computer.cpp:91,101,109,120,131
						// ,616,668,669,670,671,672,673
assign	dmem_arg_MEMB32W4096_WE2 = ( ( U_79 | U_80 ) | ( U_59 & M_180 ) ) ;	// line#=computer.cpp:119,120,130,131,139
										// ,681
always @ ( M_210 or M_212 or M_213 or M_214 or M_215 or M_216 or M_194 or M_166 or 
	M_178 or M_196 or M_182 or imem_arg_MEMB32W65536_RD1 or M_176 )
	begin
	regs_ad00_c1 = ( ( ( ( ( ( ( ( ( ( M_182 & M_196 ) | ( M_182 & M_178 ) ) | 
		M_166 ) | M_194 ) | M_216 ) | M_215 ) | M_214 ) | M_213 ) | M_212 ) | 
		M_210 ) ;	// line#=computer.cpp:616,626
	regs_ad00 = ( ( { 5{ M_176 } } & imem_arg_MEMB32W65536_RD1 [24:20] )	// line#=computer.cpp:616
		| ( { 5{ regs_ad00_c1 } } & imem_arg_MEMB32W65536_RD1 [19:15] )	// line#=computer.cpp:616,626
		) ;
	end
assign	M_210 = ( M_153 & M_172 ) ;
assign	M_212 = ( M_153 & M_157 ) ;
assign	M_213 = ( M_153 & M_164 ) ;
assign	M_214 = ( M_153 & M_168 ) ;
assign	M_215 = ( M_153 & M_190 ) ;
assign	M_216 = ( M_153 & M_170 ) ;
always @ ( M_210 or M_212 or M_213 or M_214 or M_215 or M_216 or imem_arg_MEMB32W65536_RD1 or 
	M_176 )
	begin
	regs_ad01_c1 = ( ( ( ( ( M_216 | M_215 ) | M_214 ) | M_213 ) | M_212 ) | 
		M_210 ) ;	// line#=computer.cpp:616
	regs_ad01 = ( ( { 5{ M_176 } } & imem_arg_MEMB32W65536_RD1 [19:15] )	// line#=computer.cpp:616,626
		| ( { 5{ regs_ad01_c1 } } & imem_arg_MEMB32W65536_RD1 [24:20] )	// line#=computer.cpp:616
		) ;
	end
always @ ( RG_01 or ST1_06d or RG_rd or M_208 )
	regs_ad04 = ( ( { 5{ M_208 } } & RG_rd [4:0] )	// line#=computer.cpp:70,633,637,641,647
							// ,675,706,725,748
		| ( { 5{ ST1_06d } } & RG_01 )		// line#=computer.cpp:292,293,294,295
		) ;
assign	M_171 = ~|( RG_addr1_next_pc_PC ^ 32'h00000007 ) ;
assign	M_191 = ~|( RG_addr1_next_pc_PC ^ 32'h00000006 ) ;
assign	M_197 = ~|( RG_addr1_next_pc_PC ^ 32'h00000003 ) ;
always @ ( rsft32u1ot or rsft32s1ot or RG_imm1_instr_word_addr )	// line#=computer.cpp:701,702,703
	...
	default :
		TR_16 = 32'hx ;
	endcase
always @ ( bytes_rg00 or bytes_rg01 or bytes_rg02 or bytes_rg03 or ST1_06d or U_66 or 
	RG_op2 or RG_op1_result1 or M_158 or addsub32u1ot or U_67 or U_94 or RG_05 or 
	U_68 or U_69 or TR_16 or M_169 or lsft32u1ot or U_89 or M_171 or M_191 or 
	RG_imm1_instr_word_addr or M_165 or TR_15 or U_61 or U_104 or M_197 or M_179 or 
	U_60 or add32s1ot or U_83 or U_93 or regs_rd02 or U_107 or val2_t4 or U_78 )	// line#=computer.cpp:692,711
	begin
	regs_wd04_c1 = ( U_93 & U_83 ) ;	// line#=computer.cpp:693
	regs_wd04_c2 = ( ( ( ( U_93 & ( U_60 & M_179 ) ) | ( U_93 & ( U_60 & M_197 ) ) ) | 
		( U_104 & ( U_61 & M_179 ) ) ) | ( U_104 & ( U_61 & M_197 ) ) ) ;
	regs_wd04_c3 = ( U_93 & ( U_60 & M_165 ) ) ;	// line#=computer.cpp:696
	regs_wd04_c4 = ( U_93 & ( U_60 & M_191 ) ) ;	// line#=computer.cpp:697
	regs_wd04_c5 = ( U_93 & ( U_60 & M_171 ) ) ;	// line#=computer.cpp:698
	regs_wd04_c6 = ( U_93 & U_89 ) ;	// line#=computer.cpp:699
	regs_wd04_c7 = ( U_93 & ( U_60 & M_169 ) ) ;	// line#=computer.cpp:701,702,703
	regs_wd04_c8 = ( U_69 | U_68 ) ;	// line#=computer.cpp:641,647
	regs_wd04_c9 = ( ( U_104 & U_94 ) | U_67 ) ;	// line#=computer.cpp:70,637,712
	regs_wd04_c10 = ( U_104 & ( U_61 & M_158 ) ) ;	// line#=computer.cpp:713
	regs_wd04_c11 = ( U_104 & ( U_61 & M_165 ) ) ;	// line#=computer.cpp:716
	regs_wd04_c12 = ( U_104 & ( U_61 & M_191 ) ) ;	// line#=computer.cpp:722
	regs_wd04_c13 = ( U_104 & ( U_61 & M_171 ) ) ;	// line#=computer.cpp:723
	regs_wd04_c14 = ( U_104 & ( U_61 & M_169 ) ) ;	// line#=computer.cpp:718,719,720
...
assign	M_208 = ( ( ( ( ( ( ( U_78 | U_107 ) | U_93 ) | U_69 ) | U_104 ) | U_67 ) | 
	U_68 ) | U_66 ) ;
assign	regs_we04 = ( M_208 | ST1_06d ) ;	// line#=computer.cpp:70,292,293,294,295
