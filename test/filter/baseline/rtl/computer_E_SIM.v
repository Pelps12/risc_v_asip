...
module MEMB32W40961 ( RA1 ,RD1 ,RE1 ,RCLK1 ,WA2 ,WD2 ,WE2 ,WCLK2 );
input	[11:0]	RA1 ;
output	[31:0]	RD1 ;
input		RE1 ;
input		RCLK1 ;
...
MEMB32W40961_sub INST_MEMB32W40961_sub_1 ( .RD1(RD1) ,.RE1(RE1) ,.WE2(WE2) ,.WD2(WD2) ,
	.RA1(RA1) ,.WA2(WA2) ,.RCLK1(RCLK1) ,.WCLK2(WCLK2) );

endmodule

module MEMB32W40961_sub ( RD1 ,RE1 ,WE2 ,WD2 ,RA1 ,WA2 ,RCLK1 ,WCLK2 );
output	[31:0]	RD1 ;
input		RE1 ;
input		WE2 ;
input	[31:0]	WD2 ;
