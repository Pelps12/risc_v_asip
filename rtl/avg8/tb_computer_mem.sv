// ============================================================================
// Testbench for HLS-generated avg8 computer module (MEM-style dmem).
// avg8 uses MEM_SIZE=4096 → MEMB32W4096 port names.
// ============================================================================
...
`endif
  ...
  // Parameters
  // --------------------------------------------------------------------------
  parameter IMEM_SIZE  = 4096;  // 4K words (MEM_SIZE in avg8/computer.cpp)
  ...
  reg [31:0] dmem [0:DMEM_SIZE-1];  // loaded but internal to DUT
